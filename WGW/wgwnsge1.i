...
DEFINE VAR  nv_modcod  AS CHAR FORMAT "x(8)" INIT "" .       
...
DEFINE VAR  nv_txt1          AS CHAR FORMAT "x(100)"  .
DEFINE VAR  nv_txt2          AS CHAR FORMAT "x(100)"  .
DEFINE VAR  nv_txt3          AS CHAR FORMAT "x(100)"  .
DEFINE VAR  nv_txt4          AS CHAR FORMAT "x(100)"  .
...
DEFINE VAR  np_docno         AS CHAR FORMAT "x(10)"  INIT "".
DEFINE VAR  np_Promotion     AS CHAR FORMAT "x(16)"  INIT "".
DEFINE VAR  nv_numberno      AS DECI INIT 0 FORMAT ">>>9".     
