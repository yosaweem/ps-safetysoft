...
/*Modify by  : Ranu I. A62-0422 12/09/2019 เพิ่มตัวแปรเก็บค่าจากไฟล์แจ้งงานแบบใหม่    */ 
/*Modify by  : Kridtiya i. A63-0209  เพิ่ม Promotion Code ,Product                    */
/*Modify by  : Kridtiya i. A63-0472 Date. 09/11/2020 add field firstname ,lastname.....*/
/*Modify by  : Ranu I. A64-0344 date.07/09/2021 เพิ่มตัวแปรในการคำนวณเบี้ยกลาง */
/*Modify by  : Ranu I. A64-0138 เพิ่มตัวแปรเก็บค่าการคำนวณเบี้ย */
/*Modify by  : Ranu I. A65-0156 เพิ่มตัวแปรเก็บข้อมูล comment */
...
DEFINE NEW SHARED TEMP-TABLE wdetail2 NO-UNDO  
   ...
   FIELD claimdi                 AS CHAR FORMAT "x(50)"  INIT ""  /*A63-0209*/
   FIELD product                 AS CHAR FORMAT "x(50)"  INIT ""  /*A63-0209*/
   ...
   FIELD comment                 AS CHAR FORMAT "x(100)" INIT ""   /*A65-0156 */
...
DEFINE NEW SHARED TEMP-TABLE wdetail NO-UNDO
    ...
    /* create by A61-0152 ...*/
     ...
     /* end A61-0152 */
      ...
      /*FIELD remark1     AS CHAR FORMAT "x(100)" INIT ""    /*A58-0489*/*/ /*A66-0252*/
      ...
      FIELD ton         AS CHAR FORMAT "x(5)" INIT ""    /*A61-0152*/
      FIELD memo        AS CHAR FORMAT "x(100)" INIT ""    /*A61-0152*/
      FIELD promotion   AS CHAR FORMAT "x(50)"  INIT ""    /*A63-0209*/
      FIELD product     AS CHAR FORMAT "x(50)"  INIT ""    /*A63-0209*/
      FIELD firstName   AS CHAR FORMAT "x(60)" INIT ""   /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/
      FIELD lastName    AS CHAR FORMAT "x(60)" INIT ""   /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/
