...
DEFINE FRAME fr_main
     ...
     "    IMPORT TEXT FILE MOTOR [KK-RENEWโอนย้าย ภาคสมัครใจ]" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Load Text File KK[renew-โอนย้าย ภาคสมัครใจ]"
         HEIGHT             = 23.76
         WIDTH              = 124.67
         MAX-HEIGHT         = 33.71
         MAX-WIDTH          = 170.67
...
ON END-ERROR OF C-Win /* Load Text File KK[renew-โอนย้าย ภาคสมัครใจ] */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Load Text File KK[renew-โอนย้าย ภาคสมัครใจ] */
DO:
...
REPEAT:
    CREATE wdetail2.
    IMPORT DELIMITER "|" 
        wdetail2.recno           /* 0   ลำดับที่        */
        wdetail2.Notify_dat      /* 1   วันที่รับแจ้ง   */                                       
        wdetail2.recive_dat      /* 2   วันที่รับเงินค่าเบิ้ยประกัน */                           
        wdetail2.comp_code       /* 3   รายชื่อบริษัทประกันภัย  */                               
        wdetail2.cedpol          /* 4   เลขที่สัญญาเช่าซื้อ */                                   
        wdetail2.prepol          /* 5   เลขที่กรมธรรม์เดิม  */                                   
        wdetail2.cmbr_no         /* 6   รหัสสาขา    */                                           
        wdetail2.cmbr_code       /* 7   สาขา KK */                                               
        wdetail2.notifyno        /* 8   เลขรับเเจ้ง */                                           
        wdetail2.campaigno       /* 9   Campaign    */                                           
        wdetail2.campaigsub      /* 10  Sub Campaign    */                                       
        wdetail2.typper          /* 11  บุคคล/นิติบุคคล */                                       
        wdetail2.n_TITLE         /* 12  คำนำหน้าชื่อ    */                                       
        wdetail2.n_name1         /* 13  ชื่อผู้เอาประกัน    */                                   
        wdetail2.n_name2         /* 14  นามสกุลผู้เอาประกัน */                                   
        wdetail2.ADD_1           /* 15  บ้านเลขที่  */                                           
        wdetail2.ADD_2           /* 21  ตำบล/แขวง   */                                           
        wdetail2.ADD_3           /* 22  อำเภอ/เขต   */                                           
        wdetail2.ADD_4           /* 23  จังหวัด */                                               
        wdetail2.ADD_5           /* 24  รหัสไปรษณีย์    */                                       
        wdetail2.cover           /* 25  ประเภทความคุ้มครอง  */                                   
        wdetail2.garage          /* 26  ประเภทการซ่อม   */                                       
        wdetail2.comdat          /* 27  วันเริ่มคุ้มครอง    */                                   
        wdetail2.expdat          /* 28  วันสิ้นสุดคุ้มครอง  */                                   
        wdetail2.subclass        /* 29  รหัสรถ  */                                               
        wdetail2.n_43            /* 30  ประเภทประกันภัยรถยนต์   */                               
        wdetail2.brand           /* 31  ชื่อยี่ห้อรถ    */                                       
        wdetail2.model           /* 32  รุ่นรถ  */                                               
        wdetail2.nSTATUS         /* 33  New/Used    */                                           
        wdetail2.licence         /* 34  เลขทะเบียน  */                                           
        wdetail2.chassis         /* 35  เลขตัวถัง   */                                           
        wdetail2.engine          /* 36  เลขเครื่องยนต์  */                                       
        wdetail2.cyear           /* 37  ปีรถยนต์    */                                           
        wdetail2.power           /* 38  ซีซี    */                                               
        wdetail2.weight          /* 39  น้ำหนัก/ตัน */                                           
        wdetail2.ins_amt1        /* 40  ทุนประกันปี 1   */                                       
        wdetail2.prem1           /* 41  เบี้ยรวมภาษีเเละอากรปี 1    */                           
        wdetail2.ins_amt2        /* 42  ทุนประกันปี 2   */ 
        wdetail2.fi              /* A60-0232 ทุนประกันรถยนต์สูญหาย/ไฟไหม้ ปี2(F&T) */
        wdetail2.prem2           /* 43  เบี้ยรวมภาษีเเละอากรปี 2    */                           
        wdetail2.time_notify     /* 44  เวลารับเเจ้ง    */                                       
        wdetail2.NAME_mkt        /* 45  ชื่อเจ้าหน้าที่ MKT */                                   
        wdetail2.bennam          /* 46  หมายเหตุ    */                                           
        wdetail2.drivno1         /* 47  ผู้ขับขี่ที่ 1 เเละวันเกิด  */                           
        wdetail2.drivno2         /* 48  ผู้ขับขี่ที่ 2 เเละวันเกิด  */                           
        wdetail2.reci_title      /* 49  คำนำหน้าชื่อ (ใบเสร็จ/ใบกำกับภาษี)  */                   
        wdetail2.reci_name1      /* 50  ชื่อ (ใบเสร็จ/ใบกำกับภาษี)  */                           
        wdetail2.reci_name2      /* 51  นามสกุล (ใบเสร็จ/ใบกำกับภาษี)   */                       
        wdetail2.reci_1      /* 52  บ้านเลขที่ (ใบเสร็จ/ใบกำกับภาษี)    */                   
        wdetail2.reci_2          /* 57  ตำบล/แขวง (ใบเสร็จ/ใบกำกับภาษี) */                       
        wdetail2.reci_3          /* 58  อำเภอ/เขต (ใบเสร็จ/ใบกำกับภาษี) */                       
        wdetail2.reci_4          /* 59  จังหวัด (ใบเสร็จ/ใบกำกับภาษี)   */                       
        wdetail2.reci_5          /* 60  รหัสไปรษณีย์ (ใบเสร็จ/ใบกำกับภาษี)  */                   
        wdetail2.ncb             /* 61  ส่วนลดประวัติดี */                                       
        wdetail2.fleet          /* 62  ส่วนลดงาน Fleet */
        /*A60-0232*/
        ...
        /* end : A60-0232*/
        wdetail2.nsend       /*ที่จัดส่ง */ /*A61-0335*/
        wdetail2.sendname    /*ชื่อผู้รับเอกสาร */ /*A61-0335*/
        wdetail2.bennefit    /*ผู้รับผลประโยชน์ */ /*A61-0335*/
...
FOR EACH wdetail2 .
    ...
    ELSE DO:
        ...
        ELSE DO: 
            ...
            ELSE ASSIGN
                wdetail2.ADD_2 = IF trim(wdetail2.ADD_2) = "" THEN "" ELSE "ตำบล"  + trim(wdetail2.ADD_2)
                wdetail2.ADD_3 = IF trim(wdetail2.ADD_3) = "" THEN "" ELSE "อำเภอ" + trim(wdetail2.ADD_3) 
...
FOR EACH wdetail2 .
    IF wdetail2.cedpol NE "" THEN DO:
        ...
        ELSE IF index(n_vehpro,"อุทัยธานี")        <> 0 THEN wdetail2.licence = SUBSTR(wdetail2.licence,1,index(n_vehpro,"อุทัยธานี") - 2 )     + " อน".    /*70*/
    ...
    IF wdetail2.cedpol NE "" THEN DO:
        ...
        IF NOT AVAIL wdetail THEN DO:
            ...
            ASSIGN
                ...
                wdetail.vehuse      = "1"
              /*wdetail.garage      = IF index(trim(wdetail2.garage),"ห้าง") = 0 THEN " " ELSE "G"*//*A55-0104*/
                ...
                wdetail.prempa      = IF      (index(wdetail2.cover,"1") <> 0 ) AND ((index(wdetail2.garage,"ห้าง") <> 0 ) ) THEN fi_pack
                ...
                wdetail.n_IMPORT    = "IM"
                wdetail.n_EXPORT    = ""  
                wdetail.nmember     = "เลขรับเเจ้ง[REKK] : " + wdetail2.notifyno + "ชื่อเจ้าหน้าที่ MKT: " + trim(wdetail2.NAME_mkt)
                /* A60-0232 */
                ...
                wdetail.bennefit    = trim(wdetail2.bennefit)    /*ผู้รับผลประโยชน์ */ /*A61-0335*/
...
IF wdetail.branch <> nv_brchk THEN 
    ASSIGN 
    wdetail.comment = wdetail.comment + "สาขาจากไฟล์แจ้งงาน: " + wdetail.branch + " ไม่ตรงกับสาขากรมธรรม์เดิม: "  +  nv_brchk 
    wdetail.pass    = "Y" .
/*end....Add A55-0016..... */
/* add by A63-0130 */
...
IF NOT AVAILABLE uwm130 THEN 
    ...
    ELSE nv_newsck =  wdetail.stk.
         ...
         ASSIGN
             ...
             sic_bran.uwm301.body      = wdetail.body
             sic_bran.uwm301.seats     = INTEGER(wdetail.seat)
             /*sic_bran.uwm301.mv_ben83  = IF INDEX(wdetail.benname,"ปรกติ")  <> 0 THEN "ธนาคาร เกียรตินาคิน จำกัด (มหาชน)" ELSE ""*/ /*A61-0335*/
...
DO WHILE nv_line1 <= 15: /*A60-0232*/
    ...
    IF nv_line1 = 2  THEN wuppertxt3.txt = "เลขที่สัญญาเช่าซื้อ : " + substr(wdetail.cedpol,1,LENGTH(wdetail.cedpol) - 4 ) .
    ...
    IF nv_line1 = 6  THEN wuppertxt3.txt = "เบอร์ติดต่อ : " + wdetail.phone  + "  " + "เลขประจำตัวผู้เสียภาษี : " + wdetail.tax.         /*A60-0232*/
    IF nv_line1 = 7  THEN wuppertxt3.txt = "วันเดือนปีเกิด : " + wdetail.bdate .                                                         /*A60-0232*/
    IF nv_line1 = 8  THEN wuppertxt3.txt = "อาชีพ : " + wdetail.occup + "  " + "สถานภาพ : " + wdetail.cstatus.                           /*A60-0232*/
    IF nv_line1 = 9  THEN wuppertxt3.txt = "ชื่อกรรมการ 1 : " + wdetail.tname1 + " " + wdetail.cname1 + " " + wdetail.lname1 + " " +     /*A60-0232*/
                                           "ICNO1 :" + wdetail.icno1.                                                                    /*A60-0232*/
    IF nv_line1 = 10 THEN wuppertxt3.txt = "ชื่อกรรมการ 2 : " + wdetail.tname2 + " " + wdetail.cname2 + " " + wdetail.lname2 + " " +     /*A60-0232*/
                                           "ICNO2 :" + wdetail.icno2.                                                                    /*A60-0232*/
    IF nv_line1 = 11 THEN wuppertxt3.txt = "ชื่อกรรมการ 3 : " + wdetail.tname3 + " " + wdetail.cname3 + " " + wdetail.lname3 + " " +     /*A60-0232*/
                                           "ICNO3 :" + wdetail.icno3.                                                                    /*A60-0232*/
    IF nv_line1 = 12 THEN wuppertxt3.txt = "จัดส่งเอกสารที่สาขา: " + wdetail.nsend + " ชื่อผู้รับเอกสาร: " + wdetail.sendname .   /*A61-0335*/
    IF nv_line1 = 13 THEN wuppertxt3.txt = "เลขที่สัญญา : " + wdetail.cedpol.                                                   /*A61-0335*/
