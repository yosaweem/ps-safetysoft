...
buCANCEL br_QueueRequest fi_notfound fi_notfound2 rd_SystemExt ~
fi_TextRemark fi_company RECT-4 
&Scoped-Define DISPLAYED-OBJECTS fi_output fi_ResponseJob fi_waitcount ~
fi_notfound fi_notfound2 rd_SystemExt fi_TextRemark fi_company 
...
DEFINE FRAME DEFAULT-FRAME
     fi_output AT ROW 4.14 COL 23.33 COLON-ALIGNED NO-LABEL WIDGET-ID 182
     ...
     br_QueueRequest AT ROW 8.91 COL 1.5 WIDGET-ID 200
     fi_notfound AT ROW 7.24 COL 5.67 COLON-ALIGNED NO-LABEL WIDGET-ID 20
     fi_notfound2 AT ROW 8 COL 5.67 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     rd_SystemExt AT ROW 2.62 COL 63 NO-LABEL WIDGET-ID 64
     fi_TextRemark AT ROW 6.1 COL 2.83 NO-LABEL WIDGET-ID 180
     fi_company AT ROW 2.43 COL 39.17 COLON-ALIGNED NO-LABEL WIDGET-ID 188
     "      Queue Export PDF  ON WEB SERVICES [TESCO LOTUS]" VIEW-AS TEXT
          SIZE 60 BY .71 AT ROW 1.33 COL 35.5 WIDGET-ID 166
     ...
     "OutPut Path :" VIEW-AS TEXT
          ...
          FONT 6
     "ตัวอย่าง :        D:~\TGIB                   *** [TESCO LOTUS]" VIEW-AS TEXT
          SIZE 53.5 BY .81 AT ROW 5.19 COL 11.83 WIDGET-ID 186
          BGCOLOR 8 FGCOLOR 1 FONT 6
     RECT-6 AT ROW 1.14 COL 1.5 WIDGET-ID 162
     RECT-4 AT ROW 6.95 COL 3.17 WIDGET-ID 138
...
OPEN QUERY {&SELF-NAME}
    FOR EACH ExtPDFLKT70 WHERE
             ExtPDFLKT70.SystemRq   = fi_ResponseJob
         AND ExtPDFLKT70.text1      = fi_company
NO-LOCK.
     _END_FREEFORM
     _Query            is OPENED
...
ON LEAVE OF fi_company IN FRAME DEFAULT-FRAME
DO:
    fi_company = INPUT fi_company.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  gv_prgid = "WRSBQPDFLT".
  gv_prog  = "Queue Transfer PDF File TESCO LOTUS".
/*
  ...
  DISPLAY fi_ResponseJob  fi_company WITH FRAME DEFAULT-FRAME.
...
------------------------------------------------------------------------------*/
  DISPLAY fi_output fi_ResponseJob fi_waitcount fi_notfound fi_notfound2 
          rd_SystemExt fi_TextRemark fi_company 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE fi_output fi_ResponseJob fi_waitcount buOK buCANCEL br_QueueRequest 
         fi_notfound fi_notfound2 rd_SystemExt fi_TextRemark fi_company RECT-4 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
