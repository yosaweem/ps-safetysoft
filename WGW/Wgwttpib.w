...
/*******************************/                                       
/*programid   : wgwttpib.w                                              */ 
/*programname : Load text file Non-TIL to GW -สำหรับงานต่ออายุ             */ 
/* Copyright  : Safety Insurance Public Company Limited                 */  
/*                            บริษัท ประกันคุ้มภัย จำกัด (มหาชน)        */  
/*create by   : Kridtiya i. A56-0121   date. 16/12/2013              
          ปรับโปรแกรมให้สามารถนำเข้า text file non-TIL-renew to GW system   */
...
&Scoped-Define ENABLED-OBJECTS br_comp ra_typefile fi_loaddat fi_branch ~
...
bu_hpacno72 bu_hpagent72 fi_process fi_prom bu_del bu_add fi_packcom ~
fi_premcomp fi_mocode RECT-370 RECT-372 RECT-373 RECT-374 RECT-376 ~
br_wdetail RECT-377 RECT-378 RECT-379 
&Scoped-Define DISPLAYED-OBJECTS ra_typefile fi_loaddat fi_branch fi_bchno ~
...
fi_completecnt fi_premtot fi_agtname fi_premsuc fi_process fi_prom ~
fi_packcom fi_premcomp fi_mocode 
...
DEFINE VARIABLE fi_mocode AS CHARACTER FORMAT "X(30)":U 
     VIEW-AS FILL-IN 
     SIZE 18 BY .95
     BGCOLOR 15 FGCOLOR 0  NO-UNDO.
...
DEFINE VARIABLE fi_prom AS CHARACTER FORMAT "X(20)":U 
     VIEW-AS FILL-IN 
     SIZE 16 BY .95
     BGCOLOR 15 FGCOLOR 0  NO-UNDO.
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 30.5 BY 6.05
         BGCOLOR 15 FONT 6 ROW-HEIGHT-CHARS .5 EXPANDABLE.
...
DEFINE FRAME fr_main
     br_comp AT ROW 3.86 COL 92.5
     ra_typefile AT ROW 8 COL 24.67 NO-LABEL
     fi_loaddat AT ROW 2.76 COL 31.5 COLON-ALIGNED NO-LABEL
     fi_branch AT ROW 4.86 COL 31.5 COLON-ALIGNED NO-LABEL
     fi_bchno AT ROW 22.57 COL 17 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi_producer AT ROW 5.95 COL 31.5 COLON-ALIGNED NO-LABEL
     fi_agent AT ROW 7 COL 31.5 COLON-ALIGNED NO-LABEL
     fi_prevbat AT ROW 9.05 COL 31.5 COLON-ALIGNED NO-LABEL
     fi_bchyr AT ROW 9.05 COL 67 COLON-ALIGNED NO-LABEL
     fi_filename AT ROW 10.05 COL 31.5 COLON-ALIGNED NO-LABEL
     bu_file AT ROW 10.05 COL 94.5
     fi_output1 AT ROW 11.05 COL 31.5 COLON-ALIGNED NO-LABEL
     fi_output2 AT ROW 12.05 COL 31.5 COLON-ALIGNED NO-LABEL
     fi_output3 AT ROW 13.05 COL 31.5 COLON-ALIGNED NO-LABEL
     fi_usrcnt AT ROW 14.14 COL 31.67 COLON-ALIGNED NO-LABEL
     fi_usrprem AT ROW 14.14 COL 71.33 NO-LABEL
     buok AT ROW 10.91 COL 104.67
     bu_exit AT ROW 12.81 COL 104.67
     fi_brndes AT ROW 4.86 COL 42.33 COLON-ALIGNED NO-LABEL
     bu_hpbrn AT ROW 4.86 COL 40
     fi_impcnt AT ROW 22.29 COL 60.33 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     bu_hpacno72 AT ROW 5.95 COL 49
     bu_hpagent72 AT ROW 7 COL 49
     fi_proname AT ROW 5.95 COL 51.33 COLON-ALIGNED NO-LABEL
     ...
     fi_agtname AT ROW 7 COL 51.33 COLON-ALIGNED NO-LABEL
     fi_premsuc AT ROW 23.33 COL 96.17 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi_process AT ROW 15.24 COL 26 COLON-ALIGNED NO-LABEL
     fi_prom AT ROW 2.76 COL 61.83 COLON-ALIGNED NO-LABEL
     bu_del AT ROW 4.05 COL 124.67
     bu_add AT ROW 2.76 COL 124.67
     fi_packcom AT ROW 2.76 COL 91.5 COLON-ALIGNED NO-LABEL
     fi_premcomp AT ROW 2.76 COL 112 COLON-ALIGNED NO-LABEL
     fi_mocode AT ROW 3.81 COL 61.83 COLON-ALIGNED NO-LABEL
     br_wdetail AT ROW 16.71 COL 2
     "                    Branch  :" VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 4.86 COL 10
          BGCOLOR 3 FGCOLOR 7 FONT 6
     "Batch Year :" VIEW-AS TEXT
          SIZE 12.83 BY .95 AT ROW 9.05 COL 65.83 RIGHT-ALIGNED
          BGCOLOR 3 FGCOLOR 7 FONT 6
     "Batch File Name :" VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 13.05 COL 10
          BGCOLOR 3 FGCOLOR 7 
     "Previous Batch No.  :" VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 9.05 COL 10
          BGCOLOR 3 FGCOLOR 7 FONT 6
     "                Load Date :":35 VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 2.76 COL 10
          BGCOLOR 3 FGCOLOR 7 FONT 6
     "Base comp :" VIEW-AS TEXT
          SIZE 12.5 BY .95 AT ROW 2.76 COL 101
          BGCOLOR 5 FGCOLOR 0 FONT 6
     "Packcomp :" VIEW-AS TEXT
          SIZE 11.5 BY .95 AT ROW 2.76 COL 81.5
          BGCOLOR 5 FGCOLOR 0 FONT 6
     "Model :" VIEW-AS TEXT
          SIZE 8 BY .95 AT ROW 3.81 COL 54.83
          BGCOLOR 3 FGCOLOR 7 FONT 6
     "Prom. :" VIEW-AS TEXT
          SIZE 8 BY .95 AT ROW 2.76 COL 54.83
          BGCOLOR 3 FGCOLOR 7 FONT 6
     "BHT.":60 VIEW-AS TEXT
          SIZE 6 BY 1 AT ROW 22.29 COL 117.17
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Output Data Load :" VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 11.05 COL 10
          BGCOLOR 3 FGCOLOR 7 
...
DEFINE FRAME fr_main
     ...
     "   Total Net Premium  :" VIEW-AS TEXT
          ...
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "                                   IMPORT TEXT FILE RENEW ต่ออายุ NON TIL-TPIB" VIEW-AS TEXT
     ...
     RECT-379 AT ROW 2.57 COL 123.5
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 133 BY 24
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW c-Win ASSIGN
         HIDDEN             = YES
         TITLE              = " IMPORT TEXT FILE RENEW ต่ออายุ NON TIL-TPIB"
         HEIGHT             = 24
         WIDTH              = 133.17
         MAX-HEIGHT         = 33.71
         MAX-WIDTH          = 170.67
...
/* SETTINGS FOR FILL-IN fi_usrprem IN FRAME fr_main
   ALIGN-L                                                              */
/* SETTINGS FOR TEXT-LITERAL "                                   IMPORT TEXT FILE RENEW ต่ออายุ NON TIL-TPIB"
          SIZE 128 BY .95 AT ROW 1.29 COL 129.5 RIGHT-ALIGNED           */
...
ON END-ERROR OF c-Win /*  IMPORT TEXT FILE RENEW ต่ออายุ NON TIL-TPIB */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-Win c-Win
ON WINDOW-CLOSE OF c-Win /*  IMPORT TEXT FILE RENEW ต่ออายุ NON TIL-TPIB */
DO:
...
DO:
    ...
    ELSE IF ra_typefile = 3 THEN RUN proc_matfileloadstk.
    ELSE DO:
        ASSIGN
...
/********************  T I T L E   F O R  C - W I N  ****************/
  ...
  gv_prgid = "wgwttpib".
  gv_prog  = "Load Text & Generate NON-TIL[RENEW]".
  fi_loaddat = TODAY.
  DISP fi_loaddat WITH FRAME fr_main.
  RUN proc_createcomp.
  OPEN QUERY br_comp FOR EACH wcomp.
  ...
  ASSIGN
      ...
      fi_process    = "Load Text file NON-TIL [renew]"    
      ra_typefile   = 1   
      fi_bchyr    = YEAR(TODAY) .
  DISP fi_prom fi_branch fi_mocode fi_producer fi_agent  fi_bchyr ra_typefile fi_process WITH FRAME fr_main.
/*********************************************************************/  
...
------------------------------------------------------------------------------*/
  DISPLAY ra_typefile fi_loaddat fi_branch fi_bchno fi_producer fi_agent 
          ...
          fi_premtot fi_agtname fi_premsuc fi_process fi_prom fi_packcom 
          fi_premcomp fi_mocode 
      WITH FRAME fr_main IN WINDOW c-Win.
  ENABLE br_comp ra_typefile fi_loaddat fi_branch fi_producer fi_agent 
         fi_prevbat fi_bchyr fi_filename bu_file fi_output1 fi_output2 
         fi_output3 fi_usrcnt fi_usrprem buok bu_exit bu_hpbrn bu_hpacno72 
         bu_hpagent72 fi_process fi_prom bu_del bu_add fi_packcom fi_premcomp 
         fi_mocode RECT-370 RECT-372 RECT-373 RECT-374 RECT-376 br_wdetail 
...
ASSIGN
    ...
    wdetail.compul  = "y"
    wdetail.tariff  = "9" . 
IF length(wdetail.policy) <> 12 THEN 
    ASSIGN wdetail.comment = wdetail.comment + "| เลขกรมธรรม์ไม่เท่ากับ 12 หลักไม่สามารถนำเข้าระบบได้" 
    wdetail.pass    = "N"
    wdetail.OK_GEN  = "N". 
...
IF NOT AVAILABLE sic_bran.uwm130 THEN 
    ...
    ELSE nv_newsck = wdetail.stk.               /*--End Amparat C. A51-0253--*/       
    ...
    IF wdetail.compul = "y" THEN DO:
        ...
        IF NOT AVAIL brstat.Detaitem THEN DO:   
            CREATE brstat.Detaitem.       /*--STR Amparat C. A51-0253---*/
            ASSIGN                                                            
    ...
    IF wdetail.subclass = "110" THEN ASSIGN n_class = "110"  wdetail.subclass = "110".
    ELSE IF (wdetail.subclass = "210") OR (wdetail.subclass = "140A") THEN ASSIGN n_class = "210"  wdetail.subclass = "140A".
    ELSE IF (wdetail.subclass = "210") OR (wdetail.subclass = "140B") THEN ASSIGN n_class = "210"  wdetail.subclass = "140A".
    ELSE IF (wdetail.subclass = "210") OR (wdetail.subclass = "140B") THEN ASSIGN n_class = "210"  wdetail.subclass = "140A".
    ELSE IF (wdetail.subclass = "210") OR (wdetail.subclass = "140D") THEN ASSIGN n_class = "210"  wdetail.subclass = "140A".
    ELSE IF (wdetail.subclass = "320") OR (wdetail.subclass = "120A") THEN ASSIGN n_class = "320"  wdetail.subclass = "120A".
    ELSE IF (wdetail.subclass = "320") OR (wdetail.subclass = "120B") THEN ASSIGN n_class = "320"  wdetail.subclass = "120A".
    ELSE IF (wdetail.subclass = "320") OR (wdetail.subclass = "120B") THEN ASSIGN n_class = "320"  wdetail.subclass = "120A".
    ELSE IF (wdetail.subclass = "320") OR (wdetail.subclass = "120D") THEN ASSIGN n_class = "320"  wdetail.subclass = "120A".
...
/*              stat.maktab_fil.seats    GE  inte(wdetail.seat) */                                          */
        ...
        If  avail stat.maktab_fil  THEN
            ...
            sic_bran.uwm301.moddes  =  stat.maktab_fil.makdes  +  " "  +  stat.maktab_fil.moddes
            sic_bran.uwm301.seats   =  IF (wdetail.seat = "") OR (INT(wdetail.seat) = 0 ) THEN  stat.maktab_fil.seat ELSE INT(wdetail.seat)
    ...
    IF wdetail.redbook  = "" THEN DO:
        FIND LAST sicsyac.xmm102 USE-INDEX xmm10201 WHERE
            sicsyac.xmm102.modest =  wdetail.brand  NO-LOCK NO-ERROR.
        IF AVAIL sicsyac.xmm102 THEN DO:
            ASSIGN
                sic_bran.uwm301.modcod         = sicsyac.xmm102.modcod
                Substring(sic_bran.uwm301.moddes,1,18)   = SUBSTRING(sicsyac.xmm102.modest, 1,18)  /*Thai language*/  
                Substring(sic_bran.uwm301.moddes,19,22)  = SUBSTRING(sicsyac.xmm102.modest,19,22)  /*Thai Language*/
                sic_bran.uwm301.Tons           = sicsyac.xmm102.tons
                sic_bran.uwm301.moddes         = sicsyac.xmm102.modest
                sic_bran.uwm301.seats          = IF (wdetail.seat = "") OR (INT(wdetail.seat) = 0 ) THEN  sicsyac.xmm102.seats
                                                 ELSE INT(wdetail.seat)  
...
DO: 
    ...
    REPEAT:     
        ...
        ELSE DO:
            IF TRIM(np_notino) <> ""  THEN DO:  /* create V70 */
                /*comment by Kridtiya i. A57-0010....
                FIND FIRST brstat.msgcode WHERE      /*mat Title name...*/
                    brstat.msgcode.compno = "999"  AND
                    brstat.msgcode.MsgDesc = TRIM(np_ntitle)  NO-LOCK NO-WAIT NO-ERROR.
                IF AVAIL brstat.msgcode THEN ASSIGN np_ntitle = brstat.msgcode.branch  .
                FIND FIRST brstat.insure USE-INDEX Insure05   WHERE   /*Match Provin.licence  */
                    brstat.insure.compno = "999" AND
                    brstat.Insure.fName  = TRIM(np_Li_Province) NO-LOCK NO-WAIT NO-ERROR.
                IF AVAIL brstat.insure THEN  
                    ASSIGN np_Li_Province = TRIM(brstat.insure.LName) .
                FIND FIRST stat.company USE-INDEX Company01 WHERE 
                    company.compno = TRIM(np_finance_Comp)  NO-LOCK NO-ERROR NO-WAIT.
                IF AVAIL stat.company THEN ASSIGN  np_finance_Comp  = trim(stat.company.name). 
                END.. comment by Kridtiya i. A57-0010.......*/
                RUN proc_cutpolnoti.
                FIND FIRST wdetail WHERE wdetail.policy = TRIM(np_notino)  NO-ERROR NO-WAIT.
                IF NOT AVAIL wdetail THEN DO:
                    CREATE wdetail.
                    ASSIGN
                        wdetail.policy      = caps(TRIM(np_notino)) 
                        ...
                        wdetail.n_EXPORT    = "" 
                        wdetail.pass        = "y"
                        wdetail.f18line1    = trim(np_f18line1)
                        wdetail.f18line2    = trim(np_f18line2)
                        wdetail.f18line3    = trim(np_f18line3)
                        wdetail.f18line4    = trim(np_f18line4).
                ...
                END.
            END.
            IF (np_Compulsory = "") OR (np_Compulsory = "-") OR (deci(np_Compulsory) = 0 )   THEN RUN proc_assigninit. 
            ELSE IF (trim(np_policy72) = "" ) THEN RUN proc_assigninit.  
            ELSE DO:  /*create v72*/
...
FOR EACH wdetail2.
    ...
    END.
    IF trim(wdetail2.instyp) = "9" THEN RUN proc_assign3_72.
    ELSE DO:
        IF wdetail2.policy = ""  THEN RUN proc_assign3_72no70.
        ELSE DO:
        FIND FIRST wdetail WHERE wdetail.policy = wdetail2.policy NO-ERROR NO-WAIT.
        IF NOT AVAIL wdetail THEN DO:
            CREATE wdetail.
            ASSIGN
                wdetail.policy      = caps(trim(wdetail2.policy)) 
                ...
                wdetail.branch      = "M" 
                wdetail.benname     = "บริษัท ตรีเพชรอีซูซุลิสซิ่ง จำกัด"
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
DEF VAR nvn_si   AS CHAR INIT "".
ASSIGN  nvn_si = ""
    nvn_si = wdetail.si.
IF NOT CONNECTED("sic_exp") THEN RUN proc_sic_exp2.
IF  CONNECTED("sic_exp") THEN DO:
    RUN wgw\wgwttpex (INPUT-OUTPUT wdetail.prvpol,      /*n_prepol  */ 
                      INPUT-OUTPUT wdetail.branch,      /*n_branch  */ 
                      INPUT-OUTPUT wdetail.insrefno,    /*Insured:  */
                      INPUT-OUTPUT wdetail.finint,
    ...
    IF  nvn_si <> wdetail.si  THEN ASSIGN wdetail.si = nvn_si .
END.
END PROCEDURE.
...
IF wdetail.poltyp = "v70" THEN DO:
    ...
    IF wdetail.prvpol = "" THEN DO:
        ASSIGN nv_dss_per = 0 
            WDETAIL.NCB = "".
        IF      (wdetail.subclass = "110") OR (wdetail.subclass = "v110") THEN RUN proc_dsp_ncb2.                       
        ELSE IF (wdetail.subclass = "210") OR (wdetail.subclass = "v210") THEN RUN proc_dsp_ncb3.
        ELSE IF (wdetail.subclass = "320") OR (wdetail.subclass = "v320") THEN RUN proc_dsp_ncb4.
        ELSE DO: 
            RUN wgs\wgsfbas.
            ASSIGN aa = nv_baseprm.
        END.
    END.
    ELSE ASSIGN aa = nv_basere .  
    ASSIGN chk = NO
        nv_baseprm = aa
        NO_basemsg = " " .
    IF nv_drivno = 0 THEN
...
FOR EACH wdetail:
    ...
    /*------------------  renew ---------------------*/
    ASSIGN fi_process    = "Check  data Non-TIL-Renew...." + wdetail.policy.    
    DISP fi_process WITH FRAM fr_main.
    RUN proc_cr_2.
    ASSIGN 
        n_rencnt = 0
...
------------------------------------------------------------------------------*/
ASSIGN WDETAIL.NCB = "" .
IF (year(TODAY) - deci(wdetail.caryear)) <= 2 THEN DO:
    ASSIGN WDETAIL.NCB = "20".
    IF      deci(wdetail.si) = 420000 THEN ASSIGN nv_dss_per = 4.01     aa = 8000 .
    ELSE IF deci(wdetail.si) = 430000 THEN ASSIGN nv_dss_per = 5.51     aa = 8000 .
    ELSE IF deci(wdetail.si) = 440000 THEN ASSIGN nv_dss_per = 6.98     aa = 8000 .
    ELSE IF deci(wdetail.si) = 450000 THEN ASSIGN nv_dss_per = 8.39     aa = 8000 .
    ELSE IF deci(wdetail.si) = 460000 THEN ASSIGN nv_dss_per = 9.76     aa = 8000 .
    ELSE IF deci(wdetail.si) = 470000 THEN ASSIGN nv_dss_per = 11.09    aa = 8000 .
    ELSE IF deci(wdetail.si) = 480000 THEN ASSIGN nv_dss_per = 12.39    aa = 8000 .
    ELSE IF deci(wdetail.si) = 490000 THEN ASSIGN nv_dss_per = 13.29    aa = 8000 .
    ELSE IF deci(wdetail.si) = 500000 THEN ASSIGN nv_dss_per = 13.10    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 510000 THEN ASSIGN nv_dss_per = 12.98    aa = 8000 .          
    ELSE IF deci(wdetail.si) = 520000 THEN ASSIGN nv_dss_per = 12.86    aa = 8000 .         
    ELSE IF deci(wdetail.si) = 530000 THEN ASSIGN nv_dss_per = 12.74    aa = 8000 .
    ELSE IF deci(wdetail.si) = 540000 THEN ASSIGN nv_dss_per = 12.63    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 550000 THEN ASSIGN nv_dss_per = 12.51    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 560000 THEN ASSIGN nv_dss_per = 12.40    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 570000 THEN ASSIGN nv_dss_per = 12.29    aa = 8000 .            
    ELSE IF deci(wdetail.si) = 580000 THEN ASSIGN nv_dss_per = 12.19    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 590000 THEN ASSIGN nv_dss_per = 12.08    aa = 8000 .  
    ELSE IF deci(wdetail.si) = 600000 THEN ASSIGN nv_dss_per = 11.98    aa = 8000 .
    ELSE IF deci(wdetail.si) = 610000 THEN ASSIGN nv_dss_per = 11.87    aa = 8000 .      
    ELSE IF deci(wdetail.si) = 620000 THEN ASSIGN nv_dss_per = 11.77    aa = 8000 .
    ELSE IF deci(wdetail.si) = 630000 THEN ASSIGN nv_dss_per = 11.67    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 640000 THEN ASSIGN nv_dss_per = 11.58    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 650000 THEN ASSIGN nv_dss_per = 11.48    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 660000 THEN ASSIGN nv_dss_per = 11.39    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 670000 THEN ASSIGN nv_dss_per = 11.29    aa = 8000 .  
    ELSE IF deci(wdetail.si) = 680000 THEN ASSIGN nv_dss_per = 11.20    aa = 8000 .  
    ELSE IF deci(wdetail.si) = 690000 THEN ASSIGN nv_dss_per = 11.11    aa = 8000 .  
    ELSE IF deci(wdetail.si) = 700000 THEN ASSIGN nv_dss_per = 11.03    aa = 8000 .
    ELSE IF deci(wdetail.si) = 710000 THEN ASSIGN nv_dss_per = 10.94    aa = 8000 .
    ELSE IF deci(wdetail.si) = 720000 THEN ASSIGN nv_dss_per = 10.85    aa = 8000 .
    ELSE IF deci(wdetail.si) = 730000 THEN ASSIGN nv_dss_per = 10.77    aa = 8000 .
    ELSE IF deci(wdetail.si) = 740000 THEN ASSIGN nv_dss_per = 10.69    aa = 8000 .
    ELSE IF deci(wdetail.si) = 750000 THEN ASSIGN nv_dss_per = 10.61    aa = 8000 .
    ELSE IF deci(wdetail.si) = 760000 THEN ASSIGN nv_dss_per = 10.53    aa = 8000 .
    ELSE IF deci(wdetail.si) = 770000 THEN ASSIGN nv_dss_per = 10.45    aa = 8000 .
    ELSE IF deci(wdetail.si) = 780000 THEN ASSIGN nv_dss_per = 10.37    aa = 8000 .
    ELSE IF deci(wdetail.si) = 790000 THEN ASSIGN nv_dss_per = 10.29    aa = 8000 .
    ELSE IF deci(wdetail.si) = 800000 THEN ASSIGN nv_dss_per = 10.22    aa = 8000 .
    ELSE IF deci(wdetail.si) = 810000 THEN ASSIGN nv_dss_per = 10.14    aa = 8000 .
    ELSE IF deci(wdetail.si) = 820000 THEN ASSIGN nv_dss_per = 10.07    aa = 8000 .
    ELSE IF deci(wdetail.si) = 830000 THEN ASSIGN nv_dss_per = 10.00    aa = 8000 .
    ELSE IF deci(wdetail.si) = 840000 THEN ASSIGN nv_dss_per = 9.92     aa = 8000 .
    ELSE IF deci(wdetail.si) = 850000 THEN ASSIGN nv_dss_per = 9.85     aa = 8000 .
    ELSE IF deci(wdetail.si) = 860000 THEN ASSIGN nv_dss_per = 9.78     aa = 8000 .
    ELSE IF deci(wdetail.si) = 870000 THEN ASSIGN nv_dss_per = 9.72     aa = 8000 .
    ELSE IF deci(wdetail.si) = 880000 THEN ASSIGN nv_dss_per = 9.65     aa = 8000 .
    ELSE IF deci(wdetail.si) = 890000 THEN ASSIGN nv_dss_per = 9.58     aa = 8000 .
    ELSE IF deci(wdetail.si) = 900000 THEN ASSIGN nv_dss_per = 9.52     aa = 8000 .
    ELSE IF deci(wdetail.si) = 910000 THEN ASSIGN nv_dss_per = 9.45     aa = 8000 .
    ELSE IF deci(wdetail.si) = 920000 THEN ASSIGN nv_dss_per = 9.39     aa = 8000 .
    ELSE IF deci(wdetail.si) = 930000 THEN ASSIGN nv_dss_per = 9.33     aa = 8000 .
    ELSE IF deci(wdetail.si) = 940000 THEN ASSIGN nv_dss_per = 9.26     aa = 8000 .
    ELSE IF deci(wdetail.si) = 950000 THEN ASSIGN nv_dss_per = 9.20     aa = 8000 .
    ELSE IF deci(wdetail.si) = 960000 THEN ASSIGN nv_dss_per = 9.14     aa = 8000 .
    ELSE IF deci(wdetail.si) = 970000 THEN ASSIGN nv_dss_per = 9.08     aa = 8000 .
    ELSE IF deci(wdetail.si) = 980000 THEN ASSIGN nv_dss_per = 9.02     aa = 8000 .
    ELSE IF deci(wdetail.si) = 990000 THEN ASSIGN nv_dss_per = 8.97     aa = 8000 .
    ELSE IF deci(wdetail.si) = 1000000 THEN ASSIGN nv_dss_per = 8.91    aa = 8000 .
END.
ELSE IF (year(TODAY) - deci(wdetail.caryear)) <= 3 THEN DO:
    ASSIGN WDETAIL.NCB = "20".
    IF      deci(wdetail.si) = 410000   THEN ASSIGN nv_dss_per = 4.34   aa = 8000 .
    ELSE IF deci(wdetail.si) = 420000   THEN ASSIGN nv_dss_per = 5.87   aa = 8000 .
    ELSE IF deci(wdetail.si) = 430000   THEN ASSIGN nv_dss_per = 7.35   aa = 8000 .
    ELSE IF deci(wdetail.si) = 440000   THEN ASSIGN nv_dss_per = 8.78   aa = 8000 .
    ELSE IF deci(wdetail.si) = 450000   THEN ASSIGN nv_dss_per = 10.16  aa = 8000 .
    ELSE IF deci(wdetail.si) = 460000   THEN ASSIGN nv_dss_per = 11.52  aa = 8000 .
    ELSE IF deci(wdetail.si) = 470000   THEN ASSIGN nv_dss_per = 12.82  aa = 8000 .
    ELSE IF deci(wdetail.si) = 480000   THEN ASSIGN nv_dss_per = 13.22  aa = 8000 .
    ELSE IF deci(wdetail.si) = 490000   THEN ASSIGN nv_dss_per = 13.03  aa = 8000 .
    ELSE IF deci(wdetail.si) = 500000   THEN ASSIGN nv_dss_per = 12.85  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 510000   THEN ASSIGN nv_dss_per = 12.73  aa = 8000 .          
    ELSE IF deci(wdetail.si) = 520000   THEN ASSIGN nv_dss_per = 12.61  aa = 8000 .         
    ELSE IF deci(wdetail.si) = 530000   THEN ASSIGN nv_dss_per = 12.50  aa = 8000 .
    ELSE IF deci(wdetail.si) = 540000   THEN ASSIGN nv_dss_per = 12.38  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 550000   THEN ASSIGN nv_dss_per = 12.27  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 560000   THEN ASSIGN nv_dss_per = 12.16  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 570000   THEN ASSIGN nv_dss_per = 12.05  aa = 8000 .            
    ELSE IF deci(wdetail.si) = 580000   THEN ASSIGN nv_dss_per = 11.95  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 590000   THEN ASSIGN nv_dss_per = 11.84  aa = 8000 .  
    ELSE IF deci(wdetail.si) = 600000   THEN ASSIGN nv_dss_per = 11.74  aa = 8000 .
    ELSE IF deci(wdetail.si) = 610000   THEN ASSIGN nv_dss_per = 11.64  aa = 8000 .      
    ELSE IF deci(wdetail.si) = 620000   THEN ASSIGN nv_dss_per = 11.54  aa = 8000 .
    ELSE IF deci(wdetail.si) = 630000   THEN ASSIGN nv_dss_per = 11.45  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 640000   THEN ASSIGN nv_dss_per = 11.35  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 650000   THEN ASSIGN nv_dss_per = 11.26  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 660000   THEN ASSIGN nv_dss_per = 11.17  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 670000   THEN ASSIGN nv_dss_per = 11.07  aa = 8000 .  
    ELSE IF deci(wdetail.si) = 680000   THEN ASSIGN nv_dss_per = 10.99  aa = 8000 .  
    ELSE IF deci(wdetail.si) = 690000   THEN ASSIGN nv_dss_per = 10.90  aa = 8000 .  
    ELSE IF deci(wdetail.si) = 700000   THEN ASSIGN nv_dss_per = 10.81  aa = 8000 .
    ELSE IF deci(wdetail.si) = 710000   THEN ASSIGN nv_dss_per = 10.73  aa = 8000 .
    ELSE IF deci(wdetail.si) = 720000   THEN ASSIGN nv_dss_per = 10.64  aa = 8000 .
    ELSE IF deci(wdetail.si) = 730000   THEN ASSIGN nv_dss_per = 10.56  aa = 8000 .
    ELSE IF deci(wdetail.si) = 740000   THEN ASSIGN nv_dss_per = 10.48  aa = 8000 .
    ELSE IF deci(wdetail.si) = 750000   THEN ASSIGN nv_dss_per = 10.40  aa = 8000 .
    ELSE IF deci(wdetail.si) = 760000  THEN ASSIGN nv_dss_per = 10.32  aa = 8000 .
    ELSE IF deci(wdetail.si) = 770000  THEN ASSIGN nv_dss_per = 10.24  aa = 8000 .
    ELSE IF deci(wdetail.si) = 780000  THEN ASSIGN nv_dss_per = 10.17  aa = 8000 .
    ELSE IF deci(wdetail.si) = 790000  THEN ASSIGN nv_dss_per = 10.09  aa = 8000 .
    ELSE IF deci(wdetail.si) = 800000  THEN ASSIGN nv_dss_per = 10.02  aa = 8000 .
    ELSE IF deci(wdetail.si) = 810000  THEN ASSIGN nv_dss_per = 9.94   aa = 8000 .
    ELSE IF deci(wdetail.si) = 820000  THEN ASSIGN nv_dss_per = 9.87   aa = 8000 .
    ELSE IF deci(wdetail.si) = 830000  THEN ASSIGN nv_dss_per = 9.80   aa = 8000 .
    ELSE IF deci(wdetail.si) = 840000  THEN ASSIGN nv_dss_per = 9.73   aa = 8000 .
    ELSE IF deci(wdetail.si) = 850000  THEN ASSIGN nv_dss_per = 9.66   aa = 8000 .
    ELSE IF deci(wdetail.si) = 860000  THEN ASSIGN nv_dss_per = 9.59   aa = 8000 .
    ELSE IF deci(wdetail.si) = 870000  THEN ASSIGN nv_dss_per = 9.53   aa = 8000 .
    ELSE IF deci(wdetail.si) = 880000  THEN ASSIGN nv_dss_per = 9.46   aa = 8000 .
    ELSE IF deci(wdetail.si) = 890000  THEN ASSIGN nv_dss_per = 9.40   aa = 8000 .
    ELSE IF deci(wdetail.si) = 900000  THEN ASSIGN nv_dss_per = 9.33   aa = 8000 .
    ELSE IF deci(wdetail.si) = 910000  THEN ASSIGN nv_dss_per = 9.27   aa = 8000 .
    ELSE IF deci(wdetail.si) = 920000  THEN ASSIGN nv_dss_per = 9.21   aa = 8000 .
    ELSE IF deci(wdetail.si) = 930000  THEN ASSIGN nv_dss_per = 9.14   aa = 8000 .
    ELSE IF deci(wdetail.si) = 940000  THEN ASSIGN nv_dss_per = 9.08   aa = 8000 .
    ELSE IF deci(wdetail.si) = 950000  THEN ASSIGN nv_dss_per = 9.02   aa = 8000 .
    ELSE IF deci(wdetail.si) = 960000  THEN ASSIGN nv_dss_per = 8.96   aa = 8000 .
    ELSE IF deci(wdetail.si) = 970000  THEN ASSIGN nv_dss_per = 8.91   aa = 8000 .
    ELSE IF deci(wdetail.si) = 980000  THEN ASSIGN nv_dss_per = 8.85   aa = 8000 .
    ELSE IF deci(wdetail.si) = 990000  THEN ASSIGN nv_dss_per = 8.79   aa = 8000 .
    ELSE IF deci(wdetail.si) = 1000000  THEN ASSIGN nv_dss_per = 8.73   aa = 8000 .
END.
ELSE IF (year(TODAY) - deci(wdetail.caryear)) <= 4 THEN DO:
    ASSIGN WDETAIL.NCB = "20".
    IF      deci(wdetail.si) = 370000   THEN ASSIGN nv_dss_per = 0.60  aa = 8000 .
    ELSE IF deci(wdetail.si) = 380000   THEN ASSIGN nv_dss_per = 2.29  aa = 8000 .
    ELSE IF deci(wdetail.si) = 390000   THEN ASSIGN nv_dss_per = 3.94  aa = 8000 .
    ELSE IF deci(wdetail.si) = 400000   THEN ASSIGN nv_dss_per = 5.51  aa = 8000 .
    ELSE IF deci(wdetail.si) = 410000   THEN ASSIGN nv_dss_per = 7.04  aa = 8000 .
    ELSE IF deci(wdetail.si) = 420000   THEN ASSIGN nv_dss_per = 8.53  aa = 8000 .
    ELSE IF deci(wdetail.si) = 430000   THEN ASSIGN nv_dss_per = 9.96  aa = 8000 .
    ELSE IF deci(wdetail.si) = 440000   THEN ASSIGN nv_dss_per = 11.35  aa = 8000 .
    ELSE IF deci(wdetail.si) = 450000   THEN ASSIGN nv_dss_per = 12.71  aa = 8000 .
    ELSE IF deci(wdetail.si) = 460000   THEN ASSIGN nv_dss_per = 13.23  aa = 8000 .
    ELSE IF deci(wdetail.si) = 470000   THEN ASSIGN nv_dss_per = 13.04  aa = 8000 .
    ELSE IF deci(wdetail.si) = 480000   THEN ASSIGN nv_dss_per = 12.85  aa = 8000 .
    ELSE IF deci(wdetail.si) = 490000   THEN ASSIGN nv_dss_per = 12.66  aa = 8000 .
    ELSE IF deci(wdetail.si) = 500000   THEN ASSIGN nv_dss_per = 12.49  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 510000   THEN ASSIGN nv_dss_per = 12.37  aa = 8000 .          
    ELSE IF deci(wdetail.si) = 520000   THEN ASSIGN nv_dss_per = 12.25  aa = 8000 .         
    ELSE IF deci(wdetail.si) = 530000   THEN ASSIGN nv_dss_per = 12.14  aa = 8000 .
    ELSE IF deci(wdetail.si) = 540000   THEN ASSIGN nv_dss_per = 12.03  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 550000   THEN ASSIGN nv_dss_per = 11.92  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 560000   THEN ASSIGN nv_dss_per = 11.82  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 570000   THEN ASSIGN nv_dss_per = 11.71  aa = 8000 .            
    ELSE IF deci(wdetail.si) = 580000   THEN ASSIGN nv_dss_per = 11.61  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 590000   THEN ASSIGN nv_dss_per = 11.51  aa = 8000 .  
    ELSE IF deci(wdetail.si) = 600000   THEN ASSIGN nv_dss_per = 11.41  aa = 8000 .
    ELSE IF deci(wdetail.si) = 610000   THEN ASSIGN nv_dss_per = 11.31  aa = 8000 .      
    ELSE IF deci(wdetail.si) = 620000   THEN ASSIGN nv_dss_per = 11.22  aa = 8000 .
    ELSE IF deci(wdetail.si) = 630000   THEN ASSIGN nv_dss_per = 11.12  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 640000   THEN ASSIGN nv_dss_per = 11.03  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 650000   THEN ASSIGN nv_dss_per = 10.94  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 660000   THEN ASSIGN nv_dss_per = 10.85  aa = 8000 .   
    ELSE IF deci(wdetail.si) = 670000   THEN ASSIGN nv_dss_per = 10.76  aa = 8000 .  
    ELSE IF deci(wdetail.si) = 680000   THEN ASSIGN nv_dss_per = 10.68  aa = 8000 .  
    ELSE IF deci(wdetail.si) = 690000   THEN ASSIGN nv_dss_per = 10.59  aa = 8000 .  
    ELSE IF deci(wdetail.si) = 700000   THEN ASSIGN nv_dss_per = 10.51  aa = 8000 .
    ELSE IF deci(wdetail.si) = 710000   THEN ASSIGN nv_dss_per = 10.42  aa = 8000 .
    ELSE IF deci(wdetail.si) = 720000   THEN ASSIGN nv_dss_per = 10.34  aa = 8000 .
    ELSE IF deci(wdetail.si) = 730000   THEN ASSIGN nv_dss_per = 10.26  aa = 8000 .
    ELSE IF deci(wdetail.si) = 740000   THEN ASSIGN nv_dss_per = 10.18  aa = 8000 .
    ELSE IF deci(wdetail.si) = 750000   THEN ASSIGN nv_dss_per = 10.10  aa = 8000 .
    ELSE IF deci(wdetail.si) = 760000   THEN ASSIGN nv_dss_per = 10.03  aa = 8000 .
    ELSE IF deci(wdetail.si) = 770000   THEN ASSIGN nv_dss_per = 9.95   aa = 8000 .
    ELSE IF deci(wdetail.si) = 780000   THEN ASSIGN nv_dss_per = 9.88   aa = 8000 .
    ELSE IF deci(wdetail.si) = 790000   THEN ASSIGN nv_dss_per = 9.81   aa = 8000 .
    ELSE IF deci(wdetail.si) = 800000   THEN ASSIGN nv_dss_per = 9.73   aa = 8000 .
    ELSE IF deci(wdetail.si) = 810000   THEN ASSIGN nv_dss_per = 9.66   aa = 8000 .
    ELSE IF deci(wdetail.si) = 820000   THEN ASSIGN nv_dss_per = 9.59   aa = 8000 .
    ELSE IF deci(wdetail.si) = 830000   THEN ASSIGN nv_dss_per = 9.52   aa = 8000 .
    ELSE IF deci(wdetail.si) = 840000   THEN ASSIGN nv_dss_per = 9.46   aa = 8000 .
    ELSE IF deci(wdetail.si) = 850000   THEN ASSIGN nv_dss_per = 9.39   aa = 8000 .
    ELSE IF deci(wdetail.si) = 860000   THEN ASSIGN nv_dss_per = 9.32   aa = 8000 .
    ELSE IF deci(wdetail.si) = 870000   THEN ASSIGN nv_dss_per = 9.26   aa = 8000 .
    ELSE IF deci(wdetail.si) = 880000   THEN ASSIGN nv_dss_per = 9.19   aa = 8000 .
    ELSE IF deci(wdetail.si) = 890000   THEN ASSIGN nv_dss_per = 9.13   aa = 8000 .
END.
ELSE RUN proc_dsp_ncb2_y5.
END PROCEDURE.

/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_dsp_ncb2_y5 c-Win 
PROCEDURE proc_dsp_ncb2_y5 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
IF (year(TODAY) - deci(wdetail.caryear)) <= 5 THEN DO:
    ASSIGN WDETAIL.NCB = "20".
    IF      deci(wdetail.si) = 320000   THEN ASSIGN nv_dss_per = 2.10    aa = 8000 .
    ELSE IF deci(wdetail.si) = 330000   THEN ASSIGN nv_dss_per = 3.92    aa = 8000 .
    ELSE IF deci(wdetail.si) = 340000   THEN ASSIGN nv_dss_per = 5.68    aa = 8000 .
    ELSE IF deci(wdetail.si) = 350000   THEN ASSIGN nv_dss_per = 7.38    aa = 8000 .
    ELSE IF deci(wdetail.si) = 360000   THEN ASSIGN nv_dss_per = 9.01    aa = 8000 .
    ELSE IF deci(wdetail.si) = 370000   THEN ASSIGN nv_dss_per = 0.13    aa = 8000 .
    ELSE IF deci(wdetail.si) = 380000   THEN ASSIGN nv_dss_per = 1.83    aa = 8000 .
    ELSE IF deci(wdetail.si) = 390000   THEN ASSIGN nv_dss_per = 3.48    aa = 8000 .
    ELSE IF deci(wdetail.si) = 400000   THEN ASSIGN nv_dss_per = 5.07    aa = 8000 .
    ELSE IF deci(wdetail.si) = 410000   THEN ASSIGN nv_dss_per = 6.61    aa = 8000 .
    ELSE IF deci(wdetail.si) = 420000   THEN ASSIGN nv_dss_per = 8.09    aa = 8000 .
    ELSE IF deci(wdetail.si) = 430000   THEN ASSIGN nv_dss_per = 8.72    aa = 8000 .
    ELSE IF deci(wdetail.si) = 440000   THEN ASSIGN nv_dss_per = 8.50    aa = 8000 .
    ELSE IF deci(wdetail.si) = 450000   THEN ASSIGN nv_dss_per = 8.29    aa = 8000 .
    ELSE IF deci(wdetail.si) = 460000   THEN ASSIGN nv_dss_per = 8.09    aa = 8000 .
    ELSE IF deci(wdetail.si) = 470000   THEN ASSIGN nv_dss_per = 7.89    aa = 8000 .
    ELSE IF deci(wdetail.si) = 480000   THEN ASSIGN nv_dss_per = 7.70    aa = 8000 .
    ELSE IF deci(wdetail.si) = 490000   THEN ASSIGN nv_dss_per = 7.52    aa = 8000 .
    ELSE IF deci(wdetail.si) = 500000   THEN ASSIGN nv_dss_per = 7.33    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 510000   THEN ASSIGN nv_dss_per = 7.22    aa = 8000 .          
    ELSE IF deci(wdetail.si) = 520000   THEN ASSIGN nv_dss_per = 7.11    aa = 8000 .         
    ELSE IF deci(wdetail.si) = 530000   THEN ASSIGN nv_dss_per = 6.99    aa = 8000 .
    ELSE IF deci(wdetail.si) = 540000   THEN ASSIGN nv_dss_per = 6.88    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 550000   THEN ASSIGN nv_dss_per = 6.77    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 560000   THEN ASSIGN nv_dss_per = 6.66    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 570000   THEN ASSIGN nv_dss_per = 6.56    aa = 8000 .            
    ELSE IF deci(wdetail.si) = 580000   THEN ASSIGN nv_dss_per = 6.45    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 590000   THEN ASSIGN nv_dss_per = 6.35    aa = 8000 .  
    ELSE IF deci(wdetail.si) = 600000   THEN ASSIGN nv_dss_per = 6.24    aa = 8000 .
    ELSE IF deci(wdetail.si) = 610000   THEN ASSIGN nv_dss_per = 6.16    aa = 8000 .      
    ELSE IF deci(wdetail.si) = 620000   THEN ASSIGN nv_dss_per = 6.05    aa = 8000 .
    ELSE IF deci(wdetail.si) = 630000   THEN ASSIGN nv_dss_per = 5.96    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 640000   THEN ASSIGN nv_dss_per = 5.87    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 650000   THEN ASSIGN nv_dss_per = 5.77    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 660000   THEN ASSIGN nv_dss_per = 5.69    aa = 8000 .   
    ELSE IF deci(wdetail.si) = 670000   THEN ASSIGN nv_dss_per = 5.59    aa = 8000 .  
    ELSE IF deci(wdetail.si) = 680000   THEN ASSIGN nv_dss_per = 5.50    aa = 8000 .  
    ELSE IF deci(wdetail.si) = 690000   THEN ASSIGN nv_dss_per = 5.42    aa = 8000 .  
    ELSE IF deci(wdetail.si) = 700000   THEN ASSIGN nv_dss_per = 5.34    aa = 8000 .
    ELSE IF deci(wdetail.si) = 710000   THEN ASSIGN nv_dss_per = 5.26    aa = 8000 .
    ELSE IF deci(wdetail.si) = 720000   THEN ASSIGN nv_dss_per = 5.17    aa = 8000 .
    ELSE IF deci(wdetail.si) = 730000   THEN ASSIGN nv_dss_per = 5.09    aa = 8000 .
    ELSE IF deci(wdetail.si) = 740000   THEN ASSIGN nv_dss_per = 5.01    aa = 8000 .
    ELSE IF deci(wdetail.si) = 750000   THEN ASSIGN nv_dss_per = 4.93    aa = 8000 .
    ELSE IF deci(wdetail.si) = 760000   THEN ASSIGN nv_dss_per = 4.85    aa = 8000 .
    ELSE IF deci(wdetail.si) = 770000   THEN ASSIGN nv_dss_per = 4.77    aa = 8000 .
    ELSE IF deci(wdetail.si) = 780000   THEN ASSIGN nv_dss_per = 4.71    aa = 8000 .
    ELSE IF deci(wdetail.si) = 790000   THEN ASSIGN nv_dss_per = 4.63    aa = 8000 .
    ELSE IF deci(wdetail.si) = 800000   THEN ASSIGN nv_dss_per = 4.56    aa = 8000 .
    ELSE IF deci(wdetail.si) = 810000   THEN ASSIGN nv_dss_per = 4.48    aa = 8000 .
    ELSE IF deci(wdetail.si) = 820000   THEN ASSIGN nv_dss_per = 4.41    aa = 8000 .
END.
END PROCEDURE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_dsp_ncb3 c-Win 
PROCEDURE proc_dsp_ncb3 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
IF (year(TODAY) - deci(wdetail.caryear)) <= 2 THEN DO:
    ASSIGN WDETAIL.NCB = "20".
    IF      deci(wdetail.si) = 310000 THEN ASSIGN nv_dss_per = 2.81    aa = 14000.          
    ELSE IF deci(wdetail.si) = 320000 THEN ASSIGN nv_dss_per = 0.62    aa = 13500.         
    ELSE IF deci(wdetail.si) = 330000 THEN ASSIGN nv_dss_per = 1.98    aa = 13500.
    ELSE IF deci(wdetail.si) = 340000 THEN ASSIGN nv_dss_per = 3.29    aa = 13500.   
    ELSE IF deci(wdetail.si) = 350000 THEN ASSIGN nv_dss_per = 4.58    aa = 13500.   
    ELSE IF deci(wdetail.si) = 360000 THEN ASSIGN nv_dss_per = 5.82    aa = 13500.   
    ELSE IF deci(wdetail.si) = 370000 THEN ASSIGN nv_dss_per = 7.04    aa = 13500.            
    ELSE IF deci(wdetail.si) = 380000 THEN ASSIGN nv_dss_per = 8.23    aa = 13500.   
    ELSE IF deci(wdetail.si) = 390000 THEN ASSIGN nv_dss_per = 9.26    aa = 13500.  
    ELSE IF deci(wdetail.si) = 400000 THEN ASSIGN nv_dss_per = 9.11    aa = 13500.
    ELSE IF deci(wdetail.si) = 410000 THEN ASSIGN nv_dss_per = 8.95    aa = 13500.
    ELSE IF deci(wdetail.si) = 420000 THEN ASSIGN nv_dss_per = 8.79    aa = 13500.
    ELSE IF deci(wdetail.si) = 430000 THEN ASSIGN nv_dss_per = 8.65    aa = 13500.
    ELSE IF deci(wdetail.si) = 440000 THEN ASSIGN nv_dss_per = 8.49    aa = 13500.
    ELSE IF deci(wdetail.si) = 450000 THEN ASSIGN nv_dss_per = 8.35    aa = 13500.
    ELSE IF deci(wdetail.si) = 460000 THEN ASSIGN nv_dss_per = 8.21    aa = 13500.
    ELSE IF deci(wdetail.si) = 470000 THEN ASSIGN nv_dss_per = 8.08    aa = 13500.
    ELSE IF deci(wdetail.si) = 480000 THEN ASSIGN nv_dss_per = 7.94    aa = 13500.
    ELSE IF deci(wdetail.si) = 490000 THEN ASSIGN nv_dss_per = 7.82    aa = 13500.
    ELSE IF deci(wdetail.si) = 500000 THEN ASSIGN nv_dss_per = 7.69    aa = 13500.   
    ELSE IF deci(wdetail.si) = 510000 THEN ASSIGN nv_dss_per = 7.56    aa = 13500.          
    ELSE IF deci(wdetail.si) = 520000 THEN ASSIGN nv_dss_per = 7.44    aa = 13500.         
    ELSE IF deci(wdetail.si) = 530000 THEN ASSIGN nv_dss_per = 7.32    aa = 13500.
    ELSE IF deci(wdetail.si) = 540000 THEN ASSIGN nv_dss_per = 7.21    aa = 13500.   
    ELSE IF deci(wdetail.si) = 550000 THEN ASSIGN nv_dss_per = 7.09    aa = 13500.   
    ELSE IF deci(wdetail.si) = 560000 THEN ASSIGN nv_dss_per = 6.98    aa = 13500.   
    ELSE IF deci(wdetail.si) = 570000 THEN ASSIGN nv_dss_per = 6.87    aa = 13500.            
    ELSE IF deci(wdetail.si) = 580000 THEN ASSIGN nv_dss_per = 6.76    aa = 13500.   
    ELSE IF deci(wdetail.si) = 590000 THEN ASSIGN nv_dss_per = 6.65    aa = 13500.  
    ELSE IF deci(wdetail.si) = 600000 THEN ASSIGN nv_dss_per = 6.56    aa = 13500.
    ELSE IF deci(wdetail.si) = 610000 THEN ASSIGN nv_dss_per = 6.45    aa = 13500.      
    ELSE IF deci(wdetail.si) = 620000 THEN ASSIGN nv_dss_per = 6.35    aa = 13500.
    ELSE IF deci(wdetail.si) = 630000 THEN ASSIGN nv_dss_per = 6.26    aa = 13500.   
    ELSE IF deci(wdetail.si) = 640000 THEN ASSIGN nv_dss_per = 6.16    aa = 13500.   
    ELSE IF deci(wdetail.si) = 650000 THEN ASSIGN nv_dss_per = 6.07    aa = 13500.   
    ELSE IF deci(wdetail.si) = 660000 THEN ASSIGN nv_dss_per = 5.98    aa = 13500.   
    ELSE IF deci(wdetail.si) = 670000 THEN ASSIGN nv_dss_per = 5.89    aa = 13500.  
    ELSE IF deci(wdetail.si) = 680000 THEN ASSIGN nv_dss_per = 5.80    aa = 13500.  
    ELSE IF deci(wdetail.si) = 690000 THEN ASSIGN nv_dss_per = 5.71    aa = 13500.  
    ELSE IF deci(wdetail.si) = 700000 THEN ASSIGN nv_dss_per = 5.62    aa = 13500.
    ELSE IF deci(wdetail.si) = 710000 THEN ASSIGN nv_dss_per = 5.54    aa = 13500.
    ELSE IF deci(wdetail.si) = 720000 THEN ASSIGN nv_dss_per = 5.46    aa = 13500.
    ELSE IF deci(wdetail.si) = 730000 THEN ASSIGN nv_dss_per = 5.38    aa = 13500.
END.
ELSE IF (year(TODAY) - deci(wdetail.caryear)) <= 3 THEN DO:
    ASSIGN WDETAIL.NCB = "20".
    IF      deci(wdetail.si) = 280000   THEN ASSIGN nv_dss_per = 4.34   aa = 14000.
    ELSE IF deci(wdetail.si) = 290000   THEN ASSIGN nv_dss_per = 5.87   aa = 13500.
    ELSE IF deci(wdetail.si) = 300000   THEN ASSIGN nv_dss_per = 7.35   aa = 13500.
    ELSE IF deci(wdetail.si) = 310000   THEN ASSIGN nv_dss_per = 8.78   aa = 13500.
    ELSE IF deci(wdetail.si) = 320000   THEN ASSIGN nv_dss_per = 10.16  aa = 13500.
    ELSE IF deci(wdetail.si) = 330000   THEN ASSIGN nv_dss_per = 11.52  aa = 13500.
    ELSE IF deci(wdetail.si) = 340000   THEN ASSIGN nv_dss_per = 12.82  aa = 13500.
    ELSE IF deci(wdetail.si) = 350000   THEN ASSIGN nv_dss_per = 13.22  aa = 13500.
    ELSE IF deci(wdetail.si) = 360000   THEN ASSIGN nv_dss_per = 13.03  aa = 13500.
    ELSE IF deci(wdetail.si) = 370000   THEN ASSIGN nv_dss_per = 12.85  aa = 13500.   
    ELSE IF deci(wdetail.si) = 380000   THEN ASSIGN nv_dss_per = 12.73  aa = 13500.          
    ELSE IF deci(wdetail.si) = 390000   THEN ASSIGN nv_dss_per = 12.61  aa = 13500.         
    ELSE IF deci(wdetail.si) = 400000   THEN ASSIGN nv_dss_per = 12.50  aa = 13500.
    ELSE IF deci(wdetail.si) = 410000   THEN ASSIGN nv_dss_per = 12.38  aa = 13500.   
    ELSE IF deci(wdetail.si) = 420000   THEN ASSIGN nv_dss_per = 12.27  aa = 13500.   
    ELSE IF deci(wdetail.si) = 430000   THEN ASSIGN nv_dss_per = 12.16  aa = 13500.   
    ELSE IF deci(wdetail.si) = 440000   THEN ASSIGN nv_dss_per = 12.05  aa = 13500.            
    ELSE IF deci(wdetail.si) = 450000   THEN ASSIGN nv_dss_per = 11.95  aa = 13500.   
    ELSE IF deci(wdetail.si) = 460000   THEN ASSIGN nv_dss_per = 11.84  aa = 13500.  
    ELSE IF deci(wdetail.si) = 470000   THEN ASSIGN nv_dss_per = 11.74  aa = 13500.
    ELSE IF deci(wdetail.si) = 480000   THEN ASSIGN nv_dss_per = 11.64  aa = 13500.      
    ELSE IF deci(wdetail.si) = 490000   THEN ASSIGN nv_dss_per = 11.54  aa = 13500.
    ELSE IF deci(wdetail.si) = 500000   THEN ASSIGN nv_dss_per = 11.45  aa = 13500.   
    ELSE IF deci(wdetail.si) = 510000   THEN ASSIGN nv_dss_per = 11.35  aa = 13500.   
    ELSE IF deci(wdetail.si) = 520000   THEN ASSIGN nv_dss_per = 11.26  aa = 13500.   
    ELSE IF deci(wdetail.si) = 530000   THEN ASSIGN nv_dss_per = 11.17  aa = 13500.   
    ELSE IF deci(wdetail.si) = 540000   THEN ASSIGN nv_dss_per = 11.07  aa = 13500.  
    ELSE IF deci(wdetail.si) = 550000   THEN ASSIGN nv_dss_per = 10.99  aa = 13500.  
    ELSE IF deci(wdetail.si) = 560000   THEN ASSIGN nv_dss_per = 10.90  aa = 13500.  
    ELSE IF deci(wdetail.si) = 570000   THEN ASSIGN nv_dss_per = 10.81  aa = 13500.
    ELSE IF deci(wdetail.si) = 580000   THEN ASSIGN nv_dss_per = 10.73  aa = 13500.
    ELSE IF deci(wdetail.si) = 590000   THEN ASSIGN nv_dss_per = 10.64  aa = 13500.
    ELSE IF deci(wdetail.si) = 600000   THEN ASSIGN nv_dss_per = 10.56  aa = 13500.
    ELSE IF deci(wdetail.si) = 610000   THEN ASSIGN nv_dss_per = 10.48  aa = 13500.
    ELSE IF deci(wdetail.si) = 620000   THEN ASSIGN nv_dss_per = 10.40  aa = 13500.
    ELSE IF deci(wdetail.si) = 630000   THEN ASSIGN nv_dss_per = 10.32  aa = 13500.
    ELSE IF deci(wdetail.si) = 640000   THEN ASSIGN nv_dss_per = 10.24  aa = 13500.
END.
ELSE IF (year(TODAY) - deci(wdetail.caryear)) <= 4 THEN DO:
    ASSIGN WDETAIL.NCB = "20".
    IF      deci(wdetail.si) = 270000   THEN ASSIGN nv_dss_per = 0.94   aa = 14000.
    ELSE IF deci(wdetail.si) = 280000   THEN ASSIGN nv_dss_per = 2.39   aa = 14000.
    ELSE IF deci(wdetail.si) = 290000   THEN ASSIGN nv_dss_per = 3.80   aa = 14000.
    ELSE IF deci(wdetail.si) = 300000   THEN ASSIGN nv_dss_per = 5.17   aa = 14000.
    ELSE IF deci(wdetail.si) = 310000   THEN ASSIGN nv_dss_per = 6.50   aa = 14000.
    ELSE IF deci(wdetail.si) = 320000   THEN ASSIGN nv_dss_per = 7.78   aa = 14000.
    ELSE IF deci(wdetail.si) = 330000   THEN ASSIGN nv_dss_per = 9.04   aa = 14000.
    ELSE IF deci(wdetail.si) = 340000   THEN ASSIGN nv_dss_per = 10.27  aa = 14000.
    ELSE IF deci(wdetail.si) = 350000   THEN ASSIGN nv_dss_per = 11.46  aa = 14000.
    ELSE IF deci(wdetail.si) = 360000   THEN ASSIGN nv_dss_per = 12.49  aa = 14000.
    ELSE IF deci(wdetail.si) = 370000   THEN ASSIGN nv_dss_per = 12.33  aa = 14000.
    ELSE IF deci(wdetail.si) = 380000   THEN ASSIGN nv_dss_per = 12.17  aa = 14000.
    ELSE IF deci(wdetail.si) = 390000   THEN ASSIGN nv_dss_per = 12.02  aa = 14000.
    ELSE IF deci(wdetail.si) = 400000   THEN ASSIGN nv_dss_per = 11.87  aa = 14000.   
    ELSE IF deci(wdetail.si) = 410000   THEN ASSIGN nv_dss_per = 11.72  aa = 14000.          
    ELSE IF deci(wdetail.si) = 420000   THEN ASSIGN nv_dss_per = 11.58  aa = 14000.         
    ELSE IF deci(wdetail.si) = 430000   THEN ASSIGN nv_dss_per = 11.44  aa = 14000.
    ELSE IF deci(wdetail.si) = 440000   THEN ASSIGN nv_dss_per = 11.31  aa = 14000.   
    ELSE IF deci(wdetail.si) = 450000   THEN ASSIGN nv_dss_per = 11.17  aa = 14000.   
    ELSE IF deci(wdetail.si) = 460000   THEN ASSIGN nv_dss_per = 11.04  aa = 14000.   
    ELSE IF deci(wdetail.si) = 470000   THEN ASSIGN nv_dss_per = 10.92  aa = 14000.            
    ELSE IF deci(wdetail.si) = 480000   THEN ASSIGN nv_dss_per = 10.79  aa = 14000.   
    ELSE IF deci(wdetail.si) = 490000   THEN ASSIGN nv_dss_per = 10.67  aa = 14000.  
    ELSE IF deci(wdetail.si) = 500000   THEN ASSIGN nv_dss_per = 10.56  aa = 14000.
    ELSE IF deci(wdetail.si) = 510000   THEN ASSIGN nv_dss_per = 10.44  aa = 14000.      
    ELSE IF deci(wdetail.si) = 520000   THEN ASSIGN nv_dss_per = 10.33  aa = 14000.
    ELSE IF deci(wdetail.si) = 530000   THEN ASSIGN nv_dss_per = 10.22  aa = 14000.   
    ELSE IF deci(wdetail.si) = 540000   THEN ASSIGN nv_dss_per = 10.11  aa = 14000.   
    ELSE IF deci(wdetail.si) = 550000   THEN ASSIGN nv_dss_per = 10.00  aa = 14000.   
    ELSE IF deci(wdetail.si) = 560000   THEN ASSIGN nv_dss_per = 9.90   aa = 14000.   
    ELSE IF deci(wdetail.si) = 570000   THEN ASSIGN nv_dss_per = 9.80   aa = 14000.  
    ELSE IF deci(wdetail.si) = 580000   THEN ASSIGN nv_dss_per = 9.70   aa = 14000.  
    ELSE IF deci(wdetail.si) = 590000   THEN ASSIGN nv_dss_per = 9.60   aa = 14000.  
    ELSE IF deci(wdetail.si) = 600000   THEN ASSIGN nv_dss_per = 9.50   aa = 14000.
END.
ELSE RUN proc_dsp_ncb3_y5.
END PROCEDURE.

/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_dsp_ncb3_y5 c-Win 
PROCEDURE proc_dsp_ncb3_y5 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
IF (year(TODAY) - deci(wdetail.caryear)) <= 4 THEN DO:
    ASSIGN WDETAIL.NCB = "20".
    IF      deci(wdetail.si) = 260000   THEN ASSIGN nv_dss_per = 1.32   aa = 14000.
    ELSE IF deci(wdetail.si) = 270000   THEN ASSIGN nv_dss_per = 2.78   aa = 14000.
    ELSE IF deci(wdetail.si) = 280000   THEN ASSIGN nv_dss_per = 4.21   aa = 14000.
    ELSE IF deci(wdetail.si) = 290000   THEN ASSIGN nv_dss_per = 5.59   aa = 14000.
    ELSE IF deci(wdetail.si) = 300000   THEN ASSIGN nv_dss_per = 6.93   aa = 14000.
    ELSE IF deci(wdetail.si) = 310000   THEN ASSIGN nv_dss_per = 8.24   aa = 14000.
    ELSE IF deci(wdetail.si) = 320000   THEN ASSIGN nv_dss_per = 9.50   aa = 14000.
    ELSE IF deci(wdetail.si) = 330000   THEN ASSIGN nv_dss_per = 10.74  aa = 14000.
    ELSE IF deci(wdetail.si) = 340000   THEN ASSIGN nv_dss_per = 11.93  aa = 14000.
    ELSE IF deci(wdetail.si) = 350000   THEN ASSIGN nv_dss_per = 12.42  aa = 14000.
    ELSE IF deci(wdetail.si) = 360000   THEN ASSIGN nv_dss_per = 12.26  aa = 14000.
    ELSE IF deci(wdetail.si) = 370000   THEN ASSIGN nv_dss_per = 12.10  aa = 14000.
    ELSE IF deci(wdetail.si) = 380000   THEN ASSIGN nv_dss_per = 11.94  aa = 14000.
    ELSE IF deci(wdetail.si) = 390000   THEN ASSIGN nv_dss_per = 11.79  aa = 14000.
    ELSE IF deci(wdetail.si) = 400000   THEN ASSIGN nv_dss_per = 11.65  aa = 14000.   
    ELSE IF deci(wdetail.si) = 410000   THEN ASSIGN nv_dss_per = 11.50  aa = 14000.          
    ELSE IF deci(wdetail.si) = 420000   THEN ASSIGN nv_dss_per = 11.36  aa = 14000.         
    ELSE IF deci(wdetail.si) = 430000   THEN ASSIGN nv_dss_per = 11.23  aa = 14000.
    ELSE IF deci(wdetail.si) = 440000   THEN ASSIGN nv_dss_per = 11.10  aa = 14000.   
    ELSE IF deci(wdetail.si) = 450000   THEN ASSIGN nv_dss_per = 10.97  aa = 14000.   
    ELSE IF deci(wdetail.si) = 460000   THEN ASSIGN nv_dss_per = 10.84  aa = 14000.   
    ELSE IF deci(wdetail.si) = 470000   THEN ASSIGN nv_dss_per = 10.71  aa = 14000.            
    ELSE IF deci(wdetail.si) = 480000   THEN ASSIGN nv_dss_per = 10.59  aa = 14000.   
    ELSE IF deci(wdetail.si) = 490000   THEN ASSIGN nv_dss_per = 10.47  aa = 14000.  
    ELSE IF deci(wdetail.si) = 500000   THEN ASSIGN nv_dss_per = 10.36  aa = 14000.
    ELSE IF deci(wdetail.si) = 510000   THEN ASSIGN nv_dss_per = 10.25  aa = 14000.      
    ELSE IF deci(wdetail.si) = 520000   THEN ASSIGN nv_dss_per = 10.13  aa = 14000.
    ELSE IF deci(wdetail.si) = 530000   THEN ASSIGN nv_dss_per = 10.03  aa = 14000.   
    ELSE IF deci(wdetail.si) = 540000   THEN ASSIGN nv_dss_per = 9.92   aa = 14000.   
    ELSE IF deci(wdetail.si) = 550000   THEN ASSIGN nv_dss_per = 9.82   aa = 14000. 
END.
END PROCEDURE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_dsp_ncb4 c-Win 
PROCEDURE proc_dsp_ncb4 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
IF (year(TODAY) - deci(wdetail.caryear)) <= 2 THEN DO:
    ASSIGN WDETAIL.NCB = "20".
    IF      deci(wdetail.si) = 450000 THEN ASSIGN nv_dss_per = 5.11    aa = 13000.
    ELSE IF deci(wdetail.si) = 460000 THEN ASSIGN nv_dss_per = 6.21    aa = 13000.
    ELSE IF deci(wdetail.si) = 470000 THEN ASSIGN nv_dss_per = 7.28    aa = 13000.
    ELSE IF deci(wdetail.si) = 480000 THEN ASSIGN nv_dss_per = 8.33    aa = 13000.
    ELSE IF deci(wdetail.si) = 490000 THEN ASSIGN nv_dss_per = 9.36    aa = 13000.
    ELSE IF deci(wdetail.si) = 500000 THEN ASSIGN nv_dss_per = 10.36   aa = 13000.   
    ELSE IF deci(wdetail.si) = 510000 THEN ASSIGN nv_dss_per = 8.68    aa = 13000.          
    ELSE IF deci(wdetail.si) = 520000 THEN ASSIGN nv_dss_per = 8.53    aa = 13000.         
    ELSE IF deci(wdetail.si) = 530000 THEN ASSIGN nv_dss_per = 8.38    aa = 13000.
    ELSE IF deci(wdetail.si) = 540000 THEN ASSIGN nv_dss_per = 8.24    aa = 13000.   
    ELSE IF deci(wdetail.si) = 550000 THEN ASSIGN nv_dss_per = 8.10    aa = 13000.   
    ELSE IF deci(wdetail.si) = 560000 THEN ASSIGN nv_dss_per = 7.96    aa = 13000.   
    ELSE IF deci(wdetail.si) = 570000 THEN ASSIGN nv_dss_per = 7.83    aa = 13000.            
    ELSE IF deci(wdetail.si) = 580000 THEN ASSIGN nv_dss_per = 7.69    aa = 13000.   
    ELSE IF deci(wdetail.si) = 590000 THEN ASSIGN nv_dss_per = 7.56    aa = 13000.  
    ELSE IF deci(wdetail.si) = 600000 THEN ASSIGN nv_dss_per = 7.43    aa = 13000.
    ELSE IF deci(wdetail.si) = 610000 THEN ASSIGN nv_dss_per = 7.30    aa = 13000.      
    ELSE IF deci(wdetail.si) = 620000 THEN ASSIGN nv_dss_per = 7.18    aa = 13000.
    ELSE IF deci(wdetail.si) = 630000 THEN ASSIGN nv_dss_per = 7.06    aa = 13000.   
    ELSE IF deci(wdetail.si) = 640000 THEN ASSIGN nv_dss_per = 6.94    aa = 13000.   
    ELSE IF deci(wdetail.si) = 650000 THEN ASSIGN nv_dss_per = 6.82    aa = 13000.   
    ELSE IF deci(wdetail.si) = 660000 THEN ASSIGN nv_dss_per = 6.71    aa = 13000.   
    ELSE IF deci(wdetail.si) = 670000 THEN ASSIGN nv_dss_per = 6.60    aa = 13000.  
    ELSE IF deci(wdetail.si) = 680000 THEN ASSIGN nv_dss_per = 6.49    aa = 13000.  
    ELSE IF deci(wdetail.si) = 690000 THEN ASSIGN nv_dss_per = 6.38    aa = 13000.  
    ELSE IF deci(wdetail.si) = 700000 THEN ASSIGN nv_dss_per = 6.28    aa = 13000.
END.
ELSE IF (year(TODAY) - deci(wdetail.caryear)) <= 3 THEN DO:
    ASSIGN WDETAIL.NCB = "20".
    IF      deci(wdetail.si) = 400000   THEN ASSIGN nv_dss_per = 1.99  aa = 13000.
    ELSE IF deci(wdetail.si) = 410000   THEN ASSIGN nv_dss_per = 3.20  aa = 13000.   
    ELSE IF deci(wdetail.si) = 420000   THEN ASSIGN nv_dss_per = 4.37  aa = 13000.   
    ELSE IF deci(wdetail.si) = 430000   THEN ASSIGN nv_dss_per = 5.52  aa = 13000.   
    ELSE IF deci(wdetail.si) = 440000   THEN ASSIGN nv_dss_per = 6.64  aa = 13000.            
    ELSE IF deci(wdetail.si) = 450000   THEN ASSIGN nv_dss_per = 7.73  aa = 13000.   
    ELSE IF deci(wdetail.si) = 460000   THEN ASSIGN nv_dss_per = 8.80  aa = 13000.  
    ELSE IF deci(wdetail.si) = 470000   THEN ASSIGN nv_dss_per = 9.85  aa = 13000.
    ELSE IF deci(wdetail.si) = 480000   THEN ASSIGN nv_dss_per = 9.78  aa = 13000.      
    ELSE IF deci(wdetail.si) = 490000   THEN ASSIGN nv_dss_per = 9.19  aa = 13000.
    ELSE IF deci(wdetail.si) = 500000   THEN ASSIGN nv_dss_per = 8.76  aa = 13000.   
    ELSE IF deci(wdetail.si) = 510000   THEN ASSIGN nv_dss_per = 7.57  aa = 13000.   
    ELSE IF deci(wdetail.si) = 520000   THEN ASSIGN nv_dss_per = 7.44  aa = 13000.   
    ELSE IF deci(wdetail.si) = 530000   THEN ASSIGN nv_dss_per = 7.31  aa = 13000.   
    ELSE IF deci(wdetail.si) = 540000   THEN ASSIGN nv_dss_per = 7.18  aa = 13000.  
    ELSE IF deci(wdetail.si) = 550000   THEN ASSIGN nv_dss_per = 7.04  aa = 13000.  
    ELSE IF deci(wdetail.si) = 560000   THEN ASSIGN nv_dss_per = 6.93  aa = 13000.  
    ELSE IF deci(wdetail.si) = 570000   THEN ASSIGN nv_dss_per = 6.81  aa = 13000.
    ELSE IF deci(wdetail.si) = 580000   THEN ASSIGN nv_dss_per = 6.68  aa = 13000.
    ELSE IF deci(wdetail.si) = 590000   THEN ASSIGN nv_dss_per = 6.57  aa = 13000.
    ELSE IF deci(wdetail.si) = 600000   THEN ASSIGN nv_dss_per = 6.45  aa = 13000.
    ELSE IF deci(wdetail.si) = 610000   THEN ASSIGN nv_dss_per = 6.34  aa = 13000.
    ELSE IF deci(wdetail.si) = 620000   THEN ASSIGN nv_dss_per = 6.23  aa = 13000.
    ELSE IF deci(wdetail.si) = 630000   THEN ASSIGN nv_dss_per = 6.12  aa = 13000.
    ELSE IF deci(wdetail.si) = 640000   THEN ASSIGN nv_dss_per = 6.02  aa = 13000.
END.
ELSE IF (year(TODAY) - deci(wdetail.caryear)) <= 4 THEN DO:
    ASSIGN WDETAIL.NCB = "20".
    IF      deci(wdetail.si) = 380000   THEN ASSIGN nv_dss_per = 1.31  aa = 13000.
    ELSE IF deci(wdetail.si) = 390000   THEN ASSIGN nv_dss_per = 2.56  aa = 13000.
    ELSE IF deci(wdetail.si) = 400000   THEN ASSIGN nv_dss_per = 3.77  aa = 13000.   
    ELSE IF deci(wdetail.si) = 410000   THEN ASSIGN nv_dss_per = 4.95  aa = 13000.          
    ELSE IF deci(wdetail.si) = 420000   THEN ASSIGN nv_dss_per = 6.11  aa = 13000.         
    ELSE IF deci(wdetail.si) = 430000   THEN ASSIGN nv_dss_per = 7.23  aa = 13000.
    ELSE IF deci(wdetail.si) = 440000   THEN ASSIGN nv_dss_per = 8.33  aa = 13000.   
    ELSE IF deci(wdetail.si) = 450000   THEN ASSIGN nv_dss_per = 9.41  aa = 13000.   
    ELSE IF deci(wdetail.si) = 460000   THEN ASSIGN nv_dss_per = 8.82  aa = 13000.   
    ELSE IF deci(wdetail.si) = 470000   THEN ASSIGN nv_dss_per = 8.80  aa = 13000.            
    ELSE IF deci(wdetail.si) = 480000   THEN ASSIGN nv_dss_per = 8.77  aa = 13000.   
    ELSE IF deci(wdetail.si) = 490000   THEN ASSIGN nv_dss_per = 8.73  aa = 13000.  
    ELSE IF deci(wdetail.si) = 500000   THEN ASSIGN nv_dss_per = 8.58  aa = 13000.
    ELSE IF deci(wdetail.si) = 510000   THEN ASSIGN nv_dss_per = 8.43  aa = 13000.      
    ELSE IF deci(wdetail.si) = 520000   THEN ASSIGN nv_dss_per = 8.28  aa = 13000.
    ELSE IF deci(wdetail.si) = 530000   THEN ASSIGN nv_dss_per = 8.14  aa = 13000.   
    ELSE IF deci(wdetail.si) = 540000   THEN ASSIGN nv_dss_per = 8.01  aa = 13000.   
    ELSE IF deci(wdetail.si) = 550000   THEN ASSIGN nv_dss_per = 7.87  aa = 13000.   
    ELSE IF deci(wdetail.si) = 560000   THEN ASSIGN nv_dss_per = 7.74  aa = 13000.   
    ELSE IF deci(wdetail.si) = 570000   THEN ASSIGN nv_dss_per = 7.61  aa = 13000.  
    ELSE IF deci(wdetail.si) = 580000   THEN ASSIGN nv_dss_per = 7.48  aa = 13000.  
    ELSE IF deci(wdetail.si) = 590000   THEN ASSIGN nv_dss_per = 7.35  aa = 13000. 
END.
ELSE RUN proc_dsp_ncb4_y5.
END PROCEDURE.

/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_dsp_ncb4_y5 c-Win 
PROCEDURE proc_dsp_ncb4_y5 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
IF (year(TODAY) - deci(wdetail.caryear)) <= 4 THEN DO:
    ...
    ELSE IF deci(wdetail.si) = 430000   THEN ASSIGN nv_dss_per = 7.23  aa = 13000.
    ELSE IF deci(wdetail.si) = 440000   THEN ASSIGN nv_dss_per = 8.33  aa = 13000.   
    ELSE IF deci(wdetail.si) = 450000   THEN ASSIGN nv_dss_per = 6.66  aa = 13000.   
    ELSE IF deci(wdetail.si) = 460000   THEN ASSIGN nv_dss_per = 6.65  aa = 13000.   
    ELSE IF deci(wdetail.si) = 470000   THEN ASSIGN nv_dss_per = 6.22  aa = 13000.            
    ELSE IF deci(wdetail.si) = 480000   THEN ASSIGN nv_dss_per = 6.08  aa = 13000.   
    ELSE IF deci(wdetail.si) = 490000   THEN ASSIGN nv_dss_per = 5.95  aa = 13000.  
    ELSE IF deci(wdetail.si) = 500000   THEN ASSIGN nv_dss_per = 5.82  aa = 13000.
    ELSE IF deci(wdetail.si) = 510000   THEN ASSIGN nv_dss_per = 5.69  aa = 13000.      
    ELSE IF deci(wdetail.si) = 520000   THEN ASSIGN nv_dss_per = 5.57  aa = 13000.
    ELSE IF deci(wdetail.si) = 530000   THEN ASSIGN nv_dss_per = 5.45  aa = 13000.   
    ELSE IF deci(wdetail.si) = 540000   THEN ASSIGN nv_dss_per = 5.32  aa = 13000.   
    ELSE IF deci(wdetail.si) = 550000   THEN ASSIGN nv_dss_per = 5.21  aa = 13000.
END.
END PROCEDURE.
...
REPEAT:   
    ...
    IMPORT DELIMITER "|" 
        ...
        wdetail2.License            /*  ทะเบียน/License   */                                            
        wdetail2.Li_Province        /*  จังหวัด/Province  */                                        
        wdetail2.Chassis            /*  เลขตัวถัง/Chassis */                                        
        wdetail2.Engine             /*  เลขเครื่อง/Engine */                                        
        wdetail2.model_year         /*  รถปี/Model year   */                                            
        ...
        wdetail2.Insured_Amount     /*  จำนวนเงินเอาประกันภัย/ Insured Amount  */    
        wdetail2.Voluntary          /*  ค่าเบี้ยประกันภัย/ Insurance Premium ประกันภัย/Voluntary */
        wdetail2.Compulsory         /*  พรบ./Compulsory  */                                        
        wdetail2.nTotal             /*  รวม/Total        */                                                
...
FOR EACH wdetail2.
    ...
    ELSE DO:
        /*add by Kridtiya i. A57-0010....*/
            FIND FIRST brstat.msgcode WHERE      /*mat Title name...*/
                brstat.msgcode.compno = "999"  AND
                brstat.msgcode.MsgDesc = TRIM(wdetail2.ntitle)  NO-LOCK NO-WAIT NO-ERROR.
            IF AVAIL brstat.msgcode THEN ASSIGN wdetail2.ntitle = brstat.msgcode.branch  .
            FIND FIRST brstat.insure USE-INDEX Insure05   WHERE   /*Match Provin.licence  */
                brstat.insure.compno = "999" AND
                brstat.Insure.fName  = TRIM(wdetail2.Li_Province) NO-LOCK NO-WAIT NO-ERROR.
            IF AVAIL brstat.insure THEN  
                ASSIGN wdetail2.Li_Province = TRIM(brstat.insure.LName) .
            FIND FIRST stat.company USE-INDEX Company01 WHERE 
                company.compno = TRIM(wdetail2.finance_Comp)  NO-LOCK NO-ERROR NO-WAIT.
            IF AVAIL stat.company THEN ASSIGN  wdetail2.finance_Comp  = trim(stat.company.name). 
            /*end... by Kridtiya i. A57-0010.......*/
        FIND LAST sicuw.uwm301 USE-INDEX uwm30103 WHERE 
            sicuw.uwm301.trareg = TRIM(wdetail2.Chassis) AND
            SUBSTR(sicuw.uwm301.policy,3,2)  = "70"      NO-LOCK NO-ERROR NO-WAIT.
        IF AVAIL sicuw.uwm301  THEN  ASSIGN wdetail2.prepol = trim(sicuw.uwm301.policy).
        ELSE ASSIGN wdetail2.prepol = "".
...
REPEAT:   
    ...
    IMPORT DELIMITER "|" 
        ...
        wdetail2.companyins             /*  บริษัทประกันภย */                                            
        wdetail2.policy72               /*  กรมธรรมุ้คุ้มครองผู้ประสบภัยจากรถ (พรบ.) เลขที่     */            
        wdetail2.nn_class72             /*  ระยะเวลาคุ้มครอง/Period Insured วันเริ่มต้น Start   */            
        wdetail2.nn_seat72              /*  วันสิ้นสุด Expiry   */                                        
        wdetail2.nn_stk                 /*  กรมธรรม์เดิม        */                                            
        wdetail2.nn_docno               /*  เลขรับแจ้ง      */                                                
        wdetail2.comdat72               /*  Remark      */                                                    
        wdetail2.expdat72               /*  เลขบัตรประชาชน      */
        wdetail2.prepol                 /*  ที่อยู่จัดส่งเอกสาร     ทีอยู่ที่ติดต่อได้/ Contact Address */
        wdetail2.nn_noti70              /*  ตำบล/   Sub District  */
        wdetail2.nn_class70           
        wdetail2.nn_seat70          
        wdetail2.remark             
        wdetail2.icno            
...
FOR EACH wdetail2.
    ...
    ELSE IF wdetail2.number  = ""    THEN DELETE wdetail2.
    ELSE DO:
        IF SUBSTR(trim(wdetail2.nn_stk),1,1) <> "0"  THEN wdetail2.nn_stk = "0" + trim(wdetail2.nn_stk).
...
DO TRANSACTION:
   ASSIGN
      ...
      sic_bran.uwm100.opnpol = trim(fi_prom)
...
IF AVAIL sicuw.uwm100  THEN DO:
    IF sicuw.uwm100.renpol <> " " THEN DO:
        MESSAGE "กรมธรรณ์มีการต่ออายุแล้ว...."  sicuw.uwm100.policy  VIEW-AS ALERT-BOX .
        ASSIGN  
...
DO WHILE nv_line1 <= 8:
    ...
    IF nv_line1 = 4  THEN wuppertxt3.txt =  wdetail.f18line1.   
    IF nv_line1 = 5  THEN wuppertxt3.txt =  wdetail.f18line2.   
    IF nv_line1 = 6  THEN wuppertxt3.txt =  wdetail.f18line3.   
    IF nv_line1 = 7  THEN wuppertxt3.txt =  wdetail.f18line4.   
    nv_line1 = nv_line1 + 1.                                                
END.
...
FOR EACH wdetail2  NO-LOCK 
    ...
    IF (TRIM(wdetail2.Compulsory) <> "-") OR (TRIM(wdetail2.Compulsory) <> "")  THEN DO:
        FIND LAST wcomp WHERE wcomp.premcomp = deci(wdetail2.Compulsory) NO-LOCK NO-ERROR.
   ...
   PUT STREAM ns2 "C;Y" STRING(nv_row) ";X18;K" '"'  wdetail2.License           '"' SKIP.  
   PUT STREAM ns2 "C;Y" STRING(nv_row) ";X19;K" '"'  wdetail2.Li_Province       '"' SKIP.  
   PUT STREAM ns2 "C;Y" STRING(nv_row) ";X20;K" '"'  wdetail2.Chassis           '"' SKIP.  
   PUT STREAM ns2 "C;Y" STRING(nv_row) ";X21;K" '"'  wdetail2.Engine            '"' SKIP.  
   PUT STREAM ns2 "C;Y" STRING(nv_row) ";X22;K" '"'  wdetail2.model_year        '"' SKIP.  
   ...
   PUT STREAM ns2 "C;Y" STRING(nv_row) ";X27;K" '"'  wdetail2.Insured_Amount    '"' SKIP. 
   PUT STREAM ns2 "C;Y" STRING(nv_row) ";X28;K" '"'  string(ROUND(((deci(wdetail2.Voluntary) * 100 ) / 107.43),0)) '"' SKIP.  
   PUT STREAM ns2 "C;Y" STRING(nv_row) ";X29;K" '"'  wdetail2.Voluntary         '"' SKIP.  
   PUT STREAM ns2 "C;Y" STRING(nv_row) ";X30;K" '"'  string(truncate(((deci(wdetail2.Compulsory) * 100 ) / 107.43),0)) '"' SKIP. 
   PUT STREAM ns2 "C;Y" STRING(nv_row) ";X31;K" '"'  wdetail2.Compulsory        '"' SKIP.  
   PUT STREAM ns2 "C;Y" STRING(nv_row) ";X32;K" '"'  wdetail2.nTotal            '"' SKIP.  
   ...
   PUT STREAM ns2 "C;Y" STRING(nv_row) ";X42;K" '"'  wdetail2.prepol            '"' SKIP.   
