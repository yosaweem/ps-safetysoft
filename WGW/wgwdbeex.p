...
/* Duppicate from  : wgwbu2ex.p                               */             
/* Modify by      : Ranu i.  A60-0050  Date : 25/02/2016                    */
...
DEFINE INPUT-OUTPUT  PARAMETER np_com1      AS DECI FORMAT ">>>,>>>,>>9.99-" .
DEFINE INPUT-OUTPUT  PARAMETER n_premt      AS DECI FORMAT ">>>,>>>,>>9.99". /*A64-0138*/
/*Add kridtiya i. A56-0151*/
    ...
    IF AVAIL uwm301 THEN DO:
        ...
        FOR EACH sic_exp.uwd132 USE-INDEX uwd13290  WHERE
            ...
            IF sic_exp.uwd132.bencod <> "comp"  THEN DO:
                n_premt = n_premt + sic_exp.uwd132.prem_c.  /* create by : A64-0138...*/
