...
program name : Query Make/Model Details
Create  by   : Kridtiya i. [A57-0088]   On   07/03/2014
Connect      : GW_SAFE LD SIC_BRAN, SICSYAC SICUW  Stat
+++++++++++++++++++++++++++++++++++++++++++++++*/

/*DEF VAR n_branch As   Char    Format    "x(40)".
DEF VAR n_brand  As   Char    Format    "x(20)".
DEF VAR n_year   As   Char    Format    "x(10)".
DEF VAR n_engcc  As   DECI    Format    "->>,>>9.99".*/
...
maktab_fil.makdes maktab_fil.moddes maktab_fil.maksi maktab_fil.si ~
maktab_fil.makyea maktab_fil.engine maktab_fil.tons maktab_fil.seats 
...
fi_brand1 fi_model1 fi_caryear Bu_ch3 fi_brand fi_model fi_caryear1 br_tlt ~
fi_class Bu_ch4 fi_readbook fi_class3 Bu_ch5 bu_exit btnFirst btnPrev ~
btnNext btnLast fi_makmodel fi_marketprice fi_redbook RECT-332 RECT-340 ~
...
fi_class3 fi_makmodel fi_marketprice fi_redbook 
...
DEFINE VARIABLE fi_makmodel AS CHARACTER FORMAT "X(50)":U 
     VIEW-AS FILL-IN 
     SIZE 72 BY .95
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE fi_marketprice AS CHARACTER FORMAT "X(25)":U 
     VIEW-AS FILL-IN 
     SIZE 19 BY .95
     BGCOLOR 15  NO-UNDO.
...
DEFINE VARIABLE fi_redbook AS CHARACTER FORMAT "X(10)":U 
     VIEW-AS FILL-IN 
     SIZE 15 BY .95
     BGCOLOR 15  NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_tlt c-wins _STRUCTURED
  QUERY br_tlt NO-LOCK DISPLAY
      maktab_fil.sclass COLUMN-LABEL "คลาส" FORMAT "x(4)":U WIDTH 4.83
      maktab_fil.modcod COLUMN-LABEL "ReadBook" FORMAT "x(10)":U
            WIDTH 11.5
      maktab_fil.makdes COLUMN-LABEL "Brand" FORMAT "x(30)":U WIDTH 13.67
      maktab_fil.moddes COLUMN-LABEL "Model" FORMAT "x(40)":U WIDTH 44.83
      maktab_fil.maksi COLUMN-LABEL "Market Price" FORMAT ">,>>>,>>>,>>9":U
            WIDTH 12
      maktab_fil.si FORMAT ">>>,>>>,>>9":U WIDTH 12
      maktab_fil.makyea COLUMN-LABEL "Year" FORMAT "9999":U WIDTH 5.5
      maktab_fil.engine COLUMN-LABEL "CC's" FORMAT ">>>>9":U WIDTH 6.33
      maktab_fil.tons COLUMN-LABEL "Tons" FORMAT ">>>9.99":U WIDTH 6
      maktab_fil.seats COLUMN-LABEL "Seats" FORMAT ">>9":U WIDTH 5.5
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS NO-COLUMN-SCROLLING SEPARATORS NO-TAB-STOP SIZE 132.5 BY 13.76
...
DEFINE FRAME fr_main
     ...
     bu_exit AT ROW 1.95 COL 120.5
     btnFirst AT ROW 8.48 COL 64.5
     btnPrev AT ROW 8.48 COL 70.17
     btnNext AT ROW 8.48 COL 75.83
     btnLast AT ROW 8.48 COL 81.67
     fi_makmodel AT ROW 9.62 COL 13.17 COLON-ALIGNED NO-LABEL
     fi_marketprice AT ROW 8.48 COL 43 COLON-ALIGNED NO-LABEL
     fi_redbook AT ROW 8.48 COL 13.17 COLON-ALIGNED NO-LABEL
     " รุ่นรถ :" VIEW-AS TEXT
     ...
     "  Redbook :" VIEW-AS TEXT
          SIZE 11 BY .95 AT ROW 8.48 COL 3.5
          BGCOLOR 2 FGCOLOR 7 FONT 6
     "      Model :" VIEW-AS TEXT
          SIZE 11 BY .95 AT ROW 9.62 COL 3.5
          BGCOLOR 2 FGCOLOR 7 FONT 6
     " Market Price :" VIEW-AS TEXT
          SIZE 14 BY .95 AT ROW 8.48 COL 30.67
          BGCOLOR 2 FGCOLOR 7 FONT 6
     " Class :" VIEW-AS TEXT
...
/* SETTINGS FOR FRAME fr_main
   FRAME-NAME Custom                                                    */
/* BROWSE-TAB br_tlt fi_caryear1 fr_main */
...
"maktab_fil.sclass" "คลาส" ? "character" ? ? ? ? ? ? no ? no no "4.83" yes no no "U" "" ""
     _FldNameList[2]   > stat.maktab_fil.modcod
"maktab_fil.modcod" "ReadBook" "x(10)" "character" ? ? ? ? ? ? no ? no no "11.5" yes no no "U" "" ""
     _FldNameList[3]   > stat.maktab_fil.makdes
"maktab_fil.makdes" "Brand" "x(30)" "character" ? ? ? ? ? ? no ? no no "13.67" yes no no "U" "" ""
     _FldNameList[4]   > stat.maktab_fil.moddes
"maktab_fil.moddes" "Model" ? "character" ? ? ? ? ? ? no ? no no "44.83" yes no no "U" "" ""
     _FldNameList[5]   > stat.maktab_fil.maksi
"maktab_fil.maksi" "Market Price" ? "integer" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" ""
     _FldNameList[6]   > stat.maktab_fil.si
"maktab_fil.si" ? ">>>,>>>,>>9" "integer" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" ""
     _FldNameList[7]   > stat.maktab_fil.makyea
"maktab_fil.makyea" "Year" ? "integer" ? ? ? ? ? ? no ? no no "5.5" yes no no "U" "" ""
     _FldNameList[8]   > stat.maktab_fil.engine
"maktab_fil.engine" "CC's" ? "integer" ? ? ? ? ? ? no ? no no "6.33" yes no no "U" "" ""
     _FldNameList[9]   > stat.maktab_fil.tons
"maktab_fil.tons" "Tons" ? "decimal" ? ? ? ? ? ? no ? no no "6" yes no no "U" "" ""
     _FldNameList[10]   > stat.maktab_fil.seats
"maktab_fil.seats" "Seats" ? "integer" ? ? ? ? ? ? no ? no no "5.5" yes no no "U" "" ""
...
DO:
    ...
    Get  current  br_tlt.
    nv_recidtlt  =  Recid(stat.maktab_fil).
   /* {&WINDOW-NAME}:hidden  =  Yes. 
    Run  wgw\wgwqtis4(Input  nv_recidtlt).
...
DO:
  GET FIRST br_tlt.
  IF NOT AVAIL stat.maktab_fil THEN RETURN NO-APPLY.  
  REPOSITION br_tlt TO ROWID ROWID (stat.maktab_fil).
...
DO:
    Open Query br_tlt 
        ...
        BY stat.maktab_fil.si    .
            RUN pdDispIns IN THIS-PROCEDURE.
            ASSIGN nv_recidtlt  =  Recid(stat.maktab_fil).
...
ON CHOOSE OF Bu_ch3 IN FRAME fr_main /* Search */
DO:
    Open Query br_tlt 
        FOR EACH stat.maktab_fil  USE-INDEX maktab04 NO-LOCK WHERE
...
------------------------------------------------------------------------------*/
  DISPLAY fi_brand3 fi_brand2 fi_model2 fi_brand1 fi_model1 fi_caryear fi_brand 
          fi_model fi_caryear1 fi_class fi_readbook fi_class3 fi_makmodel 
          fi_marketprice fi_redbook 
      WITH FRAME fr_main IN WINDOW c-wins.
  ENABLE fi_brand3 Bu_ch1 fi_brand2 fi_model2 Bu_ch2 fi_brand1 fi_model1 
         fi_caryear Bu_ch3 fi_brand fi_model fi_caryear1 br_tlt fi_class Bu_ch4 
         fi_readbook fi_class3 Bu_ch5 bu_exit btnFirst btnPrev btnNext btnLast 
         fi_makmodel fi_marketprice fi_redbook RECT-332 RECT-340 RECT-341 
         RECT-2 RECT-3 RECT-4 RECT-5 RECT-6 
      WITH FRAME fr_main IN WINDOW c-wins.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdDispIns c-wins 
PROCEDURE pdDispIns :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
------------------------------------------------------------------------------*/
DISPLAY 
    stat.maktab_fil.modcod  @ fi_redbook    
    stat.maktab_fil.maksi   @ fi_marketprice
    stat.maktab_fil.moddes  @ fi_makmodel
    WITH FRAME fr_main. 
END PROCEDURE.
