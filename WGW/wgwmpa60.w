...
/*++++++++++++++++++++++++++++++++++++++++++++++
  program id   : wgwmpa60.w   [Menu Import Text file PA60 PMIB] 
...
RECT-347 RECT-344 RECT-348 RECT-350 bu_update bu_import72 bu_gen bu_gen-2 ~
bu_mat bu_mat-2 bu_exit 
...
DEFINE BUTTON bu_import72 
     LABEL "MATCH POLICY M60" 
     SIZE 42 BY 1.24
     BGCOLOR 15 FGCOLOR 2 FONT 6.

DEFINE BUTTON bu_mat 
     LABEL "LOAD DATA PA60" 
     SIZE 42 BY 1.24
     BGCOLOR 15 FGCOLOR 2 FONT 6.
...
DEFINE FRAME DEFAULT-FRAME
     bu_update AT ROW 3.91 COL 5.67
     bu_import72 AT ROW 3.91 COL 51.33
     bu_gen AT ROW 6.1 COL 5.33
     bu_gen-2 AT ROW 6.1 COL 51
     bu_mat AT ROW 8.19 COL 5.33
     bu_mat-2 AT ROW 8.19 COL 51
     bu_exit AT ROW 10.86 COL 45.83
     "                                        MENU LOAD TEX FILE PMIB PA60" VIEW-AS TEXT
          SIZE 87.83 BY 1.24 AT ROW 1.62 COL 5.67
          BGCOLOR 1 FGCOLOR 7 FONT 6
     RECT-329 AT ROW 1 COL 1
     RECT-342 AT ROW 3.57 COL 4.17
     RECT-343 AT ROW 10.43 COL 44
     RECT-346 AT ROW 5.67 COL 4.17
     RECT-349 AT ROW 1.24 COL 4.17
     RECT-347 AT ROW 7.81 COL 4.17
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Import And Export Data PMIB PA60"
         HEIGHT             = 12
         WIDTH              = 97.33
         MAX-HEIGHT         = 33.91
         MAX-WIDTH          = 170.67
...
ON END-ERROR OF C-Win /* Import And Export Data PMIB PA60 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Import And Export Data PMIB PA60 */
DO:
...
ON CHOOSE OF bu_gen IN FRAME DEFAULT-FRAME /* QUERY DATA PA60 */
DO:
...
ON CHOOSE OF bu_import72 IN FRAME DEFAULT-FRAME /* MATCH POLICY M60 */
DO:
     {&WINDOW-NAME} :Hidden = Yes.
        Run  wgw\wgwmat60.  
     {&WINDOW-NAME} :Hidden = No.
...
ON CHOOSE OF bu_mat IN FRAME DEFAULT-FRAME /* LOAD DATA PA60 */
DO:
    {&WINDOW-NAME} :Hidden = Yes.
    Run  wgw\wgwgen60.  
    {&WINDOW-NAME} :Hidden = No.
...
ON CHOOSE OF bu_update IN FRAME DEFAULT-FRAME /* IMPORT FILE TO TLT */
DO:
    {&WINDOW-NAME} :Hidden = Yes.
    Run  wgw\wgwimpa60.  
    {&WINDOW-NAME} :Hidden = No.
...
/********************  T I T L E   F O R  C - W I N  ****************/
  ...
  gv_prgid = "wgwmpa60.w".
  gv_prog  = "Import And Export Data PMIB60".
...
------------------------------------------------------------------------------*/
  ENABLE RECT-329 RECT-342 RECT-343 RECT-346 RECT-349 RECT-347 RECT-344 
         RECT-348 RECT-350 bu_update bu_import72 bu_gen bu_gen-2 bu_mat 
         bu_mat-2 bu_exit 
