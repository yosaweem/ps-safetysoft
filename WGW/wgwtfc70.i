...
/*Mofify by   : Ranu i. A65-0035 ขยายฟอร์แมตตัวแปร class*/
...
/*DEF VAR engno           AS CHAR FORMAT "x(25)"  INIT ""  . */ /*A65-0035*/ 
/*DEF VAR engno           AS CHAR FORMAT "x(30)"  INIT ""  .    /*A65-0035*//*A65-0356*/
...
/*DEF VAR package         AS CHAR FORMAT "x(4)"  INIT "" . */  /*A65-0035*/
DEF VAR package         AS CHAR FORMAT "x(5)"  INIT "" .   /*A65-0035*/
...
/*DEF VAR class           AS CHAR FORMAT "X(3)"  INIT "" . *//*A65-0035*/
DEF VAR class           AS CHAR FORMAT "X(4)"  INIT "" .  /*A65-0035*/
...
def var polno    as char format "x(20)" init "" .
...
DEFINE TEMP-TABLE wdetail 
    ...
    /*FIELD eng          AS CHAR FORMAT "x(25)" INIT ""       /*  6   Engine*/  */ /*A65-0035*/   
    /*FIELD eng          AS CHAR FORMAT "x(30)" INIT ""       /*  6   Engine*/   /*A65-0035*//*A65-0356*/  
    FIELD chasno       AS CHAR FORMAT "x(25)" INIT ""  */     /*  7   Chassis*//*A65-0356*/   
    FIELD eng          AS CHAR FORMAT "x(35)" INIT ""       /*  6   Engine*/   /*A65-0035*//*A65-0356*/  
    ...
    FIELD vehreg       AS CHAR FORMAT "x(25)" INIT ""       /*  11  licence no*/    /*A54-0112*//*A65-0356*/
...
DEFINE  WORKFILE wcomp NO-UNDO
      ...
      FIELD ev          AS CHAR FORMAT "x(2)" INIT "N" . /*a67-0087*/
...
DEFINE TEMP-TABLE tbinsurid 
    ...
    FIELD insurbr    AS CHAR FORMAT "x(5)"   INIT "" .  /*A65-0035*/ 
