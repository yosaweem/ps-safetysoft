...
&Scoped-Define ENABLED-OBJECTS fi_loaddat fi_companoti fi_pack fi_pack2 ~
fi_branch fi_producer_c fi_rectyp1 fi_producer_n fi_agent fi_prevbat ~
...
bu_hpacno2 fi_process fi_rectyp2 fi_pack3 fi_pack5 fi_pack_01 fi_pack_02 ~
fi_pack_03 fi_pack_05 RECT-368 RECT-370 RECT-372 RECT-373 RECT-376 RECT-379 ~
RECT-380 
&Scoped-Define DISPLAYED-OBJECTS fi_loaddat fi_companoti fi_pack fi_pack2 ~
fi_bchno fi_branch fi_producer_c fi_rectyp1 fi_producer_n fi_agent ~
...
fi_pronamenew fi_process fi_rectyp2 fi_pack3 fi_premtot fi_pack5 fi_pack_01 ~
fi_premsuc fi_pack_02 fi_pack_03 fi_pack_05 
...
DEFINE VARIABLE fi_pack_01 AS CHARACTER FORMAT "X(1)":U 
     VIEW-AS FILL-IN 
     SIZE 5 BY .95
     BGCOLOR 15 FGCOLOR 0 FONT 6 NO-UNDO.

DEFINE VARIABLE fi_pack_02 AS CHARACTER FORMAT "X(1)":U 
     VIEW-AS FILL-IN 
     SIZE 5.33 BY .95
     BGCOLOR 15 FGCOLOR 0 FONT 6 NO-UNDO.

DEFINE VARIABLE fi_pack_03 AS CHARACTER FORMAT "X(1)":U 
     VIEW-AS FILL-IN 
     SIZE 5.33 BY .95
     BGCOLOR 15 FGCOLOR 0 FONT 6 NO-UNDO.

DEFINE VARIABLE fi_pack_05 AS CHARACTER FORMAT "X(1)":U 
     VIEW-AS FILL-IN 
     SIZE 5.33 BY .95
     BGCOLOR 15 FGCOLOR 0 FONT 6 NO-UNDO.
...
DEFINE VARIABLE fi_producer_c AS CHARACTER FORMAT "X(10)":U 
     VIEW-AS FILL-IN 
     SIZE 15.5 BY .95
     BGCOLOR 15 FGCOLOR 0  NO-UNDO.

DEFINE VARIABLE fi_producer_n AS CHARACTER FORMAT "X(10)":U 
     VIEW-AS FILL-IN 
     SIZE 15.5 BY .95
     BGCOLOR 15 FGCOLOR 0  NO-UNDO.
...
DEFINE VARIABLE fi_pronamenew AS CHARACTER FORMAT "X(40)":U 
     VIEW-AS FILL-IN 
     SIZE 40 BY .95
     BGCOLOR 19 FGCOLOR 1  NO-UNDO.

DEFINE VARIABLE fi_rectyp1 AS CHARACTER FORMAT "X(25)":U 
     VIEW-AS FILL-IN 
     SIZE 12 BY .95
     BGCOLOR 15 FGCOLOR 0  NO-UNDO.

DEFINE VARIABLE fi_rectyp2 AS CHARACTER FORMAT "X(25)":U 
     VIEW-AS FILL-IN 
     SIZE 12 BY .95
     BGCOLOR 15 FGCOLOR 0  NO-UNDO.
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 130 BY 4
         BGCOLOR 15 FONT 6.
...
DEFINE FRAME fr_main
     fi_loaddat AT ROW 2.71 COL 26.5 COLON-ALIGNED NO-LABEL
     fi_companoti AT ROW 2.71 COL 58.83 COLON-ALIGNED NO-LABEL
     fi_pack AT ROW 5.91 COL 43 COLON-ALIGNED NO-LABEL
     fi_pack2 AT ROW 5.91 COL 65 COLON-ALIGNED NO-LABEL
     fi_bchno AT ROW 23.1 COL 17 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi_branch AT ROW 3.76 COL 26.5 COLON-ALIGNED NO-LABEL
     fi_producer_c AT ROW 4.81 COL 26.5 COLON-ALIGNED NO-LABEL
     fi_rectyp1 AT ROW 4.81 COL 56.67 COLON-ALIGNED NO-LABEL
     fi_producer_n AT ROW 6.95 COL 26.5 COLON-ALIGNED NO-LABEL
     fi_agent AT ROW 9.05 COL 26.5 COLON-ALIGNED NO-LABEL
     fi_prevbat AT ROW 10.1 COL 26.5 COLON-ALIGNED NO-LABEL
     fi_bchyr AT ROW 10.1 COL 58.5 COLON-ALIGNED NO-LABEL
     fi_filename AT ROW 11.14 COL 26.5 COLON-ALIGNED NO-LABEL
     bu_file AT ROW 11.14 COL 89.17
     fi_output1 AT ROW 12.19 COL 26.5 COLON-ALIGNED NO-LABEL
     fi_output2 AT ROW 13.19 COL 26.5 COLON-ALIGNED NO-LABEL
     fi_output3 AT ROW 14.24 COL 26.5 COLON-ALIGNED NO-LABEL
     fi_usrcnt AT ROW 16.29 COL 26.5 COLON-ALIGNED NO-LABEL
     fi_usrprem AT ROW 16.43 COL 67.5 NO-LABEL
     buok AT ROW 11.62 COL 104.5
     bu_exit AT ROW 13.52 COL 104.67
     fi_brndes AT ROW 3.76 COL 37.5 COLON-ALIGNED NO-LABEL
     bu_hpbrn AT ROW 3.76 COL 35
     fi_impcnt AT ROW 22.52 COL 60.33 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     bu_hpacno1 AT ROW 4.81 COL 44.83
     bu_hpagent AT ROW 9.05 COL 43.17
     fi_proname AT ROW 4.81 COL 69.17 COLON-ALIGNED NO-LABEL
     fi_agtname AT ROW 9.05 COL 45.83 COLON-ALIGNED NO-LABEL
     br_wdetail AT ROW 17.81 COL 2
     bu_hpacno2 AT ROW 6.95 COL 44.5
     fi_completecnt AT ROW 23.52 COL 60.33 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi_pronamenew AT ROW 6.95 COL 69.5 COLON-ALIGNED NO-LABEL
     fi_process AT ROW 15.24 COL 26.5 COLON-ALIGNED NO-LABEL
     fi_rectyp2 AT ROW 6.95 COL 56.67 COLON-ALIGNED NO-LABEL
     fi_pack3 AT ROW 5.91 COL 87.5 COLON-ALIGNED NO-LABEL
     fi_premtot AT ROW 22.52 COL 98.17 NO-LABEL NO-TAB-STOP 
     fi_pack5 AT ROW 5.91 COL 110 COLON-ALIGNED NO-LABEL
     fi_pack_01 AT ROW 8 COL 42.67 COLON-ALIGNED NO-LABEL
     fi_premsuc AT ROW 23.52 COL 96.17 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi_pack_02 AT ROW 8 COL 64.67 COLON-ALIGNED NO-LABEL
     fi_pack_03 AT ROW 8 COL 87.17 COLON-ALIGNED NO-LABEL
     fi_pack_05 AT ROW 8 COL 109.67 COLON-ALIGNED NO-LABEL
     "                  Branch :" VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 3.76 COL 5
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Package Cov3 :" VIEW-AS TEXT
          SIZE 15.5 BY .95 AT ROW 5.91 COL 73
          BGCOLOR 2 FGCOLOR 7 FONT 6
     "Package Cov5 :" VIEW-AS TEXT
          SIZE 15.5 BY .95 AT ROW 5.91 COL 95.5
          BGCOLOR 2 FGCOLOR 7 FONT 6
     "Output Data Load :" VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 12.19 COL 5
          BGCOLOR 8 FGCOLOR 1 
     "Package Cov 1:" VIEW-AS TEXT
          SIZE 15.5 BY .95 AT ROW 8.05 COL 29
          BGCOLOR 2 FGCOLOR 7 FONT 6
     "Success Record :" VIEW-AS TEXT
          SIZE 17.5 BY .95 AT ROW 23.52 COL 58.83 RIGHT-ALIGNED
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Package Cov5 :" VIEW-AS TEXT
          SIZE 15.5 BY .95 AT ROW 8.05 COL 95.5
          BGCOLOR 2 FGCOLOR 7 FONT 6
...
DEFINE FRAME fr_main
     ...
     "     Total Record :":60 VIEW-AS TEXT
          SIZE 17.5 BY .95 AT ROW 22.52 COL 58.83 RIGHT-ALIGNED
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Previous Batch No.  :" VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 10.1 COL 5
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Total Net Premium Imp  :":60 VIEW-AS TEXT
          SIZE 23.5 BY .95 AT ROW 16.43 COL 42.83
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "                Load Date :":35 VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 2.71 COL 5
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "       Batch File Name :" VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 14.29 COL 5
          BGCOLOR 8 FGCOLOR 1 
     "RecType" VIEW-AS TEXT
          SIZE 9 BY .95 AT ROW 4.81 COL 49.33
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "         Producer  Code :" VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 4.81 COL 5
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Batch No. :" VIEW-AS TEXT
          SIZE 11.5 BY .95 AT ROW 23.1 COL 6.5
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Input File Name Load :" VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 11.14 COL 5
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "BHT.":60 VIEW-AS TEXT
          SIZE 6 BY .95 AT ROW 16.43 COL 85.33
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "    Policy Import Total :":60 VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 16.33 COL 5
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Batch Year :" VIEW-AS TEXT
          SIZE 12.83 BY .95 AT ROW 10.1 COL 47
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Package Cov2 :" VIEW-AS TEXT
          SIZE 15.5 BY .95 AT ROW 8.05 COL 50.5
          BGCOLOR 2 FGCOLOR 7 FONT 6
     "    Load Text File ICBC" VIEW-AS TEXT
          SIZE 128.5 BY .95 AT ROW 1.24 COL 2.5
          BGCOLOR 1 FGCOLOR 7 FONT 6
     "         Producer  Code :" VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 6.95 COL 5
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Output Data Not Load :" VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 13.24 COL 5
          BGCOLOR 8 FGCOLOR 1 
     "BHT.":60 VIEW-AS TEXT
          SIZE 6 BY .95 AT ROW 22.52 COL 117.17
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Package Cov 1:" VIEW-AS TEXT
          SIZE 15.5 BY .95 AT ROW 5.91 COL 29
          BGCOLOR 2 FGCOLOR 7 FONT 6
     "              Agent Code  :" VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 9.05 COL 5
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "BHT.":60 VIEW-AS TEXT
          SIZE 6 BY .95 AT ROW 23.52 COL 117.17
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "CompanyNotify :" VIEW-AS TEXT
          SIZE 15.5 BY .95 AT ROW 2.71 COL 44.67
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "   Total Net Premium  :" VIEW-AS TEXT
          SIZE 21.5 BY .95 AT ROW 22.52 COL 95.83 RIGHT-ALIGNED
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Package Cov2 :" VIEW-AS TEXT
          SIZE 15.5 BY .95 AT ROW 5.91 COL 50.5
          BGCOLOR 2 FGCOLOR 7 FONT 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
...
DEFINE FRAME fr_main
     "Package Cov3 :" VIEW-AS TEXT
          SIZE 15.5 BY .95 AT ROW 8.05 COL 73
          BGCOLOR 2 FGCOLOR 7 FONT 6
     "RecType" VIEW-AS TEXT
          SIZE 9 BY .95 AT ROW 6.95 COL 49
          BGCOLOR 8 FGCOLOR 1 FONT 6
     RECT-368 AT ROW 15.67 COL 40.83
     RECT-370 AT ROW 1 COL 1
     RECT-372 AT ROW 2.52 COL 1
     RECT-373 AT ROW 17.62 COL 1
     RECT-376 AT ROW 22.19 COL 1
     RECT-379 AT ROW 11.29 COL 103
     RECT-380 AT ROW 13.1 COL 103
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 133 BY 24
...
/* SETTINGS FOR FILL-IN fi_proname IN FRAME fr_main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN fi_pronamenew IN FRAME fr_main
   NO-ENABLE                                                            */
...
DO:
    ...
    IF fi_branch = " " THEN DO: 
        ...
        RETURN NO-APPLY.
    END.
    IF fi_producer_c = " " THEN DO:
        MESSAGE "Producer code is Mandatory" VIEW-AS ALERT-BOX .
        APPLY "entry" TO fi_producer_c.
        RETURN NO-APPLY.
    END.
    IF fi_agent = " " THEN DO:
    ...
    IF nv_batprev = "" THEN DO:  
        FIND LAST uzm700 USE-INDEX uzm70002      WHERE 
            ...
            uzm700.acno    = TRIM(fi_producer_c) AND
        ...
        IF AVAIL uzm700 THEN DO:   
            ...
            FIND LAST uzm701 USE-INDEX uzm70102     WHERE 
                ...
                uzm701.bchno   = trim(fi_producer_c) + TRIM(nv_batbrn) + string(nv_batrunno,"9999")  NO-LOCK NO-ERROR.
        ...
        ELSE  
            ASSIGN nv_batcnt = 1
                nv_batrunno  = 1.
        ASSIGN nv_batchno = CAPS(fi_producer_c) + CAPS(nv_batbrn) + STRING(nv_batrunno,"9999").
    END.
    ELSE DO:  
    ...
    ASSIGN
        ...
        fi_producer_c = INPUT fi_producer_c  fi_agent        = INPUT fi_agent 
...
DO:
    ...
    Run whp\whpacno1(output  n_acno, /*a490166 note modi*/ /*28/11/2006*/
                     output  n_agent).
    If  n_acno  <>  ""  Then  fi_producer_c =  n_acno.
    disp  fi_producer_c  with frame  fr_main.
    Apply "Entry"  to  fi_producer_c.
    Return no-apply.
END.
...
DO:
   ...
   Run whp\whpacno1(output  n_acno, /*a490166 note modi*/ /*28/11/2006*/
     ...
     If  n_acno  <>  ""  Then  fi_producer_n =  n_acno.
     
     disp  fi_producer_n  fi_pronamenew  with frame  fr_main.

     Apply "Entry"  to  fi_producer_n.
     Return no-apply.
...
&Scoped-define SELF-NAME fi_pack_01
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_pack_01 c-Win
ON LEAVE OF fi_pack_01 IN FRAME fr_main
DO:
    fi_pack_01  =  Input  fi_pack_01.
    Disp  fi_pack_01  with  frame  fr_main.
END.
...
&Scoped-define SELF-NAME fi_pack_02
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_pack_02 c-Win
ON LEAVE OF fi_pack_02 IN FRAME fr_main
DO:
    fi_pack_02  =  Input  fi_pack_02.
    Disp  fi_pack_02  with  frame  fr_main.
END.
...
&Scoped-define SELF-NAME fi_pack_03
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_pack_03 c-Win
ON LEAVE OF fi_pack_03 IN FRAME fr_main
DO:
    fi_pack_03  =  Input  fi_pack_03.
    Disp  fi_pack_03  with  frame  fr_main.
END.
...
&Scoped-define SELF-NAME fi_pack_05
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_pack_05 c-Win
ON LEAVE OF fi_pack_05 IN FRAME fr_main
DO:
    fi_pack_05  =  Input  fi_pack_05.
    Disp  fi_pack_05  with  frame  fr_main.
END.
...
&Scoped-define SELF-NAME fi_producer_c
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_producer_c c-Win
ON LEAVE OF fi_producer_c IN FRAME fr_main
DO:
    fi_producer_c = caps( INPUT fi_producer_c )  .
    IF  fi_producer_c <> " " THEN DO:
        FIND sicsyac.xmm600 USE-INDEX xmm60001      WHERE
            sicsyac.xmm600.acno  =  Input fi_producer_c  NO-LOCK NO-ERROR NO-WAIT.
        IF NOT AVAIL sicsyac.xmm600 THEN DO:
        ...
        ELSE DO:
            ASSIGN
                ...
                fi_producer_c =  caps(INPUT  fi_producer_c)    /*note modi 08/11/05*/
                nv_producer   =  fi_producer_c .               /*note add  08/11/05*/
        END.
    END.
    Disp  fi_producer_c  fi_proname  WITH Frame  fr_main. 
END.
...
&Scoped-define SELF-NAME fi_producer_n
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_producer_n c-Win
ON LEAVE OF fi_producer_n IN FRAME fr_main
DO:
    fi_producer_n = caps(INPUT fi_producer_n)  .
    IF  fi_producer_n <> " " THEN DO:
        FIND sicsyac.xmm600 USE-INDEX xmm60001      WHERE
            sicsyac.xmm600.acno  =  Input fi_producer_n  NO-LOCK NO-ERROR NO-WAIT.
        IF NOT AVAIL sicsyac.xmm600 THEN DO:
            Message  "Not on Name & Address Master File xmm600"  View-as alert-box.
            Apply "Entry" To  fi_producer_n.
            RETURN NO-APPLY. /*note add on 10/11/2005*/
        ...
        ELSE  
            ASSIGN
                fi_pronamenew  =  TRIM(sicsyac.xmm600.ntitle) + "  "  + TRIM(sicsyac.xmm600.name)
                fi_producer_n  =  caps(INPUT  fi_producer_n)  /*note modi 08/11/05*/
                nv_producer    =  fi_producer_n .             /*note add  08/11/05*/
...
&Scoped-define SELF-NAME fi_rectyp1
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_rectyp1 c-Win
ON LEAVE OF fi_rectyp1 IN FRAME fr_main
DO:
    fi_rectyp1 = INPUT fi_rectyp1 .
    Disp  fi_rectyp1  WITH Frame  fr_main. 
END.
...
&Scoped-define SELF-NAME fi_rectyp2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_rectyp2 c-Win
ON LEAVE OF fi_rectyp2 IN FRAME fr_main
DO:
    fi_rectyp2 = INPUT fi_rectyp2 .
    Disp  fi_rectyp2  WITH Frame  fr_main. 
END.
...
/********************  T I T L E   F O R  C - W I N  ****************/
  ...
  gv_prgid = "Wgwticbc".
  gv_prog  = "Load Text & Generate ICBC".
  fi_loaddat = TODAY.
  DISP fi_loaddat WITH FRAME fr_main.
  ...
  ASSIGN
      ...
      fi_companoti   = "ICBCTL"
      fi_branch      = "M"
      fi_producer_c    = "A0M0097"
      fi_rectyp1      = "ICBC-C"
      /*fi_producer2   = "A0M0079"*/
      fi_producer_n  = "A0M0079"
      fi_rectyp2      = "ICBC-N"
      fi_agent       = "B300303"
      /*fi_updby       = "0892"*/
      fi_bchyr       = YEAR(TODAY) 
  ...
  DISP fi_process fi_pack   fi_companoti
      ...
      /* fi_base1 fi_base2 fi_uom1_v fi_rectyp1 fi_rectyp2 fi_producernew
       ...
       fi_branch fi_producer_c fi_producer_n
...
------------------------------------------------------------------------------*/
  DISPLAY fi_loaddat fi_companoti fi_pack fi_pack2 fi_bchno fi_branch 
          fi_producer_c fi_rectyp1 fi_producer_n fi_agent fi_prevbat fi_bchyr 
          fi_filename fi_output1 fi_output2 fi_output3 fi_usrcnt fi_usrprem 
          fi_brndes fi_impcnt fi_proname fi_agtname fi_completecnt fi_pronamenew 
          fi_process fi_rectyp2 fi_pack3 fi_premtot fi_pack5 fi_pack_01 
          fi_premsuc fi_pack_02 fi_pack_03 fi_pack_05 
      WITH FRAME fr_main IN WINDOW c-Win.
  ENABLE fi_loaddat fi_companoti fi_pack fi_pack2 fi_branch fi_producer_c 
         fi_rectyp1 fi_producer_n fi_agent fi_prevbat fi_bchyr fi_filename 
         bu_file fi_output1 fi_output2 fi_output3 fi_usrcnt fi_usrprem buok 
         bu_exit bu_hpbrn bu_hpacno1 bu_hpagent br_wdetail bu_hpacno2 
         fi_process fi_rectyp2 fi_pack3 fi_pack5 fi_pack_01 fi_pack_02 
         fi_pack_03 fi_pack_05 RECT-368 RECT-370 RECT-372 RECT-373 RECT-376 
         RECT-379 RECT-380 
      WITH FRAME fr_main IN WINDOW c-Win.
...
DO:
    ...
    REPEAT:
        IMPORT DELIMITER "|" 
            ...
            wdetail2.nocheck     .       /*เลขตรวจสภาพ*/*/ /*comment by Kridtiya i. A56-0071..*/
            ...
            ns_model             /*  43  Cname       */          
            ns_titlen            /*  44  CSname      */ 
            ns_cname             /*  45  วันเกิดของผู้เอาประกัน */          
            ns_csname            /*  46  อาชีพ       */          
        ...
        IF index(ns_rectype,"Record") = 0  THEN DO:
            IF ns_rectype <> ""  THEN DO:
                ...
                END.
                IF trim(ns_policy)   <> ""   THEN RUN proc_assignwdetail .     /*A56-0071*/
                IF TRIM(ns_policy72) <> ""   THEN RUN proc_assignwdetail72 .   /*A56-0071*/
            END.
        END.
        RUN proc_assign_init.
    END.   /* repeat  */
...
FOR EACH wdetail WHERE wdetail.policy  NE " "  .
    ...
    ELSE IF INDEX(n_char,"ตำบล") <> 0 THEN 
        ...
        ind2   = INDEX(n_char,"อำเภอ")
        ind3   = INDEX(n_char,"จังหวัด") .
    ...
    /*END.*//*
    ASSIGN 
        wdetail.addr1 =   trim(wdetail.addr1)                          
        wdetail.addr2 =   trim(wdetail.tambon)                        
        wdetail.addr3 =   trim(wdetail.amper + " " + wdetail.country)   
        wdetail.addr4 =   "" .  */                                            
...
DEF VAR nnr_producer AS CHAR FORMAT "x(10)" INIT "" .  /*A57-0194*/
DEF VAR nnr_agent    AS CHAR FORMAT "x(10)" INIT "" .  /*A57-0194*/
DEF VAR nnr_branch   AS CHAR FORMAT "x(2)"  INIT "" .  /*A57-0194*/
...
ASSIGN 
    ...
    nv_cl_per   = 0  
    nnr_branch    = ""                    /*A57-0194*/
    nnr_producer  = ""                    /*A57-0194*/
    nnr_agent     = ""                    /*A57-0194*/
    nnr_branch    = wdetail.n_branch      /*A57-0194*/
    nnr_producer  = wdetail.producer      /*A57-0194*/
    nnr_agent     = wdetail.agent.        /*A57-0194*/
IF  CONNECTED("sic_exp") THEN DO:
    RUN wgw\wgwqicex (INPUT-OUTPUT  wdetail.prepol,                       
                      ...
                      INPUT-OUTPUT  wdetail.np_name2,            
                      INPUT-OUTPUT  wdetail.np_name3,       
                      INPUT-OUTPUT  wdetail.addr1,            
                      INPUT-OUTPUT  wdetail.addr2,                    
                      INPUT-OUTPUT  wdetail.addr3,            
                      INPUT-OUTPUT  wdetail.addr4,            
    ...
    ASSIGN  
        wdetail.n_branch =  nnr_branch      /*A57-0194*/
        wdetail.producer =  nnr_producer    /*A57-0194*/
        wdetail.agent    =  nnr_agent      /*A57-0194*/
...
IF NOT AVAIL wdetail  THEN DO:
    CREATE wdetail .
    ASSIGN 
        wdetail.policy     = caps(trim(ns_policy))
        wdetail.prepol     = trim(ns_prepol)
        wdetail.cr_2       = caps(TRIM(ns_policy72))
        ...
        wdetail.subclass   = TRIM(ns_inslictyp)
        wdetail.covcod     = IF INDEX(ns_covtyp,"1") > 0 THEN "1"
                             ELSE IF INDEX(ns_covtyp,"tot") > 0 THEN "5"
                             ELSE IF INDEX(ns_covtyp,"5") > 0 THEN "5"
        ...
        wdetail.stk        = ""
        wdetail.addr1      = IF trim(ns_titlen) = "คุณ" THEN trim(ns_addpol) ELSE trim(ns_addsend) 
        /*wdetail.benname    = "บริษัท ลีสซิ่งสินเอเซีย จำกัด"  */ 
        wdetail.benname    = trim(ns_assured)
        wdetail.txtmemo    = trim(ns_memmo)
        wdetail.txtmemo2   = TRIM(trim(ns_notfyby) + ":" ) + " inslictyp: " + trim(ns_inslictyp)
        wdetail.tariff     = "x" 
        wdetail.compul     = "n"
        wdetail.comment    = ""
        /*wdetail.producer   = IF trim(ns_notfyby) = trim(fi_updby) THEN fi_producernew ELSE fi_producer    *//*A57-0125*/ 
        wdetail.producer   = IF index(trim(ns_rectype),trim(fi_rectyp1)) <> 0 THEN  trim(fi_producer_c)  ELSE trim(fi_producer_n)  /*A57-0125*/
...
IF NOT AVAIL wdetail  THEN DO:
    CREATE wdetail .
    ASSIGN 
        wdetail.policy     = caps(trim(ns_policy72))
        wdetail.prepol     = ""
        wdetail.cr_2       = caps(trim(ns_policy))
        wdetail.cedpol     = trim(ns_contno)
        wdetail.tiname     = trim(ns_titlen)          
        wdetail.insnam     = trim(ns_cname)  + " " + TRIM(ns_csname)
        wdetail.idno       = trim(ns_id)
...
IF wdetail.prepol = "" THEN DO:
    ...
    IF nv_modcod = "" THEN DO:
        ...
        ELSE IF INDEX(wdetail.model," ") <> 0 THEN
            wdetail.model = SUBSTR(wdetail.model,1,INDEX(wdetail.model," ")).
        ...
        IF wdetail.covcod = "1" OR wdetail.covcod = "2" THEN DO:
            Find First stat.maktab_fil USE-INDEX maktab04    Where
                ...
                stat.maktab_fil.engine   =     Integer(wdetail.engcc)   AND
                stat.maktab_fil.sclass   =     wdetail.subclass         AND
                (stat.maktab_fil.si - (stat.maktab_fil.si * n_ratmin / 100 ) LE deci(wdetail.fire)    OR
                 stat.maktab_fil.si + (stat.maktab_fil.si * n_ratmax / 100 ) GE deci(wdetail.fire) )  AND  
                stat.maktab_fil.seats    =     INTEGER(wdetail.seat)    No-lock no-error no-wait.
            If  avail stat.maktab_fil  Then 
                ASSIGN 
                chkred           =  YES
...
IF NOT AVAILABLE uwm130 THEN 
    ...
    IF avail stat.clastab_fil Then do: 
        IF (wdetail.prepol = "") AND (wdetail.prempa <> "Z" ) THEN
            Assign  
        ...
        IF wdetail.prempa <> "Z" THEN DO:
            ...
            /*IF wdetail.prempa = "Z" THEN
                ASSIGN 
                /*sic_bran.uwm130.uom1_v =  fi_uom1_v 
                sic_bran.uwm130.uom2_v  =  fi_uom2_v 
                sic_bran.uwm130.uom5_v  =  fi_uom5_v  
                nv_41     =   fi_41  
                nv_42     =   fi_42  
                nv_43     =   fi_43  */
...
/*ELSE wdetail.benname    = "บริษัท ลีสซิ่งไอซีบีซี (ไทย) จำกัด"  .    *//*a57-0125*/
DO TRANSACTION:
   ASSIGN
      sic_bran.uwm100.renno  = ""
      ...
      sic_bran.uwm100.opnpol = TRIM(n_promt)
      ...
      sic_bran.uwm100.name2  = wdetail.np_name2              /*wdetail.receipt_name*/        /*และ/หรือ */              
...
IF (wdetail.poltyp = "v70") AND ((wdetail.txtmemo <> "") OR (wdetail.txtmemo2 <> "")) THEN  RUN proc_uwd102. /*A57-0125*/
/* --------------------U W M 1 2 0 -------------- */
...
"       Producer Code : " fi_producer_C   SKIP
