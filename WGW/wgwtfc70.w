...
/* Connected Databases 
*/
&Scoped-define WINDOW-NAME WGWTFC70
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _DEFINITIONS WGWTFC70 
/*------------------------------------------------------------------------
...
/*Modify by : Ranu I. A64-0092 Date.03/0/2021  แก้ไขงาน group Ford ให้ดึงข้อมูลชื่อที่อยู่ตาม XMM600 */
/*Modify by : Ranu I. A64-0138 เพิ่มเงื่อนไขการคำนวณเบี้ยจากโปรแกรมกลาง */
/*Modify by : Ranu I. A65-0035 เพิ่มเงื่อนไขการเช็ควันที่ และวันที่รับประกันภัย แก้ไข message ไม่ให้แสดงที่หน้าจอ */
/*Modify by   : Kridtiya i. A65-0356 Date. 07/01/2023 ขยายช่อง เลขเครื่องเลขถัง ทะเบียน สี */
/*Modify by   : Kridtiya i. A66-0070 Date. 26/04/2023 ปรับการแสดงค่าอุปกรณ์เสริม*/
/*Modify by   : Kridtiya i. A66-0140 Date. 01/07/2023 เพิ่ม งาน 2ปี GWM */
/*Modify by   : Kridtiya i. A66-0196 Date. 11/09/2023 เพิ่ม สาขาใบกำกับภาษี  */
/*Modify by  : Ranu I. A67-0087 เพิ่มการเก็บข้อมูลรถไฟฟ้า */
/*Modify by  : Ranu I. A67-0114 แก้ไข Format file Load แก้ไขการเช็ค  CC ,อุปกรณ์เสริม ,Promo ,Product*/
...
/*DEFINE NEW SHARED VAR nv_class      AS CHAR      FORMAT "X(4)".   */ /*A65-0035*/  
DEFINE NEW SHARED VAR nv_class      AS CHAR      FORMAT "X(5)".    /*A65-0035*/ 
...
/*DEFINE NEW SHARED VAR nv_sclass     AS CHAR      FORMAT "x(3)". */ /*A65-0035*/  
DEFINE NEW SHARED VAR nv_sclass     AS CHAR      FORMAT "x(4)".  /*A65-0035*/  
...
DEFINE TEMP-TABLE tbprotis 
    ...
    FIELD cover      AS CHAR FORMAT "x(3)"  INIT "". /*A67-0114*/
DEF VAR nv_pol702y   AS CHAR FORMAT "x(20)" INIT ""  .
DEF VAR nv_pol722y   AS CHAR FORMAT "x(20)" INIT ""  .

DEF VAR nv_drivname  AS CHAR FORMAT "x(100)" INIT "" . /* A67-0087*/
...
&Scoped-define OPEN-QUERY-br_proinsur OPEN QUERY br_proinsur FOR EACH tbinsurid.
...
RECT-370 RECT-372 RECT-373 RECT-376 RECT-377 RECT-378 br_proinsur 
...
DEFINE VAR WGWTFC70 AS WIDGET-HANDLE NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_proinsur WGWTFC70 _FREEFORM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_protis WGWTFC70 _FREEFORM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_wdetail WGWTFC70 _FREEFORM
...
DEFINE FRAME fr_main
     ...
     fi_chkpro AT ROW 2.71 COL 109.67 COLON-ALIGNED NO-LABEL
     ...
     buok AT ROW 14.1 COL 94.33
     bu_exit AT ROW 14.05 COL 107.83
     ...
     tg_flag AT ROW 11.33 COL 93 WIDGET-ID 40
     tg_flagRN AT ROW 12.38 COL 93 WIDGET-ID 46
     br_proinsur AT ROW 6.91 COL 94.17 WIDGET-ID 100
     " Branch  :" VIEW-AS TEXT
...
DEFINE FRAME fr_main
     ...
     "    IMPORT TEXT FILE MOTOR [OEM-FORD 70 ,72 NEW]" VIEW-AS TEXT
          SIZE 129 BY .95 AT ROW 1.24 COL 3
          BGCOLOR 2 FGCOLOR 7 FONT 6
     "** ใช้ Format File Match ISP Load **" VIEW-AS TEXT
          SIZE 34.5 BY .62 AT ROW 1.43 COL 93.5 WIDGET-ID 8
          BGCOLOR 2 FGCOLOR 15 
     "Company :" VIEW-AS TEXT
          SIZE 9.5 BY .95 AT ROW 2.76 COL 48
          BGCOLOR 18 FGCOLOR 1 FONT 6
     "์New Tariff Calculate (Used)" VIEW-AS TEXT
          SIZE 29.5 BY 1 AT ROW 12.38 COL 95.5 WIDGET-ID 44
     ...
     "์New Tariff Calculate (New)" VIEW-AS TEXT
          SIZE 29.5 BY 1 AT ROW 11.33 COL 95.5 WIDGET-ID 42
          BGCOLOR 10 FGCOLOR 6 
     " Output Data Not Load :" VIEW-AS TEXT
          SIZE 23 BY .95 AT ROW 12.19 COL 4.5
          BGCOLOR 18 FGCOLOR 1 
     "ICE: 13/05/2025" VIEW-AS TEXT
          SIZE 16.83 BY .76 AT ROW 15.62 COL 115.17 WIDGET-ID 6
          BGCOLOR 8 
     ...
     "Product/Promo :" VIEW-AS TEXT
          SIZE 16.67 BY .95 AT ROW 2.71 COL 94.33
          BGCOLOR 18 FGCOLOR 1 FONT 6
...
DEFINE FRAME fr_main
     ...
     RECT-377 AT ROW 13.62 COL 92.67
     RECT-378 AT ROW 13.57 COL 106.33
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 132.33 BY 23.91
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW WGWTFC70 ASSIGN
         HIDDEN             = YES
         TITLE              = "Load Text file OEM-FORD [70]"
         HEIGHT             = 23.91
         WIDTH              = 132.33
         MAX-HEIGHT         = 45.76
         MAX-WIDTH          = 213.33
...
IF NOT WGWTFC70:LOAD-ICON("wimage/safety.ico":U) THEN
...
IF SESSION:DISPLAY-TYPE = "GUI":U AND VALID-HANDLE(WGWTFC70)
THEN WGWTFC70:HIDDEN = no.
...
&Scoped-define SELF-NAME WGWTFC70
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL WGWTFC70 WGWTFC70
ON END-ERROR OF WGWTFC70 /* Load Text file OEM-FORD [70] */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL WGWTFC70 WGWTFC70
ON WINDOW-CLOSE OF WGWTFC70 /* Load Text file OEM-FORD [70] */
DO:
...
&Scoped-define SELF-NAME br_wdetail
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br_wdetail WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL buok WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bu_exit WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bu_file WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bu_hpacno1 WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bu_hpacno2 WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bu_hpagent WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bu_hpbrn WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiCompno WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_agent WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_bchyr WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_branch WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_camp WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_chkpro WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_compa WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_loaddat WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_pack WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_prevbat WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_producer WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_producer2 WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_textf17 WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_usrcnt WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_usrprem WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tg_flag WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tg_flagRN WGWTFC70
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _MAIN-BLOCK WGWTFC70 
...
ASSIGN 
    gv_prgid = "WGWTFC70"
    gv_prog  = "Load Text & Generate OEM FORD_70 [ป้ายแดง/ต่ออายุ]"
    fi_loaddat = TODAY.
DISP fi_loaddat WITH FRAME fr_main.
RUN  WUT\WUTHEAD (wgwtfc70:handle,gv_prgid,gv_prog).  
ASSIGN
    fiCompno     = "Model_tis"
    fi_pack      = "F"
    fi_branch    = "M"
    ...
    fi_producer2 = "A0M2033"  /*A64-0092*/
    fi_agent     = "B3M0002"
    fi_bchyr     = YEAR(TODAY)
    /*fi_camp      = "C61_00116"    */
    fi_camp  = "PACK_TISCO" /*A67-0114*/
    fi_compa     = "TISCO"
    fi_textf17   = "TISCO_F7"
    tg_flag      = YES    /*A68-0044*/
    tg_flagRN    = NO     /*A68-0044*/
    fi_process   = "Load Text & Generate OEM FORD_70 [ป้ายแดง/ต่ออายุ]" .
    RUN proc_protis.  /*A60-0095*/
    RUN proc_insuricno.  /*A60-0095*/
...
/*********************************************************************/  
RUN  WUT\WUTWICEN (wgwtfc70:handle).  
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE 00-proc_723-01 WGWTFC70 
PROCEDURE 00-proc_723-01 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE 00-proc_acctxt WGWTFC70 
PROCEDURE 00-proc_acctxt :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:add by : A65-0035        
------------------------------------------------------------------------------*/
/* add by : A65-0035  ย้ายมาจาก Check test2 */
IF INDEX(wdetail.remark,"FE2+") <> 0 THEN DO: 
    ASSIGN 
        ...
        SUBSTRING(sic_bran.uwm301.prmtxt,181,60) =  SUBSTRING(wdetail.caracc,1,60)  
        SUBSTRING(sic_bran.uwm301.prmtxt,241,60) =  SUBSTRING(wdetail.caracc,61,60) 
        SUBSTRING(sic_bran.uwm301.prmtxt,301,60) =  SUBSTRING(wdetail.caracc,121,60)
        SUBSTRING(sic_bran.uwm301.prmtxt,361,60) =  SUBSTRING(wdetail.caracc,181,60).
    RUN proc_uwd105.
END.
ELSE DO:
    /*A66-0070*/
    IF  INDEX(wdetail.brand,"HAVAL")  <> 0 OR INDEX(wdetail.brand,"ORA") <> 0 THEN DO:   /*A66-0070*/
        IF wdetail.caracc = "" THEN ASSIGN  SUBSTRING(sic_bran.uwm301.prmtxt,1,60)   = "ความคุ้มครองโจรกรรมทรัพย์สินส่วนบุคคลภายในรถ 20,000 บาท"  
                                            SUBSTRING(sic_bran.uwm301.prmtxt,61,60)  = "คุ้มครองอุปกรณ์เสริมเพิ่มเติมไม่เกิน 50,000 บาทรวมในทุน". 
        ELSE DO:  /*มีอุปกรณ์*/
            ASSIGN 
                SUBSTRING(sic_bran.uwm301.prmtxt,1,60)   = "ความคุ้มครองโจรกรรมทรัพย์สินส่วนบุคคลภายในรถ 20,000 บาท"  /*A65-0035*/
                SUBSTRING(sic_bran.uwm301.prmtxt,61,60)  = SUBSTRING(wdetail.caracc,1,60)       /*A63-00472*/ 
                SUBSTRING(sic_bran.uwm301.prmtxt,121,60) = SUBSTRING(wdetail.caracc,61,60)      /*A63-00472*/ 
                SUBSTRING(sic_bran.uwm301.prmtxt,181,60) = SUBSTRING(wdetail.caracc,121,60)     /*A63-00472*/ 
                SUBSTRING(sic_bran.uwm301.prmtxt,241,60) = SUBSTRING(wdetail.caracc,181,60)     /*A63-00472*/ 
                SUBSTRING(sic_bran.uwm301.prmtxt,301,60) = SUBSTRING(wdetail.caracc,241,60)     /*A63-00472*/ 
                SUBSTRING(sic_bran.uwm301.prmtxt,361,60) = SUBSTRING(wdetail.caracc,301,60).    /*A63-00472*/ 
        END.
        RUN proc_uwd105 .
    END.   /*A66-0070*/
    ELSE IF wdetail.covcod = "1" THEN DO:
        IF (INDEX(wdetail.brand,"Ford") <> 0 OR TRIM(wdetail.brand) = "HAVAL" OR trim(wdetail.brand) = "ORA" ) THEN DO:   /*A65-0035*/
           IF wdetail.caracc = "" THEN ASSIGN  SUBSTRING(sic_bran.uwm301.prmtxt,1,60)   = "ความคุ้มครองโจรกรรมทรัพย์สินส่วนบุคคลภายในรถ 20,000 บาท"  /*A65-0035*/
                                               SUBSTRING(sic_bran.uwm301.prmtxt,61,60)  = "อุปกรณ์ตกแต่งเพิ่มเติมไม่เกิน 20,000 บาท".  /*A63-00472*/
           ELSE DO:  /*มีอุปกรณ์*/
               ASSIGN 
                       SUBSTRING(sic_bran.uwm301.prmtxt,1,60)   = "ความคุ้มครองโจรกรรมทรัพย์สินส่วนบุคคลภายในรถ 20,000 บาท"  /*A65-0035*/
                       SUBSTRING(sic_bran.uwm301.prmtxt,61,60)  = SUBSTRING(wdetail.caracc,1,60)       /*A63-00472*/ 
           ...
           RUN proc_uwd105 .
        END.
        ELSE IF TRIM(wdetail.brand) = "NISSAN" THEN DO : /*ป้ายแดง อื่นๆ */
            IF wdetail.caracc = ""  THEN ASSIGN SUBSTRING(sic_bran.uwm301.prmtxt,1,60)   = "อุปกรณ์ตกแต่งเพิ่มเติมไม่เกิน 30,000 บาท" .
            ELSE DO:
                ASSIGN 
                    SUBSTRING(sic_bran.uwm301.prmtxt,1,60)   = "" /*"อุปกรณ์ตกแต่งเพิ่มเติมไม่เกิน 30,000 บาท"*/ /*A65-0035*/
                    SUBSTRING(sic_bran.uwm301.prmtxt,61,60)  =  SUBSTRING(wdetail.caracc,1,60)      /*A63-00472*/ 
                    SUBSTRING(sic_bran.uwm301.prmtxt,121,60) =  SUBSTRING(wdetail.caracc,61,60)     /*A63-00472*/ 
                    SUBSTRING(sic_bran.uwm301.prmtxt,181,60) =  SUBSTRING(wdetail.caracc,121,60)    /*A63-00472*/ 
                    SUBSTRING(sic_bran.uwm301.prmtxt,241,60) =  SUBSTRING(wdetail.caracc,181,60)    /*A63-00472*/ 
        ...
        END.
        ELSE DO:
            IF wdetail.caracc <> "" THEN /*ไม่ป้ายแดง*/
                ASSIGN 
                SUBSTRING(sic_bran.uwm301.prmtxt,1,60)   =  ""
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE 00-proc_calpremt WGWTFC70 
...
IF wdetail.poltyp = "V70" THEN DO:
    ...
    IF wdetail.redbook = ""  THEN DO:
        ...
        IF wdetail.redbook <> ""  THEN DO: 
            ...
            If  avail  stat.maktab_fil  Then 
                ...
                sic_bran.uwm301.body   =  stat.maktab_fil.body     /*A65-0035*/
    ...
    FIND LAST stat.maktab_fil WHERE maktab_fil.makdes   =  wdetail.brand AND 
                                    maktab_fil.sclass   =  trim(SUBSTR(nv_class,2,5)) NO-LOCK NO-ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE 00-proc_calpremt_ev WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE 00-proc_chktest1 WGWTFC70 
PROCEDURE 00-proc_chktest1 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
FOR EACH wdetail BREAK BY wdetail.poltyp  :
  ...
  ELSE DO:
    ...
    END. END ...Add by Kridtiya i. A63-0472 Date. 09/11/2020*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE 00-proc_chktest2 WGWTFC70 
    ...
    IF avail stat.clastab_fil Then do: 
        ...
        ELSE 
            Assign  
                ...
                nv_uom1_v              =  if deci(wdetail.tp1) <> 0 then deci(wdetail.tp1) else stat.clastab_fil.uom1_si    /*deci(wdetail.tp_bi)   */ 
                nv_uom2_v              =  if deci(wdetail.tp2) <> 0 then deci(wdetail.tp2) else stat.clastab_fil.uom2_si    /*deci(wdetail.tp_bi2) */  
                nv_uom5_v              =  if deci(wdetail.tp3) <> 0 then deci(wdetail.tp3) else stat.clastab_fil.uom5_si  . /*deci(wdetail.tp_bi3) */  
        ASSIGN 
...
END.
ELSE DO:
    /*IF ((INDEX(wdetail.brand,"Ford") <> 0)   AND (deci(wdetail.caryear) = YEAR(TODAY))) THEN SUBSTRING(sic_bran.uwm301.prmtxt,1,60)   = "อุปกรณ์ตกแต่งเพิ่มเติมไม่เกิน 20,000 บาท".*/ /*A63-00472*/
    /* ฟอร์ด ป้ายแดง */
    IF ((INDEX(wdetail.brand,"Ford") <> 0)   AND (deci(wdetail.caryear) = YEAR(TODAY))) THEN DO:                           /*A63-00472*/
        /*ฟอร์ด ป้ายแดง ไม่มีอุปกรณ์ */
        IF wdetail.caracc = "" THEN ASSIGN SUBSTRING(sic_bran.uwm301.prmtxt,1,60)  = "อุปกรณ์ตกแต่งเพิ่มเติมไม่เกิน 20,000 บาท".  /*A63-00472*/
        /*ELSE  SUBSTRING(sic_bran.uwm301.prmtxt,1,60) = TRIM(wdetail.caracc).    */                                       /*A63-00472*/     
        ELSE DO:  /*มีอุปกรณ์*/
            ASSIGN 
                SUBSTRING(sic_bran.uwm301.prmtxt,1,60)   = SUBSTRING(wdetail.caracc,1,60)       /*A63-00472*/ 
                SUBSTRING(sic_bran.uwm301.prmtxt,61,60)  = SUBSTRING(wdetail.caracc,61,60)      /*A63-00472*/ 
                SUBSTRING(sic_bran.uwm301.prmtxt,121,60) = SUBSTRING(wdetail.caracc,121,60)     /*A63-00472*/ 
                SUBSTRING(sic_bran.uwm301.prmtxt,181,60) = SUBSTRING(wdetail.caracc,181,60)     /*A63-00472*/ 
                SUBSTRING(sic_bran.uwm301.prmtxt,241,60) = SUBSTRING(wdetail.caracc,241,60)     /*A63-00472*/ 
                SUBSTRING(sic_bran.uwm301.prmtxt,301,60) = SUBSTRING(wdetail.caracc,301,60).    /*A63-00472*/ 
        END.
    END.
    ELSE IF (deci(wdetail.caryear) = YEAR(TODAY)) THEN  /*ป้ายแดง อื่นๆ */
        ASSIGN 
        SUBSTRING(sic_bran.uwm301.prmtxt,1,60)   = "อุปกรณ์ตกแต่งเพิ่มเติมไม่เกิน 30,000 บาท"
        SUBSTRING(sic_bran.uwm301.prmtxt,61,60)  =  SUBSTRING(wdetail.caracc,1,60)      /*A63-00472*/ 
        SUBSTRING(sic_bran.uwm301.prmtxt,121,60) =  SUBSTRING(wdetail.caracc,61,60)     /*A63-00472*/ 
        SUBSTRING(sic_bran.uwm301.prmtxt,181,60) =  SUBSTRING(wdetail.caracc,121,60)    /*A63-00472*/ 
        SUBSTRING(sic_bran.uwm301.prmtxt,241,60) =  SUBSTRING(wdetail.caracc,181,60)    /*A63-00472*/ 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE 00-proc_driver WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE 00-proc_driver2 WGWTFC70 
PROCEDURE 00-proc_driver2 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE 00-proc_mailtxt WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE disable_UI WGWTFC70  _DEFAULT-DISABLE
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE enable_UI WGWTFC70  _DEFAULT-ENABLE
PROCEDURE enable_UI :
/*------------------------------------------------------------------------------
...
------------------------------------------------------------------------------*/
  DISPLAY fiCompno fi_loaddat fi_pack fi_chkpro fi_branch fi_producer fi_agent 
          ...
          fi_proname2 fi_premsuc fi_compa fi_textf17 fi_camp tg_flag tg_flagRN 
      WITH FRAME fr_main IN WINDOW WGWTFC70.
  ENABLE br_wdetail br_protis fiCompno fi_loaddat fi_pack fi_chkpro fi_branch 
         ...
         RECT-373 RECT-376 RECT-377 RECT-378 br_proinsur 
      WITH FRAME fr_main IN WINDOW WGWTFC70.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_72 WGWTFC70 
PROCEDURE proc_72 :
...
ELSE DO:   /* 110 120  140 class 72->70*/
        IF      TRIM(wdetail.bev) = "Y" THEN n_sclass72 = "E" + trim(SUBSTR(wdetail.subclass,1,2)) . /*A67-0114 */
        ELSE IF index(wdetail.subclass,"110") <> 0  THEN ASSIGN   n_sclass72 = "110".
    ...
    /*IF nv_modcod = "" THEN DO:  /*A65-0035*/
        ...
        IF wdetail.bev = "Y"  THEN DO:
            ...
            If  avail stat.maktab_fil  Then DO: 
                ...
                wdetail.cargrp   =  stat.maktab_fil.prmpac
                wdetail.weight   =  string(stat.maktab_fil.tons) 
                wdetail.engcc    =  STRING(stat.maktab_fil.watt)   /*A67-0087*/
                wdetail.maksi    =  string(stat.maktab_fil.maksi). /*A67-0087*/
                IF wdetail.seat = 0 THEN wdetail.seat  =  stat.maktab_fil.seats .
            END.
        END.
        /* end : A67-0087 */
...
IF wdetail.redbook = "" THEN DO:
    ASSIGN 
             ...
             n_model = trim(wdetail.model) . 
    IF index(wdetail.brand,"benz") <> 0 THEN DO: 
        /*IF INDEX(wdetail.brand," ") <> 0 THEN  */ /*A65-0035*/
        ASSIGN 
        /* n_model =  trim(SUBSTR(wdetail.brand,INDEX(wdetail.brand," ") + 1 ))  /*A57-0431*/  *//*A65-0035*/
        /* wdetail.model = n_model          /*A60-0095*/  *//*A65-0035*/
        n_model =  TRIM(wdetail.model)     /*A65-0035*/                                 
        ...
        IF index(wdetail.model,"cls") <> 0 THEN DO:
            /* comment by : A65-0035..
            IF index(wdetail.model," ") <> 0   THEN
                ASSIGN n_model = SUBSTR(wdetail.model,1,index(wdetail.model," ") - 1) + SUBSTR(wdetail.model,index(wdetail.model," ") + 1) .  /*A57-0431*/
            ...end A65-0035..*/
            IF index(wdetail.model," ") <> 0   THEN 
    ...
    ELSE DO:
        ...
        ELSE IF INDEX(wdetail.model,"cap4")   <> 0 THEN n_model = "D-Max".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_722 WGWTFC70 
PROCEDURE proc_722 :
/* ---------------------------------------------  U W M 1 3 0 -------------- */
/* comment by a60-0095............*/
...
ELSE nv_newsck = wdetail.stk.
     ...
     Assign 
         ...
         sic_bran.uwm301.body     = wdetail.body
         sic_bran.uwm301.seats    = INTEGER(wdetail.seat)
         sic_bran.uwm301.mv41seat = IF wdetail.seat41 <> 0 THEN wdetail.seat41 ELSE wdetail.seat /*A65-0035*/
     ...
     FIND sic_bran.uwd132  USE-INDEX uwd13201 WHERE
       /*  sic_bran.uwd132.policy = wdetail.policy   AND  A67-0185 */
       /*  sic_bran.uwd132.rencnt = 0                AND  A67-0185 */
       /*  sic_bran.uwd132.endcnt = 0                AND  A67-0185 */
         sic_bran.uwd132.policy = sic_bran.uwm301.policy  AND   /* A67-0185 */ 
         sic_bran.uwd132.rencnt = sic_bran.uwm301.rencnt  AND   /* A67-0185 */ 
         sic_bran.uwd132.endcnt = sic_bran.uwm301.endcnt  AND   /* A67-0185 */ 
     ...
     ASSIGN  wdetail.comp_prm = string(TRUNCATE(((deci(wdetail.comp_prm)  * 100 ) / 107.43),0))
         ...
         /*sic_bran.uwd132.policy  = wdetail.policy           /*Policy No. - uwm130*/        */ /*A67-0185*/
         /*sic_bran.uwd132.rencnt  = 0                        /*Renewal Count - uwm130*/     */ /*A67-0185*/
         /*sic_bran.uwd132.endcnt  = 0                        /*Endorsement Count - uwm130*/ */ /*A67-0185*/
         sic_bran.uwd132.policy  = sic_bran.uwm301.policy   /*Policy No. - uwm130*/          /*A67-0185*/
         sic_bran.uwd132.rencnt  = sic_bran.uwm301.rencnt   /*Renewal Count - uwm130*/       /*A67-0185*/
         sic_bran.uwd132.endcnt  = sic_bran.uwm301.endcnt   /*Endorsement Count - uwm130*/   /*A67-0185*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_723 WGWTFC70 
PROCEDURE proc_723 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_7231 WGWTFC70 
PROCEDURE proc_7231 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_acctxt WGWTFC70 
PROCEDURE proc_acctxt :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:add by : A67-0087     
------------------------------------------------------------------------------*/
def  var nv_acc as char format "x(450)"   init "" .
...
IF wdetail.caracc <> ""  THEN DO:
    ASSIGN nv_acc  = trim(wdetail.caracc)   .

    IF INDEX(nv_acc,"อปก.") <> 0 THEN DO:
        ASSIGN nv_acc = trim(SUBSTR(nv_acc,1,INDEX(nv_acc,"อปก.") - 1)) .
    END.
    /*IF INDEX(nv_acc,".00") <> 0 THEN ASSIGN nv_acc = trim(REPLACE(nv_acc,".00","")) .*/
...
IF INDEX(wdetail.remark,"FE2+") <> 0 THEN DO: 
    ASSIGN 
        ...
        SUBSTRING(sic_bran.uwm301.prmtxt,61,60)  =  "ที่อยู่ภายในรถยนต์ 20,000 บาท." 
        SUBSTRING(sic_bran.uwm301.prmtxt,121,60) =  "คุ้มครองภัยน้ำท่วม ตามทุนประกัน"
        SUBSTRING(sic_bran.uwm301.prmtxt,181,60) =  trim(nv_acc1)
        SUBSTRING(sic_bran.uwm301.prmtxt,241,60) =  trim(nv_acc2)
        SUBSTRING(sic_bran.uwm301.prmtxt,301,60) =  trim(nv_acc3)
        SUBSTRING(sic_bran.uwm301.prmtxt,361,60) =  trim(nv_acc4)
        SUBSTRING(sic_bran.uwm301.prmtxt,421,60) =  trim(nv_acc5)
        SUBSTRING(sic_bran.uwm301.prmtxt,481,60) =  trim(nv_acc6) .
...
ELSE DO:
    ...
    IF  INDEX(wdetail.brand,"HAVAL")  <> 0 OR INDEX(wdetail.brand,"ORA") <> 0 OR INDEX(wdetail.brand,"TANK") <> 0  THEN DO:    /* A67-0087*/
        ...
        ELSE DO:  /*มีอุปกรณ์*/
            ASSIGN 
                SUBSTRING(sic_bran.uwm301.prmtxt,1,60)   = "ความคุ้มครองโจรกรรมทรัพย์สินส่วนบุคคลภายในรถ 20,000 บาท"  /*A65-0035*/
                SUBSTRING(sic_bran.uwm301.prmtxt,61,60)  = trim(nv_acc1)   
                SUBSTRING(sic_bran.uwm301.prmtxt,121,60) = trim(nv_acc2)   
                SUBSTRING(sic_bran.uwm301.prmtxt,181,60) = trim(nv_acc3)   
                SUBSTRING(sic_bran.uwm301.prmtxt,241,60) = trim(nv_acc4)   
                SUBSTRING(sic_bran.uwm301.prmtxt,301,60) = trim(nv_acc5)   
                SUBSTRING(sic_bran.uwm301.prmtxt,361,60) = trim(nv_acc6)   .
        END.
        RUN proc_uwd105 .
    END.   /*A66-0070*/
    ELSE IF wdetail.covcod = "1" THEN DO:
        IF INDEX(wdetail.brand,"Ford") <> 0 /*OR TRIM(wdetail.brand) = "HAVAL" OR trim(wdetail.brand) = "ORA" )*/ /*A67-0087*/ THEN DO:   /*A65-0035*/
           IF wdetail.caracc = "" THEN ASSIGN  SUBSTRING(sic_bran.uwm301.prmtxt,1,60)   = "ความคุ้มครองโจรกรรมทรัพย์สินส่วนบุคคลภายในรถ 20,000 บาท"  /*A65-0035*/
                                               SUBSTRING(sic_bran.uwm301.prmtxt,61,60)  = "อุปกรณ์ตกแต่งเพิ่มเติมไม่เกิน 20,000 บาท".  /*A63-00472*/
           ELSE DO:  /*มีอุปกรณ์*/
               ASSIGN 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_adduwd132 WGWTFC70 
...
DEF VAR nv_ry31 AS DECI INIT 0. /*A68-0044*/
DO:
    FIND sic_bran.uwm100 WHERE RECID(sic_bran.uwm100) = s_recid1 NO-WAIT NO-ERROR.
    FIND sic_bran.uwm130 WHERE RECID(sic_bran.uwm130) = s_recid3 NO-WAIT NO-ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_adduwd132prem WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_assign11 WGWTFC70 
...
DO:
    ...
    REPEAT:
        ...
        IF  (index(Pro_off,"บริษัท") = 0)  AND   
            ...
            ASSIGN nv_pol702y = ""
                   nv_pol722y = "" .
            IF index(trim(remark),"_2Y") <> 0 THEN DO:
                ASSIGN nv_pol702y = n_policyno + "2Y"
                       nv_pol722y = n_policy72 + "2Y"
                       n_policyno = replace(n_policyno,"TMSTHTW","TMSTH") 
                       n_policy72 = replace(n_policy72,"TMSTHTW","TMSTH") 
                       nv_pol702y = replace(nv_pol702y,"TMSTHTW","TMSTH")
                       nv_pol722y = replace(nv_pol722y,"TMSTHTW","TMSTH") .  
            END.
            ...
            IF NOT AVAIL wdetail THEN DO:
                ...
                ASSIGN 
                    ...
                    wdetail.premt      =   IF index(trim(remark),"_2Y") <> 0 THEN  STRING(deci(trim(premt)) / 2 ) ELSE trim(premt)  
                    ...
                    wdetail.remark     =   trim(remark) + " " + trim(vehuse) /*A60-0118*/      
                    wdetail.Account_no =   trim(accountno)           
                    wdetail.client_no  =   trim(clientNo)       
                    wdetail.expdat     =   IF index(trim(remark),"_2Y") = 0 THEN trim(expirydate) ELSE 
                                           string(day(DATE(comdat))) + "/" + 
                                           string(MONTH(DATE(comdat))) + "/" + 
                                           string(YEAR(DATE(comdat)) + 1 ) 
            ...
            END.
            RELEASE wdetail.
            IF index(trim(remark),"_2Y") <> 0 THEN RUN proc_assign112Y.  /*Policy 2Y 70*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_assign112Y WGWTFC70 
PROCEDURE proc_assign112Y :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
  /* 2 Year Policy  2 */ 
  DEF VAR nv_yr AS INTE INIT 0 . /*A68-0044*/
  DEF VAR nv_sum2Y AS CHAR INIT "".
IF nv_pol702y <> "" THEN DO: 
    FIND LAST  brstat.Insure USE-INDEX Insure02 WHERE 
        brstat.Insure.InsNo       = "PRO_TIS" AND 
        brstat.insure.compno      = "PRO_TIS" AND
        deci(brstat.Insure.LName) = deci(Price_Ford) AND 
        deci(brstat.Insure.Addr1) = DECI(si)  NO-LOCK NO-ERROR NO-WAIT.
    IF AVAIL brstat.insure THEN  ASSIGN nv_sum2Y = trim(brstat.Insure.Addr2)      .
    ELSE ASSIGN nv_sum2Y = string(DECI(si) - (DECI(si) * 10 / 100)).
FIND FIRST wdetail WHERE wdetail.policy = nv_pol702y NO-ERROR NO-WAIT.
IF NOT AVAIL wdetail THEN DO:
    CREATE wdetail.
    ASSIGN 
        nv_yr = 0     /*A68-0044*/              
        nv_yr = (YEAR(TODAY) - INTEGER(caryear) + 1 ) /*A68-0044*/
        wdetail.policy     =   trim(nv_pol702y)
        wdetail.cr_2       =   trim(nv_pol722y) 
        wdetail.deler      =   IF INDEX(policyno,",") <> 0 THEN SUBSTR(policyno,INDEX(policyno,",") + 1 ) ELSE ""
        wdetail.caryear    =   trim(caryear)    
        wdetail.eng        =   trim(engno) 
        wdetail.chasno     =   trim(chasno)  
        wdetail.weight     =   trim(weight)   
        ...
        wdetail.orthper    =   trim(orthper)
        wdetail.vehuse     =   ""   
        wdetail.comdat     =   string(day(DATE(comdat))) + "/" + 
                               string(MONTH(DATE(comdat))) + "/" + 
                               string(YEAR(DATE(comdat)) + 1 )  
        wdetail.si         =   nv_sum2Y   /*trim(si) */
        wdetail.not_office =  "ชื่อผู้แจ้ง:" + trim(not_office) +  " รหัสผู้แจ้ง:" + trim(name_insur)  
        wdetail.entdat     = "Notify date:" +  trim(entdat) + " " + 
                             "Notify time:" +  trim(enttim) + " " +
        ...
        wdetail.caracc       = TRIM(Blank_tis)   
        wdetail.Rec_name72   = TRIM(Rec_name72)    
        wdetail.Rec_add1     = TRIM(Rec_add1)      
        wdetail.Rec_add2     = TRIM(Rec_add2)
        wdetail.seat41       = wdetail.seat   
        wdetail.caracc       = REPLACE(wdetail.caracc," ","") 
        wdetail.colorcode    = trim(colorcode)
        /* Add by : A67-0087 */
        wdetail.drivnam1    = TRIM(drivename1) 
        wdetail.driag1      = TRIM(bdatedriv1) 
        wdetail.drioc1      = TRIM(occupdriv1) 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_assign2 WGWTFC70 
...
DEF BUFFER bfwdetail FOR wdetail. /*A67-0087*/
FOR EACH wdetail WHERE wdetail.policy  NE " "  .
    ...
    IF wdetail.bev = "Y" THEN ASSIGN wdetail.hp = wdetail.engcc .
    /* end : A67-0114 */
     /*A67-0185*/
    IF wdetail.poltyp = "V72" THEN DO: 
        ASSIGN n_packcomp = "" .
    ...
    ELSE IF  wdetail.vehreg = "ป้ายแดง" THEN wdetail.vehreg = "/" +  SUBSTRING(wdetail.chasno,LENGTH(wdetail.chasno) - 8) . /*A60-0095*/
    /*ELSE DO:*/ /*A60-0095*/
    ...
    ELSE IF TRIM(wdetail.tambon +  " " + wdetail.amper + " " + wdetail.country) = "" THEN DO:
        ...
        ELSE IF  R-INDEX(wdetail.addr1,"จ.") <> 0 AND  R-INDEX(wdetail.addr1,"บมจ.") = 0 /*A65-0035*/
             THEN   /*ถนนสาทรเหนือ แขวงสีลม เขตบางรัก กรุงเทพฯ 10500  */    
       ...
       /*
        ...
        ELSE DO:
            ...
            IF AVAIL stat.insure THEN DO:
                ASSIGN wdetail.deler       = stat.Insure.insno 
                       wdetail.financecd   = stat.Insure.Text3. 
            END.
    ...
    IF AVAIL brstat.insure THEN DO:
        ASSIGN 
            ...
            wdetail.no_411  = IF deci(wdetail.no_411) = 0 THEN brstat.insure.addr3 ELSE wdetail.no_411
            wdetail.no_42   = IF deci(wdetail.no_42) = 0 THEN brstat.insure.addr4  ELSE wdetail.no_42
            wdetail.no_43   = IF deci(wdetail.no_43) = 0 THEN brstat.insure.telno  ELSE wdetail.no_43. 
    END.
    /*end : A67-0114 */
    /* a67-0114...
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_assign2addr WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_assign72 WGWTFC70 
...
DO:
    IF deci(comp_prm)  > 0    THEN DO:
       ASSIGN n_packcomp = ""
              bev  = IF bev = "" THEN "N" ELSE bev . /*A67-0087*/
      /*FIND FIRST wcomp WHERE  wcomp.premcomp  = deci(comp_prm) NO-LOCK NO-ERROR NO-WAIT.*/ /*A67-0087*/
      /* comment by : A67-0185...
      FIND FIRST wcomp WHERE  wcomp.premcomp  = deci(comp_prm) AND wcomp.ev = trim(bev) NO-LOCK NO-ERROR NO-WAIT. /*A67-0087*/
      IF AVAIL wcomp  THEN ASSIGN n_packcomp = wcomp.package . 
      ELSE n_packcomp = "".
      
        /* ---A60-0095---*/
       /*ASSIGN n_brand = IF INDEX(brand," ") <> 0 THEN trim(SUBSTR(brand,1,INDEX(brand," ") - 1 )) ELSE trim(brand).*/ /*A65-0035*/
        ...
        IF n_packcomp = ""  THEN DO: 
            ...
            ELSE IF TRIM(CLASS) = "420" THEN n_packcomp = "350"  .    /*A63-0210*/
        ...
        IF NOT AVAIL wdetail THEN DO:
            ...
            ASSIGN 
               ...
               /* wdetail.engcc      =   IF trim(bev) = "Y" THEN trim(power) /*A67-0087 */ 
                                       ELSE IF index(typepoli,"re") = 0 THEN  STRING(round(DECI(trim(power))/ 1,0 ) * 100 )
                                       ELSE IF (trim(power) = "" ) OR (deci(trim(power)) = 0 ) THEN "0" ELSE STRING(round(DECI(trim(power))/ 100 ,0 ) * 100 ) A67-0114*/
                wdetail.engcc      =  trim(power) /*A67-0114 */ 
                wdetail.vehreg     =  trim(vehreg)     
                wdetail.garage     =   ""  
                ...
                wdetail.comp_prm   =   trim(comp_prm)
                wdetail.stk        =   trim(stk) 
                wdetail.brand      =   IF index(brand,"benz") <> 0 THEN trim(REPLACE(brand,"benz","MERCEDES-BENZ")) ELSE TRIM(brand)                            
                wdetail.tiname     =   trim(titlename)      
                wdetail.insnam     =   trim(firstname) + " " + trim(lastname)
                wdetail.benname    =   TRIM(benefic) 
                wdetail.remark     =   trim(remark) + " " + trim(vehuse)  
                wdetail.Account_no =   trim(accountno)           
                wdetail.client_no  =   trim(clientNo)       
                wdetail.expdat     =   IF index(trim(remark),"_2Y") = 0 THEN trim(comp_expdat) ELSE 
                                          string(day(DATE(comp_comdat))) + "/" + 
                                          string(MONTH(DATE(comp_comdat))) + "/" + 
                                          string(YEAR(DATE(comp_comdat)) + 1 ) 
                wdetail.gap        =   trim(insuranceamt)          
                wdetail.re_country =   trim(province)            
                ...
                /* end : A67-0087 */
        END.
        IF nv_pol722y <> ""   THEN DO:  /*Policy 2Y 72*/
            FIND FIRST wdetail WHERE wdetail.policy = trim(nv_pol722y) NO-ERROR NO-WAIT.
            IF NOT AVAIL wdetail THEN DO:
                CREATE wdetail.
                ASSIGN 
                wdetail.policy     =   trim(nv_pol722y)
                wdetail.cr_2       =   TRIM(nv_pol702y)  
                wdetail.cedpol     =   trim(n_cedpol)    
                wdetail.deler      =   IF INDEX(policyno,",") <> 0 THEN SUBSTR(policyno,INDEX(policyno,",") + 1 ) ELSE ""
                wdetail.caryear    =   trim(caryear)    
                wdetail.eng        =   trim(engno) 
                ...
                wdetail.orthper    =   trim(orthper)   
                wdetail.vehuse     =   ""   
                wdetail.comdat     =   string(day(DATE(comp_comdat))) + "/" + 
                                       string(MONTH(DATE(comp_comdat))) + "/" + 
                                       string(YEAR(DATE(comp_comdat)) + 1 )   
                wdetail.si         =   trim(si) 
                wdetail.not_office =  "ชื่อผู้แจ้ง:" + trim(not_office) +  " รหัสผู้แจ้ง:" + trim(name_insur)  
                ...
                wdetail.premt      =   trim(premt)   
                wdetail.comp_prm   =   trim(comp_prm)
                wdetail.stk        =   IF r-index(remark," ") <> 0 THEN trim(SUBSTR(TRIM(remark),R-INDEX(trim(remark)," ")))  ELSE ""
                wdetail.brand      =   IF index(brand,"benz") <> 0 THEN trim(REPLACE(brand,"benz","MERCEDES-BENZ")) ELSE TRIM(brand)                            
                wdetail.tiname     =   trim(titlename)      
                wdetail.insnam     =   trim(firstname) + " " + trim(lastname)
                wdetail.benname    =   TRIM(benefic) 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_base2 WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_calpremt_all WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_chassic WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_chkcode WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_chkcomp WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_chkdrive WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_chkpolpremium WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_chkpromo WGWTFC70 
PROCEDURE proc_chkpromo :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes: add A67-0114    
------------------------------------------------------------------------------*/
DEF VAR nv_yr AS INTE INIT 0. 
DO: 
    ASSIGN nv_yr = (YEAR(TODAY) - DECI(wdetail.caryear) + 1 ) .
    IF sic_bran.uwm100.poltyp = "V70" AND wdetail.producer <> "A0M2012"   THEN DO:  /*A62-0386 */
        IF wdetail.producer = "B3DM000007" AND INTE(wdetail.caryear) <> YEAR(TODAY)   THEN DO: 
            ASSIGN sic_bran.uwm100.cr_1   = "PB20K"     /*product*/  
                   sic_bran.uwm100.opnpol = "USED CAR" .     /*promo */  
        END.
        ELSE IF wdetail.producer = "B3M0033" THEN DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_chktest0 WGWTFC70 
...
IF wdetail.redbook <> "" THEN DO:    /* renew or new version_new */
    ...
    IF nv_modcod = "" THEN DO:  
        IF  n_rencnt > 0 THEN DO:
            ...
            If  avail stat.maktab_fil  Then  
                ASSIGN  nv_modcod    =  stat.maktab_fil.modcod 
                    wdetail.redbook  =  stat.maktab_fil.modcod
                    wdetail.body     =  if wdetail.body   = "" then stat.maktab_fil.body   else wdetail.body   
                    wdetail.cargrp   =  if wdetail.cargrp = "" then stat.maktab_fil.prmpac else wdetail.cargrp 
                    wdetail.seat     =  IF wdetail.seat = 0    THEN stat.maktab_fil.seats  ELSE wdetail.seat   
                    wdetail.weight   =  string(stat.maktab_fil.tons) 
                    wdetail.hp       =  STRING(stat.maktab_fil.watt)     /* A67-0087 */
                    wdetail.maksi    =  IF deci(wdetail.maksi) = 0 THEN string(stat.maktab_fil.si) ELSE wdetail.maksi . /* A67-0087 */
        ...
        IF nv_modcod = ""  THEN DO:
            ASSIGN
            wdetail.comment = wdetail.comment + "|ไม่พบ Redbook Code " +  wdetail.redbook  + " ของ Class " + wdetail.subclass 
            wdetail.redbook = "" .
        END.
        /* end : A65-0035 */
    END.
...
IF nv_modcod = " " THEN DO:
    ...
    /*ASSIGN wdetail.model = wdetail.brand. */ /*A65-0035*/
    FIND LAST stat.Insure   USE-INDEX Insure01  WHERE 
        insure.compno   = fiCompno      AND 
        Insure.FName    = wdetail.model NO-LOCK  NO-ERROR NO-WAIT.
    IF AVAIL stat.insure  THEN DO:
        ASSIGN 
             n_brand = if trim(Insure.text1) <> "" then trim(Insure.text1) else trim(wdetail.brand)  
             n_model = if trim(insure.text2) <> "" then trim(insure.text2) else trim(wdetail.model). 
        /*--- add by A60-0095---*/
    END.
    ELSE DO:
        ASSIGN 
        ...
        ELSE IF INDEX(wdetail.model," ") <> 0      THEN ASSIGN n_model = SUBSTR(wdetail.model,1,R-INDEX(wdetail.model," ") - 1 ). 
        /* end : A60-0095*/
    END.
...
If no_class  <>  " " Then do:
    ...
    IF NOT AVAILABLE sicsyac.xmm016 THEN 
        ...
        wdetail.pass    = "N"    
        wdetail.OK_GEN  = "N".
    ELSE ASSIGN  wdetail.tariff =   sicsyac.xmm016.tardef
...
If nv_ncbper  <> 0 Then do:
    ...
    IF not avail  sicsyac.xmm104  Then ASSIGN  wdetail.comment = wdetail.comment + "| This NCB Step not on NCB Rates file xmm104. " .
END. 
/* A67-0087 */
IF wdetail.flag = NO THEN DO: /* add by: A68-0044 */
    /*IF (wdetail.subclass = "E11" ) AND trim(wdetail.drivnam1) = " " THEN DO:*/ /* A68-0044 */
    IF (wdetail.subclass = "E11" ) OR (wdetail.subclass = "E21" ) OR (wdetail.subclass = "E61" )  AND trim(wdetail.drivnam1) = " " THEN DO: /*  A68-0044 */
        ASSIGN wdetail.comment = wdetail.comment + "| " + "รหัสรถไฟฟ้า " + wdetail.subclass + " กรุณาระบุผู้ขัขขี่ " 
               WDETAIL.OK_GEN  = "N"     
               wdetail.pass    = "N".
    END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_chktest1 WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_chktest2 WGWTFC70 
...
IF NOT AVAILABLE uwm130 THEN 
    ...
    IF wdetail.poltyp = "v72" THEN  n_sclass72 = wdetail.subclass.
    ELSE IF index(wdetail.subclass,"E") <> 0 AND (wdetail.prempa <>  "T" OR                         /*A65-0035*/
            wdetail.prempa <> "U") THEN n_sclass72 = wdetail.prempa + substr(wdetail.subclass,1,3).  /*A65-0035*/
    ELSE n_sclass72 = wdetail.prempa + wdetail.subclass .
    FIND FIRST stat.clastab_fil Use-index clastab01 Where
        stat.clastab_fil.class   = n_sclass72       And
        stat.clastab_fil.covcod  = wdetail.covcod   No-lock  No-error No-wait.
    IF avail stat.clastab_fil Then do: 
        ...
        IF wdetail.prempa <> "Z"  THEN DO: /* a63-0122 */
            If  wdetail.garage   =  ""  Then
                Assign 
                nv_41     = IF deci(wdetail.no_411) = 0 THEN stat.clastab_fil.si_41unp ELSE deci(wdetail.no_411)
            ...
            Else If  wdetail.garage  =  "G"  Then
                Assign nv_41       =  IF deci(wdetail.no_411) = 0 THEN stat.clastab_fil.si_41pai ELSE deci(wdetail.no_411)
                       nv_42       =  IF deci(wdetail.no_42)  = 0 THEN stat.clastab_fil.si_42    ELSE deci(wdetail.no_42) 
...
ASSIGN 
    ...
    sic_bran.uwm301.body     = wdetail.body
    sic_bran.uwm301.seats    = INTEGER(wdetail.seat)
    sic_bran.uwm301.mv41seat = IF wdetail.seat41 <> 0 THEN wdetail.seat41 ELSE IF wdetail.seat <> 0 THEN wdetail.seat ELSE nv_seat41  /*A65-0035*/
    sic_bran.uwm301.mv_ben83 = trim(wdetail.benname)
    sic_bran.uwm301.vehreg   = trim(wdetail.vehreg) 
    sic_bran.uwm301.yrmanu   = inte(wdetail.caryear)
    sic_bran.uwm301.vehuse   = trim(wdetail.vehuse)
    ...
    sic_bran.uwm301.battper   = INTE(wdetail.battper) .
    /* end : A67-0087*/
    RUN proc_acctxt .  /*A65-0035*/
    IF sic_bran.uwm301.prmtxt <> "" THEN RUN proc_uwd100 . /*A65-0079*/
/* End A63-0210 */
wdetail.tariff  = sic_bran.uwm301.tariff.
 IF wdetail.compul = "y" THEN DO:
   sic_bran.uwm301.cert = "".
 ...
 s_recid4         = RECID(sic_bran.uwm301).
 IF wdetail.seat = 16 THEN wdetail.seat = 12.
 IF wdetail.redbook = "" AND wdetail.bev = "N" THEN RUN proc_maktab.  /*A65-0035*/ 
END PROCEDURE.

/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_chktest3 WGWTFC70 
...
ELSE DO:
   /* IF index(wdetail.subclass,"E") = 0 THEN RUN proc_calpremt.      /*A64-0138*/
    ELSE RUN proc_calpremt_ev. /*A67-0087*/ */ /*A68-0044 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_chktest4 WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_chktest41 WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_chktest4_comp WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_clearmailtxt WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_colorcode WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_create100 WGWTFC70 
...
ASSIGN                                              
       ...
       sic_bran.uwm100.rencnt = IF SUBSTR(wdetail.policy,LENGTH(wdetail.policy) - 1) = "2Y" THEN n_rencnt + 1  ELSE n_rencnt             
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_createcomp WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_cutchar WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_driver WGWTFC70 
...
------------------------------------------------------------------------------*/
 IF  wdetail.drivnam1 <> ""  THEN DO :      
   ...
   ASSIGN wdetail.driag1   = if trim(wdetail.driag1 ) = "" then  STRING(DATE(wdetail.driag1),"99/99/9999")  else ""
          wdetail.driag2   = if trim(wdetail.driag2 ) = "" then  STRING(DATE(wdetail.driag2),"99/99/9999")  else ""
          wdetail.drivag3  = if trim(wdetail.drivag3) = "" then  STRING(DATE(wdetail.drivag3),"99/99/9999") else ""
          wdetail.drivag4  = if trim(wdetail.drivag4) = "" then  STRING(DATE(wdetail.drivag4),"99/99/9999") else ""
          wdetail.drivag5  = if trim(wdetail.drivag5) = "" then  STRING(DATE(wdetail.drivag5),"99/99/9999") else ""
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_initcal WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_initdata WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_insnam WGWTFC70 
...
IF n_icno <> "" THEN DO:
   ...
   ELSE DO:
   /* end : A65-0035 */
    FOR EACH tbinsurid WHERE 
        tbinsurid.insuricno = n_icno NO-LOCK.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_insnam2 WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_insno WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_insuricno WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_mailtxt WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_maktab WGWTFC70 
...
IF (wdetail.si = "") OR (wdetail.si = "0.00") OR (wdetail.si = "0" ) THEN DO:
    ...
    If  avail stat.maktab_fil  Then 
        ...
        sic_bran.uwm301.engine  =  stat.maktab_fil.engine
        sic_bran.uwm301.tons    =  stat.maktab_fil.tons   /*A65-0035*/
        sic_bran.uwm301.maksi   =  stat.maktab_fil.si  /* A67-0087*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_maktab301 WGWTFC70 
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
/* comment by :A65-0035 ไม่มีการเรียกใช้งาน ....
IF wdetail.model = "commuter" THEN wdetail.seat = 12.
IF (wdetail.si = "") OR (wdetail.si = "0.00") OR (wdetail.si = "0" ) THEN DO:
    Find LAST stat.maktab_fil Use-index      maktab04           Where
        stat.maktab_fil.makdes   =    wdetail.brand             And 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_matchtypins WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_model_brand WGWTFC70 
...
IF chkred = NO THEN DO:
    ...
    IF INDEX(n_model," ") <> 0 THEN 
        n_model = substr(n_model,1,R-INDEX(n_model," ") - 1).
    IF index(wdetail.brand,"benz") <> 0 THEN DO: 
        ASSIGN wdetail.brand = "MERCEDES-BENZ".
        IF wdetail.model = "cls" THEN wdetail.model = "CLS250".
    END.
    /*IF index(wdetail.model,"cab4") <> 0 THEN wdetail.model = "cab".*/ /*A65-0035*/
    IF index(wdetail.model,"cab4") <> 0 THEN wdetail.model = "D-MAX".  /*A65-0035*/
END.
ELSE DO:
    n_model = wdetail.model .   /*a60-0118*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_open WGWTFC70 
PROCEDURE proc_open :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_policy WGWTFC70 
...
IF wdetail.policy <> "" THEN DO:
    ...
    IF wdetail.stk  <>  ""  THEN DO: 
        ...
        IF chk_sticker  <>  chr_sticker  Then 
            ASSIGN  wdetail.pass    = "N"
            wdetail.comment = wdetail.comment + "| Sticker Number ใช้ Generate ไม่ได้ เนื่องจาก Module Error" + wdetail.stk .
...
ELSE DO:  /*wdetail.policy = ""*/
    IF wdetail.stk  <>  ""  THEN DO:
        ...
        IF AVAIL stat.detaitem THEN 
            ASSIGN  wdetail.pass    = "N"
            wdetail.comment = wdetail.comment + "| หมายเลข Sticker เบอร์นี้ได้ถูกใช้ไปแล้ว" + wdetail.stk
            wdetail.warning = "Program Running Policy No. ให้ชั่วคราว".
        IF wdetail.policy = "" THEN DO:
            RUN proc_temppolicy.
            wdetail.policy  = nv_tmppol.
...
/* s_recid1  =  Recid(sic_bran.uwm100). --- A67-0185 --*/
...
ELSE DO:
    IF INDEX(wdetail.receipt_name,"ทิสโก้") <> 0 THEN DO:
        FIND FIRST stat.insure USE-INDEX insure01 WHERE stat.insure.compno = "TISCO" AND
    ...
    ELSE DO:
        ...
        /* A65-0035 */
        ELSE DO: 
            FIND FIRST stat.insure USE-INDEX insure01 WHERE stat.insure.compno = "GWM" AND
                   trim(stat.insure.lname) =  trim(wdetail.cedpol) NO-LOCK NO-WAIT NO-ERROR.
            IF AVAIL stat.insure THEN  ASSIGN nv_vatcode = stat.insure.vatcode  .
            ELSE ASSIGN nv_vatcode = ""  .
        END.
        IF nv_insref = "MC46363" AND nv_vatcode = "MC46363" THEN ASSIGN wdetail.receipt_name = "" . 
        ELSE IF nv_insref = "MC46614" AND nv_vatcode = "MC46363" THEN ASSIGN wdetail.receipt_name = "" . 
        /* end : A65-0035 */
    END.
...
DO TRANSACTION:
    ASSIGN
        ...
        sic_bran.uwm100.campaign   = caps(trim(wdetail.producer))  /*trim(wdetail.campaign_ov).*/ /*Add by Kridtiya i. A63-0472*/
...
END.   /*transaction*//**/
/*IF sic_bran.uwm100.poltyp = "V70" THEN RUN proc_uwd100.*//*A65-0035*/
RUN proc_uwd102.
IF index(trim(wdetail.remark),"_2Y") <> 0 THEN RUN proc_uwd105.
/*RUN proc_uwd102.*/
/* --------------------U W M 1 2 0 -------------- */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_prmtxt WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_protis WGWTFC70 
...
FOR EACH brstat.insure USE-INDEX insure03 WHERE brstat.insure.compno  = trim(fi_chkpro) AND  /*PRO_TIS*/
                ...
                ASSIGN tbprotis.producer = brstat.insure.icaddr2
                       ...
                       tbprotis.cover    = trim(insure.vatcode) . /*A67-0114  cover*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_redbook72 WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_renew WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_renew_veh WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_report1 WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PROC_REPORT2 WGWTFC70 
...
PUT STREAM NS2
    ...
    "comment"       "|"                  
    "WARNING"       SKIP.   
FOR EACH  wdetail NO-LOCK WHERE wdetail.PASS = "Y"  :
    PUT STREAM ns2
            wdetail.redbook    "|"   
            /*wdetail.n_branch     "|"   
            wdetail.n_delercode  "|"   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_screen WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_sic_exp2 WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_susspect WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_TempPolicy WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Proc_usdcod WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_usdcodrenew WGWTFC70 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_uwd100 WGWTFC70 
...
END.
ELSE DO:
    IF LENGTH(wdetail.caracc) <= 110 THEN ASSIGN  nv_txt2 = TRIM(wdetail.caracc) .
    ELSE IF LENGTH(wdetail.caracc) >  110 THEN DO:
        ASSIGN  nv_txt2 = SUBSTR(wdetail.caracc,1,110)
                nv_txt3 = SUBSTR(wdetail.caracc,101,110)
                nv_txt4 = SUBSTR(wdetail.caracc,211,110).
    END.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_uwd102 WGWTFC70 
...
/*DO WHILE nv_line1 <= 12:   */  /*A63-0210*/ /*A67-0087*/
DO WHILE nv_line1 <= 15 : /*A67-0087*/
    CREATE wuppertxt3.
   ...
   /* IF nv_line1 = 3  THEN wuppertxt3.txt = "Notify time:" + wdetail.enttim   .*/
    ...
    ...end A67-0087 */
    /* add by : A67-0087 */
    IF nv_line1 = 8  THEN wuppertxt3.txt = trim(wdetail.Rec_name72) + " " + trim(wdetail.Rec_add1)   + " " + trim(wdetail.Rec_add2)   . /*A63-0210*/
    IF nv_line1 = 9  THEN wuppertxt3.txt = trim(nv_Product) .                                                                          
    IF nv_line1 = 10 THEN wuppertxt3.txt = "สีรถ :" + wdetail.colorcode.                                                               
    IF nv_line1 = 11 THEN wuppertxt3.txt = "หมายเลขเครื่องยนต์ 3: " + trim(wdetail.engno3) .
    IF nv_line1 = 12 THEN wuppertxt3.txt = "หมายเลขเครื่องยนต์ 4: " + trim(wdetail.engno4) .
    IF nv_line1 = 13 THEN wuppertxt3.txt = "หมายเลขเครื่องยนต์ 5: " + trim(wdetail.engno5) .
    /*...end A67-0087 */
    /*--end A60-0118--*/
    nv_line1 = nv_line1 + 1.                                                   
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_uwd105 WGWTFC70 
...
DO:
    ...
    RELEASE sic_bran.uwd105.*/
        /*---clause----*/
    IF sic_bran.uwm100.fptr03 <> 0 THEN DO:
        FIND FIRST sic_bran.uwd105 WHERE RECID(sic_bran.uwd105) = sic_bran.uwm100.fptr03 NO-ERROR NO-WAIT.
        IF AVAIL sic_bran.uwd105 THEN DO:
            nv_fptr =  RECID(sic_bran.uwd105) .
            loop_del105:
            REPEAT:
                IF nv_fptr <> 0 THEN DO:
                    FIND FIRST sic_bran.uwd105 WHERE RECID(sic_bran.uwd105) = nv_fptr NO-ERROR NO-WAIT.
                    IF AVAIL sic_bran.uwd105 THEN DO:
                        nv_fptr = sic_bran.uwd105.fptr.
                        DELETE sic_bran.uwd105.
                    END.
                    ELSE LEAVE loop_del105.
                END.
                ELSE LEAVE loop_del105.
            END.
        END.
    ...
    ASSIGN
        ...
        sic_bran.uwm100.bptr03 = 0   
        nv_fptr       = 0   
        nv_line1      = 0 .  
        CREATE sic_bran.uwd105.
        ASSIGN
            sic_bran.uwd105.policy   = sic_bran.uwm100.policy 
            sic_bran.uwd105.rencnt   = sic_bran.uwm100.rencnt 
            sic_bran.uwd105.endcnt   = sic_bran.uwm100.endcnt 
            sic_bran.uwd105.fptr     = 0
            sic_bran.uwd105.bptr     = nv_fptr
            sic_bran.uwd105.clause   = "MT001_PB" .
        IF sic_bran.uwm100.fptr03 = 0 THEN sic_bran.uwm100.fptr03 = RECID(sic_bran.uwd105).
        sic_bran.uwm100.bptr03 = RECID(sic_bran.uwd105).
        FIND wf_uwd105 WHERE RECID(wf_uwd105) = nv_fptr NO-ERROR NO-WAIT.
        IF AVAIL wf_uwd105 THEN wf_uwd105.fptr = RECID(sic_bran.uwd105). 
        nv_fptr = RECID(sic_bran.uwd105).
    END. /* V70 */ 
END.
END PROCEDURE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_var WGWTFC70 
PROCEDURE proc_var :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_wgw72013 WGWTFC70 
