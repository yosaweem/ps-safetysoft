...
-------------------------------------------------------------------------
 Modify By : Porntiwa P.  A56-0250  05/08/2013
           : ปรับงานนำเข้าของ Thanachat เนื่องจากเพิ่ม Column IC No.
           : Check เงื่อนไข และ/ หรือ  ใหม่ รวมทั้งการออก Vat Code ใหม่  
------------------------------------------------------------------------
 Modify By : Porntiwa P. A59-0070  29/03/2016
           : ปรับการนำเข้าโปรแกรม Thanachat            
-------------------------------------------------------------------------
Modify by : Ranu I. A59-0471 Date: 04/10/2016
          : เปลี่ยนเงื่อนไขการ check พรบ. จากสติ๊กเกอร์เป็นเบี้ยพรบ. แทน                                                                
------------------------------------------------------------------------
Modify by : Ranu I. A60-0545 Date: 20/12/2017
          : เปลี่ยน format File แจ้งงานป้ายแดง 
                                                                       
Modify by : Ranu I. A63-0174 date : 28/04/2020
          : เปลี่ยน format File แจ้งงานป้ายแดงเอาคอลัมน์ attrate รหัสรถ ออก เพิ่มรุ่นยอ่ย                                                            
------------------------------------------------------------------------*/
/* Modify by : Ranu I. A64-0205 เพิ่มเงื่อนไขการดึงข้อมูล producer/Agent */
/* Modify by : Ranu I. A64-0278 แก้เงื่อนไขการใส่ และ/หรือ             */
...
------------------------------------------------------------------------------*/
    ...
    IF nv_poltyp = "70" THEN DO:
        /** และ/หรือ Line 70 **/
        nv_name2 = "".
        IF      (Imother2 = "FALSE" OR Imother2 = "0")  AND (Imandor1 = "TRUE"  OR Imandor1 = "1") THEN nv_name2 = "และ/หรือ" + " " + Imdealernam.
        ELSE IF (Imother2 = "TRUE"  OR Imother2 = "1")  AND (Imandor1 = "FALSE" OR Imandor1 = "0") THEN nv_name2 = "และ/หรือ" + " " + "ธนาคาร ธนชาต จำกัด (มหาชน)".
        ELSE IF (Imother2 = "FALSE" OR Imother2 = "0")  AND (Imandor1 = "FALSE" OR Imandor1 = "0") THEN nv_name2 = " ".
        ELSE IF Imdealernam <> ""                          THEN nv_name2 = "และ/หรือ" + " " + Imdealernam.
        ELSE "และ/หรือ" + " " + "ธนาคาร ธนชาต จำกัด (มหาชน)".
    ...
    ELSE IF nv_poltyp = "72" THEN DO:
        /** และ/หรือ Line 72 **/
        nv_name2 = "".
        IF      (Imandor3 = "FALSE" OR Imandor3 = "0") AND (Imandor2 = "TRUE"  OR Imandor2 = "1") THEN nv_name2 = "และ/หรือ" + " " + Imdealernam.
        ELSE IF (Imandor3 = "TRUE"  OR Imandor3 = "1") AND (Imandor2 = "FALSE" OR Imandor2 = "0") THEN nv_name2 = "และ/หรือ" + " " + "ธนาคาร ธนชาต จำกัด (มหาชน)".
...
DO:
    ...
    IF nv_poltyp = "70" THEN DO:
        /** และ/หรือ Line 70 **/
        nv_name2 = "".
        /*IF      INDEX(Imother1,"Dealer") <> 0  THEN nv_name2 = "และ/หรือ" + " " + Imdealernam.                  */ /*A64-0205*/
        /*ELSE IF INDEX(Imother1,"Tbank")  <> 0  THEN nv_name2 = "และ/หรือ" + " " + "ธนาคาร ธนชาต จำกัด (มหาชน)". */ /*A64-0205*/
        ...
        ELSE IF INDEX(Imother1,"Tbank")  <> 0  THEN DO: 
           ...
           FIND LAST stat.insure USE-INDEX insure01 WHERE 
              stat.insure.comp   = fi_vatcode   AND 
              index(stat.insure.fNAME,"ธนาคารธนชาต") <> 0   NO-LOCK NO-ERROR.
                IF AVAIL stat.insure THEN ASSIGN nv_vatcode = stat.insure.vatcode .
                ELSE nv_vatcode = "" .

        END.
        /* end : A64-0205 */
        ELSE IF INDEX(Imother1,"ไม่แถม") <> 0  THEN nv_name2 = " ".
        ELSE nv_name2 = " ".
    ...
    ELSE IF nv_poltyp = "72" THEN DO:
        /** และ/หรือ Line 72 **/
        nv_name2 = "".
        /*IF      INDEX(Imother2,"Dealer")  <> 0  THEN nv_name2 = "และ/หรือ" + " " + Imdealernam.                  */ /*A64-0205*/
        /*ELSE IF INDEX(Imother2,"Tbank")   <> 0  THEN nv_name2 = "และ/หรือ" + " " + "ธนาคาร ธนชาต จำกัด (มหาชน)". */ /*A64-0205*/
         /* add by : A64-0205 */
        ASSIGN nv_vatcode = ""   nv_dname = "" . 
        IF  INDEX(Imother1,"Dealer") <> 0  THEN DO: 
...
INPUT FROM VALUE (fiImpName).
    REPEAT:
        IMPORT DELIMITER ","
            ...
            /*4*/  Imstkno       /*เลขสติ๊กเกอร์*/
            /*5*/  Imstkno1      /*ค้างแจ้งเลขที่สติ๊กเกอร์*/
            /*6*/  Imyrcomp      /*พรบ ปี*/
            ...
            /*16*/ ImICNo        /*เลขที่ประจำตัว*/  /*A56-0250*/
            /*17*/ Imnfadd       /*ที่อยู่ NF*/
            /*18*/ Iminadd       /*ที่อยู่ลูกค้า*/
            /*19*/ Imdeadd       /*ที่อยู่ Dealer*/
            /*20*/ Imiadd1       /*รายละเอีดยที่อยู่*/
            /*21*/ Imiadd2       /*รายละเอียดที่อยู่ 1*/
            /*22*/ Imiadd3       /*เบอร์โทร*/
            /*23*/ Immadd1       /*ที่อยู่ส่งเอกสาร*/
            /*24*/ Immadd2       /*ที่อยู่ส่งเอกสาร1*/
            ...
            /*43*/ Imother3      /*Dealer ดำเนินการเอง*/    
            /*44*/ Imandor1      /*Dealer แถม*/             
            /*45*/ Imandor3      /*Tbank แถม พรบ.*/         
            /*46*/ Imother4      /*ไม่ซื้อ*/  /*A55-0235*/  
            /*47*/ Imandor2      /*พรบ Dealer*/
            /*48*/ Imother5      /*พรบ ลูกค้า*/
            /*49*/ Imattrate     /*PATTREN RATE*/
            /*50*/ Imcarpri      /*ราคารถ*/ 
            /*51*/ Imdealernam   /*ชื่อ Dealer*/
            /*52*/ Imsalenam     /*ชือ sale*/  /*ใส่รหัส Dealer Code */ 
            /*53*/ Imcovcod      /*ประเภทการประกันภัย*/
            /*54*/ Imvghgrp1     /*ระบุชื่อ*/
            /*55*/ Imvghgrp2     /*ไม่ระบุชื่อ*/
            /*56*/ Imdrivnam1    /*ชื่อ 1*/
            /*57*/ Imdrivbir1    /*วัน/เดือน/ปีเกิด1*/
            /*58*/ Imidno1       /*เลขที่ ID 1*/
            /*59*/ Imlicen1      /*ใบขับขี่ 1 เลขที่*/
            /*60*/ Imdrivnam2    /*ชื่อ 2*/
            /*61*/ Imdrivbir2    /*วัน/เดือน/ปีเกิด2*/
            /*62*/ Imidno2       /*เลขที่ ID 2*/
...
DO:
    ...
    IF nv_poltyp = "70" THEN DO:
        ...
        nv_name2 = "".
        ASSIGN nv_vatcode = ""   nv_dname = "" . 
        IF (INDEX(Imother1,"Dealer") <> 0 OR INDEX(Imother1,"ดีลเลอร์") <> 0 ) THEN DO: 
            nv_name2 = "และ/หรือ" + " " + Imdealernam. 
            IF INDEX(Imdealernam," ") <> 0 THEN nv_dname = REPLACE(Imdealernam," ","") .
        ...
        ELSE IF (INDEX(Imother1,"Tbank")  <> 0  OR INDEX(Imother1,"TTB") <> 0 OR
           ...
           FIND LAST stat.insure USE-INDEX insure01 WHERE 
              stat.insure.comp   = fi_vatcode   AND 
              index(stat.insure.fNAME,"ทหารไทยธนชาต") <> 0   NO-LOCK NO-ERROR.
                IF AVAIL stat.insure THEN ASSIGN nv_vatcode = stat.insure.vatcode .
                ELSE nv_vatcode = "" .
        END.
        /* end : A64-0205 */
        ...
        IF TRIM(immadd1) = "" AND TRIM(immadd2) = ""  THEN DO: /*A63-0174 */
            ...
            ELSE DO:
                ASSIGN Imiadd1  = "900 อาคารต้นสน ทาวเวอร์"
                       Imiadd2  = "ถ.เพลินจิต แขวงลุมพินี"
                       Imiadd3  = "เขตปทุมวัน กรุงเทพฯ 10330"
                       Imbennam = "ธนาคารทหารไทยธนชาต จำกัด (มหาชน)".
            END.
        END.
        ELSE DO:
           /* add :  A63-0174*/
   ...
   IF INDEX(imICNo,"'") <> 0 THEN ImICNo = TRIM(REPLACE(ImICNo,"'","")).
    ...
    IF  nv_poltyp = "70" AND Imstkno <> "" THEN DO:
        ...
        nv_name2 = "".
         ...
         /* add by : A64-0205 */
        ASSIGN nv_vatcode = ""   nv_dname = "" . 
        IF  (INDEX(Imother2,"Dealer") <> 0 OR INDEX(Imother2,"ดีลเลอร์") <> 0 ) THEN DO: 
...
IF Imbennam <> "" THEN DO:
    ...
    ELSE DO:
        ...
        IF LENGTH(imaddr) > 35 THEN DO:
           IF r-INDEX(imaddr,"กทม") <> 0  THEN DO:
               ASSIGN Imiadd4 = SUBSTR(imaddr,r-INDEX(imaddr,"กทม"))
                   imaddr  = SUBSTR(imaddr,1,r-INDEX(imaddr,"กทม") - 1 ).
           END.
           ELSE IF r-INDEX(imaddr,"กรุงเทพ") <> 0  THEN DO:
               ASSIGN Imiadd4 = SUBSTR(imaddr,r-INDEX(imaddr,"กรุงเทพ"))
                   imaddr  = SUBSTR(imaddr,1,r-INDEX(imaddr,"กรุงเทพ") - 1 ).
           END.
           ELSE IF r-INDEX(imaddr,"จ.") <> 0  THEN DO:
               ASSIGN Imiadd4 = SUBSTR(imaddr,r-INDEX(imaddr,"จ."))
                   imaddr  = SUBSTR(imaddr,1,r-INDEX(imaddr,"จ.") - 1 ).
           END.
           ELSE IF r-INDEX(imaddr,"จังหวัด") <> 0  THEN DO:
               ASSIGN Imiadd4 = SUBSTR(imaddr,r-INDEX(imaddr,"จังหวัด"))
                   imaddr  = SUBSTR(imaddr,1,r-INDEX(imaddr,"จังหวัด") - 1 ).
           END.
           /*Amper */
           IF r-INDEX(imaddr,"อ.") <> 0  THEN DO:
               ASSIGN Imiadd3   = SUBSTR(imaddr,r-INDEX(imaddr,"อ."))
                   imaddr  = SUBSTR(imaddr,1,r-INDEX(imaddr,"อ.") - 1 ).
           END.
           ELSE IF r-INDEX(imaddr,"กิ่งอำเภอ") <> 0  THEN DO:
               ASSIGN Imiadd3 = SUBSTR(imaddr,r-INDEX(imaddr,"กิ่งอำเภอ"))
                   imaddr  = SUBSTR(imaddr,1,r-INDEX(imaddr,"กิ่งอำเภอ") - 1 ).
           END.
           ELSE IF r-INDEX(imaddr,"อำเภอ") <> 0  THEN DO:
               ASSIGN Imiadd3 = SUBSTR(imaddr,r-INDEX(imaddr,"อำเภอ"))
                   imaddr  = SUBSTR(imaddr,1,r-INDEX(imaddr,"อำเภอ") - 1 ).
           END.
           ELSE IF r-INDEX(imaddr,"เขต") <> 0  THEN DO:
               ASSIGN Imiadd3 = SUBSTR(imaddr,r-INDEX(imaddr,"เขต"))
                   imaddr  = SUBSTR(imaddr,1,r-INDEX(imaddr,"เขต") - 1 ).
           END.
           /*tambon*/
           IF r-INDEX(imaddr,"ต.") <> 0  THEN DO:
               ASSIGN Imiadd2   = SUBSTR(imaddr,r-INDEX(imaddr,"ต."))
                   imaddr   = SUBSTR(imaddr,1,r-INDEX(imaddr,"ต.") - 1 ).
           END.
           ELSE IF r-INDEX(imaddr,"ตำบล") <> 0  THEN DO:
               ASSIGN Imiadd2 = SUBSTR(imaddr,r-INDEX(imaddr,"ตำบล"))
                      imaddr  = SUBSTR(imaddr,1,r-INDEX(imaddr,"ตำบล") - 1 ).
           END.
           ELSE IF r-INDEX(imaddr,"แขวง") <> 0  THEN DO:
               ASSIGN Imiadd2 = SUBSTR(imaddr,r-INDEX(imaddr,"แขวง"))
                      imaddr  = SUBSTR(imaddr,1,r-INDEX(imaddr,"แขวง") - 1 ).
           END.
...
ELSE DO:
   ...
   /* RUN PDChkBranch. */ /*A59-0070 ไม่มีกรมธรรม์มาให้เข้าตาม Parameter ตามเลขรับแจ้ง*/
END.
...
IF nv_oldpol = "" THEN DO:
    ...
    IF Imcodecar = "" AND nv_prempa = "" THEN DO:
        ...
        ELSE ASSIGN nv_prempa = "R"   ImbenNam  = "". /*--- งานต่ออายุจากที่อื่นคุ้มครอง 3 ไม่มี BenName --*/
    END.
END.
/*---- End Add A54-0076 ----*/
    ...
    /* create by Ranu I. A60-0545 */
        ...
        FOR EACH wImport WHERE wImport.pass <> "N" NO-LOCK:
          EXPORT DELIMITER "|"
            ...
            drivic1    /*40    เลขบัตรปปช. */    /*A60*0545*/
            drivid1    /*41    เลขบัตรขับขี่*/    /*A60*0545*/
            drivage1   /*42. อายุผู้ขับขี่ 1*/
            drivnam2   /*43. ชื่อผุ้ขับขี่ 2*/   
            drivbir2   /*44. วันเกิดผู้ขับขี่ 2*/
            drivic1    /*45. เลขบัตรปปช. */       /*A60*0545*/ 
            drivid1    /*46. เลขบัตรขับขี่*/      /*A60*0545*/ 
            drivage2   /*47. อายุผู้ขับขี่ 2*/   
            Redbook    /*48. รหัส redbook*/
            opnpol     /*49. ชื่อผุ้แจ้ง*/
            bandet     /*50. ตลาดสาขา*/
            tltdat     /*51. วันที่รับแจ้ง*/
            attrate    /*52. Attrate*/
            branch     /*53. Branch*/
            vatcode    /*54  Vat Code*/
            text1      /*55. Text ถังแก๊ส*/
            text2      /*56 Text ตรวจสภาพ*/
            icno       /*57 เลขที่บัตรประชาชน*/ 
            finit      /*58  Finit Code*/
            Rebate     /*59  Code Rebate*/   /*A55-0235*/
            agent      /*60  agent */        /*A60-0545*/ /*A64-0205*/
            Producer   /*61  producer */     /*A60-0545*/ /*A64-0205*/
            ""         /*62  campaign  */    /*A60-0545*/
            name3      /*63  ชื่อกรรมการ*/  /*A60-0545*/
            ""                
            ""                
            ""                    
            ""    
...
INPUT FROM VALUE (fiImpName).
    REPEAT:
        IMPORT DELIMITER "|"
            Imtltno         /*เลขที่รับแจ้งและสาขา     */  
            Imtltno1        /*เลขที่รับแจ้ง            */  
            Imbancode       /*สาขา                     */  
            Imcedpol        /*เลขที่สัญญา              */  
            Imrenpol        /*เลขที่กรมธรรม์เดิม       */  
            Imcomnam        /*บริษัทประกันเก่า         */  
            Iminsnam        /*ชื่อผู้เอาประกันภัย      */  
            Imbennam        /*ผู้รับผลประโยชน์         */  
            Imcomdate       /*วันที่เริ่มคุ้มครอง      */  
            Imexpdate       /*วันที่สิ้นสุดคุ้มครอง    */  
            Imcomdat1       /*วันทีเริ่มคุ้มครองพรบ    */  
            Imexpdat1       /*วันที่สิ้นสุดคุ้มครองพรบ */  
            Imvehreg        /*เลขทะเบียน               */  
            Imvehreg1       /*จังหวัด                  */  
            Imsi            /*ทุนประกัน                */  
            Imnetprem       /*เบี้ยประกันรวม           */  
            Imnetcomp       /*เบี้ยพรบรวม              */  
            Impremtot       /*เบี้ยรวม                 */  
            Impolcomp       /*เลขกรมธรรม์พรบ           */  
            Imstkno         /*เลขที่สติ๊กเกอร์         */  
            Imcodgrp        /*รหัสผู้แจ้ง              */  
            Imdetail        /*หมายเหตุ                 */  
            Imtltdat        /*วันที่รับแจ้ง            */  
            Imcomnam1       /*ชื่อประกันภัย            */  
            Imopnpol        /*ผู้แจ้ง                  */  
            Imbrand         /*ยี่ห้อ                   */  
            ImModel         /*รุ่น                     */  
            Imyrmanu        /*ปี                       */  
            ...
            Imcovcod        /*ประเภทประกัน             */  
            Imbody1         /*ประเภทรถ                 */  
            Imgarage1       /*สถานที่ซ่อม              */  
            Imdrivnam1      /*ระบุผู้ขับขี่1           */  
            Imlicen1        /*เลขที่ใบขับขี่1          */  
            Imidno1         /*เลขที่บัตรประชาชน1       */  
            Imdrivbir1      /*วันเดือนปีเกิด1          */  
            Imdrivnam2      /*ระบุผู้ขับขี่2           */  
            Imlicen2        /*เลขที่ใบขับขี่2          */  
            Imidno2         /*เลขที่บัตรประชาชน2       */  
            Imdrivbir2      /*วันเดือนปีเกิด2          */  
            /*Imdeduct1      
            Imdeduct2        
            Imdeduct3*/      
            Imdeductda      /*ส่วนลดประวัติเสีย        */  
            Imncb           /*ส่วนลดกลุ่ม              */  
            Imdeductpd      /*ประวัติดี                */  
            Imother         /*อื่น ๆ                   */  
            Imaddr          /*ที่อยู่ลูกค้า            */  
            Imicno          /*IDCARD                   */  
            Imiccomdat      /*DateCARD_S               */ 
            Imicexpdat      /*DateCARD_E               */ 
            Imtypaid.       /*Type_Paid_1              */ 
        IF index(Imtltno,"เลขที่รับแจ้ง") <> 0 THEN NEXT.
