/*programid   : wgwtlori.i                                               */ 
/*programname : Load text file ORICO to GW                            */ 
/*Copyright   : Safety Insurance Public Company Limited 			     */ 
/*			    บริษัท ประกันคุ้มภัย จำกัด (มหาชน)				         */ 
/* create by : Ranu I. A560-0340 Date : 30/09/2016                                    
                ปรับโปรแกรมให้สามารถนำเข้า text file ORICO to GW system*/ 
...
DEFINE NEW SHARED TEMP-TABLE wdetail
    ...
    FIELD covcod          AS CHAR FORMAT "x(3)"  INIT ""   /* covcod            */     
    ...
    FIELD txtmemo1       AS CHAR FORMAT "x(100)" INIT ""
    FIELD txtmemo2       AS CHAR FORMAT "x(100)" INIT ""
    FIELD accsor         AS CHAR FORMAT "x(250)" INIT ""
    FIELD accprice       AS CHAR FORMAT "x(15)"  INIT ""
    ...
    FIELD inspec         AS CHAR FORMAT "x(20)" INIT ""   /*A60-0263*/
    FIELD insnamtyp      AS CHAR FORMAT "x(20)" INIT ""   /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/
    ...
    FIELD damagdetail    AS CHAR FORMAT "x(500)" INIT "". /*Add by Kridtiya i. A66-0107 Date. 28/05/2023*/ 
...
DEFINE VAR  ns_no            AS CHAR FORMAT "X(3)" .   /*"ประเภทของ Record"           */                            
...
DEFINE VAR  ns_bkdate        AS CHAR FORMAT "X(15)"  .   /*"วันที่ทำสัญญา"              */                           
DEFINE VAR  ns_notidate      AS CHAR FORMAT "X(15)"  .   /*"วันที่แจ้งประกัน"           */                           
DEFINE VAR  ns_inscmp        AS CHAR FORMAT "X(5)"  .   /*"รหัสบริษัทประกันภัย"        */
DEFINE VAR  ns_instyp        AS CHAR FORMAT "X(15)"  .   /*"ประเภทประกันเดิม"           */ 
DEFINE VAR  ns_comtyp        AS CHAR FORMAT "x(15)" .  /* ประเภท พรบ */
DEFINE VAR  ns_covtyp        AS CHAR FORMAT "X(15)"  .   /*"ประเภทความคุ้มครอง"         */                           
...
DEFINE VAR  ns_effdate       AS CHAR FORMAT "X(15)"  .   /*"วันที่ประกันภัยมีผล"        */                            
DEFINE VAR  ns_expdate       AS CHAR FORMAT "X(15)"  .   /*"วันที่หมดอายุ"              */
...
DEFINE VAR  ns_acceffdat     AS CHAR FORMAT "X(15)"  .   /*"วันที่ประกันมีผล"           */                      
DEFINE VAR  ns_accexpdat     AS CHAR FORMAT "X(15)"  .   /*"วันที่หมดอายุ"              */                      
...
DEFINE VAR  ns_bdaydr1       AS CHAR FORMAT "X(15)"  .   /*"วันเกิดผู้ขับขี่คนที่ 1"               */     
...
DEFINE VAR  ns_bdaydr2       AS CHAR FORMAT "X(15)"  .   /*"วันเกิดผู้ขับขี่คนที่ 2"               */     
...
DEFINE VAR  ns_dealsub       AS CHAR FORMAT "X(50)"  .   /*"flag Dealer แถม"                       */     
...
DEF    VAR  ns_campaign      AS CHAR FORMAT "x(20)" .  
DEF    VAR  ns_nottime       AS CHAR FORMAT "x(10)" .
DEF    VAR  ns_saleid        AS CHAR FORMAT "x(15)" .
DEF    VAR  ns_taxno         AS CHAR FORMAT "x(15)" .
DEF    VAR  ns_brantax       AS CHAR FORMAT "x(5)"  .
DEF    VAR  ns_accsor        AS CHAR FORMAT "x(250)".
DEF    VAR  ns_accprice      AS CHAR FORMAT "x(15)" .
DEF    VAR  ns_pack          AS CHAR FORMAT "x(2)"  .
DEF    VAR  ns_inspec        AS CHAR FORMAT "x(20)" .
...
DEFINE VAR   nv_insnamtyp      AS CHAR FORMAT "x(30)"  INIT "".   /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/     
DEFINE VAR   nv_firstName      AS CHAR FORMAT "x(30)"  INIT "".   /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/     
DEFINE VAR   nv_lastName       AS CHAR FORMAT "x(30)"  INIT "".   /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/ 
DEFINE VAR   nv_postcd         AS CHAR FORMAT "x(30)"  INIT "".   /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/ 
DEFINE VAR   nv_codeocc        AS CHAR FORMAT "x(30)"  INIT "".   /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/  
DEFINE VAR   nv_codeaddr1      AS CHAR FORMAT "x(30)"  INIT "".   /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/  
DEFINE VAR   nv_codeaddr2      AS CHAR FORMAT "x(30)"  INIT "".   /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/  
DEFINE VAR   nv_codeaddr3      AS CHAR FORMAT "x(30)"  INIT "".   /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/  
/* add by : A64-0138 */
...
DEFINE VAR nv_damagdetail    AS CHAR FORMAT "x(500)" INIT "". /*Add by Kridtiya i. A66-0107 Date. 28/05/2023*/ 
DEF Var nv_txt6 As Char Format "X(150)" init "".
