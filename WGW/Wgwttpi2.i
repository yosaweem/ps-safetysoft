...
/*programname : Load text file tpis รถบรรทุกใหญ่  to GW                                */ 
/* Copyright  : Safety Insurance Public Company Limited                                */  
/*              บริษัท ประกันคุ้มภัย จำกัด (มหาชน)                                     */  
/*create by   : by....... Assign ..... date...............                             
               ปรับโปรแกรมให้สามารถนำเข้า text file tpis รถบรรทุกใหญ่    to GW system  */
/**************************************************************************/
...
/* def    stream  ns2.                                                                                           */
 DEFINE NEW SHARED WORKFILE wdetailtxt NO-UNDO                                                                    
     ...
     FIELD pol_name    AS CHAR FORMAT "X(60)"    INIT ""           /*3  ชื่อผู้เอาประกัน*/                     
     FIELD pol_addr1   AS CHAR FORMAT "X(160)"   INIT ""           /*4  ที่อยู่ผู้เอาประกัน1/สำหรับส่งเอกสาร*/ 
     ...
     FIELD engine      AS CHAR FORMAT "X(26)"    INIT ""           /*10 หมายเลขเครื่องยนต์*/                   
     FIELD chassis     AS CHAR FORMAT "X(26)"    INIT ""           /*11 หมายเลขตัวถังรถ*/                      
     FIELD licence     AS CHAR FORMAT "X(12)"    INIT ""           /*12 หมายเลขทะเบียนรถ */                    
     FIELD province    AS CHAR FORMAT "X(25)"    INIT ""           /*13 จังหวัดที่จดทะเบียนรถ*/                
     FIELD comp_code   AS CHAR FORMAT "X(5)"     INIT ""           /*14 รหัส บ.ประกันภัย(TLT.COMMENT)*/        
     FIELD accdat      AS CHAR FORMAT "X(8)"     INIT ""           /*15 วันที่ตกลงรับประกัน */                 
     FIELD expdat      AS CHAR FORMAT "X(8)"     INIT ""           /*16 วันทีสิ้นสุดความคุ้มครอง */            
     FIELD policy      AS CHAR FORMAT "X(26)"    INIT ""           /*17 เลขที่กรมธรรม์ */                      
     FIELD ins_amt     AS CHAR FORMAT "X(20)"    INIT ""           /*18 เลขที่กรมธรรม์ */                      
     FIELD prem_vo     AS CHAR FORMAT "X(20)"    INIT ""           /*19 ค่าเบี้ยป.1 + ภาษี + อากร */           
     FIELD sckno       AS CHAR FORMAT "X(26)"    INIT ""           /*20 เลขที่กรมธรรม์พรบ. */                  
     FIELD prem_72     AS CHAR FORMAT "X(20)"    INIT ""           /*21 เบี้ย พรบ. */                          
     FIELD stkno       AS CHAR FORMAT "X(15)"    INIT ""           /*21 เลขที่สติ๊กเกอร์ */                    
     FIELD ref_no      AS CHAR FORMAT "X(20)"    INIT ""           /*22 เลขที่กรมธรรม์ */                      
     FIELD temp        AS CHAR FORMAT "X(16)"    INIT ""           /*23 รหัสลุกค้า */  /* Add by A52-0310 */   
     ...
     FIELD mail        AS CHAR FORMAT "x(160)"   INIT ""           /*26 ที่อยู่ของลูกค้า (mailing address) */  
