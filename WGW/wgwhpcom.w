...
/* Connected Databases 
          brstat           PROGRESS
*/
&Scoped-define WINDOW-NAME WUWHPCOM
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _DEFINITIONS WUWHPCOM 
/*------------------------------------------------------------------------
...
/*Program Id. : wgwhpcom.w 
  Copyright   : # Safety Insurance Public Company Limited
                  บริษัท ประกันคุ้มภัย จำกัด (มหาชน)
  Description : Create data from sic_bran to sicuw
                Transfer program from Brach to Head Office
  Written by  : kridtiya i. A55-0015 10/01/2012                 */
  /*modify by : kridtiya i. A55-0046 03/02/2012 ปิดเงื่อนไข การเช็ค phone */
  /*modify by : kridtiya i. A57-0063 05/03/2014 เพิ่มรหัสตัวแทนงานรถจักรยานยนต์*/
  CREATE WIDGET-POOL.
...
Def Input-Output Parameter    n_name         As   Char    Format    "x(35)".
DEF Input-Output Parameter    n_nO1          As   Char    Format    "x(35)" .
DEF Input-Output Parameter    n_nO2          As   Char    Format    "x(35)" .
DEF Input-Output Parameter    n_nO3          As   Char    Format    "x(35)" .
DEF Input-Output Parameter    n_benname      As   Char    Format    "x(10)" . 
DEF Input-Output Parameter    n_producernew  As   Char    Format    "x(10)" .  
DEF Input-Output Parameter    n_produceruse  As   Char    Format    "x(10)" .  
DEF Input-Output Parameter    n_producerbike As   Char    Format    "x(10)" .  /*A57-0063*/
DEF Input-Output Parameter    n_agent        As   Char    Format    "x(10)" .  
DEF Input-Output Parameter    n_text         As   Char    Format    "x(10)" .
...
DEFINE VAR WUWHPCOM AS WIDGET-HANDLE NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brInsure WUWHPCOM _STRUCTURED
...
DEFINE FRAME frmain
     btnReturn AT ROW 21.95 COL 88.5
     btnok2 AT ROW 21.91 COL 73.17
     RECT-84 AT ROW 21.33 COL 86
     RECT-85 AT ROW 21.33 COL 71.17
...
/* SETTINGS FOR FRAME frmain
   Custom                                                               */
IF SESSION:DISPLAY-TYPE = "GUI":U AND VALID-HANDLE(WUWHPCOM)
THEN WUWHPCOM:HIDDEN = no.
...
"Insure.CompNo" ? "X(10)" "character" ? ? ? ? ? ? no ? no no "10.83" yes no no "U" "" ""
     _FldNameList[2]   > brstat.Insure.Branch
"Insure.Branch" "Br name." "X(30)" "character" ? ? ? ? ? ? no ? no no "14.33" yes no no "U" "" ""
     _FldNameList[3]   > brstat.Insure.LName
"Insure.LName" "Code" "X(20)" "character" ? ? ? ? ? ? no ? no no "5.83" yes yes no "U" "" ""
     _FldNameList[4]   > brstat.Insure.FName
"Insure.FName" "BR_STY" "X(10)" "character" ? ? ? ? ? ? no ? no no "7.83" yes no no "U" "" ""
...
&Scoped-define SELF-NAME WUWHPCOM
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL WUWHPCOM WUWHPCOM
ON END-ERROR OF WUWHPCOM /* Setup company code */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL WUWHPCOM WUWHPCOM
ON WINDOW-CLOSE OF WUWHPCOM /* Setup company code */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL brInsure WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncompadd WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncompdel WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncompfirst WUWHPCOM
ON CHOOSE OF btncompfirst IN FRAME frComp /* << */
DO:
    /*FIND FIRST Company WHERE Company.Name  = "phone"   NO-LOCK NO-ERROR.*/ 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncomplast WUWHPCOM
ON CHOOSE OF btncomplast IN FRAME frComp /* >> */
DO:
  /*FIND LAST Company WHERE Company.Name  = "phone" NO-LOCK NO-ERROR. */  /*kridtiya i. A53-0232*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncompnext WUWHPCOM
ON CHOOSE OF btncompnext IN FRAME frComp /* > */
DO:
    FIND bComp WHERE ROWID (bComp) = ROWID (Company) NO-LOCK NO-ERROR.
    /*FIND NEXT bComp WHERE bComp.NAME = "phone"   NO-LOCK NO-ERROR. 
    IF NOT AVAIL bComp THEN RETURN NO-APPLY.
    FIND NEXT Company WHERE  Company.NAME = "phone" NO-LOCK NO-ERROR. */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncompok WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncompprev WUWHPCOM
ON CHOOSE OF btncompprev IN FRAME frComp /* < */
DO:
    FIND bComp WHERE ROWID (bComp) = ROWID (Company) NO-LOCK NO-ERROR.
    /*FIND PREV bComp WHERE bcomp.NAME = "phone"   NO-LOCK NO-ERROR.    
    IF NOT AVAIL bComp THEN RETURN NO-APPLY.
    FIND PREV Company WHERE Company.NAME = "phone"   NO-LOCK NO-ERROR.*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncompreset WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncompupd WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnFirst WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btninadd WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnInCancel WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnInDelete WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnInOK WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnInUpdate WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnLast WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnNext WUWHPCOM
...
&Scoped-define SELF-NAME btnok2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnok2 WUWHPCOM
ON CHOOSE OF btnok2 IN FRAME frmain /* OK */
DO:
    ASSIGN
        n_name  = gcomp 
        n_text  = "save".
    IF n_nO3 = "" THEN DO:
        FIND FIRST Insure WHERE Insure.compno = gComp  NO-LOCK NO-ERROR NO-WAIT.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnPrev WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnReturn WUWHPCOM
...
DO:
   ASSIGN 
       ...
       gcomp = "" 
       n_benname     = ""  /*A56-0024*/
       n_producernew = ""  /*A56-0024*/
       n_produceruse = ""  /*A56-0024*/
       n_agent       = ""  /*A56-0024*/
       n_text = "exit".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bu_sch WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BU_schins WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiabname WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiAddr1 WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiAddr2 WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiAddr3 WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiAddr4 WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fibranch WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiCompNo WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiInBranch WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiInComp WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiInsch WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiIn_br WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiName WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiName2 WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiTelNo WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_agentcompa WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_producerbike WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_producernewcomp WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_producerrenew WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_producerusecomp WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_schech WUWHPCOM
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _MAIN-BLOCK WUWHPCOM 
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  RUN enable_UI.
  RUN WUT\WUTDICEN (WUWHPCOM:HANDLE).
  ...
  ASSIGN 
      ...
      fiIn_br    = ""
      fiInBranch = "" 
      fi_schech  = "SCB".  /* A55-0073 */
 /* DISP fi_schech fiuser fiFdate WITH FRAME fruser.*/
  /*FIND FIRST Company WHERE Company.NAME = "phone" NO-ERROR NO-WAIT.*//*A55-0046*/
  FIND FIRST Company WHERE 
      Company.NAME    = "phone" AND                /*kridtiya i. A55-0073*/
      Company.compno <>  ""     NO-ERROR NO-WAIT.  /*A55-0046*/
  IF AVAIL company THEN DO:
      RUN pdDispComp.
      gComp = Company.Compno.
  END.
  ELSE DO:
      DISP "" @ fi_schech  /*A55-0073 */
           "" @ fiCompNo
           "" @ fiBranch
           "" @ fiABNAme
           "" @ fiName  
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE disable_UI WUWHPCOM  _DEFAULT-DISABLE
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE enable_UI WUWHPCOM  _DEFAULT-ENABLE
PROCEDURE enable_UI :
/*------------------------------------------------------------------------------
...
------------------------------------------------------------------------------*/
  DISPLAY fi_schech fiCompNo fiabname fibranch fiName fiName2 fiAddr1 fiAddr2 
      ...
      WITH FRAME frComp IN WINDOW WUWHPCOM.
  ...
  ENABLE btnReturn btnok2 RECT-84 RECT-85 
      WITH FRAME frmain IN WINDOW WUWHPCOM.
  {&OPEN-BROWSERS-IN-QUERY-frmain}
  ENABLE brInsure 
      WITH FRAME frbrIns IN WINDOW WUWHPCOM.
  {&OPEN-BROWSERS-IN-QUERY-frbrIns}
  DISPLAY fiInBranch fiInComp fiIn_br fiInsch 
      WITH FRAME frInsure IN WINDOW WUWHPCOM.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdAddCom WUWHPCOM 
PROCEDURE pdAddCom :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDDisableComp WUWHPCOM 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pddisabledompp WUWHPCOM 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDDispComp WUWHPCOM 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdDispIns WUWHPCOM 
PROCEDURE pdDispIns :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pddisplogin WUWHPCOM 
...
ASSIGN
    ...
    fiAddr4     = Company.Addr4
    fiTelNo     = Company.TelNo
    fi_producernewcomp      =  company.Text1  /*A56-0024*/
    fi_producerusecomp      =  company.Text2  /*A56-0024*/ 
    fi_producerrenew        =  company.Text3  /*A56-0024*/  
    fi_producerbike         =  company.Text5  /*A57-0063*/
    fi_agentcompa           =  company.Text4  /*A56-0024*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdEnable WUWHPCOM 
PROCEDURE pdEnable :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdenablecomp WUWHPCOM 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDInitData WUWHPCOM 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdUpdateQ WUWHPCOM 
PROCEDURE pdUpdateQ :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
OPEN QUERY brInsure  FOR EACH Insure USE-INDEX Insure01 NO-LOCK
    ...
    BY Insure.lname .
    ASSIGN 
        /*FRAME frInsure fiInComp fiInComp fiIn_br  = ""
        FRAME frInsure fiInBranch fiInBranch = "".*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE ProcDisable WUWHPCOM 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE ProcUpdateInsure WUWHPCOM 
