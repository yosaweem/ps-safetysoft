...
/*programid   : wgwycg70.w                                              */  
/*programname : load text file ya-kult to GW                            */  
/* Copyright  : Safety Insurance Public Company Limited                 */  
/*copy write  : wgwargen.w                                              */  
/*              บริษัท ประกันคุ้มภัย จำกัด (มหาชน)                      */  
/*create by   : Kridtiya i. A54-0129   date . 30/05/2011               
                ปรับโปรแกรมให้สามารถนำเข้า text file ya-kult to GW system*/
/*modify By   : Kridtiya i. A55-0182 ปรับการให้ค่ารุ่นรถ                */
/*modify By   : Kridtiya i. A56-0072 ปรับการให้ค่างานต่ออายุพรบ         */
...
&Scoped-Define ENABLED-OBJECTS fi_loaddat fi_pack fi_covcod fi_branch ~
fi_producer fi_agent fi_insurno fi_prevbat fi_bchyr fi_filename bu_file ~
fi_output1 fi_output2 fi_output3 fi_usrcnt fi_usrprem buok bu_exit bu_hpbrn ~
bu_hpacno1 bu_hpagent bu_insured br_wdetail fi_process RECT-370 RECT-372 ~
RECT-373 RECT-374 RECT-375 RECT-376 RECT-377 RECT-378 
&Scoped-Define DISPLAYED-OBJECTS fi_loaddat fi_pack fi_covcod fi_branch ~
fi_producer fi_agent fi_insurno fi_prevbat fi_bchno fi_bchyr fi_filename ~
fi_output1 fi_output2 fi_output3 fi_usrcnt fi_usrprem fi_brndes fi_proname ~
fi_agtname fi_insurnam fi_impcnt fi_process fi_completecnt fi_premtot ~
fi_premsuc 
...
DEFINE FRAME fr_main
     fi_loaddat AT ROW 2.76 COL 32 COLON-ALIGNED NO-LABEL
     fi_pack AT ROW 2.76 COL 65.5 COLON-ALIGNED NO-LABEL
     fi_covcod AT ROW 2.76 COL 81.33 COLON-ALIGNED NO-LABEL
     fi_branch AT ROW 3.81 COL 32.5 COLON-ALIGNED NO-LABEL
     fi_producer AT ROW 4.86 COL 32.5 COLON-ALIGNED NO-LABEL
     fi_agent AT ROW 5.91 COL 32.5 COLON-ALIGNED NO-LABEL
     fi_insurno AT ROW 6.91 COL 32.5 COLON-ALIGNED NO-LABEL
     fi_prevbat AT ROW 7.95 COL 32.5 COLON-ALIGNED NO-LABEL
     fi_bchno AT ROW 22.71 COL 16 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi_bchyr AT ROW 7.95 COL 67.67 COLON-ALIGNED NO-LABEL
     fi_filename AT ROW 9 COL 32.5 COLON-ALIGNED NO-LABEL
     bu_file AT ROW 9 COL 95.17
     fi_output1 AT ROW 10.05 COL 32.5 COLON-ALIGNED NO-LABEL
     fi_output2 AT ROW 11.1 COL 32.5 COLON-ALIGNED NO-LABEL
     fi_output3 AT ROW 12.14 COL 32.5 COLON-ALIGNED NO-LABEL
     fi_usrcnt AT ROW 13.19 COL 32.5 COLON-ALIGNED NO-LABEL
     fi_usrprem AT ROW 13.19 COL 71 NO-LABEL
     buok AT ROW 9.1 COL 102
     bu_exit AT ROW 10.76 COL 102
     fi_brndes AT ROW 3.81 COL 53.83 COLON-ALIGNED NO-LABEL
     bu_hpbrn AT ROW 3.81 COL 41.33
     bu_hpacno1 AT ROW 4.86 COL 51
     bu_hpagent AT ROW 5.91 COL 51
     fi_proname AT ROW 4.86 COL 53.83 COLON-ALIGNED NO-LABEL
     fi_agtname AT ROW 5.91 COL 53.83 COLON-ALIGNED NO-LABEL
     bu_insured AT ROW 6.91 COL 51
     fi_insurnam AT ROW 6.91 COL 53.83 COLON-ALIGNED NO-LABEL
     br_wdetail AT ROW 15.95 COL 1.83
     fi_impcnt AT ROW 22.14 COL 59.33 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi_process AT ROW 14.29 COL 25.5 COLON-ALIGNED NO-LABEL
     fi_completecnt AT ROW 23.14 COL 59.33 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     fi_premtot AT ROW 22.14 COL 97.17 NO-LABEL NO-TAB-STOP 
     fi_premsuc AT ROW 23.19 COL 95.17 COLON-ALIGNED NO-LABEL NO-TAB-STOP 
     "                   Branch  :" VIEW-AS TEXT
          SIZE 22 BY .95 AT ROW 3.81 COL 11
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "   Policy Import Total :":60 VIEW-AS TEXT
          SIZE 22 BY .95 AT ROW 13.19 COL 31.83 RIGHT-ALIGNED
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "BHT.":60 VIEW-AS TEXT
          SIZE 6 BY 1.05 AT ROW 23.14 COL 116.17
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Package :" VIEW-AS TEXT
          SIZE 10.5 BY .95 AT ROW 2.76 COL 56.17
          BGCOLOR 8 FGCOLOR 1 FONT 6
     " Previous Batch No.  :" VIEW-AS TEXT
          SIZE 22 BY .95 AT ROW 7.95 COL 11
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "     Total Record :":60 VIEW-AS TEXT
          SIZE 17.5 BY 1.05 AT ROW 22.14 COL 57.83 RIGHT-ALIGNED
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "TieS 4 01/03/2022":60 VIEW-AS TEXT
          SIZE 19 BY .95 AT ROW 13.19 COL 101 WIDGET-ID 2
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Output Data Not Load :" VIEW-AS TEXT
          SIZE 22 BY .95 AT ROW 11.1 COL 11
          BGCOLOR 8 FGCOLOR 1 
     "     Output Data Load :" VIEW-AS TEXT
          SIZE 22 BY .95 AT ROW 10.05 COL 11
          BGCOLOR 8 FGCOLOR 1 
     "           Agent Code  :" VIEW-AS TEXT
          SIZE 22 BY .95 AT ROW 5.91 COL 11
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "      Batch File Name :" VIEW-AS TEXT
          SIZE 22 BY .95 AT ROW 12.14 COL 11
          BGCOLOR 8 FGCOLOR 1 
     "1= ป1, 2= ป2, 3= ป3,T= พรบ." VIEW-AS TEXT
          SIZE 29 BY .95 AT ROW 2.76 COL 90.17
          BGCOLOR 8 FGCOLOR 1 FONT 6
...
DEFINE FRAME fr_main
     "BHT.":60 VIEW-AS TEXT
          SIZE 6 BY .95 AT ROW 13.19 COL 88.67
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "                 Insured  :" VIEW-AS TEXT
          SIZE 22 BY .95 AT ROW 6.91 COL 11
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Batch No. :" VIEW-AS TEXT
          SIZE 11.5 BY .95 AT ROW 22.71 COL 5.5
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Success Net Premium :" VIEW-AS TEXT
          SIZE 22.33 BY 1.05 AT ROW 23.14 COL 95 RIGHT-ALIGNED
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "               Load Date :":35 VIEW-AS TEXT
          SIZE 22 BY .95 AT ROW 2.76 COL 11
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "       Producer  Code :" VIEW-AS TEXT
          SIZE 22 BY .95 AT ROW 4.86 COL 11
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Batch Year :" VIEW-AS TEXT
          SIZE 12.83 BY .95 AT ROW 7.95 COL 56.17
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Input File Name Load :" VIEW-AS TEXT
          SIZE 22 BY .95 AT ROW 9 COL 11
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Success Record :" VIEW-AS TEXT
          SIZE 17.5 BY 1.05 AT ROW 23.14 COL 57.83 RIGHT-ALIGNED
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Total Net Premium Imp  :":60 VIEW-AS TEXT
          SIZE 23.5 BY .95 AT ROW 13.19 COL 69.17 RIGHT-ALIGNED
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "BHT.":60 VIEW-AS TEXT
          SIZE 6 BY 1.05 AT ROW 22.14 COL 116.17
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "Covcod :" VIEW-AS TEXT
          SIZE 9.5 BY .95 AT ROW 2.76 COL 73.33
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "   Total Net Premium  :" VIEW-AS TEXT
          SIZE 21.5 BY 1.05 AT ROW 22.14 COL 94.83 RIGHT-ALIGNED
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "    IMPORT TEXT FILE MOTOR [YAKULT RENEW - ต่ออายุรถยนต์]" VIEW-AS TEXT
          SIZE 130 BY .95 AT ROW 1.33 COL 2.33
          BGCOLOR 1 FGCOLOR 7 FONT 6
     RECT-370 AT ROW 1 COL 1
     RECT-372 AT ROW 2.62 COL 1
     RECT-373 AT ROW 15.67 COL 1
     RECT-374 AT ROW 21.29 COL 1
     RECT-375 AT ROW 21.62 COL 3
     RECT-376 AT ROW 21.91 COL 4.5
     RECT-377 AT ROW 8.86 COL 100.5
     RECT-378 AT ROW 10.52 COL 100.5
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 133 BY 24
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW c-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Load Text File Yakult [ RENEW ] to GW"
         HEIGHT             = 24.05
         WIDTH              = 133.17
         MAX-HEIGHT         = 45.76
         MAX-WIDTH          = 213.33
...
/* SETTINGS FOR FRAME fr_main
   FRAME-NAME Custom                                                    */
/* BROWSE-TAB br_wdetail fi_insurnam fr_main */
ASSIGN 
...
ON END-ERROR OF c-Win /* Load Text File Yakult [ RENEW ] to GW */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-Win c-Win
ON WINDOW-CLOSE OF c-Win /* Load Text File Yakult [ RENEW ] to GW */
DO:
...
DO:
    ASSIGN
        ...
        fi_premtot             = 0
        fi_impcnt              = 0
        fi_process             = "Load Text file Yakult[Renew-Motor]..."  .
    ...
    IF  nv_reccnt = 0 THEN DO: 
        MESSAGE "No Record Can Gen123 " VIEW-AS ALERT-BOX.       
        RETURN NO-APPLY.
    END.
    ...
    IF nv_batflg = NO THEN DO:  
        ...
        ASSIGN fi_process  = "Load data not complete...error !!!" .
...
DO:
  ...
  IF fi_covcod <> "" THEN DO:
      MESSAGE "You use covcod : " fi_covcod "Do you want covcod this now !!!!"        
...
DO:
    ...
    IF fi_insurno <> ""    THEN DO:
        FIND FIRST  sicsyac.xtm600  USE-INDEX  xtm60001 WHERE
            sicsyac.xtm600.acno =   Input fi_insurno    NO-LOCK NO-ERROR NO-WAIT.
        IF AVAILABLE sicsyac.xtm600 THEN 
            ...
            nn_name2     =  ""
            nn_name3     =  ""  
            nn_icno      =  TRIM(sicsyac.xtm600.abname)
...
DO:
    ...
    IF  fi_producer <> " " THEN DO:
        FIND LAST  sicsyac.xmm600 USE-INDEX xmm60001   WHERE
            sicsyac.xmm600.acno  =  fi_producer  NO-LOCK NO-ERROR NO-WAIT.
        IF NOT AVAIL sicsyac.xmm600 THEN DO:
            Message  "Not on Name & Address Master File xmm600" 
                View-as alert-box.
            Apply "Entry" To  fi_producer.
...
/********************  T I T L E   F O R  C - W I N  ****************/
  ...
  ASSIGN
      ...
      fi_insurno  = "0C17962" 
      fi_bchyr    = YEAR(TODAY) .
  DISP fi_pack fi_branch fi_producer fi_agent fi_bchyr fi_covcod fi_insurno WITH FRAME fr_main.
/*********************************************************************/  
...
------------------------------------------------------------------------------*/
  DISPLAY fi_loaddat fi_pack fi_covcod fi_branch fi_producer fi_agent fi_insurno 
          ...
          fi_insurnam fi_impcnt fi_process fi_completecnt fi_premtot fi_premsuc 
      WITH FRAME fr_main IN WINDOW c-Win.
  ENABLE fi_loaddat fi_pack fi_covcod fi_branch fi_producer fi_agent fi_insurno 
         ...
         bu_hpagent bu_insured br_wdetail fi_process RECT-370 RECT-372 RECT-373 
...
IF wdetail.redbook = "" THEN DO:
    IF wdetail.brand = "HONDA"    THEN 
        ASSIGN wdetail.brand = "honda (motorcycle)"
...
DO:
    ...
    REPEAT:
        ...
        IMPORT DELIMITER "|" 
            /*wdetail2.prepol /*Kridtiya i. A55-0182*/
            wdetail2.policyno  . 
            ...
            as_prepol          /*Kridtiya i. A55-0182*/
            as_policyno  .      /*Kridtiya i. A55-0182*/
            
        IF   (index(as_prepol,"กรม") > 0 ) OR (index(as_policyno,"กรม")   > 0 ) THEN NEXT.
        ELSE IF   index(as_prepol,"กธ") > 0   THEN NEXT.
        ELSE IF as_prepol = ""   THEN NEXT.
        ELSE IF INDEX(as_prepol,"รายการ") <> 0 THEN NEXT.
        ELSE IF INDEX(as_prepol,"ประกัน") <> 0 THEN NEXT.
        ELSE IF INDEX(as_prepol,"ลำดับ") <> 0  THEN NEXT.
        ELSE IF INDEX(as_prepol,"ขอต่อ") <> 0  THEN NEXT.
        ELSE IF INDEX(as_prepol,"no") <> 0     THEN NEXT.
        ELSE  DO:
    ...
    END.  */  
    /*FOR EACH wdetail2.
        IF (index(wdetail2.prepol,"กรม") > 0 ) OR (index(wdetail2.policyno,"กรม")   > 0 ) THEN DELETE wdetail2.
...
FOR EACH wdetail .
    ...
    IF fi_covcod = "T" THEN    /*A53-0370  พรบ. คุ้มครอง 1 ปีนับจากวันที่คุ้มครอง*/
        ...
        ASSIGN  b_eng       = 0
            ...
            wdetail.caryear =  string(DECI(wdetail.caryear) - 543 )
            ...
            IF wdetail.vehreg = "" THEN  
                wdetail.vehreg   = "/" + SUBSTR(wdetail.chasno,LENGTH(wdetail.chasno) - 8 ,LENGTH(wdetail.chasno) ) .
            ELSE wdetail.vehreg = substr(wdetail.vehreg,1,3) + " " + substr(wdetail.vehreg,4)  + " " + wdetail.re_country.
            RUN proc_brand.
END.                                           
/*RUN proc_atestp.*/                        
END PROCEDURE.
...
IF  CONNECTED("sic_exp") THEN DO:
    RUN wgw\wgwycex2 (INPUT-OUTPUT wdetail.prepol,    /* n_prepol     */
                      ...
                      INPUT-OUTPUT wdetail.insnamtyp,    /*Add by Kridtiya i. A63-0472 */
                      INPUT-OUTPUT wdetail.firstName,    /*Add by Kridtiya i. A63-0472*/    
                      INPUT-OUTPUT wdetail.lastName,     /*Add by Kridtiya i. A63-0472*/    
                      INPUT-OUTPUT wdetail.postcd,       /*Add by Kridtiya i. A63-0472*/    
                      INPUT-OUTPUT wdetail.icno,         /*Add by Kridtiya i. A63-0472*/    
                      INPUT-OUTPUT wdetail.codeocc,      /*Add by Kridtiya i. A63-0472*/    
                      INPUT-OUTPUT wdetail.codeaddr1,    /*Add by Kridtiya i. A63-0472*/   
                      INPUT-OUTPUT wdetail.codeaddr2,    /*Add by Kridtiya i. A63-0472*/   
                      INPUT-OUTPUT wdetail.codeaddr3,    /*Add by Kridtiya i. A63-0472*/   
                      INPUT-OUTPUT wdetail.br_insured).    /*Add by Kridtiya i. A63-0472*/ 

    ASSIGN wdetail.premt = string(nre_premt).
                      
    /*add....A57-0042*/                                    
    IF DAY(DATE(wdetail.comdat)) = 29 THEN
        ASSIGN wdetail.expdat  = "01/03/" + string(year(DATE(wdetail.comdat))   + 1 ) .
    ELSE 
        ASSIGN 
        wdetail.expdat  = string(DAY(DATE(wdetail.comdat))) + "/" +     
                          string(MONTH(DATE(wdetail.comdat))) + "/" +  
...
IF wdetail.poltyp = "v70" THEN DO:
    ...
    IF wdetail.prepol = "" THEN DO: 
        ...
        ELSE IF  wdetail.covcod = "3" THEN  aa = 900.
    END.
    ...
    ASSIGN nv_yrvar = ""
     ...
     END.*/
     IF wdetail.prepol = "" THEN DO:
         IF wdetail.covcod = "3" THEN dod1 = 0.
         ELSE IF wdetail.covcod = "1" THEN dod1 = 500.
     END.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
IF index(wdetail.brand,"ฮอนด้า") <> 0        THEN wdetail.brand = "HONDA".
...
IF wdetail.prepol = "" THEN DO:
    IF wdetail.redbook <> "" THEN DO:
        ...
        If  avail stat.maktab_fil  THEN DO:
            ASSIGN  
                ...
                /*wdetail.engcc =  stat.maktab_fil.engine*/
    ...
    IF nv_modcod = "" THEN DO:
        ...
        If  avail stat.maktab_fil  Then 
            ...
            wdetail.si       =  (stat.maktab_fil.si - (stat.maktab_fil.si * 20 / 100))
            nv_engine        =  stat.maktab_fil.engine .
        IF nv_modcod = ""  THEN DO: 
            Find LAST stat.maktab_fil Use-index      maktab04          Where
                stat.maktab_fil.makdes   =    wdetail.brand              And                  
                stat.maktab_fil.makyea   =    Integer(wdetail.caryear)  AND
                stat.maktab_fil.sclass   =    wdetail.subclass         
                No-lock no-error no-wait.
            If  avail stat.maktab_fil  Then 
...
IF wdetail.prepol = "" THEN 
    ASSIGN 
    wdetail.firstdat  = wdetail.comdat 
...
ELSE  wdetail.expdat  = string(DAY(DATE(wdetail.comdat)),"99")   + "/" +     
...
DO TRANSACTION:
    ASSIGN
        ...
        sic_bran.uwm100.insref = wdetail.n_insured
        sic_bran.uwm100.opnpol = wdetail.n_opnpol
        /*sic_bran.uwm100.anam2  = ""              /* ICNO  Cover Note A51-0071 Amparat */*//*kridtiya i. A55-0182*/
        sic_bran.uwm100.anam2  = nn_icno           /*kridtiya i. A55-0182*/
        ...
        sic_bran.uwm100.name3  = wdetail.name3                                              
        sic_bran.uwm100.addr1  = wdetail.addr_1      
        sic_bran.uwm100.addr2  = wdetail.addr_2       
        sic_bran.uwm100.addr3  = wdetail.addr_3        
        sic_bran.uwm100.addr4  = wdetail.addr_4 
        sic_bran.uwm100.postcd =  "" 
        sic_bran.uwm100.undyr  = String(Year(today),"9999")   /*   nv_undyr  */
        sic_bran.uwm100.branch = IF wdetail.n_branch  = "" THEN "0" ELSE wdetail.n_branch   /* nv_branch  */                        
...
ASSIGN n_year = YEAR(TODAY) + 543
    n_year = n_year - 1 .
IF wdetail.prepol = "" THEN NEXT .    /*add Kridtiya i. A57-0042*/
ELSE IF LENGTH(wdetail.prepol) < 12  THEN DO:
...
Else do:  
    ASSIGN
        n_rencnt  =  0  
        n_Endcnt  =  0
        wdetail.comment = wdetail.comment + "| เป็นกรมธรรม์ต่ออายุจากบริษัทอื่น  " + wdetail.prepol + "/"  + wdetail.policy  
        wdetail.prepol  = "".
...
IF AVAIL sicuw.uwm100  THEN DO:
    ...
    ELSE DO: 
        ASSIGN  
            ...
            n_endcnt          =  0
            wdetail.pass      = "Y" 
            wdetail.firstName   = TRIM(sic_bran.uwm100.firstName)    /*Add by Kridtiya i. A63-0472*/ 
            wdetail.lastName    = TRIM(sic_bran.uwm100.lastName)     /*Add by Kridtiya i. A63-0472*/ 
            wdetail.postcd      = trim(sic_bran.uwm100.postcd)       /*Add by Kridtiya i. A63-0472*/ 
            wdetail.icno        = trim(sic_bran.uwm100.icno)         /*Add by Kridtiya i. A63-0472*/ 
            wdetail.codeocc     = trim(sic_bran.uwm100.codeocc)      /*Add by Kridtiya i. A63-0472*/ 
            wdetail.codeaddr1   = TRIM(sic_bran.uwm100.codeaddr1)    /*Add by Kridtiya i. A63-0472*/
            wdetail.codeaddr2   = TRIM(sic_bran.uwm100.codeaddr2)    /*Add by Kridtiya i. A63-0472*/
            wdetail.codeaddr3   = trim(sic_bran.uwm100.codeaddr3)    /*Add by Kridtiya i. A63-0472*/
            wdetail.br_insured  = trim(sic_bran.uwm100.br_insured).   /*Add by Kridtiya i. A63-0472*/
        ...
        IF AVAIL sicuw.uwm301 THEN DO:
            ASSIGN 
                ...
                wdetail.vehreg   = sicuw.uwm301.vehreg            
