/* wgwtmexp.P  : Load Text file MAXI                                        */  
/* Copyright   : Safety Insurance Public Company Limited                    */  
/*               บริษัท ประกันคุ้มภัย จำกัด (มหาชน)                         */  
/* WRITE  BY   : Kridtiya i.A58-0321   03/09/2015                           */  
...
DEFINE INPUT-OUTPUT  PARAMETER np_tons      AS CHAR FORMAT "x(30)".   
...
DEFINE INPUT-OUTPUT  PARAMETER np_baseprm   AS CHAR FORMAT "x(30)"  INIT "" . 
...
IF AVAILABLE sic_exp.uwm100 THEN DO:
    ...
    IF AVAIL uwm301 THEN DO:
        ASSIGN  
            ...
            np_tons       = string(sic_exp.uwm301.tons)   
        ...
        FOR EACH sic_exp.uwd132 USE-INDEX uwd13290  WHERE
            ...
            IF      sic_exp.uwd132.bencod = "base"         THEN ASSIGN np_baseprm  = STRING(SUBSTRING(sic_exp.uwd132.benvar,31,30)).
