...
/*create by  : Ranu I. A60-0050 Date 30/01/2017           
               ปรับโปรแกรมให้สามารถนำเข้า text file บริษัท เดอเบล จำกัด to GW  system */ 
/*Modify by : Ranu I. A62-0353 date 01/08/2019 เพิ่มตัวแปร dspc72                        */
/*Modify by   : Kridtiya i. A63-0472 Date. 09/11/2020 add field firstname ,lastname.....*/
/*Modify by   : Ranu I. A64-0138 เพิ่มตัวแปรเก็บค่าการคำนวณเบี้ย */
/*Modify by   : Kridtiya i. A66-0141 เพิ่ม ตัวแปร สีรถ Product Promotion*/
/***************************************************************************************/
...
DEFINE NEW SHARED TEMP-TABLE wdetail
    ...
    FIELD br            AS CHAR FORMAT "x(5)"  INIT "" 
    FIELD policy70      AS CHAR FORMAT "x(12)" INIT ""
    FIELD policy72      AS CHAR FORMAT "x(12)" INIT ""
    FIELD instyp        AS CHAR FORMAT "x(2)" INIT ""    /* ranu */
    /*FIELD firstName     AS CHAR FORMAT "x(60)" INIT ""   /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/*/ /*ranu*/
    ...
    FIELD nCOLOR        AS CHAR FORMAT "x(30)" INIT ""    /*A66-0141*/
    FIELD promotion     AS CHAR FORMAT "x(30)" INIT ""    /*A66-0141*/
    FIELD cedpol        AS CHAR FORMAT "x(30)" INIT "" .  /*A66-0141*/
...
DEF VAR np_br        AS CHAR FORMAT "x(5)" INIT "".
...
DEF VAR n_Tonnage    AS CHAR  INIT "" FORMAT "x(10)".   
DEF VAR n_bennams    AS CHAR  INIT "" FORMAT "x(100)".  
...
DEF VAR n_dspc72     AS CHAR . /* ranu A62-0353 31/07/2019 */
DEF VAR n_dsspc72    AS DECI INIT 0 .
...
DEFINE VAR  re_insure    AS CHAR FORMAT "x(12)" INIT "".
...
DEFINE VAR  re_fi        AS CHAR FORMAT "x(30)"  INIT "" .   
...
DEFINE VAR n_campaign_ov  AS CHAR FORMAT "x(50)"  INIT "" .   /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/
DEFINE VAR n_occupation   AS CHAR FORMAT "x(100)" INIT "" .  /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/
DEFINE VAR nv_chkerror    AS CHAR FORMAT "x(100)" INIT "" .  /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/

DEF VAR n_postcd AS CHAR FORMAT "x(5)"   INIT "" .   /* ranu*/
DEF VAR n_addr   AS CHAR FORMAT "x(355)" INIT "" .   /* ranu*/
/* add by : A64-0138 */
...
/* end A64-0138 */     
DEFINE VAR nCOLOR      AS CHAR FORMAT "x(30)" INIT "" .  /*A66-0141*/
DEFINE VAR promotion   AS CHAR FORMAT "x(30)" INIT "" .  /*A66-0141*/
DEFINE VAR cedpol      AS CHAR FORMAT "x(30)" INIT "" .  /*A66-0141*/
