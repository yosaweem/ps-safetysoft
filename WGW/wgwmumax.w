...
/*++++++++++++++++++++++++++++++++++++++++++++++
  program id   : wgwmumax.w   [Menu Import data By maxi....] 
  Create  by   : kridtiya i.  [A58-0321]  date. 07/09/2015
  Connect      : -
+++++++++++++++++++++++++++++++++++++++++++++++*/
...
DEFINE FRAME DEFAULT-FRAME
     ...
     "                                        MENU IMPORT AND EXPORT MAXI" VIEW-AS TEXT
          SIZE 88 BY 1.24 AT ROW 1.62 COL 5.67
...
ON CHOOSE OF bu_update IN FRAME DEFAULT-FRAME /* LOAD TEXT FILE MAXI */
DO:
...
/********************  T I T L E   F O R  C - W I N  ****************/
  ...
  gv_prgid = "wgwmumax.w".
  gv_prog  = "Import And Export Data MAXI".
