...
/*programname : load text file Tisco to GW (งานต่อายุ)                  */ 
...
/*modify by   : Kridtiya i. A54-0216 date 23082011 ปรับไม่ให้พรบ. เช็คงานต่ออายุ */
...
DEFINE FRAME fr_main
     ...
     "BHT.":60 VIEW-AS TEXT
          ...
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "     IMPORT TEXT FILE MOTOR [TISCO - งานต่ออายุ ]" VIEW-AS TEXT
...
DO:
    ...
    REPEAT:
        ...
        IMPORT DELIMITER "|" 
            ...
            wdetail2.tambon        /*30...2   ที่อยูผู้เอาประกัน2*/
            wdetail2.amper         /*31...2   คำนำหน้า*/
            wdetail2.country       /*32...2   ชื่อลูกค้า*/
            wdetail2.tiname        /*33...3   นามสกุล*/
            wdetail2.insnam        /*34...3   ผู้รับผลประโยชน์*/
            wdetail2.benname       /*36...2   เลขที่สัญญาของผู้เอาประกัน*/         
            wdetail2.remark        /*37...2   รหัสของผู้เอาประกัน*/
            wdetail2.Account_no    /*38...2   วันสิ้นสุดความคุ้มครอง*/
            wdetail2.client_no     /*39...3   เบี้ยรวม พรบ*/
            wdetail2.expdat        /*40...3   จังหวัดที่จดทะเบียน*/
            wdetail2.gap           /*41...2   ชื่อออกใบเสร็จ*/
            wdetail2.re_country    /*42...2   บริษัท*/
            wdetail2.receipt_name  /*43...2   บริษัทประกันภัยเดิม*/
            wdetail2.agent         /*44...2   เลขกรมธรรม์เดิม*/
            wdetail2.prev_insur    /*45...3   ส่วนลดเสียหายแรก*/
            wdetail2.prepol        /*46 add1 ภาคสมัครใจ         */
            wdetail2.deduct        /*47 add2 ภาคสมัครใจ         */
    ...
    FOR EACH wdetail2   NO-LOCK.
        ...
        IF NOT AVAIL wdetail THEN DO:
            ...
            ASSIGN wdetail2.n_branch = SUBSTR(wdetail.policyno,2,1) .   /*brach 1 หลัก*/
            ELSE 
            ASSIGN wdetail2.n_branch = SUBSTR(wdetail.policyno,1,2) .   /*brach 2 หลัก*/*/
            ASSIGN 
...
FOR EACH wdetail WHERE wdetail.policyno NE " "  .
    ...
    ASSIGN  
        ...
        IF INDEX(n_char,"ต.") <> 0 THEN 
            ASSIGN ind1 = INDEX(n_char,"ต.")
                ind2    = INDEX(n_char,"อ.")
                ind3    = INDEX(n_char,"จ.").
        ELSE IF INDEX(n_char,"ตำบล") <> 0 THEN  DO:
            ASSIGN  ind1   = INDEX(n_char,"ตำบล")
                    ind2   = INDEX(n_char,"อำเภอ").
            IF  INDEX(n_char,"จังหวัด") <> 0 THEN 
                 ind3  = INDEX(n_char,"จังหวัด").
            ELSE ind3  = ind2 + 15 .
        END.
        ELSE IF INDEX(n_char,"แขวง") <> 0 THEN DO:
            ASSIGN ind1 = INDEX(n_char,"แขวง")
        ...
        IF (wdetail.prepol = "") AND (wdetail.prempa = "") THEN DO:
            ...
            IF AVAIL brstat.tlt THEN DO:
                ASSIGN 
                    ...
                    wdetail.seat      = 7.
                IF tlt.expotim  = "" THEN 
                    MESSAGE "ไม่พบแพคเกจของเลขตัวถังนี้:" wdetail.chasno VIEW-AS ALERT-BOX .
            END.
        END.
        ...
        IF wdetail.tiname <> "คุณ" THEN wdetail.receipt_name = "".
...
DO TRANSACTION:
   ASSIGN
      ...
      sic_bran.uwm100.fstdat = date(n_firstdat)            /*DATE(wdetail.comdat) kridtiya i. a53-0171 ให้ firstdate*/
...
/*4*/   ELSE IF wdetail.re_country = "BURIRUM"            THEN wdetail.re_country = "บร".
/*5*/   ELSE IF wdetail.re_country = "CHAI NAT"           THEN wdetail.re_country = "ชน".
/*6*/   ELSE IF wdetail.re_country = "CHANTABURI"         THEN wdetail.re_country = "จบ".
/*7*/   ELSE IF wdetail.re_country = "CHIENGMAI"          THEN wdetail.re_country = "ชม".
/*8*/   ELSE IF wdetail.re_country = "CHON BURI"          THEN wdetail.re_country = "ชบ".
...
/*13*/  ELSE IF wdetail.re_country = "LOP BURI"           THEN wdetail.re_country = "ลบ".
...
/*17*/  ELSE IF wdetail.re_country = "NAKORN SITHAMMARAT" THEN wdetail.re_country = "นศ".
...
/*21*/  ELSE IF wdetail.re_country = "PITSANULOK"         THEN wdetail.re_country = "พล".
/*22*/  ELSE IF wdetail.re_country = "PRACHIN BURI"       THEN wdetail.re_country = "ปจ".
...
/*27*/  ELSE IF wdetail.re_country = "SISAKET"            THEN wdetail.re_country = "ศก".
/*28*/  ELSE IF wdetail.re_country = "SONGKHLA"           THEN wdetail.re_country = "สข".
/*29*/  ELSE IF wdetail.re_country = "SRAKAEW"            THEN wdetail.re_country = "สก".
...
/*33*/  ELSE IF wdetail.re_country = "UBON RATCHATANI"    THEN wdetail.re_country = "อบ".
/*34*/  ELSE IF wdetail.re_country = "UDON THANI"         THEN wdetail.re_country = "อด".
/*35*/  ELSE IF wdetail.re_country = "AMNAJCHAROEN"       THEN wdetail.re_country = "อจ".
/*36*/  ELSE IF wdetail.re_country = "CHAIYAPOOM"         THEN wdetail.re_country = "ชย".
/*37*/  ELSE IF wdetail.re_country = "CHIENGRAI"          THEN wdetail.re_country = "ชร".
/*38*/  ELSE IF wdetail.re_country = "CHUMPHON"           THEN wdetail.re_country = "ชพ".
/*39*/  ELSE IF wdetail.re_country = "KAMPHAENGPHET"      THEN wdetail.re_country = "กพ".
/*40*/  ELSE IF wdetail.re_country = "LAMPANG"            THEN wdetail.re_country = "ลป".
/*41*/  ELSE IF wdetail.re_country = "LAMPOON"            THEN wdetail.re_country = "ลพ".
...
/*46*/  ELSE IF wdetail.re_country = "PHATTALUNG"         THEN wdetail.re_country = "พท".
/*47*/  ELSE IF wdetail.re_country = "PHETCHABOON"        THEN wdetail.re_country = "พช".
...
/*51*/  ELSE IF wdetail.re_country = "YASOTORN"           THEN wdetail.re_country = "ยส".
...
/*54*/  ELSE IF wdetail.re_country = "CHACHOENGSAO"       THEN wdetail.re_country = "ฉท".
/*55*/  ELSE IF wdetail.re_country = "LOEI"               THEN wdetail.re_country = "ลย".
/*56*/  ELSE IF wdetail.re_country = "MAE HONG SORN"      THEN wdetail.re_country = "มส".
/*57*/  ELSE IF wdetail.re_country = "MAHA SARAKHAM"      THEN wdetail.re_country = "มค".
/*58*/  ELSE IF wdetail.re_country = "MOOKDAHAAN"         THEN wdetail.re_country = "มห".
...
/*61*/  ELSE IF wdetail.re_country = "NONGBUALAMPOO"      THEN wdetail.re_country = "นล".
/*62*/  ELSE IF wdetail.re_country = "PAYOAW"             THEN wdetail.re_country = "พย".  
...
/*65*/  ELSE IF wdetail.re_country = "PICHIT"             THEN wdetail.re_country = "พจ".
/*66*/  ELSE IF wdetail.re_country = "PRACHAUPKHIRIKHAN"  THEN wdetail.re_country = "ปข".
...
/*71*/  ELSE IF wdetail.re_country = "SATOON"             THEN wdetail.re_country = "สต".
...
/*74*/  ELSE IF wdetail.re_country = "TRAD"               THEN wdetail.re_country = "ตร".
/*75*/  ELSE IF wdetail.re_country = "UTHAI THANEE"       THEN wdetail.re_country = "อท".
...
DO WHILE nv_line1 <= 4:
    ...
    IF nv_line1 = 1  THEN wuppertxt3.txt = "ชื่อผู้แจ้ง:" + wdetail.not_office.
