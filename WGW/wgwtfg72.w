...
DEFINE  WORKFILE wcomp NO-UNDO
 ...
 FIELD EV    AS CHAR INIT "N". /*A67-0087*/
...
&Scoped-define INTERNAL-TABLES wcomp tbinsurid wdetail
...
&Scoped-Define ENABLED-OBJECTS br_comp br_proinsur rs_type fiCompno bu_del ~
bu_add fi_packcom fi_loaddat fi_pack fi_branch fi_producer fi_agent ~
fi_bchno fi_prevbat fi_bchyr fi_filename bu_file fi_output1 fi_output2 ~
fi_output3 fi_usrcnt fi_usrprem rbuok bu_exit bu_hpbrn bu_hpacno1 ~
bu_hpagent br_wdetail fi_process fi_premcomp RECT-372 RECT-373 RECT-374 ~
RECT-375 RECT-376 RECT-377 RECT-378 RECT-379 
&Scoped-Define DISPLAYED-OBJECTS rs_type fiCompno fi_packcom fi_loaddat ~
fi_pack fi_branch fi_producer fi_agent fi_bchno fi_prevbat fi_bchyr ~
fi_filename fi_output1 fi_output2 fi_output3 fi_usrcnt fi_usrprem fi_brndes ~
fi_proname fi_agtname fi_impcnt fi_process fi_completecnt fi_premtot ~
fi_premsuc fi_premcomp 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 30.5 BY 3
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 30 BY 3.33
         BGCOLOR 15 FONT 6.
...
DEFINE FRAME fr_main
     br_comp AT ROW 5.57 COL 100.5
     br_proinsur AT ROW 8.62 COL 101 WIDGET-ID 100
     rs_type AT ROW 1.24 COL 107 NO-LABEL WIDGET-ID 6
     fiCompno AT ROW 2.91 COL 76.5 COLON-ALIGNED NO-LABEL
     bu_del AT ROW 4.57 COL 123.33
     bu_add AT ROW 3.57 COL 123.33
     fi_packcom AT ROW 3.52 COL 109.83 COLON-ALIGNED NO-LABEL
     ...
     rbuok AT ROW 12.33 COL 105.17
     bu_exit AT ROW 13.91 COL 105
     ...
     fi_premcomp AT ROW 4.57 COL 109.83 COLON-ALIGNED NO-LABEL
     "                     Branch  :" VIEW-AS TEXT
          SIZE 23 BY 1 AT ROW 3.91 COL 11.17
     ...
     "          Producer  Code :" VIEW-AS TEXT
          SIZE 23 BY 1 AT ROW 5 COL 11.17
          BGCOLOR 18 FGCOLOR 1 FONT 6
     ...
     "              Agent Code  :" VIEW-AS TEXT
          SIZE 23 BY 1.05 AT ROW 6.1 COL 11.17
          BGCOLOR 18 FGCOLOR 1 FONT 6
     " Load Text & Generate OEM-FORD (พรบ. 72)" VIEW-AS TEXT
          SIZE 93 BY .95 AT ROW 1.33 COL 2.5
          BGCOLOR 1 FGCOLOR 7 FONT 6
     "        Batch File Name :" VIEW-AS TEXT
          SIZE 23 BY 1 AT ROW 11.62 COL 11.17
          BGCOLOR 18 FGCOLOR 1 
     "Base comp :" VIEW-AS TEXT
          SIZE 12.5 BY .95 AT ROW 4.57 COL 98.83
...
DEFINE FRAME fr_main
     ...
     RECT-377 AT ROW 12.05 COL 103.5
     RECT-378 AT ROW 13.62 COL 103.5
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW c-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Load Text & Generate OEM-FORD (พรบ. 72)"
         HEIGHT             = 24.1
         WIDTH              = 133
         MAX-HEIGHT         = 45.76
         MAX-WIDTH          = 213.33
...
/* BROWSE-TAB br_proinsur br_comp fr_main */
...
ON END-ERROR OF c-Win /* Load Text  Generate OEM-FORD (พรบ. 72) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-Win c-Win
ON WINDOW-CLOSE OF c-Win /* Load Text  Generate OEM-FORD (พรบ. 72) */
DO:
...
/********************  T I T L E   F O R  C - W I N  ****************/
    ...
    gv_prgid = "Wgwtfg72.w".
    gv_prog  = "Load Text & Generate OEM-FORD (พรบ.72)".
    fi_loaddat = TODAY.
    RUN proc_createcomp.
    RUN proc_insuricno.
    OPEN QUERY br_comp FOR EACH wcomp.
    ...
    ASSIGN
        ...
        fi_pack     = "F"
        fi_branch   = "M"
        /*fi_producer = "A0M2012" */ /*A64-0092*/
        fi_producer = "B3M0002"      /*A64-0092*/
        fi_agent    = "B3M0002" 
        fi_bchyr    = YEAR(TODAY)
        rs_type     = 1  /*A67-0114*/
        fi_process  = "Load Text & Generate OEM-FORD ......" .
...
DO:
    ...
    FOR EACH wdetail2 WHERE deci(wdetail2.comp_prm) > 0    NO-LOCK.
       ...
       /* comment by Ranu A61-0045............
        ...
        /*---------end A61-0045------------*/
        IF LENGTH(n_policy72) > 16 THEN ASSIGN n_policy72 = SUBSTR(n_policy72,1,16).
        ...
        IF NOT AVAIL wdetail THEN DO:
            ...
            ASSIGN 
                ...
                wdetail.br_insured = TRIM(wdetail2.id_nobr72).
            END.
    END.
...
------------------------------------------------------------------------------*/
  DISPLAY rs_type fiCompno fi_packcom fi_loaddat fi_pack fi_branch fi_producer 
          fi_agent fi_bchno fi_prevbat fi_bchyr fi_filename fi_output1 
          fi_output2 fi_output3 fi_usrcnt fi_usrprem fi_brndes fi_proname 
          fi_agtname fi_impcnt fi_process fi_completecnt fi_premtot fi_premsuc 
          fi_premcomp 
      WITH FRAME fr_main IN WINDOW c-Win.
  ENABLE br_comp br_proinsur rs_type fiCompno bu_del bu_add fi_packcom 
         ...
         fi_usrcnt fi_usrprem rbuok bu_exit bu_hpbrn bu_hpacno1 bu_hpagent 
         br_wdetail fi_process fi_premcomp RECT-372 RECT-373 RECT-374 RECT-375 
         RECT-376 RECT-377 RECT-378 RECT-379 
      WITH FRAME fr_main IN WINDOW c-Win.
...
ELSE nv_newsck = wdetail.stk.
 ...
 Assign 
     ...
     sic_bran.uwm301.watt     = deci(wdetail.hp) /*A67-0087 */
     ...
     sic_bran.uwm301.maksi     = DECI(wdetail.maksi)     /*A67-0087 */
...
IF wdetail.redbook <> "" THEN DO:
    ...
    If  avail stat.maktab_fil  THEN DO:
        ASSIGN chkred        =  YES
            ...
            sic_bran.uwm301.maksi  = stat.maktab_fil.maksi
...
ELSE DO:   /* 110 120  140 class 72->70*/
   IF      TRIM(wdetail.bev) = "Y" THEN n_sclass72 = trim(wdetail.n_class70) . /*A67-0087 */
    ...
    ELSE DO:
        ...
        ELSE DO:
            ...
            ELSE IF INDEX(wdetail.model," ") <> 0 THEN 
                ...
                ASSIGN n_model = trim(SUBSTR(wdetail.model,1,R-INDEX(wdetail.model," ") - 1 )).          /*A57-0431*/ 
        END.
    END.
END.
/*add A57-0088*/
...
IF wdetail.bev = "Y" AND wdetail.redbook = "" THEN DO:
...
END.
/* end : A67-0087 */
IF wdetail.redbook = ""  THEN DO: /* A67-0087 */
...
DO:
    ...
    FOR EACH wdetail2 WHERE deci(wdetail2.comp_prm) > 0    NO-LOCK.
        ASSIGN n_policy72   = "" 
               n_packcomp   = ""
               wdetail2.bev =  IF trim(wdetail2.bev) = "" THEN "N" ELSE TRIM(wdetail2.bev) . /*A67-0087*/
        ...
        ELSE n_policy72 = "72" + trim(wdetail2.policyno) .
        /*---------end A61-0045------------*/
        IF LENGTH(n_policy72) > 16 THEN DO: 
            IF INDEX(n_policy72,"TMSTH") <> 0 THEN ASSIGN n_policy72 = TRIM(REPLACE(n_policy72,"TMSTH","")).
            ELSE ASSIGN n_policy72 = SUBSTR(n_policy72,1,16).
        END.
        ...
        IF NOT AVAIL wdetail THEN DO:
            ...
            ASSIGN 
                ...
                wdetail.poltyp     =   "V72"
                wdetail.prepol     =  trim(wdetail2.prepol)
                wdetail.subclass   =  SUBSTR(wdetail2.prempa,2,3) /*add A57-0017 */ /* A67-0185*/
...
FOR EACH wdetail2  .
    ...
    ELSE DO:
        ...
        ELSE DO:
            ...
            ASSIGN
                wdetail2.Provi_72   = IF wdetail2.Provi_72  = "" THEN "" 
                                      ELSE IF INDEX(wdetail2.Provi_72,"จังหวัด")   <> 0 THEN TRIM(wdetail2.Provi_72) /* A67-0087*/
                                      ELSE "จังหวัด" + wdetail2.Provi_72 /*56 Province  1209 1238 30  */
                wdetail2.ZipCo_72   = IF wdetail2.ZipCo_72  = "" THEN "" ELSE wdetail2.ZipCo_72 .           /*57 ZipCode   1239 1243 5   */
...
FOR EACH wdetail WHERE wdetail.policyno NE " "  .
    ...
    IF wdetail.bev = "Y" THEN wdetail.hp = wdetail.engcc. /*A67-0114*/

    RUN proc_chkcomp. /* A67-0185 */

    IF wdetail.vehreg = "" THEN wdetail.vehreg = "/" +  SUBSTRING(wdetail.chasno,LENGTH(wdetail.chasno) - 8 ,9) . 
    ...
    IF LENGTH(wdetail.addr1) > 35 THEN DO:
        ...
        END.
    END.
    IF LENGTH(wdetail.addr1 + " " + trim(wdetail.soy) + " " + trim(wdetail.road)) <= 35 THEN
        ASSIGN wdetail.addr1 = wdetail.addr1 + " " + trim(wdetail.soy) + " " + trim(wdetail.road)
        wdetail.soy   = ""  
        wdetail.road  = "".
    ELSE IF LENGTH(wdetail.addr1 + " " + trim(wdetail.soy) ) <= 35 THEN
    ...
    END.
    IF LENGTH(trim(wdetail.soy) + " " + trim(wdetail.road) + " " + trim(wdetail.tambon) + " " + trim(wdetail.amper)) <= 35 THEN
        ASSIGN 
        ...
        wdetail.country = "" .
    ELSE IF LENGTH(trim(wdetail.soy) + " " + trim(wdetail.road) + " " + trim(wdetail.tambon)) <= 35 THEN
        ASSIGN 
        wdetail.soy     = trim(trim(wdetail.soy) + " " + trim(wdetail.road))
...
/*Modify by : Ranu I. A64-0092 date: 04/03/2021 แก้ไขงาน Group Ford ดึงชือ่ที่อยู่ ตามพารามิเตอร์ XMM600 */
...
/*Modify by : Ranu I. A67-0114 แก้ไข Format file Load แก้ไขการเช็ค CC และ Redbook72 */
...
IF wdetail.name_insur <> "" THEN DO:
     FOR EACH tbinsurid WHERE 
        tbinsurid.insuricno = TRIM(wdetail.name_insur) NO-LOCK.
...
IF (wdetail.si = "") OR (wdetail.si = "0.00") OR (wdetail.si = "0" ) THEN DO:
    ...
    If  avail stat.maktab_fil  Then 
        ...
        sic_bran.uwm301.maksi    =  stat.maktab_fil.maksi . /*A67-0087*/
END.
ELSE DO:
    Find LAST stat.maktab_fil Use-index      maktab04          Where
        stat.maktab_fil.makdes   =    wdetail.brand              And                  
...
IF chkred = NO THEN DO:
    ...
    /*wdetail.model  = n_model.*/  /*A67-0114*/
...
ELSE DO:
   ...
   /* IF n_index < 1  THEN wdetail.model  = substr(n_model,1,LENGTH(n_model)) .
    ELSE wdetail.model  = substr(n_model,1,n_index) .*/  /*A67-0114*/
END.
END PROCEDURE.
