...
/*modify by   : Kridtiya i. A56-0037 ปรับแก้ไขปิดworkfile เป็นใช้ตัวแปร         */
/*modify by   : Kridtiya i. A56-0243 เพิ่มเลขที่บัตรประชาชน        */
/*modify by   : kridtiya i. A57-0432 add ตัวนับแถวรายงาน */
/*************************************************************************/ 
/*comment by Kridtiya i. A56-0037...
DEFINE NEW SHARED TEMP-TABLE wdetail2
    FIELD n_no                AS CHAR FORMAT "x(10)"  INIT ""  /* 1   No. */                                                                               
    FIELD cedpol              AS CHAR FORMAT "x(20)"  INIT ""  /* 2   TN# เลขที่สัญญา*/                                                                                 
    FIELD companynam          AS CHAR FORMAT "x(50)"  INIT "" 
    FIELD senddate            AS CHAR FORMAT "x(10)"  INIT ""  /* 3   วันที่แจ้งประกันภัย */                                                                 
    FIELD insurcename         AS CHAR FORMAT "x(50)"  INIT ""  /* 4   ชื่อผู้เอาประกันภัย */                                                                 
    FIELD ntitle              AS CHAR FORMAT "x(20)"  INIT "" 
    FIELD insurceno           AS CHAR FORMAT "x(10)"  INIT ""  /* 5   รหัสลูกค้า  */                                                                         
    FIELD addr1               AS CHAR FORMAT "x(100)" INIT ""  /* 6   ที่อยู่ผู้เอาประกันภัย  */                                                             
    FIELD model               AS CHAR FORMAT "x(60)"  INIT ""  /* 7   ยี่ห้อ/รุ่น */                                                                         
    /*FIELD vehreg              AS CHAR FORMAT "x(15)"  INIT ""  /* 8   ทะเบียนรถ   */ *//*A54-0112*/  
    FIELD vehreg              AS CHAR FORMAT "x(30)"  INIT ""  /* 8   ทะเบียนรถ   */  /*A54-0112*/
    FIELD caryear             AS CHAR FORMAT "X(4)"   INIT ""  /* 9   ปีจดทะเบียน */                                                                         
    FIELD cha_no              AS CHAR FORMAT "x(30)"  INIT ""  /* 10  เลขตัวถัง   */                                                                         
    FIELD engno               AS CHAR FORMAT "x(30)"  INIT ""  /* 11  เลขเครื่องยนต์  */                                                                     
    FIELD engCC               AS CHAR FORMAT "x(4)"   INIT ""  /* 12  ขนาดเครื่องยนต์ */                                                                     
    FIELD benname             AS CHAR FORMAT "x(40)"  INIT ""  /* 13  ผู้รับผลประโยชน์    */                                                                 
    FIELD showroomno          AS CHAR FORMAT "x(50)"  INIT ""  /* 14  โชว์รูม     */                                                                         
    FIELD showroom2           AS CHAR FORMAT "x(50)"  INIT ""  /* 14  โชว์รูม     */                                                                         
    FIELD stkno               AS CHAR FORMAT "x(20)"  INIT ""  /* 15  เครื่องหมาย พรบ */                                                                     
    FIELD pol72               AS CHAR FORMAT "x(15)"  INIT ""  /* 16  กรมธรรม์ พรบ    */                                                                     
    FIELD garage              AS CHAR FORMAT "x(30)"  INIT ""  /* 17  ศูนย์ซ่อมรถ */                                                                         
    FIELD covcod              AS CHAR FORMAT "x(30)"  INIT ""  /* 18  ประเภทความคุ้มครอง  */                                                                 
    FIELD comdate             AS CHAR FORMAT "x(10)"  INIT ""  /* 19  วันที่เริ่มคุ้มครอง */                                                                 
    FIELD n_si                AS CHAR FORMAT "x(20)"  INIT ""  /* 20  ทุนประกันภัย    */                                                                     
    FIELD n_premt             AS CHAR FORMAT "x(20)"  INIT ""  /* 21  เบี้ยประกันภัยภาคสมัครใจ    */                                                         
    FIELD n_premtcomp         AS CHAR FORMAT "x(20)"  INIT ""  /* 22  เบี้ยประกันภัยรวม พรบ   */                                                          
    FIELD deduct              AS CHAR FORMAT "X(20)"  INIT ""  /* 23  ความเสียหายส่วนแรก  */                                                                  
    FIELD n_tper              AS CHAR FORMAT "x(20)"  INIT ""  /* 24  ความรับผิดต่อบุคคลภายนอก (บาดเจ็บหรือเสียชีวิต ต่อคน)   */                              
    FIELD n_tpbi              AS CHAR FORMAT "x(20)"  INIT ""  /* 25  ความรับผิดต่อบุคคลภายนอก (บาดเจ็บหรือเสียชีวิต ต่อครั้ง)    */                          
    FIELD n_tppd              AS CHAR FORMAT "x(20)"  INIT ""  /* 26  ความรับผิดต่อบุคคลภายนอก (ทรัพย์สิน ต่อครั้ง)   */                                      
    FIELD n_si1               AS CHAR FORMAT "x(20)"  INIT ""  /* 27  ความเสียหายต่อรถยนต์ที่เอาประกันภัย(ความเสียหายต่อตัวรถ)    */                          
    FIELD n_fire              AS CHAR FORMAT "x(20)"  INIT ""  /* 28  ความเสียหายต่อรถยนต์ที่เอาประกันภัย(การสูญหายและไฟไหม้) */                               
    FIELD n_41                AS CHAR FORMAT "x(20)"  INIT ""  /* 29  ขยายความคุ้มครอง(การประกันอุบัติเหตุส่วนบุคคล คนละ) */                                 
    FIELD n_42                AS CHAR FORMAT "x(20)"  INIT ""  /* 30  ขยายความคุ้มครอง(การประกันค่ารักษาพยาบาล คนละ)  */             
    FIELD n_43                AS CHAR FORMAT "x(20)"  INIT ""  /* 31  ขยายความคุ้มครอง(การประกันตัวผู้ขับขี่คดีอาญา)  */                                                    
    FIELD n_feet              AS CHAR FORMAT "x(20)"  INIT ""  /* 32  ส่วนลดกลุ่ม */                                                                                        
    FIELD n_ncb               AS CHAR FORMAT "x(20)"  INIT ""  /* 33  ส่วนลดประวัติดี */                                                                                    
    FIELD n_other             AS CHAR FORMAT "x(20)"  INIT ""  /* 34  ส่วนลดอื่น ๆ  */                                             
    FIELD n_seats             AS CHAR FORMAT "x(3)"   INIT ""  /* 35  จำนวนที่นั่ง */                                             
    FIELD remark              AS CHAR FORMAT "x(100)" INIT ""  /* 36  หมายเหตุ  */                                                 
    FIELD recivename          AS CHAR FORMAT "x(50)"  INIT ""  /* 37  ออกใบเสร็จในนาม */                                             
    FIELD reciveaddr          AS CHAR FORMAT "x(100)" INIT ""  /* 38  ที่อยู่ในใบเสร็จ*/                                         
    FIELD recivename2         AS CHAR FORMAT "x(50)"  INIT ""  /* 37  ออกใบเสร็จในนาม */                                             
    FIELD reciveaddr2         AS CHAR FORMAT "x(100)" INIT ""  /* 38  ที่อยู่ในใบเสร็จ*/                                         
