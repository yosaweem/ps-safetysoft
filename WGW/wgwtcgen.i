...
/*Modify by   : Ranu I. A67-0114 เพิ่มการเก็บข้อมูลรถไฟฟ้า */
...
DEFINE NEW SHARED TEMP-TABLE wdetail2
    ...
    /*FIELD vehreg       AS CHAR FORMAT "x(11)" INIT ""   /*  11  licence no*/     /*a54-0112 */*/
    FIELD vehreg       AS CHAR FORMAT "x(20)" INIT ""   /*  11  licence no*/  
