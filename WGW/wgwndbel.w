...
/*******************************/                                                
/*programid  : wgwndbel.w                                               */ 
/*programname: Load Text & Generate Data Durbell                        */  
/*Copyright  : Safety Insurance Public Company Limited                  */ 
/*            บริษัท ประกันคุ้มภัย จำกัด (มหาชน)                        */  
/*Create by  : Ranu I. A60-0050  นำเข้าข้อมูลไฟล์แจ้งงานจาก Durbell     */  
/*Modify By : Porntiwa T. A62-0105  Date : 18/07/2019 Change Host => TMSth*/
/*Modify by : Ranu I. A62-0353 date: 01/08/2019 เพิ่มส่วนลด DSPC72 และโค้ด CCTV 0001 */
/*Modify by : Ranu I. A63-0178 เพิ่มเงื่อนไข pack T คอลัมน์ Acc Text และ ผู้รับผลประโยชน์ */
/*Modify by : Kridtiya i. A63-0472 Date. 09/11/2020 add field firstname ,lastname.....*/
/*Modify by : Ranu I. A64-0138 เพิ่มเงื่อนไขการคำนวณเบี้ยที่โปรแกรมกลาง */
/*Modify by : Kridtiya i. A65-0035 comment message error premium not on file */
/*Modify by : Kridtiya i. A66-0141 Add Cedpol Promotion Color                */
/*Modify by : Kridtiya i. A66-0196 Add เงื่อนไขการส่งค่าทุน กรณี ประเภทสองไม่มีทัน uom6 ให้ใช้ uom7 แทน */
/*-------------------------------------------------------------------------------*/
...
DEF VAR n_policy   LIKE sicuw.uwm100.policy INIT "".
...
DEF  VAR n_tonn70 AS DECI INIT 0.00.  /*A59-0060*/
DEF BUFFER bwdetail FOR wdetail.
DEF VAR np_prem_nap AS DECI .
...
&Scoped-Define ENABLED-OBJECTS fi_packre rs_type fi_loaddat fi_branch ~
...
br_wdetail bu_hpbrn bu_hpacno1 bu_hpagent fi_process fi_outputHead buok-2 ~
RECT-370 RECT-372 RECT-373 RECT-374 RECT-375 RECT-377 RECT-378 
&Scoped-Define DISPLAYED-OBJECTS fi_packre rs_type fi_loaddat fi_branch ~
fi_producer fi_bchno fi_agent fi_vatcod fi_prevbat fi_bchyr fi_filename ~
...
DEFINE VARIABLE fi_packre AS CHARACTER FORMAT "X(256)":U 
     LABEL "Parameter Pack Renew" 
     VIEW-AS FILL-IN 
     SIZE 16.83 BY 1
...
DEFINE VARIABLE rs_type AS INTEGER 
     ...
     RADIO-BUTTONS 
          "LOAD TEXT FILE TO GW", 1,
"MATCH TEXT FILE POLICY ", 2
     SIZE 64 BY 1
     BGCOLOR 10  NO-UNDO.
...
DEFINE FRAME fr_main
     fi_packre AT ROW 4.57 COL 100.5 COLON-ALIGNED WIDGET-ID 6
     rs_type AT ROW 3.14 COL 67 NO-LABEL WIDGET-ID 2
     fi_loaddat AT ROW 3.86 COL 17 COLON-ALIGNED NO-LABEL
     ...
     fi_filename AT ROW 10.24 COL 24 COLON-ALIGNED NO-LABEL
     bu_file AT ROW 10.29 COL 86.67
     fi_output1 AT ROW 11.24 COL 24 COLON-ALIGNED NO-LABEL
     fi_output2 AT ROW 12.24 COL 24 COLON-ALIGNED NO-LABEL
     fi_output3 AT ROW 13.24 COL 24 COLON-ALIGNED NO-LABEL
     fi_usrcnt AT ROW 14.24 COL 24 COLON-ALIGNED NO-LABEL
     fi_usrprem AT ROW 14.24 COL 63.17 NO-LABEL
     buok AT ROW 10.86 COL 96.83
     bu_exit AT ROW 12.71 COL 97
     ...
     fi_process AT ROW 15.24 COL 24 COLON-ALIGNED NO-LABEL
     ...
     fi_outputHead AT ROW 9.24 COL 24 COLON-ALIGNED NO-LABEL
     buok-2 AT ROW 9.24 COL 86.5
     "           Branch :" VIEW-AS TEXT
          SIZE 16 BY .95 AT ROW 4.91 COL 2.5
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "TieS 4 01/03/2022":60 VIEW-AS TEXT
          SIZE 19 BY .91 AT ROW 14.24 COL 95.67 WIDGET-ID 8
          BGCOLOR 8 FGCOLOR 1 FONT 6
     ...
     "Producer Code :" VIEW-AS TEXT
          ...
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "BHT.":60 VIEW-AS TEXT
          SIZE 5 BY .91 AT ROW 14.24 COL 82.67
          BGCOLOR 8 FGCOLOR 1 FONT 6
...
DEFINE FRAME fr_main
     ...
     "        Batch File Name :" VIEW-AS TEXT
          SIZE 22.5 BY .91 AT ROW 13.24 COL 2.5
          BGCOLOR 8 FGCOLOR 1 
     "LOAD TEXT FILE MOTOR[ DURBELL]" VIEW-AS TEXT
          SIZE 130 BY .95 AT ROW 1.33 COL 2.33
          BGCOLOR 19 FGCOLOR 4 FONT 6
     "Total Net Premium Imp  :":60 VIEW-AS TEXT
          SIZE 25 BY .91 AT ROW 14.24 COL 61.83 RIGHT-ALIGNED
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "     Policy Import Total :":60 VIEW-AS TEXT
          SIZE 22.5 BY .91 AT ROW 14.24 COL 24 RIGHT-ALIGNED
          BGCOLOR 8 FGCOLOR 1 FONT 6
     ...
     RECT-377 AT ROW 10.52 COL 95.17
     RECT-378 AT ROW 12.38 COL 95.33
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 133 BY 24
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW c-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "LOAD TEXT FILE MOTOR[ DURBELL]"
         HEIGHT             = 23.95
         WIDTH              = 133
         MAX-HEIGHT         = 45.76
         MAX-WIDTH          = 213.33
...
ON END-ERROR OF c-Win /* LOAD TEXT FILE MOTOR[ DURBELL] */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-Win c-Win
ON WINDOW-CLOSE OF c-Win /* LOAD TEXT FILE MOTOR[ DURBELL] */
DO:
...
DO:
    ...
    IF rs_type = 1 THEN DO:
        ...
        RUN proc_assign. 
        FOR EACH wdetail :
            /*IF wdetail.poltyp   = "V70"  OR wdetail.poltyp   = "V72"  THEN DO:*/   /*A60-0005*/
            IF wdetail.poltyp   = "V70"  OR wdetail.poltyp   = "V72" OR              /*A60-0005*/     
               wdetail.poltyp   = "V74"  OR wdetail.poltyp   = "V73" THEN DO:        /*A60-0005*/                            
   ...
   SYSTEM-DIALOG GET-FILE cvData
    ...
    IF OKpressed = TRUE THEN DO:
         ...
         ELSE DO:
             ASSIGN
               fi_filename  = cvData
               fi_output1 = SUBSTRING(cvData,1,(LENGTH(fi_filename) - 4))  /* + "_SUCCESS" */ + no_add + "_Matchpol.fuw"  /*.csv*/
               fi_output2 = ""
               fi_output3 = "".
            DISP fi_filename fi_output1 fi_output2 fi_output3  WITH FRAME {&FRAME-NAME}. 
            APPLY "Entry" TO fi_output3.
...
&Scoped-define SELF-NAME fi_packre
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_packre c-Win
ON LEAVE OF fi_packre IN FRAME fr_main /* Parameter Pack Renew */
DO:
    fi_packre = INPUT fi_packre.
    DISP fi_packre WITH FRAME fi_packre.
...
/********************  T I T L E   F O R  C - W I N  ****************/
  ...
  ASSIGN 
      gv_prgid   = "wgwndbel.w"
      gv_prog    = "LOAD TEXT FILE MOTOR[DURBELL]"
      fi_loaddat = TODAY.
  DISP fi_loaddat WITH FRAME fr_main.
  ...
  ASSIGN
      ...
      fi_branch   = "M" 
      fi_vatcod   = ""
      fi_packre   = "PACK RENEW" /*A63-0178*/
      fi_producer = "A0M0024"
      fi_agent    = "A000000"
      fi_bchyr    = YEAR(TODAY)
      fi_process  = "LOAD TEXT FILE MOTOR[DURBELL]".
  DISP rs_type fi_process fi_branch fi_vatcod  fi_producer fi_agent fi_bchyr fi_packre WITH FRAME fr_main.
/*********************************************************************/  
...
------------------------------------------------------------------------------*/
  DISPLAY fi_packre rs_type fi_loaddat fi_branch fi_producer fi_bchno fi_agent 
  ...
  ENABLE fi_packre rs_type fi_loaddat fi_branch fi_producer fi_bchno fi_agent 
         ...
         bu_hpbrn bu_hpacno1 bu_hpagent fi_process fi_outputHead buok-2 
         RECT-370 RECT-372 RECT-373 RECT-374 RECT-375 RECT-377 RECT-378 
      WITH FRAME fr_main IN WINDOW c-Win.
...
IF wdetail.redbook = ""  THEN DO:
    ...
    IF AVAIL sicsyac.xmm102 THEN 
        ...
        /*wdetail.tonn    = IF wdetail.Tonn  = 0  THEN        sicsyac.xmm102.tons    ELSE wdetail.Tonn */ /*A59-0400*/                   
...
IF NOT AVAILABLE sic_bran.uwm130 THEN 
    ...
    Assign  
        ...
        sic_bran.uwm301.car_color = wdetail.nCOLOR  /*A66-0141*/
...
nv_rec100 = s_recid1.       nv_rec120 = s_recid2.
nv_rec130 = s_recid3.       nv_rec301 = s_recid4.
        ...
        IF AVAILABLE sicsyac.xmm107 THEN DO:
            ...
            IF AVAILABLE sicsyac.xmd107 THEN DO:
                ...
                ASSIGN sic_bran.uwd132.bencod = sicsyac.xmd107.bencod   sic_bran.uwd132.policy = wdetail.policy
                    ...
                    sic_bran.uwd132.itemno = sic_bran.uwm130.itemno     sic_bran.uwd132.bptr   = 0
                    sic_bran.uwd132.fptr   = 0                          nvffptr     = xmd107.fptr
                ...
                IF wdetail.tariff = "Z" OR wdetail.tariff = "X" THEN DO:  /* Malaysia */
                    ...
                    IF AVAILABLE sicsyac.xmm106 THEN 
                        ...
                        END.
                        ELSE DO:
                            ASSIGN sic_bran.uwd132.gap_c  = deci(wdetail.premt) 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_72dspc c-Win 
PROCEDURE proc_72dspc :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes: ranu A62-0353  01/08/2019      
------------------------------------------------------------------------------*/
DO:
    IF deci(wdetail.dspc) <> 0  THEN DO:
        nv_dss_per = 0.
        ...
        ASSIGN
            n_dsspc72     = - ROUND(nv_prem * nv_dss_per / 100,2)
            nv_dsspcvar   = ""
            nv_dsspcvar1  = ""
            nv_dsspcvar2  = "".

        IF nv_dss_per = 0 THEN n_dsspc72 = 0.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_72dspc_01 c-Win 
PROCEDURE proc_72dspc_01 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes: ranu a62-0353 01/08/2019 add DSPC72    
------------------------------------------------------------------------------*/
    ...
    FIND sic_bran.uwd132  USE-INDEX uwd13201 WHERE
       ...
       IF NOT AVAIL sic_bran.uwd132 THEN DO:
           ...
           ASSIGN
               ...
               sic_bran.uwd132.pd_aep = "E"
               sic_bran.uwd132.bencod = "DSPC"                   sic_bran.uwd132.policy = sic_bran.uwm130.policy
               sic_bran.uwd132.rencnt = sic_bran.uwm130.rencnt   sic_bran.uwd132.endcnt = sic_bran.uwm130.endcnt
               sic_bran.uwd132.riskgp = sic_bran.uwm130.riskgp   sic_bran.uwd132.riskno = sic_bran.uwm130.riskno
       ...
       ASSIGN
           sic_bran.uwd132.gap_c  = n_dsspc72 
           sic_bran.uwd132.prem_c = n_dsspc72
           sic_bran.uwd132.benvar = nv_dsspcvar
...
DO:
    ...
    REPEAT:
        IMPORT DELIMITER "|" 
            n_idno           /*NO                                    */  
            np_prepol        /*เลขกรมธรรม์เดิม V70                   */  
            n_policy70       /*เลขกรมธรรม์ใหม่ V70                   */  
            np_prepol72      /*เลขกรมธรรม์เดิม V72                   */  
            n_policy72       /*เลขกรมธรรม์ใหม่ V72                   */  
            np_insref        /*รหัสลูกค้า Acc Code                   */  
            n_cover          /*ประเภทความคุ้มครอง 1 2 3              */  
            nf_vehuse70      /*ลักษณะการใช้รถ 70                     */  
            n_class70        /*Class 70                              */  
            nf_vehuse72      /*ลักษณะการใช้รถ 72                     */  
            n_class72        /*Class 72                              */  
            n_seat1          /*seat                                  */  
            n_Engine         /*CC                                    */  
            n_Tonnage        /*Tonnage..                             */  
            n_garage         /*garage                                */  
            n_uom1_v         /*ความเสียหายต่อชีวิต ฯลฯ (บาท/คน)      */  
            n_uom2_v         /*ความเสียหายต่อชีวิต ฯลฯ (บาท/ครั้ง)   */  
            n_uom5_v         /*ความเสียหายต่อทรัพย์สิน (บาท/ครั้ง)   */  
            n_siins          /*SI                                    */  
            n_fi             /*FI                                    */  
            n_nv_41          /*อุบัติเหตุส่วนบุคคล (บาท)  4.1        */  
            n_nv_412         /*อุบัติเหตุส่วนบุคคล (บาท/คน) 4.2      */  
            n_nv_42          /*ค่ารักษาพยาบาล (บาท/คน) 4.3.1         */  
            n_nv_43          /*ค่ารักษาพยาบาล (บาท/คน) 4.3.2         */  
            n_seat_41        /*Seat_41                               */  
            n_ncb            /*NCB                                   */  
            n_feet           /*Fleet                                 */  
            nn_dedod         /*DOD                                   */  
            nn_dedpd         /*DOD PD                                */  
            n_dspc           /*dspc                                  */
            n_dspc72         /* dspc72 */    /* ranu:A62-0353 */
            nn_stf_per       /*sataff                                */
            n_base           /*Base Premium                          */  
            n_nap            /*เบี้ยกรมธรรม์                         */ 
            nn_premcom       /*เบี้ยพรบ.*/
            n_vehreg         /*Veh reg ทะเบียน                       */  
            nn_redbook       /*MAKE/MODEL  CODE  :                   */  
            n_brand1         /*Make                                  */  
            n_model1         /*Model/Class                           */  
            n_body           /*Body                                  */  
            n_chassis        /*เลขตัวถัง                             */  
            n_engno          /*เลขเครื่องยนต์                        */  
            n_caryear        /*Year Manuf                            */  
            n_comdat1        /*Com.Date 70                           */  
            n_expdat1        /*Exp.Date 70                           */  
            n_comdat72       /*Com.Date 72                           */  
            n_expdat72       /*Exp.Date 72                           */
            np_br            /* BR */
            n_textf7         /*F17=Memo01                            */  
            n_textf72        /*F17=Memo02                            */  
            n_textf73        /*F17=Memo03                            */  
            n_textacc        /*A63-0178*/
            n_textacc1       /*A63-0178*/
            n_benname        /*A63-0178*/
            nCOLOR           /*A66-0141*/
            promotion        /*A66-0141*/
            cedpol           /*A66-0141*/
                .            /*type load yes = by expiry renew , no = on file */
            ...
            ELSE DO:
                ...
                IF TRIM(wdetail.inserf) <> ""  THEN DO:
                    ...
                    IF AVAIL sicsyac.xmm600  THEN DO:
                      ASSIGN wdetail.tiname  = trim(sicsyac.xmm600.ntitle)
                             /*wdetail.insnam  = trim(sicsyac.xmm600.name)*/ /*ranu*/
                             ...
                             /*Add by Kridtiya i. A63-0472*/
                             /*wdetail.firstName      = TRIM(sicsyac.xmm600.firstname)*/ /*ranu*/
                             wdetail.instyp      = TRIM(sicsyac.xmm600.acno_typ) 
                             wdetail.insnam      = IF TRIM(sicsyac.xmm600.firstname) <> "" THEN TRIM(sicsyac.xmm600.firstname) /*ranu*/ 
                                                   ELSE TRIM(sicsyac.xmm600.name)                                              /*ranu*/
                         ...
                         IF wdetail.postcd = "" THEN DO:
                             ASSIGN wdetail.postcd = IF wdetail.n_addr4 <> "" THEN trim(substr(wdetail.n_addr4,R-INDEX(wdetail.n_addr4," ") + 1))
                                                     ELSE trim(substr(wdetail.n_addr3,R-INDEX(wdetail.n_addr3," ") + 1))
                                    n_postcd       = IF wdetail.postcd <> "" THEN SUBSTR(wdetail.postcd,1,1) ELSE ""
                                    wdetail.postcd = IF INDEX("123456789",n_postcd) <> 0 THEN wdetail.postcd ELSE "" .
                         END.
                         IF wdetail.postcd <> "" THEN DO:
                            IF wdetail.n_addr4 <> "" AND index(wdetail.n_addr4,wdetail.postcd) <> 0 then replace(wdetail.n_addr4,wdetail.postcd,"").
                            ELSE IF wdetail.n_addr3 <> "" AND index(wdetail.n_addr3,wdetail.postcd) <> 0 then replace(wdetail.n_addr3,wdetail.postcd,"").
                         END.

                         RUN proc_matchtypins (INPUT  wdetail.tiname
                                              ,INPUT  wdetail.insnam + " " + wdetail.lastName
                                              ,OUTPUT wdetail.instyp
                                              ,OUTPUT wdetail.insnam 
                                              ,OUTPUT wdetail.lastName).

                         IF wdetail.codeaddr1  = ""  OR wdetail.codeaddr2  = ""  OR wdetail.codeaddr3 = "" THEN DO:
                               n_addr = trim(wdetail.n_addr1 + " " + wdetail.n_addr2 + " " + wdetail.n_addr3 + " " + wdetail.n_addr4)  .
...
IF  CONNECTED("sic_exp") THEN DO:
    RUN wgw\wgwdbeex (INPUT-OUTPUT  wdetail.prepol,      
                      INPUT-OUTPUT  wdetail.n_branch,               
                      INPUT-OUTPUT  re_insure,
                      ...
                      INPUT-OUTPUT  wdetail.commission,
                      INPUT-OUTPUT  nRE_premt). 

    ASSIGN
        /* wdetail.prem_nap = STRING(nRE_premt)*/
           np_prem_nap = 0 
           np_prem_nap = nRE_premt
           np_prepol = wdetail.prepol
           n_policy  = wdetail.cr_2
           n_brand1  = wdetail.brand.
    /*Add by Kridtiya i. A63-0472*/
    IF  wdetail.codeaddr1 = "" AND wdetail.codeaddr2 = "" AND wdetail.codeaddr3 = "" THEN DO:
        FIND FIRST sicsyac.xmm600 USE-INDEX xmm60001 WHERE 
            sicsyac.xmm600.acno = trim(wdetail.inserf)  NO-LOCK NO-ERROR NO-WAIT.
        IF AVAIL sicsyac.xmm600  THEN DO:
            ASSIGN
                /*wdetail.firstName      = TRIM(sicsyac.xmm600.firstname) */ /*ranu*/
                /*wdetail.lastName       = TRIM(sicsyac.xmm600.lastName)  */ /*ranu*/
                /*wdetail.postcd         = trim(sicsyac.xmm600.postcd)    */ /*ranu*/
                wdetail.codeocc        = trim(sicsyac.xmm600.codeocc) 
                wdetail.codeaddr1      = TRIM(sicsyac.xmm600.codeaddr1)
                wdetail.codeaddr2      = TRIM(sicsyac.xmm600.codeaddr2)
                wdetail.codeaddr3      = trim(sicsyac.xmm600.codeaddr3)
...
IF  wdetail.inserf   = ""   THEN  ASSIGN wdetail.inserf   =  re_insure.
IF  wdetail.tiname   = ""   then  Assign wdetail.tiname   =  re_tiname . 
IF  wdetail.insnam   = ""   then  Assign wdetail.insnam   =  re_insnam . 
IF  wdetail.name2    = ""   then  Assign wdetail.name2    =  re_name2  . 
IF  wdetail.name3    = ""   then  Assign wdetail.name3    =  re_name3  . 
IF  wdetail.n_addr1  = ""   then  Assign wdetail.n_addr1  =  re_n_addr1. 
IF  wdetail.n_addr2  = ""   then  Assign wdetail.n_addr2  =  re_n_addr2. 
IF  wdetail.n_addr3  = ""   then  Assign wdetail.n_addr3  =  re_n_addr3. 
IF  wdetail.n_addr4  = ""   then  Assign wdetail.n_addr4  =  re_n_addr4. 
IF  wdetail.class    = ""   THEN  ASSIGN wdetail.class    =  re_class .
/*IF  wdetail.class    = ""   THEN DO: 
    IF wdetail.covcod = "T" THEN  ASSIGN wdetail.class = " " .
    ELSE ASSIGN wdetail.class = re_class .
END.*/
IF  wdetail.base     = "0" OR wdetail.base = "" THEN ASSIGN wdetail.base     =  STRING(re_baseprm).
...
IF  wdetail.fi       = ""   THEN ASSIGN wdetail.fi       =  re_fi.
...
IF  wdetail.benname  = ""   THEN ASSIGN wdetail.benname  =  TRIM(re_bennam1) .  /* ranu:A64-0138 */
/*
np_prem_nap = 0.
 
FOR EACH  wuwd132 WHERE wuwd132.prepol = wdetail.prepol NO-LOCK.
     np_prem_nap = np_prem_nap + wuwd132.gap_c.
END.*/

IF wdetail.prem_nap = "" THEN ASSIGN wdetail.prem_nap = STRING(np_prem_nap). 


/* a63-0148*/
 IF DATE(wdetail.comdat) >= 04/01/2020 THEN DO:
      FIND FIRST brstat.insure USE-INDEX insure01 WHERE 
        trim(brstat.Insure.compno)  = TRIM(fi_packre)  AND 
        trim(brstat.insure.vatcode) = TRIM(SUBSTR(wdetail.class,1,1))    NO-ERROR.
     IF AVAIL brstat.insure THEN 
         ASSIGN wdetail.CLASS    = TRIM(brstat.insure.Text3) + TRIM(SUBSTR(wdetail.class,2,3)) .
  END.
/* end A63-0148 */
...
IF wdetail.poltyp = "v70" THEN DO:
   ...
   /* RUN proc_wgsoper .*/ /*A64-0138*/
    ...
    IF wdetail.si = "" THEN wdetail.si = wdetail.fi.
    Assign  nv_sivar = ""
        nv_totsi = 0
        nv_sicod     = "SI"
    ...
    ASSIGN dod0 = 0
           ...
           dod2 = 0
           dpd0 = 0
           dod0 = int(wdetail.dod1)
           dpd0 = int(wdetail.dod0).
    ...
    /*-------------- load claim ---------------------*/
    nv_cl_per  = 0.
    ASSIGN nv_cl_per = deci(wdetail.cl_per).
    nv_clmvar  = " ".
    IF nv_cl_per  <> 0  THEN
        Assign 
    ...
    /*------------------ stf ---------------*/
      nv_stfvar   = "" .
      ASSIGN nv_stf_per  = DECI(wdetail.stf_per) .
...
IF wdetail.poltyp = "V70" THEN DO:
    ...
    ASSIGN               
       ...
       /*nv_cstflg  = "C"  /*C=CC ; S=Seat ; T=Tons ; W=Watts*/ 
         ...
         nv_totsi   = IF sic_bran.uwm130.uom6_v = 0 THEN  sic_bran.uwm130.uom7_v  ELSE  sic_bran.uwm130.uom6_v  /*A66-0196*/
       ...
       /*nv_supe    = NO*/                                              
         ...
         nv_411si   = deci(wdetail.nv_41)     
         nv_412si   = deci(wdetail.nv_412)      
         nv_413si   = 0                       
         nv_414si   = 0                       
         nv_42si    = deci(wdetail.nv_42)               
         nv_43si    = deci(wdetail.nv_43)               
         ...
         nv_dstfp   = deci(wdetail.stf_per)                                                    
         nv_clmp    = deci(wdetail.cl_per)                                                    
...
FOR EACH wdetail WHERE wdetail.policy <> "" :
   ...
   IF wdetail.prepol <> ""  THEN DO:  
       IF wdetail.poltyp = "V70" THEN DO:
           /*MESSAGE "chk 1 " wdetail.prepol VIEW-AS ALERT-BOX.*/
            RUN proc_renew70.  
            RUN proc_chktest0.   
            RUN proc_policy. 
            RUN proc_colorcode  . /*A66-0141*/ 
            RUN proc_chktest2.   
            RUN proc_chktest3.   
            RUN proc_chktest4.
       END.
       ELSE DO:
            /*MESSAGE "chk 1 72 " wdetail.prepol VIEW-AS ALERT-BOX.*/
           RUN proc_renew72.
           RUN proc_72.                                
           RUN proc_policy.  
           RUN proc_colorcode  . /*A66-0141*/ 
...
IF NOT AVAILABLE uwm130 THEN 
    ...
    IF wdetail.covcod = "2"  THEN 
        ...
        sic_bran.uwm130.uom7_v   = INT(wdetail.fi)
        sic_bran.uwm130.fptr01   = 0     sic_bran.uwm130.bptr01 = 0  /*Item Upper text*/
        sic_bran.uwm130.fptr02   = 0     sic_bran.uwm130.bptr02 = 0  /*Item Lower Text*/
        sic_bran.uwm130.fptr03   = 0     sic_bran.uwm130.bptr03 = 0  /*Cover & Premium*/
        sic_bran.uwm130.fptr04   = 0     sic_bran.uwm130.bptr04 = 0  /*Item Endt. Text*/
    ...
    IF wdetail.poltyp = "V70" AND trim(wdetail.DSPC) = "5" THEN sic_bran.uwm130.i_text = "0001" . /* ranu :A62-0353*/
    ...
    IF avail stat.clastab_fil Then do:
        ...
        ELSE
            Assign  sic_bran.uwm130.uom1_v     = if deci(wdetail.uom1_v) = 0 then stat.clastab_fil.uom1_si else deci(wdetail.uom1_v) 
                    sic_bran.uwm130.uom2_v     = if deci(wdetail.uom2_v) = 0 then stat.clastab_fil.uom2_si else deci(wdetail.uom2_v) 
                    sic_bran.uwm130.uom5_v     = if deci(wdetail.uom5_v) = 0 then stat.clastab_fil.uom5_si else deci(wdetail.uom5_v) 
        ...
        IF (wdetail.prepol <> "") OR (substr(wdetail.class,1,1) = "Z") THEN
         ...
         ELSE IF  wdetail.garage =  ""  Then
            ASSIGN nv_41   = if deci(wdetail.nv_41) = 0   then  stat.clastab_fil.si_41unp  else deci(wdetail.nv_41)  
            nv_42          = if deci(wdetail.nv_42) = 0   then  stat.clastab_fil.si_42     else deci(wdetail.nv_42) 
            nv_43          = if deci(wdetail.nv_43) = 0   then  stat.clastab_fil.si_43     else deci(wdetail.nv_43)  
            nv_seat41      = IF deci(wdetail.seat41) = 0 then  stat.clastab_fil.dri_41 + clastab_fil.pass_41 else deci(wdetail.seat41)  
            wdetail.seat41 = IF deci(wdetail.seat41) = 0 THEN  stat.clastab_fil.dri_41 + clastab_fil.pass_41 else deci(wdetail.seat41)  .   
        Else If  wdetail.garage  =  "G"  Then
            Assign 
            nv_41          = if deci(wdetail.nv_41) = 0    then stat.clastab_fil.si_41pai else deci(wdetail.nv_41)
            nv_42          = if deci(wdetail.nv_42) = 0    then stat.clastab_fil.si_42    else deci(wdetail.nv_42)
            nv_43          = if deci(wdetail.nv_43) = 0    then stat.clastab_fil.impsi_43 else deci(wdetail.nv_43)
            nv_seat41      = IF deci(wdetail.seat41)  = 0  then  stat.clastab_fil.dri_41 + clastab_fil.pass_41 else deci(wdetail.seat41)  
            wdetail.seat41 =  IF deci(wdetail.seat41) = 0  THEN  stat.clastab_fil.dri_41 + clastab_fil.pass_41 else deci(wdetail.seat41) .
            /* end A63-0178*/
         /* comment by a63-0178 ...
...
/*IF sic_bran.uwm100.prvpol = "" AND wdetail.commission <> "" THEN DO:  /*--งาน New : A59-0060--*/*/ /* A59-0400 */
ASSIGN wdetail.commission  = "0".
/*-------------------- calprem ---------------------*/
...
IF NOT AVAIL wdetail THEN DO:
    ...
    ASSIGN 
        ...
        wdetail.stf_per    = TRIM(nn_stf_per)
        ...
        wdetail.dod1       = TRIM(nn_dedod)    
        wdetail.dod0       = trim(nn_dedpd) 
        wdetail.br         = TRIM(np_br)
        wdetail.benname    = TRIM(n_benname)     /*A63-0178*/
        wdetail.nCOLOR     = TRIM(nCOLOR)        /*A66-0141*/
        wdetail.promotion  = TRIM(promotion)     /*A66-0141*/
        wdetail.cedpol     = TRIM(cedpol)        /*A66-0141*/
    ...
    END.
    /* add by : A63-0178 */
    IF trim(n_textacc) <> "" THEN DO:
        CREATE wacctext .
        ASSIGN wacctext.n_policytxt = trim(n_policy70) 
...
FIND FIRST wdetail WHERE wdetail.policy = trim(n_policy72) NO-ERROR NO-WAIT.
    IF NOT AVAIL wdetail THEN DO:
        ...
        ASSIGN 
            ...
            wdetail.prmtxt      = ""
            wdetail.pass        = "y"
            wdetail.vehuse      =  trim(nf_vehuse72)     
            wdetail.br          =  TRIM(np_br)
            wdetail.dspc        =  trim(n_dspc72)          /*ranu A62-0353 31/07/2019 */
            wdetail.nCOLOR     = TRIM(nCOLOR)        /*A66-0141*/
            wdetail.promotion  = TRIM(promotion)     /*A66-0141*/
            wdetail.cedpol     = TRIM(cedpol)        /*A66-0141*/
             .
        ...
        IF  (n_textf7 <> "") OR (n_textf72 <> "") OR (n_textf73 <> "" ) THEN DO:
            CREATE wacctext17.
            ASSIGN 
                wacctext17.n_policytxt17 = trim(n_policy72)     
                wacctext17.n_textacc1    = trim(n_textf7)  
                wacctext17.n_textacc2    = trim(n_textf72) 
                wacctext17.n_textacc3    = trim(n_textf73). 
        END.
        /* add by : A63-0178 */
       IF n_textacc <> "" THEN DO:
           CREATE wacctext .
           ASSIGN wacctext.n_policytxt = trim(n_policy70) 
                  wacctext.n_textacc   = trim(n_textacc) .
       END.
...
ASSIGN 
         ...
         nn_dedpd     = ""
         nn_stf_per   = ""
         n_dspc72     = ""    /* ranu A62-0353 31/07/2019*/  
         n_campaign_ov = ""   /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/      
...
FIND LAST sicsyac.xmm600 USE-INDEX  xmm60002 WHERE
    (sicsyac.xmm600.NAME      = TRIM(wdetail.insnam) + " " + trim(wdetail.lastname)) OR 
...
ELSE DO:
    IF sicsyac.xmm600.acno <> "" THEN DO:   /* กรณีพบ */
        ASSIGN
            ...
            nv_transfer              = NO 
            wdetail.instyp           = IF TRIM(sicsyac.xmm600.acno_typ) <> "" THEN TRIM(sicsyac.xmm600.acno_typ) ELSE wdetail.instyp
            wdetail.tiname           = trim(sicsyac.xmm600.ntitle)
            wdetail.insnam           = IF trim(sicsyac.xmm600.firstname) <> "" THEN trim(sicsyac.xmm600.firstname) ELSE trim(sicsyac.xmm600.name)
            wdetail.lastname         = trim(sicsyac.xmm600.lastname)
            ...
            wdetail.postcd           = IF trim(sicsyac.xmm600.postcd) = "" THEN  trim(sicsyac.xmm600.postcd) ELSE trim(wdetail.postcd) 
            sicsyac.xmm600.acno_typ  = IF sicsyac.xmm600.acno_typ = "" THEN trim(wdetail.instyp) ELSE sicsyac.xmm600.acno_typ 
            ...
            sicsyac.xmm600.firstname = IF trim(sicsyac.xmm600.firstname) <> "" THEN TRIM(wdetail.insnam) ELSE trim(sicsyac.xmm600.firstname)
            sicsyac.xmm600.lastname  = IF trim(sicsyac.xmm600.lastname)  <> "" THEN TRIM(wdetail.lastname) ELSE trim(sicsyac.xmm600.lastname)
            ...
            sicsyac.xmm600.postcd    = IF trim(sicsyac.xmm600.postcd) = "" THEN  trim(wdetail.postcd)  ELSE trim(sicsyac.xmm600.postcd) /*Postal Code*/
...
IF nv_transfer = YES THEN DO:     
    ASSIGN  sicsyac.xmm600.acno = nv_insref                 /*Account no*/
        ...
        sicsyac.xmm600.acno_typ  = IF sicsyac.xmm600.acno_typ <> wdetail.instyp THEN trim(wdetail.instyp)  ELSE sicsyac.xmm600.acno_typ 
        sicsyac.xmm600.ntitle   = trim(wdetail.tiname)      /*Title for Name Mr/Mrs/etc*/
        sicsyac.xmm600.fname    = ""                        /*First Name*/
        sicsyac.xmm600.name     = trim(wdetail.insnam) + " " + TRIM(wdetail.lastname)      /*Name Line 1*/
        ...
        sicsyac.xmm600.addr4    = IF trim(sicsyac.xmm600.addr4) = ""  THEN  trim(wdetail.n_addr4)       ELSE trim(sicsyac.xmm600.addr4)  /*Address line 4*/
        sicsyac.xmm600.postcd   = IF trim(sicsyac.xmm600.postcd) = "" THEN  trim(wdetail.postcd)        ELSE trim(sicsyac.xmm600.postcd) /*Postal Code*/
        sicsyac.xmm600.codeaddr1 = if sicsyac.xmm600.codeaddr1 = ""   THEN  trim(wdetail.codeaddr1)     else trim(sicsyac.xmm600.codeaddr1) 
        sicsyac.xmm600.codeaddr2 = if sicsyac.xmm600.codeaddr2 = ""   THEN  trim(wdetail.codeaddr2)     else trim(sicsyac.xmm600.codeaddr2) 
        sicsyac.xmm600.codeaddr3 = if sicsyac.xmm600.codeaddr3 = ""   THEN  trim(wdetail.codeaddr3)     else trim(sicsyac.xmm600.codeaddr3) 
...
IF sicsyac.xmm600.acno <> "" THEN DO:              /*A55-0268 add chk nv_insref = "" */
    ...
    IF nv_transfer = YES THEN DO:
        ASSIGN
            ...
            sicsyac.xtm600.name      = trim(wdetail.insnam) + " " + TRIM(wdetail.lastname) /*Name of Insured Line 1*/
            sicsyac.xtm600.firstname = trim(wdetail.insnam)  /*Name of Insured Line 1*/
            sicsyac.xtm600.lastname  = trim(wdetail.lastname)   /*Name of Insured Line 1*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_insnam-01 c-Win 
PROCEDURE proc_insnam-01 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
FIND LAST sicsyac.xmm600 USE-INDEX  xmm60002 WHERE
    /*sicsyac.xmm600.NAME     = TRIM(wdetail.insnam)   AND */ /* A64-0138 */
    (sicsyac.xmm600.NAME      = TRIM(wdetail.insnam) + " " + trim(wdetail.lastname)) OR /*A64-0138*/
    (sicsyac.xmm600.firstname = TRIM(wdetail.insnam)   AND                              /*A64-0138*/
    sicsyac.xmm600.lastname   = TRIM(wdetail.lastname)) AND                             /*A64-0138*/
    sicsyac.xmm600.homebr   = trim(wdetail.n_branch) AND 
    sicsyac.xmm600.clicod   = "IN"                   NO-ERROR NO-WAIT.  
IF NOT AVAILABLE sicsyac.xmm600 THEN DO: 
    IF LOCKED sicsyac.xmm600 THEN DO:   
...
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X1;K"  '"' " Data Policy Durbell " + STRING(TODAY,"99/99/9999") FORMAT "x(60)"  '"' SKIP.
nv_row  =  nv_row + 1.                                                          
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X1;K"   '"'  "NO "                        '"' SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X2;K"   '"'  "เลขกรมธรรม์เดิม "           '"' SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X3;K"   '"'  "เลขกรมธรรม์ใหม่ "           '"' SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X4;K"   '"'  "ประเภทกรมธรรม์  "           '"' SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X5;K"   '"'  "รหัสลูกค้า  "               '"' SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X6;K"   '"'  "ประเภทความคุ้มครอง 1 2 3  " '"' SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X7;K"   '"'  "ลักษณะการใช้รถ "            '"' SKIP. 
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X8;K"   '"'  "Class "                     '"' SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X9;K"   '"'  "seat    "                   '"' SKIP.   /*A59-0590*/      
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X10;K"  '"'  "CC      "                   '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X11;K"  '"'  "Tonnage."                   '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X12;K"  '"'  "garage  "                   '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X13;K"  '"'  "ความเสียหายต่อชีวิต ฯลฯ (บาท/คน)   "    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X14;K"  '"'  "ความเสียหายต่อชีวิต ฯลฯ (บาท/ครั้ง)"    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X15;K"  '"'  "ความเสียหายต่อทรัพย์สิน (บาท/ครั้ง)"    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X16;K"  '"'  "SI  "    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X17;K"  '"'  "FI  "    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X18;K"  '"'  "อุบัติเหตุส่วนบุคคล (บาท)  4.1     "    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X19;K"  '"'  "อุบัติเหตุส่วนบุคคล (บาท/คน) 4.2   "    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X20;K"  '"'  "ค่ารักษาพยาบาล (บาท/คน) 4.3.1      "    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X21;K"  '"'  "ค่ารักษาพยาบาล (บาท/คน) 4.3.2      "    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X22;K"  '"'  "Seat_41                            "    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X23;K"  '"'  "NCB            "    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X24;K"  '"'  "Fleet          "    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X25;K"  '"'  "DOD            "    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X26;K"  '"'  "DOD PD         "    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X27;K"  '"'  "dspc           "    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X28;K"  '"'  "dstf           "    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X29;K"  '"'  "Base Premium   "    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X30;K"  '"'  "เบี้ยกรมธรรม์  "    '"' SKIP.         
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X31;K"  '"'  "เบี้ยพรบ.      "   '"' SKIP.   
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X32;K"  '"'  "Vehreg ทะเบียน"     '"' SKIP.   
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X33;K"  '"'  "Redbook        "    '"' SKIP.   
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X34;K"  '"'  "Make           "    '"' SKIP.   
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X35;K"  '"'  "Model/Class    "    '"' SKIP.   
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X36;K"  '"'  "Body           "    '"' SKIP.   
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X37;K"  '"'  "เลขตัวถัง      "    '"' SKIP.   
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X38;K"  '"'  "เลขเครื่องยนต์ "    '"' SKIP.   
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X39;K"  '"'  "Year Manuf     "    '"' SKIP.   
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X40;K"  '"'  "Com.Date 70    "    '"' SKIP.   
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X41;K"  '"'  "Exp.Date 70    "    '"' SKIP.   
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X42;K"  '"'  "BR             "    '"' SKIP.   
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X43;K"  '"'  "F17=Memo01     "    '"' SKIP.   
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X44;K"  '"'  "F17=Memo02     "    '"' SKIP.   
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X45;K"  '"'  "F17=Memo03     "    '"' SKIP. 
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X46;K"  '"'  "Acc Text1      "    '"' SKIP.  /*A63-0178*/ 
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X47;K"  '"'  "ACC Text2      "    '"' SKIP.  /*a63-0178*/
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X48;K"  '"'  "ผู้รับผลประโยชน์"    '"' SKIP. /*A63-0178*/

FOR EACH wdetail WHERE wdetail.policy <> "" NO-LOCK.
    IF wdetail.prepol <> "" THEN DO:
        FIND LAST sicuw.uwm100 USE-INDEX uwm10001 WHERE sicuw.uwm100.policy = wdetail.prepol AND sicuw.uwm100.poltyp = wdetail.poltyp NO-LOCK NO-ERROR.
            IF AVAIL sicuw.uwm100 THEN DO:
                IF sicuw.uwm100.poltyp = "V70" THEN 
                    ASSIGN wdetail.policy70 = sicuw.uwm100.renpol.
                ELSE ASSIGN wdetail.policy72 = sicuw.uwm100.renpol.
            END.
            ELSE DO:
                IF wdetail.poltyp = "V72" THEN DO:
                    FIND LAST sicuw.uwm301 WHERE sicuw.uwm301.cha_no = wdetail.chassis AND sicuw.uwm301.tariff = "9"  NO-LOCK NO-ERROR.
                        IF AVAIL sicuw.uwm301 THEN DO:
                            ASSIGN wdetail.policy72 = sicuw.uwm301.policy.
                        END.
                END.
                ELSE DO:
                    FIND LAST sicuw.uwm301 WHERE sicuw.uwm301.cha_no = wdetail.chassis AND sicuw.uwm301.tariff = "X"  NO-LOCK NO-ERROR.
                        IF AVAIL sicuw.uwm301 THEN DO:
    ...
    ASSIGN  n_record =  n_record + 1                   
           nv_cnt   =  nv_cnt  + 1 
           nv_row   =  nv_row  + 1.
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X1;K"   '"' nv_cnt   '"' SKIP.
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X2;K"   '"' wdetail.prepol '"' SKIP.
    IF wdetail.poltyp = "V70" THEN PUT STREAM ns2 "C;Y" STRING(nv_row) ";X3;K"   '"' wdetail.policy70 '"' SKIP.
    ELSE IF wdetail.poltyp = "V72" THEN PUT STREAM ns2 "C;Y" STRING(nv_row) ";X3;K"   '"' wdetail.policy72 '"' SKIP.
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X4;K"   '"' wdetail.poltyp '"' SKIP.
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X5;K"   '"' wdetail.inserf '"' SKIP.
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X6;K"   '"' wdetail.covcod '"' SKIP. 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X7;K"   '"' wdetail.vehuse '"' SKIP.
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X8;K"   '"' wdetail.class   '"' SKIP.   /*A59-0590*/      
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X9;K"   '"' wdetail.seat    '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X10;K"  '"' wdetail.engcc   '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X11;K"  '"' wdetail.Tonn    '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X12;K"  '"' wdetail.garage  '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X13;K"  '"' wdetail.uom1_v  '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X14;K"  '"' wdetail.uom2_v  '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X15;K"  '"' wdetail.uom5_v  '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X16;K"  '"' wdetail.si      '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X17;K"  '"' wdetail.fi      '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X18;K"  '"' wdetail.nv_41   '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X19;K"  '"' wdetail.nv_412  '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X20;K"  '"' wdetail.nv_42   '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X21;K"  '"' wdetail.nv_43   '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X22;K"  '"' wdetail.seat41  '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X23;K"  '"' wdetail.ncb     '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X24;K"  '"' wdetail.fleet   '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X25;K"  '"' wdetail.dod1    '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X26;K"  '"' wdetail.dod0    '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X27;K"  '"' wdetail.dspc    '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X28;K"  '"' wdetail.stf_per '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X29;K"  '"' wdetail.base     '"' SKIP.         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X30;K"  '"' wdetail.prem_nap '"' SKIP.   
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X31;K"  '"' wdetail.premt    '"' SKIP.   
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X32;K"  '"' wdetail.vehreg   '"' SKIP.   
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X33;K"  '"' wdetail.redbook  '"' SKIP.   
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X34;K"  '"' wdetail.brand    '"' SKIP.   
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X35;K"  '"' wdetail.model    '"' SKIP.   
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X36;K"  '"' wdetail.body     '"' SKIP.   
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X37;K"  '"' wdetail.chassis  '"' SKIP.   
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X38;K"  '"' wdetail.engno    '"' SKIP.   
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X39;K"  '"' wdetail.caryear  '"' SKIP.   
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X40;K"  '"' wdetail.comdat   '"' SKIP.   
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X41;K"  '"' wdetail.expdat   '"' SKIP. 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X42;K"  '"' wdetail.br       '"' SKIP. 

    FIND FIRST wacctext17 WHERE wacctext17.n_policy = wdetail.policy NO-LOCK NO-ERROR.
        IF AVAIL wacctext17 THEN DO:
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X43;K"  '"' wacctext17.n_textacc1 '"' SKIP.   
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X44;K"  '"' wacctext17.n_textacc2 '"' SKIP.   
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X45;K"  '"' wacctext17.n_textacc3 '"' SKIP.
        END.
        ELSE DO: 
        ...
        END.
    /* Add by A63-0178 */
    FIND FIRST wacctext WHERE wacctext.n_policy = wdetail.policy NO-LOCK NO-ERROR.
        IF AVAIL wacctext THEN DO:
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X46;K"  '"' wacctext.n_textacc1 '"' SKIP.   
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X47;K"  '"' wacctext.n_textacc2 '"' SKIP.  
        END.
        ELSE DO: 
             PUT STREAM ns2 "C;Y" STRING(nv_row) ";X46;K"  '"' ""  '"' SKIP.   
             PUT STREAM ns2 "C;Y" STRING(nv_row) ";X47;K"  '"' ""  '"' SKIP. 
        END.
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X48;K"  '"' wdetail.benname '"' SKIP.   
    /* end A63-0178 */
   /* PUT STREAM ns2 "C;Y" STRING(nv_row) ";X43;K"  '"' wacctext17.n_textacc2 '"' SKIP.   
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X44;K"  '"' wacctext17.n_textacc3 '"' SKIP.*/
END.    /*  end  wdetail  */
nv_row  =  nv_row  + 1. 
PUT STREAM ns2 "E".
OUTPUT STREAM ns2 CLOSE.  
MESSAGE " MATCH DATA POLICY COMPLETE " VIEW-AS ALERT-BOX.
END PROCEDURE.
...
IF wdetail.comdat = "" THEN DO:
    ASSIGN  wdetail.pass = "N"
            wdetail.comment      = wdetail.comment + "| วันที่คุ้มครองเป็นค่าว่าง"
            wdetail.warning      = "วันที่คุ้มครองต้องไม่เป็นค่าว่าง !!".
END.
IF wdetail.expdat = "" THEN DO:
    ASSIGN  wdetail.pass = "N"
            wdetail.comment      = wdetail.comment + "| วันที่หมดอายุเป็นค่าว่าง "
            wdetail.warning      = "วันที่หมดอายุต้องไม่เป็นค่าว่าง !! ".
END.

RUN proc_chkcode . /*ranu : A64-0138 */
...
DO TRANSACTION:                                                                         
    ASSIGN                                                                             
        ...
        /*sic_bran.uwm100.name1  = trim(wdetail.insnam) + " " + TRIM(wdetail.br) */ /* ranu A64-0138 */
        sic_bran.uwm100.name1  = trim(trim(wdetail.insnam) + " " + 
                                 TRIM(wdetail.lastname)) + " " + TRIM(wdetail.br)  /* ranu A64-0138 */
        ...
        sic_bran.uwm100.prog   = "wgwndebel"                     
        ...
        sic_bran.uwm100.cedpol = IF wdetail.cpol  = "" THEN trim(wdetail.cedpol) ELSE wdetail.cpol    /*-- A59-0013 --*/  
        sic_bran.uwm100.finint = ""
        sic_bran.uwm100.bs_cd  = caps(trim(wdetail.vatcode))
        sic_bran.uwm100.cr_1   = ""   /* A59-0400 */
        /*sic_bran.uwm100.firstName  = TRIM(wdetail.firstName)            /*Add by Kridtiya i. A63-0472*/ */ /* ranu :A64-0138 */
        sic_bran.uwm100.firstName  = TRIM(wdetail.insnam)                 /*Add by Kridtiya i. A63-0472*/    /* ranu :A64-0138 */
        sic_bran.uwm100.lastName   = TRIM(wdetail.lastName) + " " + TRIM(wdetail.br)         /* ranu:A64-0138 */ 
        ...
        sic_bran.uwm100.opnpol     = TRIM(wdetail.promotion)    .   /*A66-0141  promo */ 
        
    IF wdetail.prepol <> " " THEN DO:
        IF wdetail.poltyp = "v72"  THEN 
            ASSIGN sic_bran.uwm100.prvpol  = caps(trim(wdetail.prepol))
...
END.     /*transaction*//**/
IF wdetail.textf7 <> "" THEN  RUN proc_uwd102.
/* --------------------U W M 1 2 0 -------------- */
    ...
    IF sicuw.uwm100.renpol <> " " THEN  DO:
        ...
        IF AVAIL bfuwm100 THEN DO:
            IF bfuwm100.polsta = "IF" THEN 
             ASSIGN wdetail.comment = wdetail.comment + "| กรมธรรณ์มีการต่ออายุแล้ว: " + sicuw.uwm100.renpol 
                    wdetail.pass    = "N"     
                    wdetail.OK_GEN  = "N".
             ELSE DO:
                ASSIGN   
...
IF AVAIL sicuw.uwm100  THEN DO:
    IF sicuw.uwm100.releas = NO THEN DO:
        ASSIGN wdetail.comment = wdetail.comment + "|ยังไม่ได้ทำการโอนไป บ/ช ไม่สามารถทำงานต่ออายุได้: " + sicuw.uwm100.policy
        wdetail.pass    = "N"     
        wdetail.OK_GEN  = "N".
        NEXT.
    END.
    ELSE IF sicuw.uwm100.renpol <> " " THEN DO: 
        /* ranu A64-0138  07/05/2021*/
        FIND LAST bfuwm100 WHERE bfuwm100.policy = sicuw.uwm100.renpol NO-LOCK NO-ERROR .
        IF AVAIL bfuwm100 THEN DO:
            IF  bfuwm100.polsta = "IF" THEN DO:
             ASSIGN wdetail.comment = wdetail.comment + "|กรมธรรณ์มีการต่ออายุแล้ว : " + sicuw.uwm100.renpol
                    wdetail.pass    = "N"     
                    wdetail.OK_GEN  = "N".
                    NEXT.
    ...
    END.
    /*ELSE DO: */
    IF wdetail.pass = "Y" THEN DO: /* ranu A64-0138 07/05/2021*/
        ASSIGN 
            n_rencnt         = sicuw.uwm100.rencnt  +  1
            n_endcnt         = 0   
            wdetail.n_rencnt = sicuw.uwm100.rencnt  +  1    
           ...
           IF wdetail.producer = "" THEN ASSIGN  wdetail.producer = sicuw.uwm100.acno1 .   /*  np_producer     */ 
           IF wdetail.agent    = "" THEN ASSIGN  wdetail.agent    = sicuw.uwm100.agent .   /*  np_agent        */ 
           /*IF wdetail.inserf   = "" THEN ASSIGN  wdetail.inserf   = sicuw.uwm100.insref.   /*  np_insref       */ *//*Add by Kridtiya i. A63-0472*/
           /*Add by Kridtiya i. A63-0472*/
           IF wdetail.inserf   = "" THEN DO: 
               ASSIGN  wdetail.inserf   = sicuw.uwm100.insref.   /*  np_insref   */ 
               IF  wdetail.codeaddr1 = "" AND wdetail.codeaddr2 = "" AND wdetail.codeaddr3 = "" THEN DO:
                   FIND FIRST sicsyac.xmm600 USE-INDEX xmm60001 WHERE 
                       sicsyac.xmm600.acno = trim(wdetail.inserf)  NO-LOCK NO-ERROR NO-WAIT.
                   IF AVAIL sicsyac.xmm600  THEN DO:
                       ASSIGN
                           /*wdetail.firstName      = TRIM(sicsyac.xmm600.firstname)*/ /* ranu:A64-0138 */
                           wdetail.insnam        = IF TRIM(sicsyac.xmm600.firstname) <> "" THEN TRIM(sicsyac.xmm600.firstname) 
                                                    ELSE TRIM(sicsyac.xmm600.NAME) /* ranu:A64-0138 */
                           wdetail.lastName       = TRIM(sicsyac.xmm600.lastName)
                           wdetail.postcd         = trim(sicsyac.xmm600.postcd)
                           wdetail.codeocc        = trim(sicsyac.xmm600.codeocc) 
                           wdetail.codeaddr1      = TRIM(sicsyac.xmm600.codeaddr1)
           ...
           END.
           /*Add by Kridtiya i. A63-0472*/
           IF wdetail.tiname   = "" THEN ASSIGN  wdetail.tiname   = sicuw.uwm100.ntitle.   /*  np_title        */ 
           /*IF wdetail.insnam   = "" THEN ASSIGN  wdetail.insnam   = sicuw.uwm100.name1 .   /*  np_name1        */ */ /* ranu:A64-0138 */
           IF wdetail.insnam   = "" THEN ASSIGN  wdetail.insnam   = IF sicuw.uwm100.firstname <> "" THEN trim(sicuw.uwm100.firstname) 
                                                                    ELSE sicuw.uwm100.name1 .   /*  ranu A64-0138   */
          /* IF wdetail.lastname = "" THEN ASSIGN  wdetail.lastname = IF sicuw.uwm100.lastname <> "" THEN trim(sicuw.uwm100.lastname) 
                                                                    ELSE "" .   /*  ranu A64-0138    */*/
           IF wdetail.name2    = "" THEN ASSIGN  wdetail.name2    = sicuw.uwm100.name2 .   /*  np_name2        */ 
           IF wdetail.name3    = "" THEN ASSIGN  wdetail.name3    = sicuw.uwm100.name3 .   /*  np_name3        */ 
           IF wdetail.n_addr1  = "" THEN ASSIGN  wdetail.n_addr1  = sicuw.uwm100.addr1 .   /*  np_addr1        */ 
           IF wdetail.n_addr2  = "" THEN ASSIGN  wdetail.n_addr2  = sicuw.uwm100.addr2 .   /*  np_addr2        */ 
           IF wdetail.n_addr3  = "" THEN ASSIGN  wdetail.n_addr3  = sicuw.uwm100.addr3 .   /*  np_addr3        */ 
           IF wdetail.n_addr4  = "" THEN ASSIGN  wdetail.n_addr4  = sicuw.uwm100.addr4 .   /*  np_addr4        */ 
           IF wdetail.postcd   = "" THEN ASSIGN  wdetail.postcd   = sicuw.uwm100.postcd.
           IF np_occupn        = "" THEN ASSIGN  np_occupn        = sicuw.uwm100.occupn.   /*  np_occupn       */ 
           IF wdetail.comdat   = "" THEN ASSIGN  wdetail.comdat   = STRING(DAY(sicuw.uwm100.comdat),"99") + "/" +
                                                                    STRING(MONTH(sicuw.uwm100.comdat),"99") + "/" +
                                                                    STRING(YEAR(sicuw.uwm100.comdat) + 1,"9999") .
           IF wdetail.expdat   = "" THEN ASSIGN  wdetail.expdat   = STRING(DAY(sicuw.uwm100.expdat),"99") + "/" +
                                                                    STRING(MONTH(sicuw.uwm100.expdat),"99") + "/" +
                                                                    STRING(YEAR(sicuw.uwm100.expdat) + 1,"9999") .
           IF wdetail.firstdat = "" THEN ASSIGN  wdetail.firstdat = string(sicuw.uwm100.fstdat,"99/99/9999") .  /*  np_firstdat     */ 
            wdetail.cpol   = sicuw.uwm100.cedpol.  /*  np_cedpol       */ 
        FIND LAST  sicuw.uwm120  WHERE
            sicuw.uwm120.policy = sicuw.uwm100.policy   NO-LOCK NO-ERROR NO-WAIT.
        IF AVAILABLE uwm120 THEN DO: 
            IF wdetail.CLASS = "" THEN ASSIGN wdetail.class = sicuw.uwm120.class .     /*  np_class        */ 
            ...
            IF AVAIL sicuw.uwm301 THEN
                ...
                IF wdetail.redbook = "" THEN ASSIGN  wdetail.redbook    = sicuw.uwm301.modcod        .  /*  np_redbook */ 
                IF wdetail.caryear = "" THEN ASSIGN  wdetail.caryear    = string(sicuw.uwm301.yrmanu).  /*  np_yrmanu  */ 
                IF wdetail.cargrp  = "" THEN ASSIGN  wdetail.cargrp     = sicuw.uwm301.vehgrp        .  /*  np_vehgrp  */ 
                IF wdetail.body    = "" THEN ASSIGN  wdetail.body       = sicuw.uwm301.body          .  /*  np_body    */ 
                IF wdetail.engcc   = "" THEN ASSIGN  wdetail.engcc      = STRING(sicuw.uwm301.engine).  /*  np_engine  */ 
                IF wdetail.Tonn    = 0  THEN ASSIGN  wdetail.Tonn       = sicuw.uwm301.tons          .  /*  np_tons    */ 
                IF wdetail.seat    = "" THEN ASSIGN  wdetail.seat       = string(sicuw.uwm301.seats) .  /*  np_seats   */ 
                IF wdetail.vehuse  = "" THEN ASSIGN  wdetail.vehuse     = sicuw.uwm301.vehuse        .   /*  np_vehuse  */ 
                IF wdetail.covcod  = "" THEN ASSIGN  wdetail.covcod     =  "T"                       .   /*  np_covcod  */ 
                IF wdetail.garage  = "" THEN ASSIGN  wdetail.garage     = sicuw.uwm301.garage        .   /*  np_garage  */ 
                IF wdetail.vehreg  = "" THEN ASSIGN  wdetail.vehreg     = sicuw.uwm301.vehreg        .   /*  np_vehreg  */ 
                IF wdetail.chassis = "" THEN ASSIGN  wdetail.chassis    = sicuw.uwm301.cha_no        .   /*  np_cha_no  */ 
                IF wdetail.engno   = "" THEN ASSIGN  wdetail.engno      = sicuw.uwm301.eng_no        .   /*  np_eng_no  */ 
                IF wdetail.seat41  = 0  THEN ASSIGN  wdetail.seat41     = sicuw.uwm301.mv41seat      .   /*  np_seat41       */ 
                IF wdetail.benname = "" THEN ASSIGN  wdetail.benname    = sicuw.uwm301.mv_ben83      .   /*  np_bennam1      */ 
                IF wdetail.prmtxt  = "" THEN ASSIGN  wdetail.prmtxt     = sicuw.uwm301.prmtxt .         /*  np_prmtxt       */ 
                IF wdetail.brand   = "" THEN ASSIGN  wdetail.brand      = sicuw.uwm301.moddes .
        END.
...
IF AVAIL  sic_bran.uwm301 THEN 
    ASSIGN   
        ...
        /* Add by A63-0178 */
        sic_bran.uwm301.tons  = IF sic_bran.uwm301.tons = 0 THEN 0 ELSE IF sic_bran.uwm301.tons < 100 THEN 
                                   sic_bran.uwm301.tons * 1000 ELSE sic_bran.uwm301.tons .
