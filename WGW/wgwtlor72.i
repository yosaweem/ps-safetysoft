...
DEFINE VAR  ns_tax           AS CHAR FORMAT "X(20)" .   /*"ทุนประกัน"                  */                           
DEFINE VAR  ns_vat           AS CHAR FORMAT "X(20)" .   /*"ทุนประกันรถหาย"             */                            
DEFINE VAR  ns_comprm        AS CHAR FORMAT "X(20)" .   /*"ค่าเบี้ยสุทธิ"                      */                            
...
DEF    VAR  ns_sckno         AS CHAR FORMAT "x(20)" .  
...
DEF    VAR  ns_docno        AS CHAR FORMAT "x(20)" .
