...
DEFINE NEW SHARED TEMP-TABLE wdetail
    ...
    FIELD fi             AS CHAR FORMAT "x(20)"  INIT ""  /* ทุนสูญหายไฟไหม้ */ /*A62-0219*/
...
DO:
    ...
    REPEAT:    
        ...
        wdetail.fi              /* ทุนสูญหาย ไฟไหม้ */ /*ฤ62-0219*/
...
DO:
    ...
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X3;K"  '"'   wdetail.time_notify  '"' SKIP.   /*เวลารับแจ้ง                    */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X4;K"  '"'   wdetail.notifyno     '"' SKIP.   /*เลขรับแจ้งงาน                  */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X5;K"  '"'   wdetail.comp_code    '"' SKIP.   /*รหัสบรษัท                      */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X6;K"  '"'   wdetail.NAME_mkt     '"' SKIP.   /*ชื่อเจ้าหน้าที่ MKT            */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X7;K"  '"'   wdetail.cmbr_no      '"' SKIP.   /*รหัสสาขา                       */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X8;K"  '"'   wdetail.cmbr_code    '"' SKIP.   /*Code:                          */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X9;K"  '"'   wdetail.branch       '"' SKIP.   /*รหัสสาขา_STY                   */       
    ...
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X14;K"  '"'  wdetail.cov_car      '"' SKIP.   /*ประเภทประกัน                   */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X15;K"  '"'  wdetail.cov_new      '"' SKIP.   /*ประเภทรถ                       */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X16;K"  '"'  wdetail.covcod       '"' SKIP.   /*ประเภทความคุ้มครอง             */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X17;K"  '"'  wdetail.product      '"' SKIP.   /*Product Type                   */        
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X18;K"  '"'  wdetail.freeprem     '"' SKIP.   /*ประกัน แถม/ไม่แถม              */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X19;K"  '"'  wdetail.freecomp     '"' SKIP.   /*พรบ.   แถม/ไม่แถม              */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X20;K"  '"'  wdetail.comdat       '"' SKIP.   /*วันเริ่มคุ้มครอง               */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X21;K"  '"'  wdetail.expdat       '"' SKIP.   /*วันสิ้นสุดความคุ้มครอง         */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X22;K"  '"'  wdetail.ispno        '"' SKIP.   /*เลขตรวจสภาพ                    */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X23;K"  '"'  wdetail.pol70        '"' SKIP.   /*เลขกรมธรรม์70                  */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X24;K"  '"'  wdetail.pol72        '"' SKIP.   /*เลขกรมธรรม์72                  */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X25;K"  '"'  wdetail.n_TITLE      '"' SKIP.   /*คำนำหน้าชื่อ                   */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X26;K"  '"'  wdetail.n_name1      '"' SKIP.   /*ชื่อผู้เอาประกัน               */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X27;K"  '"'  wdetail.idno         '"' SKIP.   /*เลขที่บัตรประชาชน              */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X28;K"  '"'  wdetail.birthday     '"' SKIP.   /*วันเกิด                        */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X29;K"  '"'  wdetail.birthdayexp  '"' SKIP.   /*วันที่บัตรหมดอายุ              */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X30;K"  '"'  wdetail.occup        '"' SKIP.   /*อาชีพ                          */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X31;K"  '"'  wdetail.namedirect   '"' SKIP.   /*ชื่อกรรมการ                    */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X32;K"  '"'  wdetail.ADD_1        '"' SKIP.   /*บ้านเลขที่                     */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X33;K"  '"'  wdetail.ADD_2        '"' SKIP.   /*ตำบล/แขวง                      */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X34;K"  '"'  wdetail.ADD_3        '"' SKIP.   /*อำเภอ/เขต                      */  
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X35;K"  '"'  wdetail.ADD_4        '"' SKIP.   /*จังหวัด                        */  
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X36;K"  '"'  wdetail.ADD_5        '"' SKIP.   /*รหัสไปรษณีย์                   */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X37;K"  '"'  wdetail.tel          '"' SKIP.   /*เบอร์โทรศัพท์                  */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X38;K"  '"'  wdetail.typ_driv     '"' SKIP.   /*ระบุผู้ขับขี่/ไม่ระบุผู้ขับขี่ */             
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X39;K"  '"'  wdetail.drivname1    '"' SKIP.   /*ผู้ขับขี่คนที่1                */                         
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X40;K"  '"'  wdetail.sex1         '"' SKIP.   /*เพศ                            */                       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X41;K"  '"'  wdetail.birthdriv1   '"' SKIP.   /*วันเกิด                        */                   
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X42;K"  '"'  wdetail.occup1       '"' SKIP.   /*อาชัพ                          */        
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X43;K"  '"'  wdetail.drivno1      '"' SKIP.   /*เลขที่ใบขับขี่                 */             
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X44;K"  '"'  wdetail.drivname2    '"' SKIP.   /*ผู้ขับขี่คนที่1                */          
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X45;K"  '"'  wdetail.sex2         '"' SKIP.   /*เพศ                            */           
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X46;K"  '"'  wdetail.birthdriv2   '"' SKIP.   /*วันเกิด                        */                             
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X47;K"  '"'  wdetail.occup2       '"' SKIP.   /*อาชัพ                          */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X48;K"  '"'  wdetail.drivno2      '"' SKIP.   /*เลขที่ใบขับขี่                 */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X49;K"  '"'  wdetail.redbook      '"' SKIP .  /*Redbook                        */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X50;K"  '"'  wdetail.brand        '"' SKIP.   /*ชื่อยี่ห้อรถ                   */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X51;K"  '"'  wdetail.model        '"' SKIP.   /*รุ่นรถ                         */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X52;K"  '"'  wdetail.engine       '"' SKIP.   /*เลขเครื่องยนต์                 */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X53;K"  '"'  wdetail.chassis      '"' SKIP.   /*เลขตัวถัง                      */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X54;K"  '"'  wdetail.power        '"' SKIP.   /*ซีซี                           */        
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X55;K"  '"'  wdetail.cyear        '"' SKIP.   /*ปีรถยนต์                       */  
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X56;K"  '"'  wdetail.licence      '"' SKIP.   /*เลขทะเบียน                     */  
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X57;K"  '"'  wdetail.provin       '"' SKIP.   /*จังหวัดที่จดทะเบียน            */  
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X58;K"  '"'  wdetail.subclass     '"' SKIP.   /*แพคเกจ                         */  
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X59;K"  '"'  wdetail.garage       '"' SKIP.   /*การซ่อม                        */  
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X60;K"  '"'  wdetail.ins_amt1     '"' SKIP.   /*ทุนประกัน                      */  
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X61;K"  '"'  wdetail.fi           '"' SKIP.   /*ทุนสูญหาย ไฟไหม้               */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X62;K"  '"'  wdetail.prem1        '"' SKIP.   /*เบี้ยสุทธิ                     */  
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X63;K"  '"'  wdetail.prem2        '"' SKIP.   /*เบี้ยประกัน                    */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X64;K"  '"'  wdetail.comprem      '"' SKIP.   /*เบี้ยพรบ.                      */       
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X65;K"  '"'  wdetail.prem3        '"' SKIP.   /*เบี้ยรวม                       */        
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X66;K"  '"'  wdetail.deduct       '"' SKIP.   /*DEDUCT OD                      */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X67;K"  '"'  wdetail.sck          '"' SKIP.   /*เลขสติ๊กเกอร์                  */  
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X68;K"  '"'  wdetail.ref          '"' SKIP.   /*เลขReferance no.               */  
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X69;K"  '"'  wdetail.recivename   '"' SKIP.   /*ออกใบเสร็จในนาม                */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X70;K"  '"'  wdetail.vatcode      '"' SKIP.   /*Vatcode                        */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X71;K"  '"'  wdetail.notiuser     '"' SKIP.   /*ผู้รับแจ้ง                     */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X72;K"  '"'  wdetail.notbr        '"' SKIP.   /*สาขาที่แจ้ง                    */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X73;K"  '"'  wdetail.bennam       '"' SKIP.   /*ผู้รับผลประโยชน์               */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X74;K"  '"'  wdetail.remak1       '"' SKIP.   /*หมายเหตุ 1                     */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X75;K"  '"'  wdetail.remak2       '"' SKIP.   /*หมายเหตุ 2                     */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X76;K"  '"'  wdetail.other1       '"' SKIP.   /*อุปกรณ์เสริม 1                 */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X77;K"  '"'  wdetail.other2       '"' SKIP.   /*ราคา                           */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X78;K"  '"'  wdetail.other3       '"' SKIP.   /*อุปกรณ์เสริม 2                 */ 
    ...
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X81;K"  '"'  wdetail.ispstatus    '"' SKIP.   /*Ststus เลขตรวจสภาพ             */ 
    ...
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X88;K"  '"'  wdetail.docno        '"' SKIP.   /*เลขที่เอกสาร                   */ 
    PUT STREAM ns2 "C;Y" STRING(nv_row) ";X89;K"  '"'  wdetail.reinsp       '"' SKIP.   /*ผลการตรวจสภาพ                  */ 
