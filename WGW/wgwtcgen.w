...
/*Modify by   : Kridtiya i. A54-0141 ปรับคำนำหน้านามให้เช็คกับโปรแกรม settitle date 24/05/2011 */
/*Modify by   : Kridtiya i. A54-0184 ปรับการแสดงที่อยู่ */
/*Modify by   : Kridtiya i. A55-0267 ปรับการค้นหาเลขที่สัญญา */
...
/*modify by   : Kridtiya i. A56-0104 ปรับการรับค่าคลาสรถ70 /72 ตามพารามิเตอร์*/
/*modify by   : Kridtiya i. A56-0146 เพิ่มการรับค่าชื่อผู้ขับขี่             */
/*modify by   : Kridtiya i. A56-0323 เพิ่มการเช็คสาขาเป็นค่าว่าง             */
...
/*Modify By   : Ranu I. A60-0095 24/02/2017 เพิ่มเงื่อนไขการเช็คทะเบียนเพิ่ม */
/*Modify By   : Ranu I. A60-0206 05/05/2017 เพิ่มการเก็บข้อมูล field uwm301.drinam[1] */
/*Modify By   : Ranu I. A60-0225 05/05/2017 เพิ่มเงื่อนไข CCTV และ โค้ด A0M1046 */
/*Modify by   : Ranu I. A60-0405 22/09/2017  เพิ่มเงื่อนไขการเช็คเลขบัตรประชาชน 13 หลัก */
/*Modify by   : Ranu I. A61-0045 30/01/2018  แก้ไขการดึงความคุ้มครองงานต่ออายุ pack O */
/*Modify By   : Ranu I. A61-0313 29/06/2018 แก้ไข Agent code ต่ออายุ และ Mazda MPI */
/*Modify By   : Ranu I. A61-0410 28/08/2018 แก้ไข งานมาสด้าต่ออายุ MPI เพิ่ม MN30 คุ้มครองภัยก่อการร้าย */
/*Modify By : Porntiwa T. A62-0105  Date : 18/07/2019 Change Host => TMSth*/
/*Modify By : Ranu I. A62-0386 28/08/2019 แก้ไข Producer งาน MPI */
/*Modify by : Ranu I. A63-0122 แก้ไข Pack T ใช้ความคุ้มครองตามแคมเปญเดิม  
              กรมธรรม์ต่ออายุยึดน้ำหนักรถตามไฟล์โหลด */
/*modify by : Sarinya C. A63-0210 เปลี่ยนแปลง Layout Text โดยเพิ่ม field  ต่อท้ายจากเดิม  */
/*Modify by   : Kridtiya i. A63-0472 Date. 09/11/2020 add field firstname ,lastname.....*/
/*Modify by : Ranu I. A64-0092 date.04/03/2021 แก้ไขการใส่อุปกรณ์เสริม */
...
/*Modify by : Kridtiya i. A66-0160 Date. 15/08/2023 assign campaign = Producer             */ 
...
DEF VAR nv_drivname AS CHAR FORMAT "x(150)" INIT "" . /*A67-0114*/
DEF VAR n_dealer AS CHAR FORMAT "x(10)" INIT "" . /*A67-0114*/
DEFINE var  nr_hp        AS DECI FORMAT ">>>>9.99".         /*A67-0114*/
def    var  nr_maksi     AS DECI FORMAT ">>,>>>,>>9.99-" . /*A67-0114*/ 
def    var  nr_eng_no2   AS CHAR FORMAT "x(50)" INIT "" .  /*A67-0114*/
...
DEFINE FRAME fr_main
     br_protis AT ROW 3.76 COL 98.33
     ...
     buok AT ROW 10.48 COL 96.67
     bu_exit AT ROW 12.57 COL 96.83
     ...
     "   Total Net Premium  :" VIEW-AS TEXT
          ...
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "    IMPORT TEXT FILE MOTOR [TISCO-ป้ายแดง/ต่ออายุ ]" VIEW-AS TEXT
...
DEFINE FRAME fr_main
     ...
     "28/08/2024":60 VIEW-AS TEXT
          SIZE 19 BY 1.05 AT ROW 15.05 COL 95.5 WIDGET-ID 6
          BGCOLOR 8 FGCOLOR 1 FONT 6
     ...
     RECT-377 AT ROW 10 COL 95
     RECT-378 AT ROW 12.1 COL 95.17
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 132.5 BY 24.05
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW c-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Load Text file TISCO - ป้ายแดง/ต่ออายุ"
         HEIGHT             = 24.05
         WIDTH              = 132.5
         MAX-HEIGHT         = 36.57
         MAX-WIDTH          = 170.67
...
ON END-ERROR OF c-Win /* Load Text file TISCO - ป้ายแดง/ต่ออายุ */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-Win c-Win
ON WINDOW-CLOSE OF c-Win /* Load Text file TISCO - ป้ายแดง/ต่ออายุ */
DO:
...
/********************  T I T L E   F O R  C - W I N  ****************/
  ...
  gv_prgid = "Wgwtcgen".
  gv_prog  = "Load Text & Generate TISCO [ป้ายแดง/ต่ออายุ]".
  fi_loaddat = TODAY.
  DISP fi_loaddat WITH FRAME fr_main.
  ...
  ASSIGN
      ...
      /*fi_agent     = "B3M0002"*/ /*A61-0313**/
      /*fi_agent     = "B3M0035" /*A61-0313*/*//*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/ 
      fi_agent     = "B3MLTIS100" /*A61-0313*/    /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/ 
      fi_bchyr     = YEAR(TODAY)
      ...
      fi_textf17   = "TISCO_F7"
      fi_camp      = "PACK_TISCO"
      /*fi_producerF = "B3M0032"*/      /*A60-0225*/
      /*fi_textf17   = "คุ้มครองการโจรกรรมทรัพย์สินส่วนบุคคลภายในรถ มูลค่าไม่เกิน 20,000 บาท"*/ /*A60-0225*/
      fi_process   = "Load Text File TISCO [งานป้ายแดง...]" .
      RUN proc_protis. /*a60-0095*/
  DISP fi_pack    fi_chkpro fi_branch  fi_producer  fi_producer2 fi_agent    fi_bchyr    fi_process  
       /*fi_product fi_prom A60-0095*/   fi_compa   fi_textf17 fi_camp   /*fi_producerF*/ /*fi_chkpro2  fi_product2 fi_prom2  A60-0095*/  
       br_protis /*A60-0095*/
       WITH FRAME fr_main.
/*********************************************************************/  
...
DO:
    ...
    REPEAT:
        ...
        IMPORT DELIMITER "|" 
            ...
            wdetail2.vehreg        /*  11  licence no  ษฐ 5774 */                                         
            ...
            wdetail2.name_insur    /*  19  ชื่อเจ้าหน้าที่ประกัน   3250500043445   */                     
            wdetail2.not_office    /*  20  รหัสเจ้าหน้าที่แจ้งประกัน   ORANONG POLSUK TEL.0-2633-5469  */ 
            wdetail2.entdat        /*  21  วันที่แจ้งประกัน    22/06/12    */                             
            wdetail2.enttim        /*  22  เวลาแจ้งประกัน  10:58:23    */                                 
            wdetail2.not_code      /*  23  รหัสแจ้งงาน     */                                             
            ...
            wdetail2.addr1         /*  28  address1    9/40 หมู่ที่ 2 ถนนเลียบคลอง 3   */                 
            /*wdetail2.addr2         /*  28  address1    9/40 หมู่ที่ 2 ถนนเลียบคลอง 3   */                 */
            wdetail2.tambon        /*  29  address2    ต.บึงยี่โถ  */                                     
            wdetail2.amper         /*  30  address3    อ.ธัญบุรี   */                                     
            wdetail2.country       /*  31  address4    จ.ปทุมธานี 12130    */                             
            wdetail2.tiname        /*  32  title name      นาง */                                         
            wdetail2.insnam        /*  33  first name  นิธินาถ ทองนุช  */                                 
            /*wdetail2.lastname    */
            wdetail2.benname       /*  34  beneficiary     ระบุ 8.3 ธนาคารทิสโก้ จำกัด (มหาชน) */         
            ...
            wdetail2.receipt_name  /*  41  receipt name    นาง นิธินาถ ทองนุช  */                         
            wdetail2.agenttis      /*  42  agent code  TISCO   */                                         
            wdetail2.prev_insur    /*  43  บริษัทประกันภัยเดิม     KRUNGTHAI PANICH INSURANCE CO.,LTD. */ 
    ...
    FOR EACH wdetail2   NO-LOCK.
        ...
        IF NOT AVAIL wdetail THEN DO:
            ...
            ASSIGN 
                ...
                wdetail.deler       =   IF INDEX(wdetail2.policyno,",") <> 0 THEN 
                                        SUBSTR(wdetail2.policyno,INDEX(wdetail2.policyno,",") + 1 )
                                        ELSE ""
                wdetail.caryear     =   trim(wdetail2.caryear)    
                wdetail.eng         =   trim(wdetail2.eng)        
                wdetail.chasno      =   trim(wdetail2.chasno)  
                ...
                /*wdetail.name_insur =   trim(wdetail2.name_insur)  */
                wdetail.not_office  =  "ชื่อผู้แจ้ง:" + trim(wdetail2.not_office) +  " รหัสผู้แจ้ง:" + trim(wdetail2.name_insur)  
                ...
                wdetail.subclass    =   IF wdetail2.prempa = "" THEN ""
                                        ...
                                        ELSE IF substr(wdetail2.policyno,3,2) = "70" THEN trim(SUBSTR(wdetail2.prempa,2))
                                        ELSE trim(SUBSTR(wdetail2.prempa,2)).
             ASSIGN  
                ...
                wdetail.n_IMPORT    = "IM"
                wdetail.n_EXPORT    = "" 
                wdetail.acc        = TRIM(wdetail2.acc)       /*Str A63-0210 */                        
            ...
            /*IF trim(wdetail.prempa) = "O"  THEN DO:*/
                ...
                IF AVAIL brstat.insure THEN DO:
                    ...
                    ASSIGN wdetail.tp1   =  brstat.insure.lname  
                           ...
                           wdetail.no_41 =  deci(brstat.insure.addr3)
                           wdetail.no_42 =  deci(brstat.insure.addr4)
                           wdetail.no_43 =  deci(brstat.insure.telno).
                           */
                END.
            /*END.*/
            /*-----end : A61-0045----*/
...
IF NOT AVAILABLE uwm130 THEN 
    ...
    IF avail stat.clastab_fil Then do: 
        IF wdetail.prempa = "z" OR wdetail.prepol <> "" THEN DO:
        ...
        ELSE DO:
            ...
            ASSIGN
                ...
                nv_seat41              = IF wdetail.seat41 = 0 THEN INTEGER(wdetail.seat) ELSE wdetail.seat41 .
...
ASSIGN 
    ...
    sic_bran.uwm301.mv41seat = IF nv_seat41 <> 0 THEN nv_seat41 ELSE IF INT(wdetail.seat41) <> 0 THEN INT(wdetail.seat41) ELSE INTEGER(wdetail.seat) /* A65-0035 */
...
/* Start A63-0210 */
/* comment by : A64-0092  อุปกรณ์เสริมงาน Ford เท่านั้น ...
IF INDEX(wdetail.remark,"FE2+") <> 0 THEN DO: 
    ASSIGN 
        SUBSTRING(sic_bran.uwm301.prmtxt,1,60)   =  "MT001_PB คุ้มครองการประกันภัยโจรกรรมทรัพย์สินส่วนบุคคล"
        SUBSTRING(sic_bran.uwm301.prmtxt,61,60)  =  "ที่อยู่ภายในรถยนต์ 20,000 บาท" 
        SUBSTRING(sic_bran.uwm301.prmtxt,121,60) =  "MT002_FL คุ้มครองการประกันภัยคุ้มครองภัยน้ำท่วมตามทุนประกัน"
        SUBSTRING(sic_bran.uwm301.prmtxt,181,60) =  "Campaign: C63/00116 (ป.2+)" 
        SUBSTRING(sic_bran.uwm301.prmtxt,241,60) =  SUBSTRING(wdetail.acc,1,60) 
        SUBSTRING(sic_bran.uwm301.prmtxt,301,60) =  SUBSTRING(wdetail.acc,61,60).
...
IF wdetail.acc <> "" THEN DO:
 ASSIGN 
     /*SUBSTRING(sic_bran.uwm301.prmtxt,1,60)   =  "อุปกรณ์ตกแต่งเพิ่มเติมไม่เกิน 20,000 บาท"*/ /*A64-0092*/
...
ELSE DO:
   ...
   IF INDEX(wdetail.brand," ") <> 0 THEN  DO:
    ...
    ELSE IF INDEX(wdetail.model,"cab") <> 0 THEN wdetail.model = "D-Max".
...
ELSE ASSIGN nclass_red = wdetail.subclass . /*a65-0035*/
/* Add by : A65-0035*/
IF wdetail.redbook <> "" THEN DO:
...
ELSE DO:
    ...
    ELSE DO:
        ...
        If  avail stat.maktab_fil  Then 
            ...
            /*wdetail.weight   =  string(stat.maktab_fil.tons)*/ /*A65-0035*/
            wdetail.weight   =  IF deci(wdetail.weight) <>  0 THEN wdetail.weight ELSE string(stat.maktab_fil.tons) /*A65-0035*/
            wdetail.cargrp   =  stat.maktab_fil.prmpac
            wdetail.seat     =  IF wdetail.seat = 0 THEN stat.maktab_fil.seats ELSE wdetail.seat  . /*A65-0035*/ 
    END.
...
ELSE nv_newsck = wdetail.stk.
     ...
     Assign sic_bran.uwm301.policy  = sic_bran.uwm120.policy                   
         ...
         sic_bran.uwm301.vehgrp     = wdetail.cargrp
         sic_bran.uwm301.seats      = INTEGER(wdetail.seat)
         sic_bran.uwm301.mv41seat   = IF INTEGER(wdetail.seat41) <> 0 THEN INT(wdetail.seat41) ELSE INT(wdetail.seat)  /*A65-0035*/
        ...
        IF NOT AVAIL wdetail THEN DO:
            ...
            ASSIGN 
             ...
             ASSIGN                 
                ...
                wdetail.bev         =   IF trim(wdetail2.bev) = "" THEN "N" ELSE trim(wdetail2.bev)          
                ...
                ELSE IF INDEX(wdetail.benname,"ไม่") <> 0 THEN wdetail.benname = "".
                ELSE DO: 
                    IF      index(wdetail.benname,"ระบุ 8.3") <> 0 THEN ASSIGN wdetail.benname = trim(REPLACE(wdetail.benname,"ระบุ 8.3","")). 
                    ELSE IF index(wdetail.benname,"ระบุ8.3")  <> 0 THEN ASSIGN wdetail.benname = trim(REPLACE(wdetail.benname,"ระบุ8.3","")).
                    ELSE ASSIGN wdetail.benname = wdetail.benname.
                END.
                /*-- end : A60-0225--*/
                IF TRIM(wdetail.bev) = "N" OR TRIM(wdetail.bev) = " " THEN DO: /*A67-0114 */
                    FIND LAST brstat.insure WHERE brstat.insure.insno = TRIM(fi_camp) AND 
                                                  brstat.insure.text3 = TRIM(wdetail.prempa) NO-LOCK NO-ERROR NO-WAIT .
                    IF AVAIL brstat.insure THEN DO:
                        ASSIGN 
...
FOR EACH wdetail WHERE wdetail.policy  NE " "  .
   ...
   /*A54-0141 */
    ...
    IF wdetail.tiname = "คุณ"   THEN DO:
        ...
        IF wdetail.receipt_name <> "" THEN DO: 
            IF INDEX(wdetail.receipt_name,trim(wdetail.insnam)) = 0 THEN
                wdetail.receipt_name = "และ/หรือ " + wdetail.receipt_name.
    ...
    ELSE IF LENGTH(trim(wdetail.re_country)) <> 2 THEN DO:  /*--A60-0095--*/
        ...
        IF AVAIL brstat.insure THEN DO:
            ...
            /*wdetail.vehreg = trim(substr(wdetail.vehreg,1,7) + " " + trim(wdetail.re_country)) . /*a54-0112*/
    ...
    /*comment by Kridtiya i. A55-0184....
    ASSIGN 
        wdetail.add1_70 = TRIM(wdetail.add1_70)  + " " + TRIM(wdetail.add2_70)
            n_char = wdetail.add1_70.
        ...
        ASSIGN 
            ...
            wdetail.tambon  =  substr(n_char,ind1,( ind2 - ind1)) 
            wdetail.amper   =  substr(n_char,ind2,( ind3 - ind2)) 
            wdetail.country =  substr(n_char,ind3) . 
        IF LENGTH(wdetail.addr1) > 30 THEN DO:  
            IF INDEX(wdetail.addr1,"ถนน") <> 0 THEN
                ASSIGN ind4   = INDEX(wdetail.addr1,"ถนน")  +  3
                wdetail.tambon  =  substr(wdetail.addr1,ind4,LENGTH(wdetail.addr1))  + " " + wdetail.tambon .
            
        END.*/
        /*IF (SUBSTR(wdetail.policy,2,1) >= "A") AND (SUBSTR(wdetail.policy,2,1) <= "Z")  THEN
            wdetail.n_branch = SUBSTR(wdetail.policy,2,1) .   /*brach 1 หลัก*/
        ELSE wdetail.n_branch = SUBSTR(wdetail.policy,1,2) .  /*brach 2 หลัก*/
        end...comment by Kridtiya i. A55-0184...*/
    /*Add Kridtiya i. A55-0184...*/
    ...
    IF INDEX(wdetail.addr1,fi_compa) <> 0 THEN DO:
        ...
        ELSE wdetail.addr1 = "".
        IF INDEX(wdetail.addr1,"กรุงเทพ") <> 0 THEN  /*ถนนสาทรเหนือ แขวงสีลม เขตบางรัก กรุงเทพฯ 10500  */    
            ASSIGN wdetail.country = SUBSTR(wdetail.addr1,INDEX(wdetail.addr1,"กรุงเทพ"))
            wdetail.addr1          = SUBSTR(wdetail.addr1,1,INDEX(wdetail.addr1,"กรุงเทพ") - 1)   .
        IF INDEX(wdetail.addr1,"เขต") <> 0 THEN
            ASSIGN wdetail.amper   = SUBSTR(wdetail.addr1,INDEX(wdetail.addr1,"เขต"))
            wdetail.addr1          = SUBSTR(wdetail.addr1,1,INDEX(wdetail.addr1,"เขต") - 1)   .
        IF INDEX(wdetail.addr1,"แขวง") <> 0 THEN
            ASSIGN wdetail.tambon   = SUBSTR(wdetail.addr1,INDEX(wdetail.addr1,"แขวง"))
            wdetail.addr1          = SUBSTR(wdetail.addr1,1,INDEX(wdetail.addr1,"แขวง") - 1)   .
    END.
    /*ELSE IF LENGTH(wdetail.addr1) > 35 THEN DO:  /*moo soy road*/*/ /* A67-0114*/
    ELSE IF LENGTH(wdetail.addr1) > 45 THEN DO:  /*moo soy road*/ /* A67-0114*/
        /*road */
        IF INDEX(wdetail.addr1,"ถนน") <> 0  THEN DO:
        ...
        END.      /*end  road..*/
        ELSE IF INDEX(wdetail.addr1,"ถ.") <> 0  THEN DO:
        ...
        ELSE IF INDEX(wdetail.addr1,"ซอย") <> 0 THEN  
            ASSIGN 
            wdetail.soy     = TRIM(SUBSTR(wdetail.addr1,r-INDEX(wdetail.addr1,"ซอย")))
            wdetail.addr1   = TRIM(SUBSTR(wdetail.addr1,1,r-INDEX(wdetail.addr1,"ซอย") - 1 ))
            wdetail.tambon  = TRIM(wdetail.soy) + " " + TRIM(wdetail.tambon) .
            /*wdetail.amper   = wdetail.amper  + " " + wdetail.country*/ /*A64-0138*/
            /*wdetail.country = "" .                                  */ /*A64-0138*/
        ELSE IF R-INDEX(wdetail.addr1,"หมู่") <> 0  THEN
            ASSIGN  wdetail.moo     = TRIM(SUBSTR(wdetail.addr1,R-INDEX(wdetail.addr1,"หมู่")))
                   ...
                   /* wdetail.amper   = wdetail.amper + " " + wdetail.country */ /*A64-0138*/
                   /* wdetail.country = "" .                                  */ /*A64-0138*/
        ELSE IF R-INDEX(wdetail.addr1,"บมจ.") <> 0  THEN DO:
            ASSIGN  
                wdetail.moo     = Trim(SUBSTR(wdetail.addr1,R-INDEX(wdetail.addr1,"บมจ.")))
                wdetail.addr1   = TRIM(SUBSTR(wdetail.addr1,1,R-INDEX(wdetail.addr1,"บมจ.") - 1 )).
            /*IF LENGTH(wdetail.moo + " " + wdetail.tambon) <= 35 THEN*/ /*A67-0114*/
            IF LENGTH(wdetail.moo + " " + wdetail.tambon) <= 45 THEN  /*A67-0114*/
                ASSIGN 
                wdetail.tambon  = TRIM(wdetail.moo)   + " " + TRIM(wdetail.tambon) . 
                /* wdetail.amper   = wdetail.amper + " " + wdetail.country */ /*A64-0138*/
                /* wdetail.country = "" .                                  */ /*A64-0138*/
             /*ELSE IF LENGTH(wdetail.moo) > 35 THEN DO:*/  /*A67-0114*/
            ELSE IF LENGTH(wdetail.moo) > 45 THEN DO:      /*A67-0114*/
                IF R-INDEX(wdetail.moo,"ชั้น") <> 0  THEN  
                    ASSIGN 
                    wdetail.amper  = trim(SUBSTR(wdetail.moo,R-INDEX(wdetail.moo,"ชั้น"))) 
                                     + " " + trim(wdetail.tambon) 
                                     + " " + trim(wdetail.amper) 
                    wdetail.tambon = TRIM(SUBSTR(wdetail.moo,1,R-INDEX(wdetail.moo,"ชั้น") - 1 )).
            END.
        END.
       /* add by : A63-0138 */
         /*IF LENGTH(wdetail.amper) > 35 THEN DO:*/ /*A67-0114*/
        IF LENGTH(wdetail.amper) > 45 THEN DO:  /*A67-0114*/
          wdetail.amper = trim(wdetail.amper) + " " + trim(wdetail.country) .
          IF r-INDEX(wdetail.amper,"จ.") <> 0 THEN
              ASSIGN 
              wdetail.country = TRIM(SUBSTR(wdetail.amper,r-INDEX(wdetail.amper,"จ.")))
              wdetail.amper   = TRIM(SUBSTR(wdetail.amper,1,r-INDEX(wdetail.amper,"จ.") - 1)).
          ELSE IF r-INDEX(wdetail.amper,"จังหวัด") <> 0 THEN 
              ASSIGN 
              wdetail.country = TRIM(SUBSTR(wdetail.amper,r-INDEX(wdetail.amper,"จังหวัด")))
              wdetail.amper   = TRIM(SUBSTR(wdetail.amper,1,r-INDEX(wdetail.amper,"จังหวัด") - 1)).
          ELSE IF r-INDEX(wdetail.amper,"เขต") <> 0 THEN
              ASSIGN 
          ...
          /*IF LENGTH(wdetail.amper) > 35 THEN ASSIGN wdetail.amper = TRIM(REPLACE(wdetail.amper," ","")) .*/ /*A67-0114*/
          IF LENGTH(wdetail.amper) > 45 THEN ASSIGN wdetail.amper = TRIM(REPLACE(wdetail.amper," ","")) . /*A67-0114*/
        END.
        /*...end A14-0138..*/
    END.
   ...
   IF wdetail.redbook = ""  THEN DO:
       ...
       IF wdetail.bev = "N"  THEN DO: /*A67-0114*/
   ...
   END.
    IF wdetail.br_insured <> "" THEN DO:  /*A66-0160*/
        wdetail.br_insured = trim(REPLACE(wdetail.br_insured,"สาขาที่","")).  /*A66-0160*/
        IF index(wdetail.br_insured,"สำนักงานใหญ่") <> 0 THEN wdetail.br_insured = "00000".  /*A66-0160*/
    END.
END. 
END PROCEDURE.
...
IF      R-INDEX(nv_address,"จ.") <> 0 AND R-INDEX(nv_address,"บมจ.") = 0 /*A65-0035*/ 
                                            THEN ASSIGN np_mail_country = trim(SUBSTR(nv_address,R-INDEX(nv_address,"จ.")         + 2 )) 
...
IF  CONNECTED("sic_exp") THEN DO:
    RUN wgw\wgwtcex1
                 (INPUT-OUTPUT wdetail.prepol,   /*n_prepol  */ 
                  ...
                  INPUT-OUTPUT n_dealer  , /*A67-0114*/
                  ...
                  INPUT-OUTPUT nr_premtxt,
                  INPUT-OUTPUT nre_premt,      /* f6 access renew */
                  input-output nr_hp     ,    /*A67-0114*/
                  input-output nr_maksi  ,    /*A67-0114*/
                  input-output wdetail.engno2, /*A67-0114*/
                  INPUT-OUTPUT wdetail.battyr ).   /*A67-0114*/
...
IF wdetail.poltyp = "v70" THEN DO:
   ...
   /*-------nv_baseprm----------*/
    ...
    IF wdetail.prepol <> "" THEN DO: 
        /*ASSIGN nv_41 = n_41*/ /*A61-0045*/      /*ต่ออายุ*/          
        /*nv_42 = n_42       */ /*A61-0045*/                    
        /*nv_43 = n_43       */ /*A61-0045*/ 
        ASSIGN nv_41 = wdetail.no_41     /*A61-0045*/      /*ต่ออายุ*/          
    ...
    END.
    ELSE IF wdetail.prempa = "T" THEN DO:
        ASSIGN 
...
IF wdetail.poltyp = "v70" THEN DO:
    ...
    */
    ...
    ASSIGN  nv_prem1   = nv_baseprm
        ...
        SUBSTRING(nv_basevar,31,30)  = nv_basevar2.
    /*-------nv_add perils----------*/
    IF wdetail.prepol <> "" THEN   /*ต่ออายุ*/
...
IF wdetail.poltyp = "V70" THEN DO:
    ...
    ASSIGN               
       ...
       /*nv_supe    = NO*/                                              
         ...
         nv_dedod   = DOD1       
         nv_addod   = DOD2                                
         /*nv_dedpd   = DPD0   */ /* ranu : 09/11/2022 */  
         nv_dedpd   = DOD0       /* ranu : 09/11/2022 */   
         nv_ncbp    = deci(wdetail.ncb)                                     
         nv_fletp   = deci(wdetail.fleet)                                  
         nv_dspcp   = nv_dss_per                                      
         nv_dstfp   = 0                                                     
         nv_clmp    = nv_cl_per  
         nv_netprem  = IF wdetail.prepol <> "" THEN deci(wdetail.premt) ELSE TRUNCATE(((deci(wdetail.premt) * 100 ) / 107.43 ),0 ) + 
                        (IF ((deci(wdetail.premt) * 100) / 107.43) - TRUNCATE(((deci(wdetail.premt) * 100 ) / 107.43 ),0 ) > 0 THEN 1 ELSE 0 ) /*A65-0035*/
    ...
    IF wdetail.redbook = ""  THEN DO:
        ...
        IF wdetail.redbook <> ""  THEN DO:
            ...
            If  avail  stat.maktab_fil  Then 
                ...
                wdetail.body           =  stat.maktab_fil.body.  /*A65-0035*/
        END.
        ELSE DO:
            ASSIGN
...
/* Add by : A64-0138 */ 
 ...
 END.*/
    /*
 IF wdetail.typrequest <> "" THEN DO:
     FIND LAST sicsyac.xmm600 USE-INDEX xmm60001 WHERE sicsyac.xmm600.acno = TRIM(wdetail.typrequest) NO-LOCK NO-ERROR.
     IF NOT AVAIL sicsyac.xmm600 THEN 
         ASSIGN wdetail.comment = wdetail.comment + "| Not found Code Vat " + wdetail.typrequest + "(xmm600)" 
            wdetail.pass    = "N" 
            wdetail.OK_GEN  = "N".
     ELSE DO:
         IF sicsyac.xmm600.closed <> ? AND sicsyac.xmm600.closed < TODAY THEN
         ASSIGN wdetail.comment = wdetail.comment + "| Code VAT " + wdetail.typrequest + " Closed Date: " + STRING(sicsyac.xmm600.closed,"99/99/9999") 
             wdetail.pass    = "N" 
             wdetail.OK_GEN  = "N".
    END.
 END.
...
IF wdetail.redbook <> "" THEN DO:
    ...
    If  avail stat.maktab_fil  Then  
        ASSIGN  nv_modcod   =  stat.maktab_fil.modcod 
           ...
           /*wdetail.brand  =  stat.maktab_fil.makdes  
           wdetail.model    =  stat.maktab_fil.moddes*/
           wdetail.cargrp   =  stat.maktab_fil.prmpac        /*A65-0035*/
           wdetail.weight   =  string(stat.maktab_fil.tons)  /*A65-0035*/
           wdetail.seat     =  IF wdetail.seat = 0 THEN stat.maktab_fil.seats  ELSE wdetail.seat /*A65-0035*/
           nv_si            = maktab_fil.si   .
    IF nv_modcod = "" THEN DO: /*A65-0035*/
       IF n_rencnt > 0 THEN DO: /*A65-0035*/
        FIND FIRST stat.maktab_fil USE-INDEX maktab01  WHERE 
            stat.maktab_fil.modcod = wdetail.redbook   No-lock no-error no-wait.
         If  avail stat.maktab_fil  THEN
             ASSIGN  nv_modcod    =  stat.maktab_fil.modcod 
...
IF nv_modcod = " " THEN DO:
    ...
    IF      INDEX(wdetail.model,"vigo")   <> 0 THEN /*wdetail.model = --A65-0035--*/  n_model = "vigo".
    ELSE IF INDEX(wdetail.model,"soluna") <> 0 THEN /*wdetail.model = --A65-0035--*/  n_model = "vios".
    ELSE IF INDEX(wdetail.model,"altis")  <> 0 THEN /*wdetail.model = --A65-0035--*/  n_model = "altis".
    ELSE IF INDEX(wdetail.model,"cab4")   <> 0 THEN  n_model = "D-Max". /*A65-0035*/
    ELSE IF INDEX(wdetail.model,"SPACECAB") <> 0 THEN  n_model = "D-Max". /*A65-0035*/
    ELSE IF INDEX(wdetail.model," ")    <> 0 THEN 
        ASSIGN n_model = trim(SUBSTR(wdetail.model,1,R-INDEX(wdetail.model," ") - 1 )).     /*A65-0035*/
        /*ASSIGN wdetail.model = SUBSTR(wdetail.model,1,INDEX(wdetail.model," ") - 1 ).*/  /*A65-0035*/
    FIND FIRST stat.makdes31 USE-INDEX makdes31    WHERE 
    ...
    IF (wdetail.covcod = "3") OR (wdetail.covcod = "2") THEN DO:
        IF (Integer(wdetail.engcc) = 0 )  THEN DO:
            Find First stat.maktab_fil USE-INDEX maktab04         Where
                stat.maktab_fil.makdes   = wdetail.brand            And                  
                /*index(stat.maktab_fil.moddes,wdetail.model) <> 0    And*//*A65-0035*/
                index(stat.maktab_fil.moddes,n_model) <> 0    AND  /*A65-0035*/
                stat.maktab_fil.makyea   = Integer(wdetail.caryear) AND 
                /*stat.maktab_fil.engine   <=    Integer(wdetail.engcc)  AND*/
                stat.maktab_fil.sclass   =  wdetail.subclass        AND
                stat.maktab_fil.seats    =  INTEGER(wdetail.seat)   No-lock no-error no-wait.
...
FOR EACH wdetail :
    ...
    IF      wdetail.producer = "A0M2008"    THEN ASSIGN wdetail.producer  = "B3MLTIS101" wdetail.financecd = "FTIS"   wdetail.campaign_ov = "RENEW".  
    ...
    ELSE IF wdetail.producer = "A0M2010"    THEN ASSIGN wdetail.producer  = "B3MLTIS102" wdetail.financecd = "FTIS"   wdetail.campaign_ov = "RENEW". 
    ...
    ELSE IF wdetail.producer = "A0M2011"    THEN ASSIGN wdetail.producer  = "B3MLTIS103" wdetail.financecd = "FTIS"   wdetail.campaign_ov = "RENEW".   
    ...
    ELSE IF wdetail.producer = "A0M2012"    THEN ASSIGN wdetail.producer  = "B3MLTIS104" wdetail.financecd = "FTIS"   wdetail.campaign_ov = "RENEW".  
    ...
    ELSE IF wdetail.producer = "B3M0007"    THEN ASSIGN wdetail.producer  = "B3MLTIS202" wdetail.financecd = "FTISCO" wdetail.campaign_ov = "BTREDPLATE".   
    ...
    ELSE IF wdetail.producer = "B3M0028"    THEN ASSIGN wdetail.producer  = "B3MLTIS203" wdetail.financecd = "FTISCO" wdetail.campaign_ov = "BBREDPLATE".
    ...
    ELSE IF wdetail.producer = "A0M0013"    THEN ASSIGN wdetail.producer  = "B3MLTIS301" wdetail.financecd = "FHIWAY" wdetail.campaign_ov = "REDPLATE".     
    ELSE IF wdetail.producer = "A0M0013"    THEN ASSIGN wdetail.producer  = "B3MLTIS301" wdetail.financecd = "FHIWAY" wdetail.campaign_ov = "RENEW". 
    ELSE IF wdetail.producer = "B3MLTIS101" THEN ASSIGN wdetail.financecd = "FTIS"       wdetail.campaign_ov = "RENEW".  
    ELSE IF wdetail.producer = "B3MLTIS101" THEN ASSIGN wdetail.financecd = "FTIS"       wdetail.campaign_ov = "TRANSF".
    ELSE IF wdetail.producer = "B3MLTIS102" THEN ASSIGN wdetail.financecd = "FTIS"       wdetail.campaign_ov = "RENEW". 
    ELSE IF wdetail.producer = "B3MLTIS102" THEN ASSIGN wdetail.financecd = "FTIS"       wdetail.campaign_ov = "TRANSF".
    ELSE IF wdetail.producer = "B3MLTIS103" THEN ASSIGN wdetail.financecd = "FTIS"       wdetail.campaign_ov = "RENEW".   
    ELSE IF wdetail.producer = "B3MLTIS103" THEN ASSIGN wdetail.financecd = "FTIS"       wdetail.campaign_ov = "TRANSF".
    ELSE IF wdetail.producer = "B3MLTIS104" THEN ASSIGN wdetail.financecd = "FTIS"       wdetail.campaign_ov = "RENEW".  
    ...
    ELSE IF wdetail.producer = "B3MLTIS202" THEN ASSIGN wdetail.financecd = "FTISCO"     wdetail.campaign_ov = "BTREDPLATE".   
    ELSE IF wdetail.producer = "B3MLTIS202" THEN ASSIGN wdetail.financecd = "FTISCO"     wdetail.campaign_ov = "BTRENEW".
    ELSE IF wdetail.producer = "B3MLTIS203" THEN ASSIGN wdetail.financecd = "FTISCO"     wdetail.campaign_ov = "BBREDPLATE".
    ...
    ELSE IF wdetail.producer = "B3MLTIS301" THEN ASSIGN wdetail.financecd = "FHIWAY"     wdetail.campaign_ov = "REDPLATE".     
...
FIND sic_bran.uwm130 WHERE RECID(sic_bran.uwm130) = s_recid3 NO-WAIT NO-ERROR.
FIND sic_bran.uwm301 WHERE RECID(sic_bran.uwm301) = s_recid4 NO-WAIT NO-ERROR.
ASSIGN  /*dod1 = 0   dod2 = 0     dpd0 = 0    /*add A64-0138*/*/ /* ranu : 09/11/2022 */
...
/*IF nv_gapprm <> inte(wdetail.premt) THEN  DO:
    ...
    ASSIGN 
        ...
        wdetail.pass    = "N".
END. */ 
IF TRIM(wdetail.bev) = "Y" THEN RUN proc_calpremt_ev. /*A67-0114*/
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
/* comment by : a65-0035 ไม่มีการเรียกใช้..
IF wdetail.model = "commuter" THEN wdetail.seat = 12.
IF (wdetail.si = "") OR (wdetail.si = "0.00") OR (wdetail.si = "0" ) THEN DO:
    Find LAST stat.maktab_fil Use-index      maktab04           Where
        stat.maktab_fil.makdes   =    wdetail.brand             And                  
...
IF chkred = NO THEN DO:
    ASSIGN   /*wdetail.model   = wdetail.brand */
       ...
       /* wdetail.brand = substr(n_brand,1,INDEX(n_brand," ") - 1) */ /*A65-0035*/
       /* n_index       = INDEX(n_brand," ") + 1                   */ /*A65-0035*/
       /* n_model       = substr(n_brand,n_index).                 */ /*A65-0035*/
    IF INDEX(n_model," ") <> 0 THEN 
        n_model = substr(n_model,1,R-INDEX(n_model," ") - 1).
    /*wdetail.model  = n_model.*//*A65-0035*/
    IF index(wdetail.brand,"benz") <> 0 THEN DO: 
        ASSIGN wdetail.brand = "MERCEDES-BENZ".
        IF wdetail.model = "cls" THEN n_model = "CLS250".
    END.
    IF index(wdetail.model,"cab4") <> 0 THEN n_model = "D-Max".
END.
ELSE DO:
    IF index(wdetail.brand,"benz")     <> 0 THEN wdetail.brand = "MERCEDES-BENZ".
    IF index(wdetail.model,"cab4")     <> 0 THEN n_model = "D-Max".    /*A65-0035*/
    IF index(wdetail.model,"SPACECAB") <> 0 THEN n_model = "D-Max".    /*A65-0035*/
   /* a65-0035..
    ASSIGN 
...
DO TRANSACTION:
  ...
  sic_bran.uwm100.fstdat = DATE(wdetail.comdat)       /*kridtiya i. a53-0171 ให้ firstdate=comdate */
  ...
  sic_bran.uwm100.campaign   = trim(wdetail.producer) .      /*A66-0160*/
        ...
        sic_bran.uwm100.opnpol = IF fi_chkpro = "" THEN ""
                                 ...
                                 ELSE "" .  /*add kridtiya i. A53-0171 เพิ่มวันที่รับเงิน*/
       .............end : A60-0095.............*/
...
/*3*/   ELSE IF wdetail.re_country = "BKK"                THEN wdetail.re_country = "กท". 
...
/*/*31*/  ELSE IF wdetail.re_country = "SURAT THANI"        THEN wdetail.re_country = "สฏ". A63-0210*/
/*31*/  ELSE IF wdetail.re_country = "SURAT THANI"        THEN wdetail.re_country = "สฎ".
...
DO WHILE nv_line1 <= 9:
   ...
   /* IF nv_line1 = 3  THEN wuppertxt3.txt = "Notify time:" + wdetail.enttim   .*/
    ...
    IF nv_line1 = 9  THEN wuppertxt3.txt = "สีรถ :" + wdetail.colorcode.  /*A65-0356*/ 
