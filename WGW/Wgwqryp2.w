...
/*************************************************************************
 Wgwqryp1.W : Query Detail Policy
...
DEFINE VARIABLE fi_AgencyEmployee AS CHARACTER FORMAT "X(80)":U 
     LABEL "ผู้แจ้ง" 
      VIEW-AS TEXT 
     SIZE 23.5 BY .81
     FGCOLOR 2  NO-UNDO.
...
DEFINE FRAME frDisp
     ...
     bu_page2 AT ROW 4.91 COL 123.33 WIDGET-ID 398
     ...
     fi_AgencyEmployee AT ROW 5.76 COL 97 COLON-ALIGNED WIDGET-ID 246
...
&Scoped-define FRAME-NAME frDisp
&Scoped-define SELF-NAME bu_page2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bu_page2 C-Win
ON CHOOSE OF bu_page2 IN FRAME frDisp /* Next Page */
DO:
C-WIn:Hidden = Yes.  

  RUN WRs/WRSQReqPN2 (INPUT RECID(INTPol7072), "POLICY").  /*5. Query ข้อมูลกรมธรรม์รถยนต์ / พรบ.ที่เข้าระบบ */
...
------------------------------------------------------------------------------*/
  ...
  ENABLE fi_PolicyNumber fi_vehreg rd_approve buMessage fi_ContractNumber 
         fi_CMIPolicyNumber buDriverName buViewOTHER bu_page2 fi_test3 
         fi_GenSicBranText fi_Status fi_test2 fi_test1 fi_GenSicBran 
         fi_GenSicBranDt fi_GenSicBranTime fi_CompanyCode fi_BranchCd 
         fi_AgencyEmployee fi_PolicyTypeCd fi_RateGroup fi_TranDate 
         fi_EffectiveDt fi_EndDt fi_ContractDt fi_TranTime fi_InsuredType 
         fi_InsuredUniqueID fi_IDText fi_InsuredUniqueIDExpirationDt 
         fi_InsuredBranch fi_InsuredName fi_Addr fi_RegisteredProvinceCode 
         fi_PlateNumber fi_Manufacturer fi_Model fi_Displacement 
