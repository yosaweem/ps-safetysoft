/* program ID : wgwkkfile.p  
 Description : Export File Issue send KK 
 Create by : Ranu I. A63-0230  date: 20/05/2020 
 ******************************************************/
...
DO:
  ...
  IF nv_type = 2 THEN DO:
    OUTPUT STREAM ns1 TO VALUE(nv_output) .
         ...
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "SystemCode      "          '"' SKIP.  nv_column = nv_column + 1.      /*3 */                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "InsuredCardType "          '"' SKIP.  nv_column = nv_column + 1.      /*4 */                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "InsuredCardNo   "          '"' SKIP.  nv_column = nv_column + 1.      /*5 */                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "InsuredTitleName"          '"' SKIP.  nv_column = nv_column + 1.      /*6 */                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "InsuredFirstName"          '"' SKIP.  nv_column = nv_column + 1.      /*7 */                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "InsuredLastName "          '"' SKIP.  nv_column = nv_column + 1.      /*8 */                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "InsuredMobileNo "          '"' SKIP.  nv_column = nv_column + 1.      /*9 */                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "InsuredOccupation  "       '"' SKIP.  nv_column = nv_column + 1.      /*10*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "InsuredMaritalStatus  "    '"' SKIP.  nv_column = nv_column + 1.      /*11*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "AddressContact    "        '"' SKIP.  nv_column = nv_column + 1.      /*12*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "AddressTemplateContact"    '"' SKIP.  nv_column = nv_column + 1.      /*13*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "UnstructureAddressContact" '"' SKIP.  nv_column = nv_column + 1.      /*14*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "AddressNoContact  "        '"' SKIP.  nv_column = nv_column + 1.      /*15*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "MooContact        "        '"' SKIP.  nv_column = nv_column + 1.      /*16*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "VillageBuildingContact "   '"' SKIP.  nv_column = nv_column + 1.      /*17*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "FloorContact       "       '"' SKIP.  nv_column = nv_column + 1.      /*18*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "RoomNumberContact  "       '"' SKIP.  nv_column = nv_column + 1.      /*19*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "SoiContact         "       '"' SKIP.  nv_column = nv_column + 1.      /*20*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "StreetContact      "       '"' SKIP.  nv_column = nv_column + 1.      /*21*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "SubDistrictContact "       '"' SKIP.  nv_column = nv_column + 1.      /*22*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "DistrictContact    "       '"' SKIP.  nv_column = nv_column + 1.      /*23*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "ProvinceContact    "       '"' SKIP.  nv_column = nv_column + 1.      /*24*/                                
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "CountryContact     "       '"' SKIP.  nv_column = nv_column + 1.      /*25*/                                
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "ZipCodeContact     "       '"' SKIP.  nv_column = nv_column + 1.      /*26*/                                
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "AddressTax         "       '"' SKIP.  nv_column = nv_column + 1.      /*27*/                                    
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "AddressTemplateTax "       '"' SKIP.  nv_column = nv_column + 1.      /*28*/                                    
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "UnstructureAddressTax "    '"' SKIP.  nv_column = nv_column + 1.      /*29*/                                
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "AddressNoTax  "            '"' SKIP.  nv_column = nv_column + 1.      /*30*/                                
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "MooTax        "            '"' SKIP.  nv_column = nv_column + 1.      /*31*/                                
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "VillageBuildingTax "       '"' SKIP.  nv_column = nv_column + 1.      /*32*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "FloorTax       "           '"' SKIP.  nv_column = nv_column + 1.      /*33*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "RoomNumberTax  "           '"' SKIP.  nv_column = nv_column + 1.      /*34*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "SoiTax         "           '"' SKIP.  nv_column = nv_column + 1.      /*35*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "StreetTax      "           '"' SKIP.  nv_column = nv_column + 1.      /*36*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "SubDistrictTax "           '"' SKIP.  nv_column = nv_column + 1.      /*37*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "DistrictTax    "           '"' SKIP.  nv_column = nv_column + 1.      /*38*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "ProvinceTax    "           '"' SKIP.  nv_column = nv_column + 1.      /*39*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "CountryTax     "           '"' SKIP.  nv_column = nv_column + 1.      /*40*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "ZipCodeTax     "           '"' SKIP.  nv_column = nv_column + 1.      /*41*/                               
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "KKInsApplicationNo "       '"' SKIP.  nv_column = nv_column + 1.      /*42*/                                  
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "InsuranceCompanyCode"      '"' SKIP.  nv_column = nv_column + 1.      /*43*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "InsurerApplicationNo"      '"' SKIP.  nv_column = nv_column + 1.      /*44*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "PolicyNo         "         '"' SKIP.  nv_column = nv_column + 1.      /*45*/                               
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "EffectiveDate    "         '"' SKIP.  nv_column = nv_column + 1.      /*46*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "ExpireDate       "         '"' SKIP.  nv_column = nv_column + 1.      /*47*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "Packagecode      "         '"' SKIP.  nv_column = nv_column + 1.      /*48*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "PaymentMode      "         '"' SKIP.  nv_column = nv_column + 1.      /*49*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "PaymentPeriod    "         '"' SKIP.  nv_column = nv_column + 1.      /*50*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "SumInsure        "         '"' SKIP.  nv_column = nv_column + 1.      /*51*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "NetPremium       "         '"' SKIP.  nv_column = nv_column + 1.      /*52*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "VATPremium       "         '"' SKIP.  nv_column = nv_column + 1.      /*53*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "StampPremium     "         '"' SKIP.  nv_column = nv_column + 1.      /*54*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "GrossPremium     "         '"' SKIP.  nv_column = nv_column + 1.      /*55*/                               
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "WHTPremium       "         '"' SKIP.  nv_column = nv_column + 1.      /*56*/                               
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "PremiumAmount    "         '"' SKIP.  nv_column = nv_column + 1.      /*57*/                               
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "BeneficiaryType  "         '"' SKIP.  nv_column = nv_column + 1.      /*58*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "BeneficiaryName  "         '"' SKIP.  nv_column = nv_column + 1.      /*59*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "Remark           "         '"' SKIP.  nv_column = nv_column + 1.      /*60*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "CarType          "         '"' SKIP.  nv_column = nv_column + 1.      /*61*/                                     
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "CarBrand         "         '"' SKIP.  nv_column = nv_column + 1.      /*62*/                               
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "CarLicenseNo     "         '"' SKIP.  nv_column = nv_column + 1.      /*63*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "CarLicenseIssue  "         '"' SKIP.  nv_column = nv_column + 1.      /*64*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "ChassisNo        "         '"' SKIP.  nv_column = nv_column + 1.      /*65*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "EngineNo         "         '"' SKIP.  nv_column = nv_column + 1.      /*66*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "ModelYear        "         '"' SKIP.  nv_column = nv_column + 1.      /*67*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "Maintenance      "         '"' SKIP.  nv_column = nv_column + 1.      /*68*/                             
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "yr               "         '"' SKIP.  nv_column = nv_column + 1.      /*69*/                               
         PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' "reasoncode       "         '"' SKIP.  nv_column = nv_column + 1.      /*70 */
         ...
         FOR EACH wdetail NO-LOCK .                                              
              ...
              nv_column = nv_column + 1. 
              /*3*/
              IF trim(SystemCode) <> "" THEN n_length  = LENGTH(SystemCode) . ELSE n_length = 0.      
              IF n_length > 0 THEN PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' trim(SystemCode)      FORMAT "x(" + STRING(n_length) + ")"    '"' SKIP.  /*3 */
              nv_column = nv_column + 1.                                                                    
               /*4*/                                                                                                                        
              ...
              nv_column = nv_column + 1.   
              /*49*/
              IF trim(PaymentMode) <> "" THEN n_length  = LENGTH(PaymentMode) . ELSE n_length = 0.
              IF n_length > 0 THEN PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' trim(PaymentMode)   FORMAT "x(" + STRING(n_length) + ")"   '"' SKIP.  
              nv_column = nv_column + 1.   
              /*50*/
              IF trim(PaymentPeriod) <> "" THEN n_length  = LENGTH(PaymentPeriod) . ELSE n_length = 0.
              IF n_length > 0 THEN PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' trim(PaymentPeriod)   FORMAT "x(" + STRING(n_length) + ")"  '"' SKIP.  
              nv_column = nv_column + 1.   
              /*51*/ 
              ...
              nv_column = nv_column + 1.   
              /*53*/
              IF trim(string(VATPremium)) <> "" THEN n_length  = LENGTH(string(VATPremium)) . ELSE n_length = 0.
              IF n_length > 0 THEN PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' trim(string(VATPremium))    FORMAT "x(" + STRING(n_length) + ")"   '"' SKIP.  
              nv_column = nv_column + 1.   
              /*54*/ 
              IF trim(string(StampPremium)) <> "" THEN n_length  = LENGTH(string(StampPremium)) . ELSE n_length = 0.
              IF n_length > 0 THEN PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' trim(string(StampPremium))    FORMAT "x(" + STRING(n_length) + ")"  '"' SKIP.  
              nv_column = nv_column + 1.   
              /*55*/ 
              IF trim(string(GrossPremium)) <> "" THEN n_length  = LENGTH(string(GrossPremium)) . ELSE n_length = 0.
              IF n_length > 0 THEN PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' trim(string(GrossPremium))   FORMAT "x(" + STRING(n_length) + ")" '"' SKIP.  
              nv_column = nv_column + 1.   
              /*56*/ 
              IF trim(string(WHTPremium)) <> "" THEN n_length  = LENGTH(string(WHTPremium)) . ELSE n_length = 0.
              IF n_length > 0 THEN PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' trim(string(WHTPremium))   FORMAT "x(" + STRING(n_length) + ")" '"' SKIP.  
              nv_column = nv_column + 1.   
              /*57*/
              ...
              nv_column = nv_column + 1.   
              /*69*/
              IF trim(yr) <> "" THEN n_length  = LENGTH(yr) . ELSE n_length = 0.
              IF n_length > 0 THEN PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' trim(yr)  FORMAT "x(" + STRING(n_length) + ")"  '"' SKIP.  
              nv_column = nv_column + 1.   
              /*70*/
              IF trim(reasoncode) <> "" THEN n_length  = LENGTH(reasoncode) . ELSE n_length = 0.
              IF n_length > 0 THEN PUT STREAM ns1 "C;Y" STRING(nv_row) ";X" STRING(nv_column) ";K" '"' trim(reasoncode)  FORMAT "x(" + STRING(n_length) + ")"  '"' SKIP.  
              nv_column = nv_column + 1.   
