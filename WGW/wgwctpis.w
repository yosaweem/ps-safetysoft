...
/* Connected Databases 
          brstat           PROGRESS
*/
&Scoped-define WINDOW-NAME wgwctpis
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _DEFINITIONS wgwctpis 
/*------------------------------------------------------------------------
...
Insure.Deci1 Insure.Deci2 Insure.ICNo Insure.LName Insure.Addr1 ~
Insure.Addr2 Insure.Addr3 Insure.Addr4 Insure.TelNo Insure.ICAddr3 ~
Insure.ICAddr1 Insure.Text1 Insure.Text2 Insure.ICAddr4 Insure.Branch 
...
DEFINE VAR wgwctpis AS WIDGET-HANDLE NO-UNDO.
...
DEFINE VARIABLE fiyear AS CHARACTER FORMAT "X(4)":U 
     VIEW-AS FILL-IN 
     SIZE 7 BY .95
     BGCOLOR 15 FONT 6 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brInsure wgwctpis _STRUCTURED
  QUERY brInsure NO-LOCK DISPLAY
      ...
      Insure.Text4 COLUMN-LABEL "sumin" FORMAT "x(15)":U WIDTH 9
      Insure.Text5 COLUMN-LABEL "Base" FORMAT "x(10)":U WIDTH 5.83
      Insure.Deci1 COLUMN-LABEL "NCB" FORMAT "->>>,>>>,>>9.99":U
            WIDTH 3.83
      Insure.Deci2 COLUMN-LABEL "Dspc" FORMAT "->>>,>>>,>>9.99":U
            WIDTH 4.33
      Insure.ICNo COLUMN-LABEL "EngCC." FORMAT "x(20)":U WIDTH 5.83
      ...
      Insure.ICAddr3 COLUMN-LABEL "Seat" FORMAT "x(3)":U WIDTH 3.83
      Insure.ICAddr1 COLUMN-LABEL "Seat41" FORMAT "x(3)":U
      Insure.Text1 COLUMN-LABEL "ยี่ห้อ" FORMAT "X(50)":U WIDTH 16.67
      Insure.Text2 COLUMN-LABEL "Model" FORMAT "X(40)":U WIDTH 27.17
      Insure.ICAddr4 COLUMN-LABEL "caryear" FORMAT "x(5)":U
...
DEFINE FRAME frInsure
     ...
     fibrand AT ROW 7.1 COL 7 COLON-ALIGNED NO-LABEL
     fimodel AT ROW 7.1 COL 27.83 COLON-ALIGNED NO-LABEL
     fiyear AT ROW 7.1 COL 56 COLON-ALIGNED NO-LABEL
     fipack AT ROW 8.1 COL 7 COLON-ALIGNED NO-LABEL
     ...
     fidspc AT ROW 9.1 COL 7 COLON-ALIGNED NO-LABEL
     ...
     "Per Accident (PD):" VIEW-AS TEXT
          ...
          BGCOLOR 20 FGCOLOR 15 
     "Year :" VIEW-AS TEXT
          SIZE 5 BY .95 AT ROW 7.1 COL 52.67
          BGCOLOR 20 FGCOLOR 15 
     ...
     "Sum SI :" VIEW-AS TEXT
          ...
          BGCOLOR 20 FGCOLOR 15 
     "Model :" VIEW-AS TEXT
          SIZE 6.5 BY .95 AT ROW 7.1 COL 23
          BGCOLOR 20 FGCOLOR 15 
     "Pack :" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wgwctpis ASSIGN
         HIDDEN             = YES
         TITLE              = "Set Campaign Code ( wgwctpis.w)"
         HEIGHT             = 23.91
         WIDTH              = 132.5
         MAX-HEIGHT         = 33.71
         MAX-WIDTH          = 170.67
...
/* SETTINGS FOR FILL-IN fivatcode IN FRAME frInsure
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN fiyear IN FRAME frInsure
   NO-ENABLE                                                            */
...
/* SETTINGS FOR FRAME frUser
                                                                        */
IF SESSION:DISPLAY-TYPE = "GUI":U AND VALID-HANDLE(wgwctpis)
THEN wgwctpis:HIDDEN = no.
...
"Insure.Text4" "sumin" "x(15)" "character" ? ? ? ? ? ? no ? no no "9" yes no no "U" "" ""
     _FldNameList[7]   > brstat.Insure.Text5
"Insure.Text5" "Base" "x(10)" "character" ? ? ? ? ? ? no ? no no "5.83" yes no no "U" "" ""
     _FldNameList[8]   > brstat.Insure.Deci1
"Insure.Deci1" "NCB" ? "decimal" ? ? ? ? ? ? no ? no no "3.83" yes no no "U" "" ""
     _FldNameList[9]   > brstat.Insure.Deci2
"Insure.Deci2" "Dspc" ? "decimal" ? ? ? ? ? ? no ? no no "4.33" yes no no "U" "" ""
     _FldNameList[10]   > brstat.Insure.ICNo
"Insure.ICNo" "EngCC." ? "character" ? ? ? ? ? ? no ? no no "5.83" yes no no "U" "" ""
...
"Insure.TelNo" "4.3" ? "character" ? ? ? ? ? ? no ? no no "10.5" yes no no "U" "" ""
     _FldNameList[17]   > brstat.Insure.ICAddr3
"Insure.ICAddr3" "Seat" "x(3)" "character" ? ? ? ? ? ? no ? no no "3.83" yes no no "U" "" ""
...
"Insure.Text1" "ยี่ห้อ" ? "character" ? ? ? ? ? ? no ? no no "16.67" yes no no "U" "" ""
     _FldNameList[20]   > brstat.Insure.Text2
"Insure.Text2" "Model" "X(40)" "character" ? ? ? ? ? ? no ? no no "27.17" yes no no "U" "" ""
     _FldNameList[21]   > brstat.Insure.ICAddr4
"Insure.ICAddr4" "caryear" "x(5)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[22]   > brstat.Insure.Branch
...
&Scoped-define SELF-NAME wgwctpis
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wgwctpis wgwctpis
ON END-ERROR OF wgwctpis /* Set Campaign Code ( wgwctpis.w) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wgwctpis wgwctpis
ON WINDOW-CLOSE OF wgwctpis /* Set Campaign Code ( wgwctpis.w) */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL brInsure wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncompadd wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncompdel wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncompfirst wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncomplast wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncompnext wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncompok wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncompprev wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncompreset wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btncompupd wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnFirst wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btninadd wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnInCancel wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnInDelete wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnInOK wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnInUpdate wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnLast wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnNext wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnPrev wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL btnReturn wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bu_exp wgwctpis
    ...
    FOR EACH   brstat.insure USE-INDEX Insure03  WHERE 
        ...
        IF NOT AVAIL wdetail2 THEN DO:
            ...
            ASSIGN
                ...
                wdetail2.caryear    =    brstat.insure.ICAddr4
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bu_im wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bu_imp wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiabname wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fibase wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fibranch wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fibrand wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiCompNo wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fidspc wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiengcc wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiFName wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiInAddr1 wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiInAddr2 wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiInAddr3 wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiInAddr4 wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiInBranch wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiInComp wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiInproducer wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiInTelNo wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiLName wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fimodel wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiName wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiName2 wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fincb wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fipack wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiseat41 wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiseats wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fisumin wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fivatcode wgwctpis
...
&Scoped-define SELF-NAME fiyear
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiyear wgwctpis
ON LEAVE OF fiyear IN FRAME frInsure
DO:
    fiyear  = INPUT fiyear.
    DISP fiyear WITH FRAM frinsure. 
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_filename wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_fileout wgwctpis
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _MAIN-BLOCK wgwctpis 
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    RUN enable_UI.
    RUN WUT\WUTDICEN (wgwctpis:HANDLE).
    ...
    FIND FIRST Company WHERE Company.Compno = "CAMPAIGN_TPIS" NO-LOCK NO-ERROR NO-WAIT.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE disable_UI wgwctpis  _DEFAULT-DISABLE
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE enable_UI wgwctpis  _DEFAULT-ENABLE
PROCEDURE enable_UI :
/*------------------------------------------------------------------------------
...
------------------------------------------------------------------------------*/
  DISPLAY fiCompNo fiabname fibranch fiName fiName2 fiAddr1 fiAddr2 fiAddr3 
          fiAddr4 fiTelNo 
      WITH FRAME frComp IN WINDOW wgwctpis.
  ...
  ENABLE btnReturn RECT-84 
      WITH FRAME frmain IN WINDOW wgwctpis.
  {&OPEN-BROWSERS-IN-QUERY-frmain}
  DISPLAY fiInComp fiInproducer fiInBranch fivatcode fiFName fiLName fiInAddr1 
          fiInAddr2 fiInAddr3 fiInAddr4 fiInTelNo fibrand fimodel fiyear fipack 
          fisumin fibase fincb fidspc fiengcc fiseats fiseat41 
      WITH FRAME frInsure IN WINDOW wgwctpis.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdAddCom wgwctpis 
PROCEDURE pdAddCom :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDDisableComp wgwctpis 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDDispComp wgwctpis 
...
DISP fiCompNo
 ...
 IF AVAIL insure  THEN DO:
     ...
     DISP 
         ...
         fincb
         fidspc   fiInproducer
         fiengcc  fiseat41  fiseats  fiyear
         WITH FRAME frinsure.
     gComp = company.compno.
  RUN pdUpdateQ.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdDispIns wgwctpis 
PROCEDURE pdDispIns :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pddisplogin wgwctpis 
...
DISP    fiincomp  fiinbranch fivatcode  fifname   
        filname   fiinAddr1   fiinAddr2   fiinAddr3          
        fiinAddr4 fiinTelNo  fibrand    fimodel    fiyear     
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdEnable wgwctpis 
PROCEDURE pdEnable :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
ENABLE 
    ...
    fiInTelNo   btnInOK     btnInCancel fibrand     fimodel fiyear
    fipack      fisumin     fibase      fincb       fidspc
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdenablecomp wgwctpis 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDInitData wgwctpis 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdUpdateQ wgwctpis 
PROCEDURE pdUpdateQ :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE ProcDisable wgwctpis 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE ProcUpdateInsure wgwctpis 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc_assign1 wgwctpis 
    ...
    IF AVAIL company THEN DO:
        ...
        IF NOT AVAIL brstat.insure THEN DO:
            ...
            ASSIGN
                ...
                brstat.insure.ICAddr4  = wdetail2.caryear
