...
DEFINE FRAME fr_main
     ...
     ":รหัสบริษัท RABBIT" VIEW-AS TEXT
...
IF NOT AVAIL wdetail THEN DO:
    ...
    ASSIGN 
        ...
        wdetail.VehicleUse                = "ใช้ส่วนบุคคล ไม่ใช้รับจ้างหรือให้เช่า"      /* nv_VehicleUse  */                         
