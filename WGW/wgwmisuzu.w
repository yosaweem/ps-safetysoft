...
/*++++++++++++++++++++++++++++++++++++++++++++++
  program id   : wgwmisuzu.w
 Create  by   : ranu I. A64-0426 date :07/12/2021
...
&Scoped-Define ENABLED-OBJECTS bu_exit bu_kk-74 bu_kk-75 bu_kk-76 RECT-349 ~
RECT-367 RECT-361 RECT-363 RECT-364 
...
DEFINE BUTTON bu_kk-74 
     LABEL "LOAD TEXT FILE ISUZU" 
     SIZE 44 BY 1.24
     BGCOLOR 15 FGCOLOR 0 FONT 6.

DEFINE BUTTON bu_kk-75 
     LABEL "QUERY AND UPDATE DATA (ISUZU)" 
     SIZE 45.33 BY 1.24
     BGCOLOR 15 FGCOLOR 0 FONT 6.

DEFINE BUTTON bu_kk-76 
     LABEL "IMPORT FILE HOLD ISUZU" 
     SIZE 45.33 BY 1.24
     BGCOLOR 15 FGCOLOR 0 FONT 6.
...
DEFINE FRAME DEFAULT-FRAME
     ...
     "IMPORT AND LOAD FILE ISUZU DEALER (NEW)" VIEW-AS TEXT
          SIZE 47 BY 1 AT ROW 1.48 COL 7.17
...
ON END-ERROR OF C-Win /* Import Data ISUZU */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Import Data ISUZU */
DO:
...
ON CHOOSE OF bu_kk-74 IN FRAME DEFAULT-FRAME /* LOAD TEXT FILE ISUZU */
DO:
...
ON CHOOSE OF bu_kk-75 IN FRAME DEFAULT-FRAME /* QUERY AND UPDATE DATA (ISUZU) */
DO:
    {&WINDOW-NAME} :Hidden = Yes.
    Run  wgw\wgwqisuzu.   
    {&WINDOW-NAME} :Hidden = No.
...
ON CHOOSE OF bu_kk-76 IN FRAME DEFAULT-FRAME /* IMPORT FILE HOLD ISUZU */
DO:
    {&WINDOW-NAME} :Hidden = Yes.
    Run  wgw\wgwimisuzu.   
    {&WINDOW-NAME} :Hidden = No.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  gv_prgid = "wgwmisuzu.w".
  gv_prog  = "Import Text File(isuzu new)".
...
------------------------------------------------------------------------------*/
  ENABLE bu_exit bu_kk-74 bu_kk-75 bu_kk-76 RECT-349 RECT-367 RECT-361 RECT-363 
         RECT-364 
