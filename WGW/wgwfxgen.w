...
fi_tpp fi_tba fi_tpa RECT-368 RECT-370 RECT-372 RECT-373 RECT-375 RECT-376 ~
RECT-377 RECT-378 
...
DEFINE FRAME fr_main
     ...
     "BHT.":60 VIEW-AS TEXT
          ...
          BGCOLOR 8 FGCOLOR 1 FONT 6
     "    IMPORT TEXT FILE MOTOR [ FAX ]" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW c-win ASSIGN
         HIDDEN             = YES
         TITLE              = "IMPORT TEXT FILE MOTOR [ FAX ]"
         HEIGHT             = 24
         WIDTH              = 133
         MAX-HEIGHT         = 33.71
         MAX-WIDTH          = 170.67
...
ON END-ERROR OF c-win /* IMPORT TEXT FILE MOTOR [ FAX ] */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-win c-win
ON WINDOW-CLOSE OF c-win /* IMPORT TEXT FILE MOTOR [ FAX ] */
DO:
...
ASSIGN 
    gv_prgid   = "WGWFXGEN"
    gv_prog    = "IMPORT TEXT FILE MOTOR [BY New FAX ... ]"
    fi_loaddat = TODAY.
DISP fi_loaddat WITH FRAME fr_main.
...
ASSIGN
    ...
    fi_tba      = 10000000
    fi_tpa      = 2500000
    fi_show     = "IMPORT TEXT FILE MOTOR [BY New FAX ... ]... ".
    ...
    IF (wdetail2.notifyno NE "")  THEN DO:
        ...
        IF NOT AVAIL wdetail THEN DO:
            ...
            ASSIGN  /*wdetail.policy      = wdetail2.pol70*/  /*A55-0125*/
                ...
                wdetail.deler       = trim(wdetail2.deler)
                ...
                wdetail.n_IMPORT    = "IM"
                wdetail.n_EXPORT    = ""  
                wdetail.nmember     = "เลขรับเเจ้ง[FAX] : " + trim(wdetail2.notifyno) + 
...
IF NOT AVAILABLE uwm130 THEN 
    ...
    ELSE nv_newsck =  wdetail.stk.
         ...
         ASSIGN
          ...
          /*IF wdetail.poltyp = "v70" THEN "คุ้มครองอุปกรณ์ตกแต่งราคาไม่เกิน 20,000 บาท" ELSE "" .*/
...
FIND LAST sicsyac.xmm600 USE-INDEX  xmm60002 WHERE
    ...
    sicsyac.xmm600.clicod   = "IN"                         /*A56-0047  Add check sicsyac.xmm600.clicod   = "IN" */
    NO-ERROR NO-WAIT.
...
DO TRANSACTION:
   ASSIGN
      ...
      sic_bran.uwm100.anam2  = wdetail.idno      
      ...
      sic_bran.uwm100.name2  = IF nv_vatname = "" THEN trim(wdetail.namedirect) 
                               ELSE TRIM(trim(wdetail.namedirect) + " " + nv_vatname)   
