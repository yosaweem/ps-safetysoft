...
DEFINE NEW SHARED TEMP-TABLE wdetail
    ...
    FIELD tel           AS CHAR INIT "" FORMAT "X(50)"
    FIELD dobexp        AS CHAR INIT "" FORMAT "X(50)"
    FIELD fdri1         AS CHAR INIT ""
    FIELD fdri2         AS CHAR INIT ""
    FIELD fddo1         AS CHAR INIT ""
    FIELD fddo2         AS CHAR INIT ""
    FIELD finint        AS CHAR INIT ""
    FIELD mkval         AS CHAR INIT ""
    /*---begin by Chaiyong W. A59-0614 18/04/2017*/
    FIELD prom          AS CHAR INIT ""  
    FIELD insnam2       AS CHAR FORMAT "x(60)"   INIT ""  
    /*End by Chaiyong W. A59-0614 18/04/2017-----*/
...
DEF VAR n_textf74    AS CHAR  INIT "" FORMAT "x(150)".
DEF VAR n_textf75    AS CHAR  INIT "" FORMAT "x(150)".
DEF VAR n_textf76    AS CHAR  INIT "" FORMAT "x(150)".
DEF VAR n_textf77    AS CHAR  INIT "" FORMAT "x(150)".
DEF VAR n_textf78    AS CHAR  INIT "" FORMAT "x(150)".
...
DEF VAR nv_driid1      AS CHAR INIT "" FORMAT "X(50)".
DEF VAR nv_driid2      AS CHAR INIT "" FORMAT "X(50)".
...
DEF VAR nv_fcomp          AS CHAR  INIT "".  
DEF VAR nv_fdate          AS CHAR  INIT "".
DEF VAR nv_fcont          AS CHAR  INIT "".
DEF VAR nv_fname          AS CHAR  INIT "".
DEF VAR nv_fname2         AS CHAR  INIT "".
DEF VAR nv_faddr          AS CHAR  INIT "".
DEF VAR nv_ftel           AS CHAR  INIT "".
DEF VAR nv_fdob           AS CHAR  INIT "".
DEF VAR nv_fexp           AS CHAR  INIT "". 

DEF VAR nv_fdri1          AS CHAR  INIT "".
DEF VAR nv_fdri2          AS CHAR  INIT "".
DEF VAR nv_fddo1          AS CHAR  INIT "".
DEF VAR nv_fddo2          AS CHAR  INIT "".
DEF VAR nv_price          AS CHAR  INIT "".
DEF VAR n_naptx           AS CHAR  INIT "".
DEF VAR n_napcom          AS CHAR  INIT "".
DEF VAR n_napcomtx        AS CHAR  INIT "".
DEF VAR n_sticker         AS CHAR  INIT "".
DEF VAR nv_vatname70      AS CHAR  INIT "".
DEF VAR nv_vatname72      AS CHAR  INIT "".
DEF VAR nv_acc            AS CHAR  INIT "".
DEF VAR nv_f51            AS CHAR  INIT "".
DEF VAR nv_f52            AS CHAR  INIT "".
DEF VAR nv_postc  AS CHAR INIT "".
DEF VAR nv_chkint AS INT  INIT 0.
DEF VAR nv_pack AS CHAR INIT "".
DEF VAR nv_chkdat AS DATE INIT ?.
DEF BUFFER bwdetail FOR wdetail.
DEF VAR nv_addr   AS CHAR INIT "".
DEF VAR nv_ctext  AS CHAR INIT "".
DEF VAR nv_ntitle AS CHAR INIT "".
DEF VAR nv_addrx  AS CHAR INIT "".
DEF VAR nv_vatdes AS CHAR INIT "".
