...
/*    CONNECT -db BUInt     -H 16.90.20.203 -S 61760   -N tcp -U VALUE(fi_username) -P VALUE(fi_password). /*Test*/ */
    ...
    /*CONNECT -db BUINT     -H WSBUINT -S BUINT   -N tcp -U VALUE(fi_username) -P VALUE(fi_password). /* ของจริง */*//*Comment A62-0105*/
    /*CONNECT -db BUINT     -H tmsth -S BUINT   -N tcp -U VALUE(fi_username) -P VALUE(fi_password). /* ของจริง */*/ /*Comment A64-0217*/   
    CONNECT -db BUINT     -H TMPMWSDBIP01 -S BUINT   -N tcp -U VALUE(fi_username) -P VALUE(fi_password). /* ของจริง */     /*add A64-0217*/       
