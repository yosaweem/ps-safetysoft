/*************************************************************************
 ...
 modify by    : Kridtiya i. A61-0229  add  Load file Lockton 72            
 ------------------------------------------------------------------------
*************************************************************************/
...
DEFINE INPUT  PARAMETER nv_companyno       AS CHARACTER NO-UNDO.
...
DEF VAR nv_CMIWrittenAmt      AS CHAR . 
DEF VAR nv_CMIRevenueStampAmt AS CHAR . 
DEF VAR nv_CMIVatAmt          AS CHAR . 
DEF VAR nv_CMICurrentTermAmt  AS CHAR . 
...
IF AVAIL wdetail  THEN DO:
    ...
    FIND FIRST CACompany WHERE CACompany.InsurerCode = nv_companyno NO-LOCK NO-ERROR NO-WAIT.
    ...
    ELSE 
        ASSIGN 
            nUsername =  ""  
            nPassword =  ""  .
    IF      wdetail.premtnet =  "645.21"  THEN ASSIGN nv_CMIWrittenAmt =  "600" nv_CMIRevenueStampAmt = "3"  nv_CMIVatAmt =  "42.21"  .
    ELSE IF wdetail.premtnet = "1182.35"  THEN ASSIGN nv_CMIWrittenAmt = "1100" nv_CMIRevenueStampAmt = "5"  nv_CMIVatAmt =  "77.35"  .
    ELSE IF wdetail.premtnet =  "967.28"  THEN ASSIGN nv_CMIWrittenAmt =  "900" nv_CMIRevenueStampAmt = "4"  nv_CMIVatAmt =  "63.28"  .
    ELSE IF wdetail.premtnet = "2041.56"  THEN ASSIGN nv_CMIWrittenAmt = "1900" nv_CMIRevenueStampAmt = "8"  nv_CMIVatAmt = "133.56"  .
    ELSE IF wdetail.premtnet = "2041.56"  THEN ASSIGN nv_CMIWrittenAmt = "1900" nv_CMIRevenueStampAmt = "8"  nv_CMIVatAmt = "133.56"  .
    ELSE IF wdetail.premtnet = "2493.10"  THEN ASSIGN nv_CMIWrittenAmt = "2320" nv_CMIRevenueStampAmt = "10" nv_CMIVatAmt = "163.10"  .
    ELSE IF wdetail.premtnet = "3738.58"  THEN ASSIGN nv_CMIWrittenAmt = "3480" nv_CMIRevenueStampAmt = "14" nv_CMIVatAmt = "244.58"  .
    ELSE IF wdetail.premtnet = "2493.10"  THEN ASSIGN nv_CMIWrittenAmt = "2320" nv_CMIRevenueStampAmt = "10" nv_CMIVatAmt = "163.10"  .
    ELSE IF wdetail.premtnet = "3738.58"  THEN ASSIGN nv_CMIWrittenAmt = "3480" nv_CMIRevenueStampAmt = "14" nv_CMIVatAmt = "244.58"  .
    
    FIND LAST ExtPolLT70 WHERE 
        ExtPolLT70.PolicyNumber         = trim(nv_policyno) NO-ERROR NO-WAIT.
    IF NOT AVAIL ExtPolLT70 THEN DO:
        CREATE ExtPolLT70.
        ASSIGN
            ExtPolLT70.PolicyNumber         = trim(nv_policyno)        
            ...
            ExtPolLT70.CompanyCode	        = nv_companyno                  /*Company Lockton */
            ...
            ExtPolLT70.CampaignNumber       = CampaignNames                 
            ...
            ExtPolLT70.EffectiveDt	        = ""
            ExtPolLT70.ExpirationDt         = ""
            /**/                                      
            ...
            ExtPolLT70.InsuredSurname           = trim(wdetail.insnam2) 
            ExtPolLT70.Addr	                    = trim(wdetail.addr1)   
            ExtPolLT70.SubDistrict              = trim(wdetail.addr2)   
            ExtPolLT70.District                 = trim(wdetail.addr3)   
            ExtPolLT70.Province                 = trim(wdetail.addr4)   
            ExtPolLT70.PostalCode	            = trim(wdetail.addr5)
            ...
            ExtPolLT70.GrossVehOrCombinedWeight = STRING(wdetail.tons)
            ExtPolLT70.Colour	                = ""
            ...
            ExtPolLT70.RegisteredProvCd         = trim(wdetail.provin)   /*"กท"*/
            ExtPolLT70.RegisteredYear	        = trim(wdetail.caryear)
            /* Line 70 */                                
            ExtPolLT70.PolicyTypeCd                   = ""
            ExtPolLT70.RateGroup	                  = ""
            ExtPolLT70.TPBIAmtPerson	              = ""
            ExtPolLT70.TPBIAmtAccident	              = ""
            ExtPolLT70.PDAmtAccident	              = ""
            ExtPolLT70.DeductiblePDAmtAccident        = ""
            ExtPolLT70.COLLAmtAccident	              = ""
            ...
            /**/ 
            ExtPolLT70.WrittenAmt	                  = ""      
            ExtPolLT70.RevenueStampAmt                = ""
            ExtPolLT70.VatAmt	                      = ""
            ExtPolLT70.CurrentTermAmt	              = ""
            ...
            ExtPolLT70.Finint                         = trim(wdetail.delerno)      /*Kridtiya i.*/
            ExtPolLT70.PromptText                     = trim(wdetail.remark)       /*Kridtiya i.*/
            ExtPolLT70.SumInsureAmt                   = ""          /*kridtiya i.*/ 
            ...
            ExtPolLT70.CMIVehTypeCd	            = wdetail.subclass
            ...
            ExtPolLT70.CMIWrittenAmt	        = nv_CMIWrittenAmt     
            ExtPolLT70.CMIRevenueStampAmt       = nv_CMIRevenueStampAmt
            ExtPolLT70.CMIVatAmt	            = nv_CMIVatAmt   
            ExtPolLT70.CMICurrentTermAmt        = wdetail.premtnet

            /*ExtPolLT70.MsgStatusCd	            = "Test"*/
            ExtPolLT70.MsgStatusCd	            = "NEW"
...
nv_SavetoFile = TRIM(nv_node-nameHeader) + nv_policyno + ".XML".   /*kridtiya i. Test start in */
