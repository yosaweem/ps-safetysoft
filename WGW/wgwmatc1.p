...
IF nv_outagent2 <> "" THEN DO:    /*by Group Producer code */
    FOR EACH aycldeto_fil USE-INDEX aycldeti02 WHERE 
        ...
        ASSIGN nv_prem  = 0 
            ...
            nv_mon      = ""  
            nv_yea      = ""
            nv_policyno = trim(aycldeto_fil.notify)   
            nv_i        = 0                                  
        ...
        IF AVAIL sicuw.uwm100 THEN DO:  
            ...
            IF AVAIL uwm301 THEN DO:   /*เช็ค chasis และ policy ตรงกัน ให้ส่งข้อมูลได้ (ตามเงื่อนไขข้อ 1)*/
                ...
                IF AVAIL uwm100 THEN DO:
                    ...
                    IF (SUBSTR(aycldeto_fil.comdat,1,2) = SUBSTR(nv_comdat,1,2)) OR 
                        (aycldeto_fil.comdat = "000000") THEN DO:   /*เช็คปีต้องเท่ากับไฟล์ที่ส่งมา หรือถ้าเป็นค่าว่างให้ส่งค่ากลับไป*/
                        ASSIGN aycldeto_fil.policy  = CAPS(sicuw.uwm100.policy)
        ...
        ELSE DO:         /*ถ้าไม่เจอ acno                     pin. ...not group acno ......*/
            ...
            IF AVAIL sicuw.uwm100 THEN DO:
                ASSIGN 
                    nv_ncompcnt = nv_ncompcnt + 1   /* record not found count */
                    aycldeto_fil.remark         = "รหัส Code ไม่ตรง"
                    SUBSTR(aycldeto_fil.remark,100,12) = sicuw.uwm100.policy
