...
DEFINE INPUT-OUTPUT  PARAMETER np_langug        AS CHAR FORMAT "x(1)".
...
DEFINE INPUT-OUTPUT  PARAMETER np_occupn        AS CHAR FORMAT "x(35)" INIT "" .
...
DEFINE INPUT-OUTPUT  PARAMETER np_cedpol        AS CHAR FORMAT "x(16)" INIT "" .
...
DEFINE INPUT-OUTPUT  PARAMETER np_ncbyrs        AS CHAR FORMAT "x(30)"  INIT "" . 
DEFINE INPUT-OUTPUT  PARAMETER np_bennam1       AS CHAR FORMAT "x(60)"  INIT ""   .
DEFINE INPUT-OUTPUT  PARAMETER np_prmtxt        AS CHAR FORMAT "x(60)"  INIT ""   .
...
DEFINE INPUT-OUTPUT  PARAMETER np_uom6_v        AS CHAR FORMAT "x(30)"  INIT "" .
DEFINE INPUT-OUTPUT  PARAMETER np_uom7_v        AS CHAR FORMAT "x(30)"  INIT "" .
DEFINE INPUT-OUTPUT  PARAMETER np_styp20        AS CHAR FORMAT "x(30)"  INIT "" .
DEFINE INPUT-OUTPUT  PARAMETER np_baseprm       AS DECI FORMAT ">>>,>>>,>>9.99-"  . 
DEFINE INPUT-OUTPUT  PARAMETER np_use           AS DECI FORMAT ">>>,>>>,>>9.99-"  . 
DEFINE INPUT-OUTPUT  PARAMETER np_grp           AS DECI FORMAT ">>>,>>>,>>9.99-"  . 
DEFINE INPUT-OUTPUT  PARAMETER np_yr            AS DECI FORMAT ">>>,>>>,>>9.99-"  . 
DEFINE INPUT-OUTPUT  PARAMETER np_si            AS CHAR FORMAT "x(30)"  INIT "" .
DEFINE INPUT-OUTPUT  PARAMETER np_oth           AS DECI FORMAT ">>>,>>>,>>9.99-"  . 
DEFINE INPUT-OUTPUT  PARAMETER np_eng           AS DECI FORMAT ">>>,>>>,>>9.99-"  . 
DEFINE INPUT-OUTPUT  PARAMETER np_driv          AS DECI FORMAT ">>>,>>>,>>9.99-"  . 
...
IF AVAILABLE sic_exp.uwm100 THEN DO:
    ...
    ASSIGN 
        ...
        np_occupn    = TRIM(sic_exp.uwm100.occupn)
        ...
        np_cedpol    = TRIM(sic_exp.uwm100.cedpol).
    ...
    IF AVAIL uwm301 THEN DO:
        ASSIGN  
            ...
            np_moddes   = sic_exp.uwm301.moddes                                                      
            ...
            np_ncbyrs   = string(sic_exp.uwm301.ncbyrs) 
            np_bennam1  = SUBSTRING(sic_exp.uwm301.mv_ben83,1,60)
            np_prmtxt   = sic_exp.uwm301.prmtxt.
        ...
        IF AVAIL sic_exp.uwm130  THEN
            ASSIGN 
              ...
              np_uom6_v  = string(sic_exp.uwm130.uom6_v) 
              np_uom7_v  = string(sic_exp.uwm130.uom7_v)     
              np_styp20  = sic_exp.uwm130.styp20 .   /*Action*/
        FOR EACH sic_exp.uwd132 USE-INDEX uwd13290  WHERE
            ...
            ELSE IF sic_exp.uwd132.bencod = "dod2"         THEN ASSIGN np_addod    = DECI((SUBSTRING(sic_exp.uwd132.benvar,31,30))).
