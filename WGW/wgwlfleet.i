/*programid   : wgwlfleet.i                                                         */ 
/*programname : load text file fleet to GW                                          */ 
/* Copyright	: Safety Insurance Public Company Limited 			                */ 
/*			      บริษัท ประกันคุ้มภัย จำกัด (มหาชน)				                */ 
/*create by   : Ranu I. A64-0369 date:26/01/2021 เก็บตัวแปร Fleet                   */ 
/*Modify by   : Ranu I. A65-0079 เพิ่มตัวแปรรับค่าจากไฟล์โหลด                       */ 
/*Modify by   : Ranu I. A67-0029 เพิ่มตัวแปรเก็บข้อมูลรถไฟฟ้า                       */
/*Modify by   : Ranu I. A68-0044 เพิ่มตัวแปร ICE                                    */
/***********************************************************************************/
...
DEF VAR  n_textfi AS CHAR FORMAT  "x(30)" INIT "".                
def var  nv_row  as  int  init  0. 
def var  wf_riskno           as char format "x(3)" init "" .  /* Risk No                                   */                      
def var  wf_num              as char format "x(3)" init "" .  /*ItemNo                                   */                      
...
def var  wf_insref           as char format "x(20)" init "" .  /*รหัสลูกค้า           */    
...
def var  wf_ae               as char format "x(12)" init "" .  /*  ae  new Xmm600 งาน Japanes*/    
def var  wf_jtl              as char format "x(12)" init "" .  /*  jtl new Xmm600 งาน Japanes*/    
def var  wf_ts               as char format "x(12)" init "" .  /*  ts  new Xmm600 งาน Japanes*/    
...
DEF VAR  wf_redbook          AS CHAR FORMAT "x(10)" INIT "" .  /* code redbook :  A65-0079*/
...
DEF VAR  wf_body             as char format "x(50)" init "" .  /*รหัสแบบตัวถัง         */              
...
DEF VAR  wf_NO_411           as char format "x(20)" init "" .  /*PA1.1 / driver        */      
DEF VAR  wf_ac2              as char format "x(20)" init "" .  /*PA1.1 no.of passenger */      
DEF VAR  wf_no_412           as char format "x(20)" init "" .  /*PA1.1 / passenger     */      
DEF VAR  wf_no_413           as char format "x(20)" init "" .  /*PA1.2 / driver        */      
DEF VAR  wf_ac6              as char format "x(20)" init "" .  /*PA1.2 no.of passenger */      
DEF VAR  wf_no_414           as char format "x(20)" init "" .  /*PA1.2 / passenger     */      
...
DEF VAR  wf_tpbi             as char format "x(20)" init "" .  /*TPBI Amount           */      
DEF VAR  wf_tpbiocc          AS CHAR FORMAT "X(20)"  INIT "" .  /* tpbiacc*/                /*A65-0079*/  
...
def var  wf_ry412            as char format "x(20)"  init "" . /* RY412 Amount  */          /*a65-0079*/
def var  wf_ry413            as char format "x(20)"  init "" . /* RY413 Amount  */          /*a65-0079*/
def var  wf_ry414            as char format "x(20)"  init "" . /* RY414 Amount  */          /*a65-0079*/
...
DEF VAR  wf_vehuse           as char format "x(2)" init "" . /* ranu : vehuse 15/12/2021 */
...
DEFINE TEMP-TABLE wdetail 
  ...
  FIELD   itemNo         AS int  INIT 0         /*item no */                    
  FIELD   policyno       AS CHAR FORMAT "X(15)" INIT ""           /*Policy No (เลขที่กรมธรรม์ภาคสมัครใจ)*/          
  ...
  FIELD   insref         AS CHAR FORMAT "X(15)" INIT ""            /*รหัสลูกค้า           */                        
  ...
  FIELD   engcc          AS DECI INIT 0 format ">>>9"             /*ปริมาตรกระบอกสูบ (CC) */  /*A65-0043*/ 
  FIELD   weight         AS DECI INIT 0 format ">>>>>9.99"        /*น้ำหนัก (ตัน)         */                        
  /*FIELD   watt           AS inte INIT 0 format ">>>>>>9"  */    /*Kilowatt              */
  FIELD   watt           AS DECI INIT 0 format ">>>>>>9"          /*Kilowatt              */  /*A65-0043*/ 
  ...
  FIELD   docoup         AS CHAR FORMAT "X(20)" INIT ""           /*ชื่ออาชีพ             */                        
  ...
  FIELD   ddocoup        AS CHAR FORMAT "X(20)" INIT ""           /*ชื่ออาชีพ             */                        
  FIELD   dddriveno      AS CHAR FORMAT "X(13)" INIT ""           /*เลขที่ใบอนุญาตขับขี่  */ 
  ....end A67-0029...*/                       
  FIELD   baseplus       AS DECI INIT 0 /*format "->>>>>>>9"    */ /*Base Premium Plus     */                        
  FIELD   siplus         AS DECI INIT 0 /*format "->>>>>>>>>9"  */ /*Sum Insured Plus      */                        
  FIELD   rs10           AS DECI INIT 0 /*format "->>>>>>>>>9"  */ /*RS10 Amount           */                        
  FIELD   comper         AS DECI INIT 0 /*format "->>>>>>>>>>>9"*/ /*TPBI / person         */                        
  FIELD   comacc         AS DECI INIT 0 /*format "->>>>>>>>>>>9"*/ /*TPBI / occurrence     */                        
  FIELD   deductpd       AS DECI INIT 0 /*format "->>>>>>>>>>>9"*/ /*TPPD                  */                        
  FIELD   DOD            AS DECI INIT 0 /*format "->>>>9"       */ /*Deduct / OD           */                        
  FIELD   DPD            AS DECI INIT 0 /*format "->>>>>9"      */ /*Deduct / PD           */                        
  FIELD   si             AS DECI INIT 0 /*format "->>>>>>>>>>9" */ /*suminsure         */                        
  FIELD   NO_411         AS DECI INIT 0 /*format "->>>>>>>9"*/     /*PA1.1 / driver        */                        
  FIELD   seat41         AS DECI INIT 0 /*format "->>>>>>>9"*/     /*PA1.1 no.of passenger */                        
  FIELD   NO_412         AS DECI INIT 0 /*format "->>>>>>>9"*/     /*PA1.1 / passenger     */                        
  FIELD   NO_413         AS DECI INIT 0 /*format "->>>>>>>9"*/     /*PA1.2 / driver        */                        
  FIELD   ac6            AS DECI INIT 0 /*format "->>>>>>>9"*/     /*PA1.2 no.of passenger */                        
  FIELD   NO_414         AS DECI INIT 0 /*format "->>>>>>>9"*/     /*PA1.2 / passenger     */                        
  FIELD   NO_42          AS DECI INIT 0 /*format "->>>>>>>9"*/     /*PA2                   */                        
  FIELD   NO_43          AS DECI INIT 0 /*format "->>>>>>>9"*/     /*PA3                   */  
  FIELD   base           AS DECI INIT 0 /*format "->>>>>9"  */     /*Base Premium    */                              
  FIELD   unname         AS deci INIT 0 /*format "->>>>>9.99"*/   /*Unname          */                              
  FIELD   nname          AS deci INIT 0 /*format "->>>>>9.99"*/   /*Name            */                              
  FIELD   tpbi           AS deci INIT 0 /*format "->>>>>9.99"*/   /*TPBI Amount     */                              
  FIELD   tppd           AS deci INIT 0 /*format "->>>>>9.99"*/   /*TPPD Amount     */                              
  FIELD   ry01           AS deci INIT 0 /*format "->>>>>9.99"*/   /*RY01 Amount     */                              
  ...
  FIELD   polmaster      AS CHAR FORMAT "x(20)" INIT "" 
  field   jpae           as char format "x(12)" 
  field   jpjtl          as char format "x(12)" 
  field   jpts           as char format "x(12)" 
  /* add by : A67-0029 */
  ...
  field  chargper        as char format "X(20)" init "" 
...
DEF New  SHARED VAR nv_41cod3   AS CHARACTER    FORMAT "X(4)".
DEF NEW  SHARED VAR nv_41cod4   AS CHARACTER    FORMAT "X(4)".
...
DEF VAR n_body       AS CHAR  INIT "" FORMAT "x(50)".
...
DEFINE VAR nv_411prmt AS DECI FORMAT ">>>,>>>,>>9.99-". /*New*/  /* แทน nv_41prmt หาก Template ยังเป็นค่าเดียวให้ใส่มาที่ช่องนี้ */
DEFINE var nv_412prmt AS DECI FORMAT ">>>,>>>,>>9.99-". /*New*/  /* 412 PREMIUM ส่ง 0 หากยังไม่มีค่า */
DEFINE var nv_413prmt AS DECI FORMAT ">>>,>>>,>>9.99-". /*New*/  /* 413 PREMIUM ส่ง 0 หากยังไม่มีค่า */
DEFINE var nv_414prmt AS DECI FORMAT ">>>,>>>,>>9.99-". /*New*/  /* 414 PREMIUM ส่ง 0 หากยังไม่มีค่า */
...
DEFINE VAR  nv_attgap    AS DECI FORMAT ">>,>>>,>>9.99-".    /*New*/ /* รยต.FLEET Premium */
...
DEFINE VAR nv_flgsht  AS CHAR.                              /*New*/ /* Short rate = "S" , Pro rate = "P" */
...
DEFINE VAR  nv_drivlevel AS INTE INIT 0.
