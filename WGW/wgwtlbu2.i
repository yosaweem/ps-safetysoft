...
/*modify by Kridtiya i. A57-0426 add renew policy add body by file                     */
/*Modify by  :Kridtiya i. A58-0206 เพิ่ม Line: V70,V72,V74                             */
/*Modify by  :Kridtiya i. A58-0271 เพิ่ม การนำเข้างาน ประเภท 2+ 3+                     */
/*Modify by : Ranu I. A59-0013 date .11/01/2016 เพิ่มตัวแปรเก็บค่า ced.pol             */
/*Modify by : Ranu I. A59-0060  date.01/03/2016 เพิ่มตัวแปรเก็บค่างานต่ออายุ           */
/*Modify by : Ranu I. A59-0400 Date. 31/08/2016 เพิ่มตัวแปรเก็บค่า product             */
/*Modify by : Ranu I. A60-0150 Date 29/03/2017  เพิ่มตัวแปรเก็บค่าอุปกรณ์เสริมพิเศษ    */
/*Modify by : Ranu I. A60-0262 Date 12/06/2017  เพิ่มตัวแปรเก็บค่า CCTV , Fin.int      */
/*Modify by : Sarinya C A61-0468  Date 28/09/2018 เพิ่ม คอลัมน์ ส่วนลดพรบ.             
              (พารามิเตอร์ ในระบบ Dspc.)                                               */
...
DEFINE NEW SHARED TEMP-TABLE wdetail
    ...
    FIELD cpol          AS CHAR FORMAT "x(25)" INIT "" /* A59-0013 */ 
    FIELD accdat        AS CHAR INIT "" FORMAT "x(10)"  
    FIELD ICNO          AS CHAR INIT "" FORMAT "x(15)" 
    FIELD dod0          AS CHAR INIT "" FORMAT "x(20)"     /*--- a59-0060---*/
    FIELD dod1          AS CHAR INIT "" FORMAT "x(20)"     /*--- a59-0060---*/
    FIELD dod2          AS CHAR INIT "" FORMAT "x(20)"     /*--- a59-0060---*/
    FIELD stf_per       AS CHAR INIT "" FORMAT "x(20)"     /*--- a59-0060---*/
    FIELD cl_per        AS CHAR INIT "" FORMAT "x(20)"     /*--- a59-0060---*/
    FIELD product       AS CHAR FORMAT "x(10)" INIT ""     /*--A59-0400--*/
    FIELD acctype       AS CHAR FORMAT "X(1)"  INIT ""     /*--A60-0150--*/
    FIELD cctv          AS CHAR FORMAT "x(10)" INIT ""     /*A60-0262*/
    FIELD finint        AS CHAR FORMAT "x(10)" INIT ""     /*A60-0262*/
...
DEF VAR n_cpol       AS CHAR  INIT "" FORMAT "x(30)". /* A59-0013 */
DEF VAR n_product    AS CHAR  INIT "" FORMAT "x(10)". /*A59-0400*/
DEF VAR nn_uom6_u    AS CHAR  INIT "" FORMAT "X(1)".  /*A60-0150*/
def var n_cctv       AS CHAR FORMAT "x(10)" INIT "". /*A60-0262*/ 
def var n_finint      AS CHAR FORMAT "x(20)" INIT "".  /*A60-0262*/ 
def var n_finint2     AS CHAR FORMAT "x(20)" INIT "".  /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/    
...
/*DEFINE WORKFILE wacctext*/  /*comment by Kridtiya i. A63-0472 Date. 09/11/2020*/ 
DEFINE TEMP-TABLE  wacctext   /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/ 
...
/*DEFINE WORKFILE wacctext15*/  /*comment by Kridtiya i. A63-0472 Date. 09/11/2020*/  
DEFINE TEMP-TABLE  wacctext15   /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/      
    FIELD n_policytxt15   AS CHAR  INIT "" FORMAT "x(100)" 
    FIELD n_textacc1      AS CHAR  INIT "" FORMAT "x(100)"  
    FIELD n_textacc2      AS CHAR  INIT "" FORMAT "x(100)"  
    FIELD n_textacc3      AS CHAR  INIT "" FORMAT "x(100)"  .
/*DEFINE WORKFILE wacctext17*/  /*comment by Kridtiya i. A63-0472 Date. 09/11/2020*/   
DEFINE TEMP-TABLE wacctext17    /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/       
...
Define var  re_tiname    as char format "x(20)" init "".    /*A59-0400*/    
Define var  re_insnam    as char format "x(70)" init "".    /*A59-0400*/
Define var  re_name2     as char format "x(50)" init "".    /*A59-0400*/
Define var  re_name3     as char format "x(50)" init "".    /*A59-0400*/
Define var  re_n_addr1   as char format "x(60)" init "".    /*A59-0400*/
Define var  re_n_addr2   as char format "x(60)" init "".    /*A59-0400*/
Define var  re_n_addr3   as char format "x(60)" init "".    /*A59-0400*/
Define var  re_n_addr4   as char format "x(60)" init "".    /*A59-0400*/
...
/*A58-0271 add for 2+,3+*/
/**/
DEF VAR n_dspc72          AS CHAR  INIT "" FORMAT "x(15)".           /*A61-0468*/
DEF VAR n_dsspc72         AS DECI  INIT "" FORMAT ">>,>>>,>>9.99-".  /*A61-0468*/
