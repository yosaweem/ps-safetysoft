...
/*create by   : Kridtiya i. A54-0181  date . 01/07/2011                
                ปรับโปรแกรมให้สามารถนำเข้า text file Nissan to GW system  */
/*modify by   : Kridtiya i. A54-0389 date . 22/12/2011 ปรับเบี้ยตามแคมเปญ */
/*modify by   : Kridtiya i. A56-0037 ปรับเบี้ยตามแคมเปญ  */
/*modify by   : Kridtiya i. A56-0150 ปรับเพิ่มเงื่อนไข เงินสด = B3m0019   */
/*modify by   : Kridtiya i. A56-0352 เพิ่มเงื่อนไขการเช็คเลขที่สัญญาพร้อมกับประเภทกรมธรรม์ */
/*Modify by   : Kridtiya i. A56-0047  Add check sicsyac.xmm600.clicod   = "IN"             */
/*Modify by   : Kridtiya i. A57-0275  Add check chassis duplicate   */
/*Modify by   : Kridtiya i. A57-0432  Add com 0 % ,address,vatcode  */
/*Modify by   : Kridtiya i. A58-0014  Add แปลงค่ารุ่นรถให้ค้นหารหัสรถได้  */
/*Modify By : Porntiwa T. A62-0105  Date : 18/07/2019
            : Change Host => TMSth*/
{wgw\wgwnsgen.i}      /*ประกาศตัวแปร*/
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 40.33 BY 4
...
DEFINE FRAME fr_main
     ...
     bu_add AT ROW 6.81 COL 115.67
     bu_clr AT ROW 6.81 COL 121.33
     bu_del AT ROW 6.81 COL 127
...
DEFINE FRAME fr_main
     ...
     "       Producer  Code 2:" VIEW-AS TEXT
          ...
          BGCOLOR 8 FGCOLOR 4 FONT 6
     "    Load Text File NISSAN [LOCTON]" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW c-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Load Text file NISSAN [wgwnsgen.w]"
         HEIGHT             = 23.95
         WIDTH              = 132.67
         MAX-HEIGHT         = 35.33
         MAX-WIDTH          = 170.67
...
ON END-ERROR OF c-Win /* Load Text file NISSAN [wgwnsgen.w] */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-Win c-Win
ON WINDOW-CLOSE OF c-Win /* Load Text file NISSAN [wgwnsgen.w] */
DO:
...
DO:
    ...
    REPEAT:
        ...
        ELSE IF ( deci(np_no)  > 0 )  AND ( DECI(np_no) < 999 ) THEN DO:
            ...
            IF TRIM(np_pol72) <> " "  THEN RUN proc_assign72.
        END.
...
IF NOT AVAIL wdetail  THEN DO:
    ...
    ASSIGN 
        ...
        wdetail.stk        = TRIM(np_stkno)
        wdetail.cr_2       = ""
        wdetail.garage     = IF trim(np_garage) = "อู่ห้าง"  THEN "H" ELSE ""
