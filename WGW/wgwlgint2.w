...
&ANALYZE-RESUME
&Scoped-define WINDOW-NAME wgwlgint2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _DEFINITIONS wgwlgint2 
/*************************************************************************
 ...
 Database   : BUINT
 ------------------------------------------------------------------------               
 CREATE BY  : kridtiya i. A61-0482 Date. 08/10/2018 โปรแกรม สำหรับ Login database buint
 ------------------------------------------------------------------------ 
...
DEFINE VAR wgwlgint2 AS WIDGET-HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wgwlgint2 ASSIGN
         HIDDEN             = YES
         TITLE              = "LOGIN - <WGWLGINT2>DATA BASE BUInt"
         HEIGHT             = 8.14
         WIDTH              = 52.33
         MAX-HEIGHT         = 16
         MAX-WIDTH          = 80
...
IF NOT wgwlgint2:LOAD-ICON("adeicon/progress.ico":U) THEN
...
/* SETTINGS FOR WINDOW wgwlgint2
  VISIBLE,,RUN-PERSISTENT                                               */
/* SETTINGS FOR FRAME fr_main
   FRAME-NAME                                                           */
IF SESSION:DISPLAY-TYPE = "GUI":U AND VALID-HANDLE(wgwlgint2)
THEN wgwlgint2:HIDDEN = no.
...
&Scoped-define SELF-NAME wgwlgint2
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wgwlgint2 wgwlgint2
ON END-ERROR OF wgwlgint2 /* LOGIN - <WGWLGINT2>DATA BASE BUInt */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wgwlgint2 wgwlgint2
ON WINDOW-CLOSE OF wgwlgint2 /* LOGIN - <WGWLGINT2>DATA BASE BUInt */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bu_cancel wgwlgint2
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bu_OK wgwlgint2
...
DO:
    ...
    IF NOT CONNECTED("BUInt") THEN DO:   
        /*CONNECT BUExt  -H 172.17.2.34  -S 61770    -N tcp -U VALUE(fi_username) -P VALUE(fi_password)  NO-ERROR.  /*Ho*/*/
         ...
         /*connect BUInt -H 16.90.20.216 -S 5502     -N TCP -U VALUE(fi_username) -P VALUE(fi_password)  NO-ERROR.  /*Test*/ */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_password wgwlgint2
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_username wgwlgint2
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _MAIN-BLOCK wgwlgint2 
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   RUN  WUT\WUTWICEN (wgwlgint2:HANDLE).  
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE disable_UI wgwlgint2  _DEFAULT-DISABLE
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE enable_UI wgwlgint2  _DEFAULT-ENABLE
PROCEDURE enable_UI :
/*------------------------------------------------------------------------------
...
------------------------------------------------------------------------------*/
  DISPLAY fi_username fi_password 
      WITH FRAME fr_main IN WINDOW wgwlgint2.
