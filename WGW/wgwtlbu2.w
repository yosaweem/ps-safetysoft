...
RECT-373 RECT-374 RECT-375 RECT-377 RECT-378 RECT-379 
...
DEFINE FRAME fr_main
     "LOAD TEXT FILE MOTOR[BU2]" VIEW-AS TEXT
     ...
     "TieS 4 01/03/2022":60 VIEW-AS TEXT
          SIZE 19 BY .91 AT ROW 14.24 COL 95.67 WIDGET-ID 2
          BGCOLOR 8 FGCOLOR 1 FONT 6
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW c-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "LOAD TEXT FILE MOTOR[BU2]"
         HEIGHT             = 24
         WIDTH              = 132.67
         MAX-HEIGHT         = 45.76
         MAX-WIDTH          = 213.33
...
ON END-ERROR OF c-Win /* LOAD TEXT FILE MOTOR[BU2] */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-Win c-Win
ON WINDOW-CLOSE OF c-Win /* LOAD TEXT FILE MOTOR[BU2] */
DO:
...
DO:
    ...
    EXPORT DELIMITER "|" 
        ...
        "เลขกรมธรรม์ใหม่ V70"
        "Line V70"
        "เลขกรมธรรม์เดิม V72 V73 V74"
        "เลขกรมธรรม์ใหม่ V72 V73 V74"
        "Line V72 V73 V74"
        "สาขา"
        "รหัสลูกค้า Acc Code"
        "IC.NO."
        ...
        "Text F5 หลังจากนั้นเพิ่มตามหมายเหตุด้านล่าง"
        "F15=P.Text02"
        "F15=P.Text03"
        "F17=Memo01"
        "F17=Memo02"
        ...
        "Com.Date      "
        "Exp.Date      "
        "วันเริ่มประกัน72,73,74"
        "วันหมดประกัน72,73,74"
...
/********************  T I T L E   F O R  C - W I N  ****************/
  ...
  ASSIGN 
      gv_prgid   = "wgwtlbu2.w"
      gv_prog    = "LOAD TEXT FILE MOTOR[BU2]"
      fi_loaddat = TODAY.
  DISP fi_loaddat WITH FRAME fr_main.
  ...
  ASSIGN
      ...
      /*fi_branch   = "W" */ /*a60-0262*/
      fi_vatcod   = ""
      /*fi_producer = "B3F0001" */ /*a60-0262*/
      /*fi_agent    = "B3F0001" */ /*a60-0262*/
      fi_producer = ""  /*a60-0262*/  
      fi_agent    = ""  /*a60-0262*/ 
      fi_branch   = ""  /*a60-0262*/
      fi_bchyr    = YEAR(TODAY)
      fi_process  = "LOAD TEXT FILE MOTOR[BU2]".
...
IF fi_policymas72 <> ""  THEN DO:
    ...
    END.
END.
/*--- add DSPC72 by Sarinya C A61-0468 DSPC72 ----*/
IF deci(wdetail.dspc) <> 0  THEN DO:
    ...
    RUN proc_72dspc.
END.
/*--- end  add DSPC72 by Sarinya C A61-0468 DSPC72 ----*/ 
...
DO:
    ...
    REPEAT:
        IMPORT DELIMITER "|" 
          ...
          np_type01            /*A58-0206*/           /*Line V70                  */   
          np_prepol72          /*เลขกรมธรรม์เดิม V72 V73 V74                      */   
          n_policy72           /*เลขกรมธรรม์ใหม่ V72 V73 V74                      */   
          np_type02            /*A58-0206*/           /*Line V72 V73 V74          */   
          n_branch             /*สาขา                                             */   
          np_insref            /*รหัสลูกค้า Acc Code                              */   
          np_icno              /*IC.NO.                                           */   
          np_title             /*คำนำหน้า(คุณ/บริษัท)                             */   
          np_name1             /*ชื่อ-สกุล(ลูกค้า)                                */   
          np_addr1             /* ที่อยู่  1                                      */   
          np_addr2             /* ที่อยู่  2                                      */   
          np_addr3             /* ที่อยู่  3                                      */   
          np_addr4             /* ที่อยู่  4                                      */   
          n_cover              /*ประเภทความคุ้มครอง 1 2 3                         */   
          n_textf5             /*Text F5 หลังจากนั้นเพิ่มตามหมายเหตุด้านล่าง      */   
          n_textf52            /*F15=P.Text02                                     */   
          n_textf53            /*F15=P.Text03                                     */   
          n_textf7             /*F17=Memo01                                       */   
          n_textf72            /*F17=Memo02                                       */   
          n_textf73            /*F17=Memo03                                       */   
          n_com70              /*com 70                                           */   
          n_com72              /*com 72,73,74                                     */   
          nf_vehuse70          /*ลักษณะการใช้รถ 70                                */   
          n_class70            /*Class 70                                         */   
          nf_vehuse72          /*Veh.usage. 72,73,74                              */   
          n_class72            /*class 72,73,74                                   */   
          n_seat1              /*seat                                             */   
          n_Engine             /*CC                                               */   
          n_Tonnage            /*Tonnage..                                        */   
          n_garage             /*garage                                           */   
          ...
          n_ncb                /*NCB                                              */   
          n_feet               /*Fleet                                            */   
          nn_dedod             /*A60-0005*/            /*dod                      */   
          nn_dedpd             /*A60-0005*/            /*dod pd                   */   
          nn_cl_per            /*A60-0150*/            /*Load claim               */   
          nn_stf_per           /*A60-0150*/             /*Staff(%)                */   
          n_dspc               /*dspc                                             */
          n_dspc72             /*dspc72                                           */ /*A61-0468*/
          n_cctv               /*A60-0262*/           /*CCTV                      */
          n_base               /*Base Premium                                     */   
          n_nap                /*NAP                                              */   
          ...
          n_comdat1            /*Com.Date                                         */   
          n_expdat1            /*Exp.Date                                         */   
          n_comdat72           /*วันเริ่มประกัน72,73,74                           */   
          n_expdat72           /*วันหมดประกัน72,73,74                             */   
          n_benname            /*ผู้รับผลประโยชน์ Finance                         */   
          n_cpol               /*-- A59-0013 --*/    /*เลขที่สัญญา                */   
          n_product            /* A59-0400 */        /*Product type               */  
          nn_uom6_u            /*A60-0150*/           /*อุปกรณ์เสริมพิเศษ */      
          n_finint             /*A60-0262*/                                       
          n_textacc            /*F6_ACC_1                                         */   
          n_textacc1           /*F6_ACC_2                                         */   
          n_textacc2           /*F6_ACC_3                                         */   
          ...
          n_textacc7           /*F6_ACC_8                                         */   
          n_textacc8           /*F6_ACC_9                                         */   
          n_textacc9           /*F6_ACC_10                                        */ 
          n_finint2   .         /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/
        /*n_bennams*/
        ...
        ELSE DO:
          ...
          IF TRIM(wdetail.inserf) <> ""  THEN DO:
            ...
            IF AVAIL sicsyac.xmm600  THEN DO:
              IF wdetail.tiname  = "" THEN ASSIGN wdetail.tiname  = trim(sicsyac.xmm600.ntitle).
              IF wdetail.insnam  = "" THEN ASSIGN wdetail.insnam  = trim(sicsyac.xmm600.name).
              IF wdetail.icno    = "" THEN ASSIGN wdetail.icno    = IF TRIM(sicsyac.xmm600.icno) = "" THEN trim(wdetail.icno) ELSE TRIM(sicsyac.xmm600.icno).
              IF wdetail.n_addr1 = "" THEN ASSIGN wdetail.n_addr1 = trim(sicsyac.xmm600.addr1).
              IF wdetail.n_addr2 = "" THEN ASSIGN wdetail.n_addr2 = trim(sicsyac.xmm600.addr2).
              IF wdetail.n_addr3 = "" THEN ASSIGN wdetail.n_addr3 = trim(sicsyac.xmm600.addr3).
              IF wdetail.n_addr4 = "" THEN ASSIGN wdetail.n_addr4 = trim(sicsyac.xmm600.addr4) .
              /*Add by Kridtiya i. A63-0472*/
              ASSIGN wdetail.firstName = TRIM(sicsyac.xmm600.firstname)
            ...
            END.
            /* End A59-0400 */
            ELSE Message "รหัสลูกค้า  " trim(wdetail.inserf) " ไม่พบในระบบกรุณาตรวจสอบอีกครั้ง !!!"  View-as alert-box.
          END.
          ELSE DO:
              wdetail.br_insured = "00000".
              RUN proc_assign2 (INPUT  wdetail.tiname     
                               ,INPUT  wdetail.insnam     
                               ,INPUT  wdetail.n_addr1   
                               ,INPUT  wdetail.n_addr2   
                               ,INPUT  wdetail.n_addr3   
                               ,INPUT  wdetail.n_addr4  
                               ,INPUT  wdetail.occup
                               ,OUTPUT wdetail.insnamtyp
                               ,OUTPUT wdetail.firstName 
                               ,OUTPUT wdetail.lastName  
                               ,OUTPUT wdetail.postcd   
                               ,OUTPUT wdetail.codeocc     
                               ,OUTPUT wdetail.codeaddr1   
                               ,OUTPUT wdetail.codeaddr2   
                               ,OUTPUT wdetail.codeaddr3). 
              IF wdetail.postcd <> "" THEN DO:
                  IF       index(wdetail.n_addr4,wdetail.postcd) <> 0 THEN wdetail.n_addr4  = REPLACE(wdetail.n_addr4,wdetail.postcd,"").
                  ELSE IF  index(wdetail.n_addr3,wdetail.postcd) <> 0 THEN wdetail.n_addr3  = REPLACE(wdetail.n_addr3,wdetail.postcd,"").
                  ELSE IF  index(wdetail.n_addr2,wdetail.postcd) <> 0 THEN wdetail.n_addr2  = REPLACE(wdetail.n_addr2,wdetail.postcd,"").
                  ELSE IF  index(wdetail.n_addr1,wdetail.postcd) <> 0 THEN wdetail.n_addr1  = REPLACE(wdetail.n_addr1,wdetail.postcd,"").
              END.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
DEFINE INPUT PARAMETER   nnpp_title        as char init "".
DEFINE INPUT PARAMETER   nnpp_name1        as char init "".
DEFINE INPUT PARAMETER   nnpp_addr1        as char init "".
DEFINE INPUT PARAMETER   nnpp_addr2        as char init "".
DEFINE INPUT PARAMETER   nnpp_addr3        as char init "".
DEFINE INPUT PARAMETER   nnpp_addr4        as char init "".
DEFINE INPUT PARAMETER   nnpp_occupation   as char init "".
DEFINE OUTPUT PARAMETER  nnpp_insnamtyp    as char init "".
DEFINE OUTPUT PARAMETER  nnpp_firstName    as char init "".
DEFINE OUTPUT PARAMETER  nnpp_lastName     as char init "".
DEFINE OUTPUT PARAMETER  nnpp_postcd       as char init "".
DEFINE OUTPUT PARAMETER  nnpp_codeocc      as char init "".
DEFINE OUTPUT PARAMETER  nnpp_codeaddr1    as char init "".
DEFINE OUTPUT PARAMETER  nnpp_codeaddr2    as char init "".
DEFINE OUTPUT PARAMETER  nnpp_codeaddr3    as char init "".

RUN proc_assign2name  (INPUT  nnpp_title
                      ,INPUT  nnpp_name1
                      ,OUTPUT nnpp_insnamtyp
                      ,OUTPUT nnpp_firstName
                      ,OUTPUT nnpp_lastName).
ASSIGN nnpp_postcd = "".
RUN proc_assign2addr    (INPUT  nnpp_addr1
                        ,INPUT  nnpp_addr2
                        ,INPUT  nnpp_addr3 + " " +  nnpp_addr4
                        ,INPUT  nnpp_occupation 
                        ,OUTPUT nnpp_postcd
                        ,OUTPUT nnpp_codeocc  
                        ,OUTPUT nnpp_codeaddr1
                        ,OUTPUT nnpp_codeaddr2
                        ,OUTPUT nnpp_codeaddr3).
...
DEFINE OUTPUT PARAMETER  np_postcd        as char init "".
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
DEFINE INPUT  PARAMETER  npp_title       as char init "".   /*nvpp_title      */
DEFINE INPUT  PARAMETER  npp_name1        as char init "".   /*nvpp_name1      */
DEFINE OUTPUT PARAMETER  npp_insnamtyp   as char init "".
DEFINE OUTPUT PARAMETER  npp_firstName   as char init "".   /*nvpp_firstName  */
DEFINE OUTPUT PARAMETER  npp_lastName    as char init "".   /*nvpp_lastName). */
DEFINE VAR npp_textname  AS CHAR.
ASSIGN npp_textname = npp_title + np_name1  .
...
IF  R-INDEX(TRIM(npp_textname),"จก.")             <> 0  OR              
    ...
    ASSIGN
    npp_insnamtyp   = "CO"
    npp_firstName   = TRIM(npp_name1)
    npp_lastName    = "".
     
END.
ELSE DO:
    npp_insnamtyp   = "PR".
    IF INDEX(trim(npp_name1)," ") <> 0 THEN
        ASSIGN
        npp_firstName  = substr(TRIM(npp_name1),1,INDEX(trim(npp_name1)," ")) 
        npp_lastName   = substr(TRIM(npp_name1),INDEX(trim(npp_name1)," ")) .
    ELSE ASSIGN       
        npp_firstName  = TRIM(npp_name1)
        npp_lastName   = "".          
...
IF  CONNECTED("sic_exp") THEN DO:
    ...
    RUN wgw\wgwbu2ex(INPUT-OUTPUT  wdetail.prepol,      
                     ...
                     /*INPUT-OUTPUT  wdetail.tiname, */   /*A59-0400*/         
                     /*INPUT-OUTPUT  wdetail.insnam, */   /*A59-0400*/              
                     /*INPUT-OUTPUT  wdetail.name2,  */   /*A59-0400*/       
                     /*INPUT-OUTPUT  wdetail.name3,  */   /*A59-0400*/     
                     /*INPUT-OUTPUT  wdetail.n_addr1,*/   /*A59-0400*/    
                     /*INPUT-OUTPUT  wdetail.n_addr2,*/   /*A59-0400*/       
                     /*INPUT-OUTPUT  wdetail.n_addr3,*/   /*A59-0400*/       
                     /*INPUT-OUTPUT  wdetail.n_addr4,*/   /*A59-0400*/
                     INPUT-OUTPUT  re_tiname,              /*A59-0400*/
                     INPUT-OUTPUT  re_insnam,              /*A59-0400*/
                     INPUT-OUTPUT  re_name2,               /*A59-0400*/
                     INPUT-OUTPUT  re_name3,               /*A59-0400*/
                     INPUT-OUTPUT  re_n_addr1,             /*A59-0400*/
                     INPUT-OUTPUT  re_n_addr2,             /*A59-0400*/
                     INPUT-OUTPUT  re_n_addr3,             /*A59-0400*/
                     INPUT-OUTPUT  re_n_addr4,             /*A59-0400*/         
...
IF  wdetail.tiname   = ""   then  Assign wdetail.tiname   =  re_tiname . /*A59-0400*/
IF  wdetail.insnam   = ""   then  Assign wdetail.insnam   =  re_insnam . /*A59-0400*/
IF  wdetail.name2    = ""   then  Assign wdetail.name2    =  re_name2  . /*A59-0400*/
IF  wdetail.name3    = ""   then  Assign wdetail.name3    =  re_name3  . /*A59-0400*/
IF  wdetail.n_addr1  = ""   then  Assign wdetail.n_addr1  =  re_n_addr1. /*A59-0400*/
IF  wdetail.n_addr2  = ""   then  Assign wdetail.n_addr2  =  re_n_addr2. /*A59-0400*/
IF  wdetail.n_addr3  = ""   then  Assign wdetail.n_addr3  =  re_n_addr3. /*A59-0400*/
IF  wdetail.n_addr4  = ""   then  Assign wdetail.n_addr4  =  re_n_addr4. /*A59-0400*/
...
IF  wdetail.ton      = 0    THEN ASSIGN wdetail.ton      =  n_Tonn70. /*A59-0400*/   /*A60-0262*/
IF  wdetail.engcc    = ""   THEN ASSIGN wdetail.engcc    =  n_engine. /*A60-0005*/   /*A60-0262*/
...
IF  wdetail.dod0     = ""   THEN ASSIGN wdetail.dod0     =  STRING(re_dedpd).   A63-00472 */  
...
IF wdetail.poltyp = "v70" THEN DO:
   ASSIGN fi_process = "Create data to base..." + wdetail.policy 
    ...
    IF wdetail.body <> "Motorcycle" THEN DO: /*ranu */
    ...
    /*nv_cl_per  = 0.*/
    nv_clmvar  = " ".
    nv_cl_per  = DECI(wdetail.cl_per). /*A60-0150*/
    IF nv_cl_per  <> 0  THEN
        Assign 
...
IF wdetail.poltyp = "V70" THEN DO:
    ...
    ASSIGN               
       ...
       /*nv_cstflg  = "C"  /*C=CC ; S=Seat ; T=Tons ; W=Watts*/ 
         ...
         nv_access  = IF wdetail.acctyp <> "" THEN "A" ELSE ""                                             
       /*nv_supe    = NO*/                                              
...
IF NOT AVAILABLE uwm130 THEN 
    ...
    IF avail stat.clastab_fil Then do:
        ...
        IF substr(wdetail.class,1,1) = "Z" OR substr(wdetail.class,1,1) = "T" THEN  /*Add by Kridtiya i. A63/00167*/
            Assign 
        ...
        IF (wdetail.prepol <> "") OR (substr(wdetail.class,1,1) = "Z") OR (substr(wdetail.class,1,1) = "T")  THEN    /*Add by Kridtiya i. A63/00167*/    
    ...
    ASSIGN sic_bran.uwm301.policy = sic_bran.uwm120.policy                 
      ...
      /*sic_bran.uwm301.trareg    = trim(wdetail.vehreg)*/  /*A58-0206*/
        ...
        sic_bran.uwm301.Tons      = DECI(wdetail.Tonn)
        sic_bran.uwm301.engine    = IF nv_sclass  =  "320" THEN 0 ELSE INTEGER(wdetail.engcc)
        sic_bran.uwm301.yrmanu    = INTEGER(wdetail.caryear)
...
IF wdetail.commission <> "" THEN DO: /* A59-0400 */
/*-------------------- calprem ---------------------*/
    ...
    ELSE DO:
      ...
      IF wdetail.poltyp = "v72" OR wdetail.poltyp = "v74" THEN   /*Add Kridtiya i. A61-0352 V74 COMM I=0*/
                ASSIGN  
...
END. /*A59-0060*/
/* งานต่ออายุ : A59-0060 */
/*ELSE IF sic_bran.uwm100.prvpol <> "" OR  wdetail.commission = "" THEN DO:*/ /*A59-0400 */
ELSE DO:    /*A59-0400 */
    RUN proc_chktest4_2.
END.
/* End A59-0060 */
...
IF NOT AVAIL wdetail THEN DO:
    ...
    ASSIGN 
        ...
        /*wdetail.n_branch   = trim(n_branch) */ /*A60-0262*/
        wdetail.n_branch    = IF trim(n_branch) = "" THEN TRIM(fi_branch) ELSE TRIM(n_branch) /*A60-0262*/ 
        ...
        wdetail.Tonn       = IF n_Tonnage = "" THEN deci(trim(n_Engine))  ELSE deci(trim(n_Tonnage))  /*A57-0195*/   
        ...
        wdetail.product    =  TRIM(n_product)    /* A59-0400 */
        wdetail.dod1       =  TRIM(nn_dedod)     /* A60-0005 */
        wdetail.dod0       =  trim(nn_dedpd)     /* A60-0005 */
        wdetail.cl_per     =  TRIM(nn_cl_per)    /*A60-0150*/
        wdetail.stf_per    =  TRIM(nn_stf_per)   /*A60-0150*/
        wdetail.acctyp     =  TRIM(nn_uom6_u)    /*A60-0150*/
        wdetail.cctv       = trim(n_cctv)       /*A60-0262*/
        wdetail.finint     = trim(n_finint)     /*A60-0262*/
        wdetail.financecd  = trim(n_finint2) .   /*A60-0262*/
    /* Add A56-0151 */
...
FIND FIRST wdetail WHERE wdetail.policy = trim(n_policy72) NO-ERROR NO-WAIT.
    IF NOT AVAIL wdetail THEN DO:
        ...
        ASSIGN 
            ...
            /*wdetail.n_branch    = IF trim(n_branch) */ /*A60-0262*/
            wdetail.n_branch    = IF trim(n_branch) = "" THEN TRIM(fi_branch) ELSE TRIM(n_branch) /*A60-0262*/  
            wdetail.inserf      = trim(np_insref)  
            wdetail.icno        = TRIM(np_icno)
            wdetail.tiname      = trim(np_title)                                     
            ...
            wdetail.product     = TRIM(n_product)      /* A59-0400 */
            wdetail.finint      = trim(n_finint)     /*A60-0262*/
            wdetail.dspc        = trim(n_dspc72)     /*A61-0468*/
            wdetail.financecd  = trim(n_finint2) .   /*A60-0262*/
    END.
END PROCEDURE.
...
/*------------------------------------------------------------------------------
  Purpose:  Definition Program   
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
/*Modify By : Ranu I. A60-0150 Date 27/03/2017                                          */
/*           เพิ่มช่อง Load Claim(%),Staff(%) ในไฟล์โหลด และเพิ่มการดึงข้อมูลเข้าระบบ   */
/*Modify By : Ranu I. A60-0262 Date 12/06/2017  Default br agent producer = ""          */
/*           เพิ่มช่อง CCTV, Fin.int ในไฟล์โหลด และเพิ่มการดึงข้อมูลเข้าระบบ 
             งานต่ออายุดึงข้อมูลจากใบเตือนถ้าในไฟล์ CC เป็นค่าว่าง  และ Tonn เป็นค่าว่างหรือ 0 */
...
/*Modify by : Ranu I. A59-0060 01/03/2016 เพิ่มการเก็บค่าข้อมูลกรมธรรม์เดิม   */
/*Modify by : Kridtiya i. A59-0185  */
/*Modify by : Ranu I. A59-0400 งานต่ออายุเพิ่มการเก็บค่าคอมมิชชั่นจากไฟล์       */
/*            เพิ่มการเก็บค่า Product type , น้ำหนักรถ(Ton.) เอาข้อมูลจากไฟล์   */ 
/*Modify By : Ranu I. A60-0005 เพิ่มช่อง dod , dod pd ในไฟล์โหลด และเพิ่มการดึงข้อมูล Deduct ข้อมูล CC. ดึงข้อมูลจากไฟล์งาน */
/* Definitions : proc_definitons */
/*Modify By : Kridtiya i. A61-0352 Date. 19/07/2018 ให้ค่า COMM I = 0 */
/*Modify By : Porntiwa T. A62-0105  Date : 18/07/2019
            : Change Host => TMSth*/
/*Modify By : Kridtiya i. A63-0167 Date. 21/04/2020 ปรับ แพค ทั้งหมด เข้าใช้ แพค T*/    
...
ASSIGN 
         ...
         n_cctv       = ""      /*A60-0262*/
         n_finint     = ""      /*A60-0262*/
         nv_campaign_ov = ""    /*Add by Kridtiya i. A63-0472*/ 
         np_occupn    = ""      /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/
         n_finint2    = "".     /*Add by Kridtiya i. A63-0472 Date. 09/11/2020*/
...
DO TRANSACTION:                                                                         
    ASSIGN                                                                             
        ...
        /*sic_bran.uwm100.finint = "" */ /*A60-0262*/
        sic_bran.uwm100.finint = trim(wdetail.finint)           /*A60-0262*/
        sic_bran.uwm100.dealer = trim(wdetail.financecd)        /*Add by Kridtiya i. A63-0472*/ 
        sic_bran.uwm100.bs_cd  = caps(trim(wdetail.vatcode))    
        sic_bran.uwm100.cr_1   = TRIM(wdetail.product)          /* A59-0400 */
        sic_bran.uwm100.occupn     = trim(wdetail.occup)        /*Add by Kridtiya i. A63-0472*/ 
