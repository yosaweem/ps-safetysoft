...
Modify by    : Kridtiya i. A64-0137  27/03/2021 เพิ่ม รหัสตัวแทนนายหน้า ให้สามารถเลือกได้ 
                                                และ เพิ่ม ชื่อผู้รับผลประโยชน์ กรณี สถานะข้มูล คือ Active
+++++++++++++++++++++++++++++++++++++++++++++++*/
...
DEFINE NEW SHARED TEMP-TABLE wdetail NO-UNDO
    ...
    FIELD DD            AS CHAR FORMAT "X(15)"  INIT ""  /*ส่วนลดประวัติเสีย */           
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_imptxt C-Win _FREEFORM
  QUERY br_imptxt NO-LOCK DISPLAY
      ...
      wtlt.comdat       COLUMN-LABEL "วันที่คุ้มครอง 70 "      FORMAT "X(15)"       
      wtlt.comdat72     COLUMN-LABEL "วันที่คุ้มครอง 72 "       FORMAT "X(15)"  
...
DO:
    ...
    IF cb_producer = ""  THEN DO:
        MESSAGE "Producer code เป็นค่าว่าง " VIEW-AS ALERT-BOX.
        APPLY "entry" TO cb_producer .
        RETURN NO-APPLY.
    END.
    ELSE IF fi_agent = ""  THEN DO:
        MESSAGE "Agent code เป็นค่าว่าง " VIEW-AS ALERT-BOX.
        APPLY "entry" TO fi_agent .
        RETURN NO-APPLY.
    END.
    ELSE IF fi_filename = ""  THEN DO:
        MESSAGE "ไฟล์นำเข้าข้อมูล เป็นค่าว่าง " VIEW-AS ALERT-BOX.
...
DO:
    ...
    REPEAT:
        ...
        IMPORT DELIMITER "|"   
            ...
            wdetail.RegisDate       /*วันที่     */                             
            wdetail.CMRName         /*ชื่อเจ้าหน้าที่ผู้แจ้งประกันภัย*/         
            Wdetail.company         /*ชื่อบริษัท        */                      
            wdetail.pol_fname       /*ชื่อผู้เอาประกัน  */                      
            wdetail.prevpol         /*กรมธรรม์เดิม      */                      
            wdetail.cartyp          /*ประเภทรถ          */                      
            wdetail.Brand_Model     /*ยี่ห้อรถ/รุ่น     */                      
            wdetail.yrmanu          /*ปีรุ่น            */                      
            wdetail.RegisNo         /*ทะเบียนรถ         */                      
            wdetail.RegisProv       /*จังหวัด           */                      
            wdetail.CC              /*ขนาด              */                      
            wdetail.weigth          /*น้ำหนัก           */ 
            wdetail.chassis         /*เลขเครื่องยนต์    */  
            wdetail.engine          /*เลขตัวถัง         */      
            wdetail.CovTyp          /*ประเภทการประกันภัย*/                      
            wdetail.comdat          /*วันที่คุ้มครอง    */                      
            wdetail.totalprem       /*ค่าเบี้ยประกันภัย */                      
            wdetail.SI              /*ทุนประกัน         */                      
            wdetail.garage          /*สถานที่ซ่อม       */                      
            wdetail.typins          /*ประเภท            */                      
            Wdetail.ncbper          /*%NCB              */                      
            wdetail.DD              /*ค่าเสียหายส่วนแรก */                      
            wdetail.drivno          /*ระบุผู้ขับขี่     */                      
            wdetail.drivid1         /*เลขบัตรใบขับขี่   */                      
            wdetail.accsor          /*อุปกรณ์เพิ่มเติม  */                      
            wdetail.comdat72        /*วันคุ้มครองพรบ.   */                      
            wdetail.comp_prmtotal   /*ค่าเบี้ยพรบ.  */                          
            /*wdetail.stk     */        /*สติกเกอร์     */                          
            wdetail.sts             /*Status        */                          
            wdetail.icno            /*ID            */                          
            wdetail.not_time        /*เวลาส่งงาน    */                          
            wdetail.account_no      /*เลขที่สัญญา   */                          
            wdetail.pol_addr1       /*ที่อยู่ในการส่งเอกสาร*/                   
            wdetail.pol_addr2       /*ที่อยู่   */                              
            wdetail.pol_addr3       /*ที่อยู่   */                              
            wdetail.pol_addr4       /*ที่อยู่   */                              
            wdetail.pol_addr5       /*ที่อยู่   */                              
            wdetail.Remark   .       /*หมายเหตุ  */                              
        IF INDEX(wdetail.n_no,"ลำดับ") <> 0 THEN  DELETE wdetail.
...
DO:
    ...
    REPEAT:
        ...
        IMPORT DELIMITER "|"  
            ...
            wdetail.CMRName         /*ชื่อเจ้าหน้าที่ผู้แจ้งประกันภัย*/                      
            wdetail.icno            /*ID            */  .                             
        IF INDEX(wdetail.n_no,"ที่")        <> 0 THEN  DELETE wdetail.
        ELSE IF INDEX(wdetail.n_no,"No")    <> 0 THEN  DELETE wdetail.
        ELSE IF TRIM(wdetail.n_no)          <> "" THEN  DELETE wdetail.
        ELSE IF INDEX(wdetail.account_no,"เลข") <> 0 THEN  DELETE wdetail.
...
FOR EACH wdetail .
    ...
    ASSIGN   
        ...
        ELSE DO:
            ...
            IF (wdetail.comdat72 <>  ""  AND index(wdetail.comdat72,"พรบ") = 0 ) THEN ASSIGN nv_comdat72  = DATE(wdetail.comdat72).
                ...
                IF NOT AVAIL brstat.tlt THEN DO:
                    CREATE brstat.tlt.
                        ...
                        ASSIGN                                                 
                            ...
                            brstat.tlt.comp_usr_tlt =   IF trim(wdetail.typins) = "5" THEN "2.2" ELSE TRIM(wdetail.typins) /*ประเภทความคุ้มครอง   */          
                            ...
                            brstat.tlt.comp_grprm   =   IF Wdetail.comp_prmtotal <> "-" AND Wdetail.comp_prmtotal <> "" 
                                                        THEN DECI(Wdetail.comp_prmtotal)  ELSE 0     /*เบี้ยรวม พรบ. */  
                            brstat.tlt.filler1      =   TRIM(wdetail.prevpol)               /*เบอร์ต่ออายุ*/ 
                            brstat.tlt.flag         =   "R"  /* ประเภทงาน N = งานใหม่ R = ต่ออายุ */ 
                    ...
                    IF NOT AVAIL brstat.tlt THEN DO:
                       CREATE brstat.tlt.
                            ...
                            ASSIGN                                                 
                                ...
                                brstat.tlt.safe2        =   caps(trim(wdetail.Account_no))   /*เลขที่สัญญา   */ 
                                brstat.tlt.nor_usr_ins  =   trim(wdetail.CMRName)            /*ผู้แจ้ง       */
                                brstat.tlt.colorcod     =   TRIM(wdetail.CovTyp)             /*ประเภทรถประกัน*/ 
                                brstat.tlt.old_cha      =   TRIM(wdetail.cartyp )            /* ประเภทรถ */
                                brstat.tlt.comp_usr_tlt =   IF trim(wdetail.typins) = "5" THEN "2.2" ELSE TRIM(wdetail.typins)   /*ประเภทความคุ้มครอง   */ 
                                brstat.tlt.old_eng      =   TRIM(wdetail.weigth)             /* พรบ . แถม/ไม่แถม */
                                brstat.tlt.gendat       =   nv_comdat                        /*วันที่เริ่มคุ้มครอง  */ 
                                brstat.tlt.ins_name     =   trim(wdetail.pol_fname)          /*ชื่อผู้เอาประกันภัย */           
                                brstat.tlt.ins_addr5    =   trim(wdetail.icno)               /*IDCARD              */
                                brstat.tlt.nor_usr_tlt  =   TRIM(wdetail.company)            /* ชื่อบริษัท */
                                ...
                                brstat.tlt.comp_grprm   =   IF INDEX(Wdetail.comdat72,"ไม่") = 0  THEN DECI(Wdetail.comp_prmtotal)  ELSE 0     /*เบี้ยรวม พรบ. */  
                                brstat.tlt.comp_sck     =   TRIM(wdetail.stk)                /* สติ๊กเกอร์ */  
                                brstat.tlt.rec_addr5    =   "NCB:" + TRIM(wdetail.ncbper) +  /* ncb */
                                                            " DD:" + TRIM(wdetail.DD)        /*Deduct */ 
                                brstat.tlt.safe1        =   TRIM(wdetail.accsor)             /*อุปกรณ์ตกแต่ง*/ 
                                ...
                                brstat.tlt.comp_sub     =   TRIM(cb_producer)      
                                brstat.tlt.comp_noti_ins =  TRIM(fi_agent) 
                                brstat.tlt.dri_name1    =   ""   /*  ชื่อผู้ขับขี่ 1 */
                                brstat.tlt.dri_name2    =   ""   /*  ชื่อผู้ขับขี่ 2 */ 
                                brstat.tlt.dri_no2      =   ""   /* เลขใบขับขี่ 2 */
                                brstat.tlt.rec_addr1    =   "ISP: RES: "   /* isp no */
                                /*brstat.tlt.rec_addr2  =   "BEN: CAM: "   /* ผู้รับผลประโยชน์  + แคมเปญ */*/
                                brstat.tlt.rec_addr2    =  IF wdetail.sts = "Active" THEN "BEN:ธนาคารไทยพาณิชย์ จำกัด(มหาชน) CAM:" 
                                                           ELSE "BEN: CAM:"
                                brstat.tlt.rec_addr3    =   ""   /* User ID ที่แก้ไขข้อมูล */
                                brstat.tlt.nor_noti_ins =   ""   /*เบอร์ใหม่ */            
                                brstat.tlt.comp_pol     =   ""   /*เบอร์ พรบ.  */  
                                brstat.tlt.dat_ins_noti =   ?    /*วันที่ออกงาน */
                                brstat.tlt.expotim      =  nv_susupect .   /* suspect */
...
DO:   
      ASSIGN                            
             ...
             brstat.tlt.dri_name2    =   ""   /*  ชื่อผู้ขับขี่ 2 */ 
             brstat.tlt.dri_no2      =   ""   /* เลขใบขับขี่ 2 */
             brstat.tlt.rec_addr1    =   "ISP: RES: "   /* isp no + ผลตรวจสภาพ */  
             /*brstat.tlt.rec_addr2    =   "BEN: CAM: "   /* ผู้รับผลประโยชน์  + แคมเปญ */*/
             brstat.tlt.rec_addr2    =  IF wdetail.sts = "Active" THEN "BEN:ธนาคารไทยพาณิชย์ จำกัด(มหาชน) CAM:" 
                                        ELSE "BEN: CAM:"
             brstat.tlt.rec_addr3    =   ""   /* User ID ที่แก้ไขข้อมูล */
