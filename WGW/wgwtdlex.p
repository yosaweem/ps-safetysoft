...
DEFINE INPUT-OUTPUT  PARAMETER np_brand     AS CHAR FORMAT "x(65)".
DEFINE INPUT-OUTPUT  PARAMETER np_model     AS CHAR FORMAT "x(65)".
...
DEFINE INPUT-OUTPUT  PARAMETER nv_prm1      AS CHAR FORMAT "x(60)"  INIT "" .
DEFINE INPUT-OUTPUT  PARAMETER nv_prm2      AS CHAR FORMAT "x(60)"  INIT "" .
DEFINE INPUT-OUTPUT  PARAMETER nv_prm3      AS CHAR FORMAT "x(60)"  INIT "" .
DEFINE INPUT-OUTPUT  PARAMETER nv_prm4      AS CHAR FORMAT "x(60)"  INIT "" .
DEFINE INPUT-OUTPUT  PARAMETER nv_prm5      AS CHAR FORMAT "x(60)"  INIT "" .
DEFINE INPUT-OUTPUT  PARAMETER nv_prm6      AS CHAR FORMAT "x(60)"  INIT "" .
DEFINE INPUT-OUTPUT  PARAMETER nv_prm7      AS CHAR FORMAT "x(60)"  INIT "" .
DEFINE INPUT-OUTPUT  PARAMETER nv_prm8      AS CHAR FORMAT "x(60)"  INIT "" .
DEFINE INPUT-OUTPUT  PARAMETER nv_prm9      AS CHAR FORMAT "x(60)"  INIT "" .
DEFINE INPUT-OUTPUT  PARAMETER nv_prm10     AS CHAR FORMAT "x(60)"  INIT "" .
DEFINE INPUT-OUTPUT  PARAMETER nv_driver    AS CHAR.
DEFINE INPUT-OUTPUT  PARAMETER nv_netprm    AS DECI  FORMAT ">>>,>>>,>>9.99-"  .  /*A64-0138*/
DEFINE INPUT-OUTPUT  PARAMETER n_cctvcd     AS CHAR INIT "" .    /* A67-0050*/
...
IF AVAILABLE sic_exp.uwm100 THEN DO:
    ...
    IF AVAIL sic_exp.uwm130 THEN DO:
        ASSIGN n_cctvcd      = sic_exp.uwm130.i_text.    /* A67-0050*/
    END.
    ...
    IF AVAIL uwm301 THEN DO:
        ASSIGN  
            ...
            np_brand      = IF INDEX(sic_exp.uwm301.moddes," ") <> 0 THEN trim(SUBSTR(sic_exp.uwm301.moddes,1,INDEX(sic_exp.uwm301.moddes," "))) ELSE sic_exp.uwm301.moddes         /* redbook  */    
            np_model      = IF INDEX(sic_exp.uwm301.moddes," ") <> 0 THEN trim(SUBSTR(sic_exp.uwm301.moddes,INDEX(sic_exp.uwm301.moddes," ")))   ELSE sic_exp.uwm301.moddes         /* redbook  */    
            ...
            nv_prm1  = SUBSTRING(sic_exp.uwm301.prmtxt,1,60)
            nv_prm2  = SUBSTRING(sic_exp.uwm301.prmtxt,61,60) 
            nv_prm3  = SUBSTRING(sic_exp.uwm301.prmtxt,121,60)
            nv_prm4  = SUBSTRING(sic_exp.uwm301.prmtxt,181,60)
            nv_prm5  = SUBSTRING(sic_exp.uwm301.prmtxt,241,60)
            nv_prm6  = SUBSTRING(sic_exp.uwm301.prmtxt,301,60)
            nv_prm7  = SUBSTRING(sic_exp.uwm301.prmtxt,361,60)
            nv_prm8  = SUBSTRING(sic_exp.uwm301.prmtxt,421,60)
            nv_prm9  = SUBSTRING(sic_exp.uwm301.prmtxt,481,60)
            nv_prm10 = SUBSTRING(sic_exp.uwm301.prmtxt,541,60).
        ...
        FOR EACH sic_exp.uwd132 USE-INDEX uwd13290  WHERE
            ...
            IF sic_exp.uwd132.bencod <> "comp"  THEN nv_netprm = nv_netprm + sic_exp.uwd132.prem_c .
