...
/* insert */
          /*note add exp dat*/
            ...
            FIND LAST uwm100 WHERE uwm100.policy = agtprm_fil.policy
                             /*AND   uwm100.docno1 = agtprm_fil.docno*/
...
*/
            ...
            def var  ladat1  AS DATE FORMAT "99/99/9999". /*a490120*/
...
/*            ladat = IF  LOOKUP(n_trnty1,nv_MR) <> 0 THEN agtprm_fil.duedat   ELSE agtprm_fil.trndat.  /* เฉพาะ type MR เท่านั้นที่ต้องคิด duedate  */*/
            ASSIGN
                ...
                qdat  = 0
                lip   = 1.
            /*note change trndat to comdat*/
            /*If Comdate is ? Then Used Trandate To Calculate instead*/
            IF agtprm_fil.comdat = ? THEN DO:
                    IF nv_RptName2 = "With Credit Term" THEN
                            ladat   = IF  LOOKUP(n_trnty1,nv_MR) <> 0 THEN agtprm_fil.duedat   ELSE agtprm_fil.trndat.  
                    ELSE
                            ladat   = agtprm_fil.trndat.
            END. /*End Then do agtprm_fil.comdat = ? */
            ELSE DO:
                    IF nv_RptName2 = "With Credit Term" THEN
                            ladat   = IF  LOOKUP(n_trnty1,nv_MR) <> 0 THEN agtprm_fil.duedat   ELSE agtprm_fil.comdat.  /* เฉพาะ type MR เท่านั้นที่ต้องคิด duedate  */
                    ELSE
                            ladat   = agtprm_fil.comdat.
            END. /*End Else agtprm_fil.comdat = ? */
            /*end note change*/
