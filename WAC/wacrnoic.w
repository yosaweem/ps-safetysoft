...
CREATE WIDGET-POOL.
/*************************  Definitions  *************************/
/*--Create By A54-0172 Sayamol N.  21/06/2011
    Duplicate from wacrloic.w                   --*/

/*-- Modify By A54-0172  Sayamoln N. 21/06/2011 ---*/
/*-- Change for OIC (CBC)                       ---*/
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Wacrnoic - Ageing Count Day for OIC (New)"
         HEIGHT             = 23.62
         WIDTH              = 131.67
         MAX-HEIGHT         = 31.33
         MAX-WIDTH          = 170.67
...
ON END-ERROR OF C-Win /* Wacrnoic - Ageing Count Day for OIC (New) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Wacrnoic - Ageing Count Day for OIC (New) */
DO:
...
/********************  T I T L E   F O R  C - W I N  ****************/
  ...
  gv_prgid = "Wacrnoic".
  gv_prog  = "Ageing Count Day for OIC (New)".
    ...
    /* Begin */
        ...
        IF FIRST-OF(agtprm_fil.acno)  THEN DO:  /**/
            ...
            IF (nv_DetSum = "Detail")  OR (nv_DetSum = "All") THEN DO:
                ...
                /* A47-0264  - count  record เพื่อแยกไฟล์  หากเกิน  65500  limit ของ excel*/
                    {wac\wacr0604.i}
                /* end A47-0264 */
                ...
                OUTPUT TO VALUE (STRING(n_OutputFile + "com") ) APPEND NO-ECHO.
                    EXPORT DELIMITER ";"
                        ...
                        "Credit Limit " + STRING(agtprm_fil.odue6,"->>>,>>>,>>>,>>9.99") + "  " +   
