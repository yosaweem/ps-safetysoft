...
/*----------------------------------------------------------------------
  ...
  Output Parameters:
      <none>
  Author: 
  Created By : Lukkana M.  Date: 17/10/2011
  Assign No  : A54-0318  
  Modify By  : Lukkana M.  Date: 23/04/2012
  Assign No  : A55-0144 เพิ่มประเภทรายงาน Earn Report 
  Modify By  : Lukkana M.  Date: 18/07/2012
  Assign No  : A55-0239 
  Modify By  : Lukkana M.  Date: 20/11/2012
  Assign No  : A55-0357 แก้ไขช่องเบี้ย ceded เนื่องจากไม่รวม code orq80 ในรายงาน
  Modify By  : Sayamol N.  Date 14/03/2013
  Assign No  : A56-0092  เพิ่มรายงาน Cancel Report สำหรับแยกกรมธรรม์ ที่มี Status = Cancel 
               uwm100.polsta = "CA"
  Modify by  : Kridtiya i. A58-0180 เพิ่มวันที่ เริ่มต้น-สิ้นสุดต้องการเรียกรายงาน
  Modify by  : Benjaporn J. A58-0242  date 13/07/2015 เพิ่มคอลัมข้อมูล
  Modify By  : Nattanicha K. A63-0159  20/04/2020
               -Change from 65000 to 1000000 Lines for New File
  Modify By  : Nattanicha K. A64-0272   24/06/2021
               - Marine cal 90 Days
               - Add Column Agent/Producer
 Modify By  : Nattanicha K. A64-0272   22/10/2021
             - Marine C90 Date <= 91 >> UPR = Premium
             - Add rencnt , endcnt
             - Auto Post to GL ORACLE
------------------------------------------------------------------------*/
...
DEF VAR nv_output  AS CHAR FORMAT "X(250)".
DEF VAR nv_output1 AS CHAR FORMAT "X(250)".
DEF VAR nv_output2 AS CHAR FORMAT "X(250)".    /*A56-0092*/
...
DEF VAR nv_earn    AS DECI FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR nv_uearn   AS DECI FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR nv_earn1   AS DECI FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR nv_uearn1  AS DECI FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
...
DEF NEW SHARED WORKFILE wrk0f
    ...
    FIELD  sumf   AS DECI FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD  prmf   AS DECI FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
...
DEF  VAR nv_prmtre AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
...
DEF WORKFILE wtotal
    ...
    FIELD totprmcom AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD totsumprm AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD totearn   AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD totuearn  AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD totearn1  AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD totuearn1 AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    /*A64-0380*/
    FIELD totprmall AS DEC FORMAT "->>>,>>>,>>>,>>9.99"   INIT 0
    FIELD totearnall AS DEC FORMAT "->>>,>>>,>>>,>>9.99"  INIT 0
    FIELD totuearnall AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    /* comment by Benjaporn J. A58-0242                   
    FIELD totprmtre AS DEC FORMAT "->>>>>>>>>9.99"        
    FIELD totearn2  AS DEC FORMAT "->>>>>>>>>9.99"        
    FIELD totuearn2 AS DEC FORMAT "->>>>>>>>>9.99" */
     /* start A58-0242 Benjaporn J. 13/07/2015 */
    FIELD totprmtrt   AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0 
    FIELD totearntrt  AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0                   
    FIELD totuearntrt AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD totprmfac   AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD totearnfac  AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0                   
    FIELD totuearnfac AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.  /* end A58-0242 Benjaporn J. 13/07/2015 */
...
DEF BUFFER bufuwm100 FOR uwm100.
DEF BUFFER bffuwm100 FOR uwm100.
...
DEF VAR  nv_ctotprmall    AS DEC FORMAT "->>>,>>>,>>>,>>9.99"  INIT 0.
DEF VAR  nv_ctotearnall   AS DEC FORMAT "->>>,>>>,>>>,>>9.99"  INIT 0.
DEF VAR  nv_ctotuearnall  AS DEC FORMAT "->>>,>>>,>>>,>>9.99"  INIT 0.
...
/* start A58-0242 Benjaporn J.13/07/2015 */
DEF VAR nv_prmtrt    AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR nv_earntrt   AS DECI  FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR nv_uearntrt  AS DECI  FORMAT "->>>,>>>,>>>,>>9.99" INIT 0. 
DEF VAR nv_prmfac    AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR nv_earnfac   AS DECI  FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR nv_uearnfac  AS DECI  FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.  /* end A58-0242 Benjaporn J. 13/07/2015 */
/*A64-0272*/
DEF VAR nv_agent  AS CHAR FORMAT "X(10)" INIT "".
DEF VAR nv_agentname  AS CHAR FORMAT "X(255)" INIT "".
DEF VAR nv_producer   AS CHAR FORMAT "X(10)" INIT "".
DEF VAR nv_acnoname  AS CHAR FORMAT "X(255)" INIT "".
DEF VAR nn_comdate   AS DATE FORMAT "99/99/9999" INIT ?.
DEF VAR nn_expdate   AS DATE FORMAT "99/99/9999" INIT ?.

/*---A64-0380---*/
DEF VAR nv_output_newmot  AS CHAR FORMAT "X(200)" INIT "".
DEF VAR nv_output_newnon  AS CHAR FORMAT "X(200)" INIT "".
DEF VAR nv_output_newsummot  AS CHAR FORMAT "X(200)" INIT "".
DEF VAR nv_output_newsumnon  AS CHAR FORMAT "X(200)" INIT "".
DEF VAR n_prmall   AS DECI FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR nv_earnall    AS DECI FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR nv_uearnall   AS DECI FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR n_prmallCA    AS DECI FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR nv_earnallCA    AS DECI FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR nv_uearnallCA   AS DECI FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR n_prmallERR    AS DECI FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR nv_earnallERR    AS DECI FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR nv_uearnallERR   AS DECI FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF STREAM ns4. 
DEF STREAM ns5.
DEF STREAM ns6. 
DEF STREAM ns7.
...
DEF VAR  nv_totprmall    AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR  nv_totearnall   AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR  nv_totuearnall  AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
DEF VAR  nv_asdat     AS DATE FORMAT "99/99/9999" INIT ?.


DEF VAR nvd_comdat   AS DATE FORMAT "99/99/9999"  INIT ?.
DEF VAR nvd_expdat   AS DATE FORMAT "99/99/9999"  INIT ?.
DEF VAR nvd_enddat   AS DATE FORMAT "99/99/9999"  INIT ?.   
DEF VAR nvc_expdat   AS INT FORMAT ">>>,>>>,>>>,>>9"  INIT 0.

DEF WORKFILE wtsum
    FIELD asdat     AS DATE FORMAT "99/99/9999" INIT ?
    FIELD dir_ri    AS CHAR FORMAT "X" INIT ""
    FIELD branch    AS CHAR FORMAT "X(2)"
    FIELD poltyp    AS CHAR FORMAT "X(3)"
    FIELD totprmcom AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD totsumprm AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    ...
    FIELD totprmfac   AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD totearnfac  AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0                   
    FIELD totuearnfac AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0.
...
DEF WORKFILE wfcan
    ...
    FIELD branch    AS CHAR FORMAT "X(2)"
    FIELD poltyp    AS CHAR FORMAT "X(3)"
    FIELD trndat    AS DATE FORMAT "99/99/9999" INIT ?
    FIELD policy    AS CHAR FORMAT "X(15)"
    FIELD endno     AS CHAR FORMAT "X(15)"
    FIELD rencnt    AS INTEGER
    FIELD endcnt    AS INTEGER
    FIELD comdat    AS DATE FORMAT "99/99/9999" INIT ?
    FIELD expdat    AS DATE FORMAT "99/99/9999" INIT ?
    FIELD expday    AS INT
    FIELD datecal   AS INT
    FIELD prmcom    AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD sumprm    AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD earn      AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD uearn     AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD earn1     AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD uearn1    AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD prmall    AS DEC FORMAT "->>>,>>>,>>>,>>9.99"   INIT 0
    FIELD earnall   AS DEC FORMAT "->>>,>>>,>>>,>>9.99"  INIT 0
    FIELD uearnall  AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD prmtrt    AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0 
    FIELD earntrt   AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0                   
    FIELD uearntrt  AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD prmfac    AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD earnfac   AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0                   
    FIELD uearnfac  AS DEC FORMAT "->>>,>>>,>>>,>>9.99" INIT 0
    FIELD tranty    AS CHAR FORMAT "X(4)"
    FIELD agent     AS CHAR FORMAT "X(10)"
    FIELD agentname AS CHAR FORMAT "X(100)"
    FIELD acno1     AS CHAR FORMAT "X(10)"
    FIELD acnoname  AS CHAR FORMAT "X(100)".

DEF VAR n_CA AS LOGICAL INIT NO.
DEF VAR lv_monthend AS DATE FORMAT "99/99/9999" INIT ?.
...
DEF OUTPUT PARAMETER ounon_sta AS CHAR FORMAT "X(6)".
...
DEFINE VARIABLE fi_output AS CHARACTER FORMAT "X(200)":U 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fr_main
     ...
     "End :" VIEW-AS TEXT
          ...
          BGCOLOR 3 FGCOLOR 7 
     "Earn / Unearn Premium Report - Non Motor" VIEW-AS TEXT
          SIZE 42.5 BY 1.24 AT ROW 1.57 COL 47
          BGCOLOR 3 FGCOLOR 7 FONT 6
...
DO:
    ...
    /*A64-0380*/
    ASSIGN nv_output_newmot  = fi_output + "bi"
           nv_output_newnon  = fi_output + "bi"
           nv_output_newsummot  = fi_output + "sum"
           nv_output_newsumnon  = fi_output + "sum"
           nv_asdat   = fi_asdate.
        ...
        IF sym100.itmdes = "STY" THEN DO: /*เช็คถ้าเป็นของ STY ให้แยก loop เช็ค branch*/
            IF nv_reptyp = 1 THEN DO: /*Lukkana M. A55-0144 23/04/2012*/
                ...
                IF fi_poltyp = '1' THEN DO:
                    /*RUN Pd_HeaderMotor.----A64-0380---*/
                    RUN Pd_HeaderMotorerror.
                    RUN Pd_HeaderMotorCan.  /*A56-0092*/
                    RUN Pd_HeaderMotor_new. /*A64-0380*/
                    RUN Pd_Motor_earn.
                END.
                ELSE IF fi_poltyp = '2' THEN DO:
                    /*RUN Pd_HeaderNon.---A64-0380---*/
                    RUN Pd_HeaderNonerror.
                    RUN Pd_HeaderNonCan.    /*A56-0092*/
                    RUN Pd_HeaderNon_new.   /*A64-0380*/
                    RUN Pd_non_earn.
                END.
                /*--A64-0380--*/
                ELSE IF fi_poltyp = '3' THEN DO:
                    RUN Pd_HeaderMotor_new.
                    RUN Pd_HeaderNon_new.
                    RUN Pd_Motor_earn.
                    RUN Pd_non_earn.
                END.
                /*--end A64-380--*/
...
DO:
  ...
  /*A64-0380
  IF fi_poltyp <> '1' AND fi_poltyp <> '2' AND fi_poltyp <> '3' THEN DO:
      MESSAGE "Policy Type = 1 OR 2 OR 3" VIEW-AS ALERT-BOX ERROR.
      APPLY "ENTRY" TO fi_poltyp.
      RETURN NO-APPLY.
  END.
  ---end A64-0380---*/
...
/*********************************************************************/  
  ...
  ASSIGN lv_monthend  =    innon_asdat  
         fi_asdate    =    lv_monthend  
         fi_trndat    =    innon_trndat 
         fi_trndatto  =    lv_monthend.

  ASSIGN
      fi_poltyp    = "2"
      //fi_asdate    = lv_monthend
      //fi_trndat    = 02/01/2017
      //fi_trndatto  = lv_monthend
      fi_agentfr   = "0"
      fi_agentto   = "Z"
      fi_releas    = "Y"
      ...
      fi_branchto  = "Z" 
      ra_reptyp    = 2 
      fi_output    = "D:\temp\uprexp\Non\UPNON" + STRING(YEAR(lv_monthend),"9999") 
  ...
  IF      INPUT ra_reptyp = 1 THEN nv_reptyp = 1.  
  ELSE IF INPUT ra_reptyp = 2 THEN nv_reptyp = 2.  

  DISP fi_poltyp fi_asdate fi_agentfr fi_agentto fi_releas fi_branchfr fi_branchto
       fi_trndat  fi_trndatto  ra_reptyp fi_output WITH FRAME fr_main.
  
  ENABLE fi_trndatto WITH FRAME fr_main. 

  ASSIGN nv_asdat     = fi_asdate
         nv_reptyp    = 2.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_agprodname C-Win 
PROCEDURE pd_agprodname :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
FIND FIRST xtm600 NO-LOCK USE-INDEX xtm60001 
     WHERE xtm600.acno = uwm100.agent NO-ERROR.
IF AVAIL xtm600 THEN DO:
   ASSIGN nv_agentname = xtm600.ntitle + " " + xtm600.NAME.
END.
ELSE DO:
   FIND FIRST xmm600 NO-LOCK USE-INDEX xmm60001
       WHERE xmm600.acno = uwm100.agent NO-ERROR.
   IF AVAIL xmm600 THEN DO:
      ASSIGN nv_agentname = xmm600.ntitle + " " + xmm600.NAME.
   END.
   ELSE DO:
       ASSIGN nv_agentname = "".
   END.
...
FIND FIRST xtm600 NO-LOCK USE-INDEX xtm60001 
     WHERE xtm600.acno = uwm100.acno1 NO-ERROR.
IF AVAIL xtm600 THEN DO:
   ASSIGN nv_acnoname = xtm600.ntitle + " " + xtm600.NAME.
END.
ELSE DO:
   FIND FIRST xmm600 NO-LOCK USE-INDEX xmm60001
       WHERE xmm600.acno = uwm100.acno1 NO-ERROR.
   IF AVAIL xmm600 THEN DO:
      ASSIGN nv_acnoname = xmm600.ntitle + " " + xmm600.NAME.
   END.
   ELSE DO:
       ASSIGN nv_acnoname = "".
   END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_btn_ok C-Win 
PROCEDURE pd_btn_ok :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_datecal90 C-Win 
PROCEDURE pd_datecal90 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
IF uwm100.poltyp = "C90" THEN DO:
   IF uwm100.comdat = ? THEN DO:
      IF fi_asdate - uwm100.trndat >= 0 THEN nv_datecal = fi_asdate - uwm100.trndat  + 1.
      ELSE nv_datecal = 0. 
      
      IF uwm100.comdat = ? THEN ASSIGN nn_comdate = uwm100.trndat.
   ...
   ELSE DO:
      ...
      ASSIGN nn_comdate = uwm100.comdat
             nn_expdate = uwm100.expdat.

   END.

   IF uwm100.expdat = ? THEN ASSIGN nn_expdate = uwm100.trndat + 90.
   ELSE nn_expdate = uwm100.expdat.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_datecalmain C-Win 
PROCEDURE pd_datecalmain :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
/*---AAAAAAAA--*/
ASSIGN nvd_comdat = uwm100.comdat
       nvd_expdat = uwm100.expdat
       nvd_enddat = uwm100.enddat
       nvd_comdat  = nn_comdate
       nvd_expdat  = nn_expdate.

IF uwm100.poltyp = "C90"  THEN DO:
   IF uwm100.comdat = ? THEN ASSIGN nvd_comdat = uwm100.trndat.
   ELSE ASSIGN nvd_comdat = uwm100.comdat.

   IF uwm100.expdat = ? THEN ASSIGN nvd_expdat = uwm100.trndat + 90.
   ELSE ASSIGN nvd_expdat = uwm100.expdat.
   
END.

IF uwm100.tranty = "C" AND uwm100.polsta = "IF" THEN DO:
   FIND LAST bffuwm100 WHERE bffuwm100.policy = uwm100.policy
                         AND bffuwm100.rencnt = uwm100.rencnt
                         AND bffuwm100.endcnt = uwm100.endcnt - 1
                         AND bffuwm100.trndat <= fi_asdate 
                         AND bffuwm100.RELEAS = YES 
                         AND bffuwm100.tranty <> "C" NO-LOCK NO-ERROR.
   IF AVAIL bffuwm100 THEN
      ASSIGN nvd_comdat = bffuwm100.comdat
             nvd_expdat = bffuwm100.expdat
             nvd_enddat = uwm100.comdat.  
   ELSE ASSIGN nvd_comdat = uwm100.comdat
               nvd_expdat = uwm100.expdat
               nvd_enddat = uwm100.enddat.
END.
/*
ASSIGN nv_earn =  uwm100.prem_t
       nv_uearn  = ROUND(uwm100.prem_t - nv_earn,2).
       */
nvc_expdat = nvd_expdat - nvd_comdat + 1.
/*---AAAAAAAAA----*/

IF fi_asdate - nvd_comdat >= 0 THEN nv_datecal = fi_asdate - nvd_comdat + 1.   /*A64-0272*/
ELSE nv_datecal = 0.

ASSIGN nv_earn   =  uwm100.prem_t
       nv_uearn = 0.
IF nvd_expdat - fi_asdate < 0 THEN NEXT . 

/*
/*-- Earn , Uearn เบี้ยประกัน---*/
IF nv_datecal >= nvc_expdat THEN DO: 
   IF uwm100.poltyp = "C90" THEN DO:

       /*ASSIGN nv_uearn =  uwm100.prem_t
              nv_earn  = ROUND(uwm100.prem_t - nv_uearn,2).*/
       ASSIGN nv_earn =  uwm100.prem_t
              nv_uearn  = ROUND(uwm100.prem_t - nv_earn,2).

       /*------*/
       IF (nv_datecal = nvc_expdat) AND nvc_expdat > 91 THEN 
          ASSIGN nv_earn =  uwm100.prem_t
                 nv_uearn = ROUND(uwm100.prem_t - nv_earn,2).
   END.
   ELSE DO:
...
ELSE DO: 
    ...
    IF uwm100.poltyp = "C90" THEN DO:
       ...
       END.
       ELSE DO:
          /*ASSIGN nv_earn = ROUND((uwm100.prem_t / nvc_expdat) * nv_datecal,2).
                 nv_uearn = ROUND(uwm100.prem_t - nv_earn,2).*/
           nv_earn = uwm100.prem_t.
           nv_uearn = ROUND(uwm100.prem_t - nv_earn,2).
    ...
    END.
    ELSE /*ASSIGN nv_earn = ROUND(( uwm100.prem_t / nvc_expdat) * nv_datecal,2)
                nv_uearn =  ROUND(uwm100.prem_t - nv_earn,2).*/
        ASSIGN nv_earn = uwm100.prem_t
               nv_uearn = ROUND(uwm100.prem_t - nv_earn,2).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_datecalmainCA C-Win 
PROCEDURE pd_datecalmainCA :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
IF fi_asdate - nvd_enddat >= 0 THEN nv_datecal = fi_asdate - nvd_enddat + 1.   /*A64-0272*/
ELSE nv_datecal = 0.

/*-- Earn , Uearn เบี้ยประกัน---*/
IF nv_datecal >= nvc_expdat THEN DO: 
   IF bufuwm100.poltyp = "C90" THEN DO:

       ASSIGN nv_uearn =  bufuwm100.prem_t
              nv_earn = ROUND(bufuwm100.prem_t - nv_uearn,2).

       /*------*/
       IF (nv_datecal = nvc_expdat) AND nvc_expdat > 91 THEN 
          ASSIGN nv_earn =  bufuwm100.prem_t
                 nv_uearn = ROUND(bufuwm100.prem_t - nv_earn,2).
   END.
   ELSE DO:
       ASSIGN nv_earn =  bufuwm100.prem_t
              nv_uearn = ROUND(bufuwm100.prem_t - nv_earn,2).
...
ELSE DO: 
    ...
    IF bufuwm100.poltyp = "C90" THEN DO:
       ...
       END.
       ELSE DO:
          ASSIGN nv_earn = ROUND((bufuwm100.prem_t / nvc_expdat) * nv_datecal,2).
                 nv_uearn = ROUND(bufuwm100.prem_t - nv_earn,2).

       END.
       
    END.
    ELSE ASSIGN nv_earn  = ROUND((bufuwm100.prem_t / nvc_expdat) * nv_datecal,2)
                nv_uearn =  ROUND(bufuwm100.prem_t - nv_earn,2).
END.
/*----A64-0380----*/
...
------------------------------------------------------------------------------*/
RUN pd_initdata.
RUN pd_agprodname.  /*A64-0272*/ 

n_ca = NO.  /*----AAA----Partial Case----*/

FIND LAST buwm100 USE-INDEX uwm10001 WHERE 
          buwm100.policy = uwm100.policy AND
          buwm100.tranty = "C"          AND 
          buwm100.polsta = "CA"         AND
          buwm100.RELEAS = YES AND 
          buwm100.trndat <= fi_asdate  NO-LOCK NO-ERROR.
IF AVAIL  buwm100  THEN DO:
   /*----AAA----Partial Case----*/
   /*---Partial or not ถ้า CA ภายในเดือนที่เรียกรายงานให้ Earn = Premium Uearn = 0 เสมอ ---*/
   IF MONTH(buwm100.trndat) = MONTH(fi_asdate) AND
      YEAR(buwm100.trndat) = YEAR(fi_asdate) THEN DO: 
      n_CA = YES.   
      RUN pd_detailmotor_newCA.
   END.  
   ELSE DO:
      n_CA = NO.
      /*-- ถ้า Cancel ก่อน As of Date ที่เรียกรายงาน ไม่ต้องออกรายงาน ---*/
   END.
   /*----AAA---------------------*/
...
ELSE DO:        /*---For not Cancel---*/
 IF  nv_expdat <> ? AND nv_expdat >= 0 AND nv_expdat <= 3650 THEN DO: 
        ...
        IF fi_asdate - nvd_comdat /*uwm100.comdat*/ >= 0 THEN nv_datecal = fi_asdate - nvd_comdat /*uwm100.comdat*/ + 1.
        ELSE nv_datecal = 0.
    
        IF nv_datecal >= nvc_expdat  /*nv_expdat*/ THEN nv_earn = n_prmcom.
        ELSE nv_earn = ROUND((n_prmcom / nvc_expdat  /*nv_expdat*/ ) * nv_datecal,2).
        nv_uearn = ROUND(n_prmcom - nv_earn,2).   /*-- Earn , Uearn พรบ.---*/
        
        IF nv_datecal >= nvc_expdat  /*nv_expdat*/ THEN nv_earn1 = n_sumprm.
        ELSE nv_earn1 = ROUND((n_sumprm / nvc_expdat  /*nv_expdat*/ ) * nv_datecal,2).
        nv_uearn1 = ROUND(n_sumprm - nv_earn1,2).  /*-- Earn , Uearn รถยนต์---*/

        RUN pd_wrk0f.       /*A64-0380*/
        
        /*----A64-0380---*/
        ASSIGN nv_earnall = nv_earn + nv_earn1
               nv_uearnall = nv_uearn + nv_uearn1.
        
        RUN pd_report_new.   
        /*----end A64-0380----*/

         /*AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA*/
            FIND FIRST wtsum WHERE wtsum.dir_ri  = nv_dir       AND
                                   wtsum.poltyp = uwm100.poltyp AND
                                   wtsum.branch = uwm100.branch  NO-ERROR.
            IF NOT AVAIL wtsum THEN DO: 
                CREATE wtsum.
                ASSIGN wtsum.dir_ri = nv_dir
                       wtsum.poltyp = uwm100.poltyp   
                       wtsum.branch = uwm100.branch.
            END.
            ASSIGN wtsum.totprmcom   = wtsum.totprmcom   +    n_prmall     
                   wtsum.totearn     = wtsum.totearn     +    nv_earnall   
                   wtsum.totuearn    = wtsum.totuearn    +    nv_uearnall  
                   wtsum.totprmtrt   = wtsum.totprmtrt   +    nv_prmtrt     
                   wtsum.totearntrt  = wtsum.totearntrt  +    nv_earntrt    
                   wtsum.totuearntrt = wtsum.totuearntrt +    nv_uearntrt   
                   wtsum.totprmfac   = wtsum.totprmfac   +    nv_prmfac     
                   wtsum.totearnfac  = wtsum.totearnfac  +    nv_earnfac    
                   wtsum.totuearnfac = wtsum.totuearnfac +    nv_uearnfac
                   wtsum.asdat       = nv_asdat.  
            /*AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA*/
        ...
        /*A64-0380*/
        nv_totprmall    = nv_totprmall    + n_prmall
        nv_totearnall   = nv_totearnall   + nv_earnall
        nv_totuearnall  = nv_totuearnall  + nv_uearnall
           /* start A58-0242 Benjaporn J. 13/07/2015 */
 ...
 ELSE DO:
        ...
        ELSE nv_earn = ROUND((n_prmcom / nv_expdat) * nv_datecal,2).
        nv_uearn = ROUND(n_prmcom - nv_earn,2).    /*-- Earn , Uearn พรบ.---*/
        IF nv_datecal >= nv_expdat THEN nv_earn1 = n_sumprm.
        ELSE nv_earn1 = ROUND((n_sumprm / nv_expdat) * nv_datecal,2).
        nv_uearn1 = ROUND(n_sumprm - nv_earn1,2).  /*-- Earn , Uearn รถยนต์---*/
        ...
        PUT STREAM ns2 
                ...
                nv_uearnfac FORMAT "->>,>>>,>>>,>>>.99" "|" 
                uwm100.polsta "|"
                 /*--A64-0272--*/
                uwm100.agent FORMAT "X(10)" "|" 
                nv_agentname FORMAT "X(70)" "|" 
                uwm100.acno1 FORMAT "X(10)" "|" 
                nv_acnoname  FORMAT "X(70)"  SKIP.
        
    END.
    
    RUN pd_wrk0f_clear.  /*A64-0380*/
END.    
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Pd_DetailMotor_bckup C-Win 
PROCEDURE Pd_DetailMotor_bckup :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
IF AVAIL  buwm100  THEN DO:
       ...
       IF nv_expdat <> ? AND nv_expdat >= 0 AND nv_expdat <= 3650 THEN DO: 
           ...
           /*----A64-0380---*/
            ASSIGN nv_earnallCA = nv_earn + nv_earn1
                   nv_uearnallCA = nv_uearn + nv_uearn1.
            RUN pd_report_newCA.   
            /*----end A64-0380----*/
           ...
           ASSIGN /*Grand total*/
              ...
              /*A64-0380*/
              nv_ctotprmall    = nv_ctotprmall    + n_prmallCA
              nv_ctotearnall   = nv_ctotearnall   + nv_earnallCA
              nv_ctotuearnall  = nv_ctotuearnall  + nv_uearnallCA
              /*---A64-0380---*/
       ...
       ELSE DO:
          ...
          IF uwm100.comdat = uwm100.expdat THEN ASSIGN nv_earn = n_prmcom
                                                       nv_uearn = 0
                                                       nv_earn1 = n_sumprm
                                                       nv_uearn1 = 0.
          ELSE DO:
               ...
               /*----A64-0380---*/
               ASSIGN nv_earnallERR = nv_earn + nv_earn1
                      nv_uearnallERR = nv_uearn + nv_uearn1.
               RUN pd_report_newCA2.   
               /*----end A64-0380----*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_DetailMotor_newCA C-Win 
PROCEDURE pd_DetailMotor_newCA :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
FOR EACH bufuwm100 NO-LOCK WHERE  bufuwm100.policy = buwm100.policy AND
                                  bufuwm100.rencnt = buwm100.rencnt AND
                                  bufuwm100.RELEAS = YES AND
                                  bufuwm100.trndat <= nv_asdat.

  ASSIGN nv_prstp   =  bufuwm100.pstp + bufuwm100.rstp
         nv_prtax   =  bufuwm100.ptax + bufuwm100.rtax
         nv_sumpts  =  bufuwm100.prem_t + nv_prstp + nv_prtax - n_paprm - n_tstppa - n_taxpa
         n_sumprm   =  bufuwm100.prem_t - n_prmcom - n_paprm
         ...
         nu_vat     = nu_tax 
         n_prmall   = TRUNCATE(n_prmcom + n_sumprm,2)  /* A64-0380*/  
         n_prmallCA = TRUNCATE(n_prmcom + n_sumprm,2).
  
  ASSIGN nv_expdat      = 0      nv_datecal       = 0
         nv_earn        = 0      nv_uearn         = 0
         nv_earn1       = 0      nv_uearn1        = 0
         nv_prmtre      = 0                   
         nv_earnall     = 0      nv_uearnall      = 0  /*A64-0380*/
         nv_earnallCA   = 0      nv_uearnallCA    = 0
         nv_earnallERR  = 0      nv_uearnallERR   = 0.

  IF bufuwm100.tranty <> "C" THEN 
     ASSIGN nvd_comdat = bufuwm100.comdat
            nvd_expdat = bufuwm100.expdat
            nvd_enddat = bufuwm100.comdat.  
  ELSE ASSIGN nvd_comdat = uwm100.comdat
              nvd_expdat = uwm100.expdat
              nvd_enddat = bufuwm100.enddat.

      nvc_expdat = nvd_expdat - nvd_comdat + 1.

      IF nvc_expdat <> ? AND nvc_expdat >= 0 AND nvc_expdat <= 3650 THEN DO: 

         IF nv_asdat - nvd_enddat  >= 0 THEN nv_datecal = nv_asdat - nvd_enddat + 1.
         ELSE nv_datecal = 0.

         IF nv_datecal >= nvc_expdat THEN nv_earn = n_prmcom.
           ELSE nv_earn = ROUND((n_prmcom / nvc_expdat) * nv_datecal,2).
           nv_uearn = ROUND(n_prmcom - nv_earn,2).  /*-- Earn , Uearn พรบ.---*/

         IF nv_datecal >= nvc_expdat THEN nv_earn1 = n_sumprm.
         ELSE nv_earn1 = ROUND((n_sumprm / nvc_expdat) * nv_datecal,2).
         nv_uearn1 = ROUND(n_sumprm - nv_earn1,2).  /*-- Earn , Uearn รถยนต์---*/

         /*---AAAA---Partial case--*/
         IF n_CA = YES THEN DO:
            ASSIGN nv_earn = n_prmcom
                   nv_uearn = 0
                   nv_earn1 = n_sumprm
                   nv_uearn1 = 0.
         END.
...
IF AVAIL buwm100 THEN DO:
   ...
   /*RUN pd_detailnon_newCA.---------AAAAAAAAAAAAAAA*/
...
ELSE DO:   /*---For not Cancel---*/
     ...
     IF nv_expdat <> ? AND nv_expdat >= 0 AND nv_expdat <= 3650 THEN DO: 
         ...
         PUT STREAM ns1 nv_dir                                                 "|"
                        ...
                        uwm100.policy                                          "|"  
                        uwm100.endno  FORMAT "X(10)"                           "|"
                        nn_comdate FORMAT "99/99/9999"                      "|"
                        nn_expdate FORMAT "99/99/9999"                      "|"
                        nv_expdat     FORMAT ">>>>>>9"                         "|"
                        nv_datecal    FORMAT ">>>>>>9"                         "|"
         ...
         IF NOT AVAIL wtsum THEN DO: 
             ...
             ASSIGN wtsum.dir_ri = nv_dir
                    ...
                    wtsum.branch = uwm100.branch.
         END.
         ASSIGN wtsum.totprmcom   = wtsum.totprmcom   +    uwm100.prem_t 
                wtsum.totearn     = wtsum.totearn     +    nv_earn       
                wtsum.totuearn    = wtsum.totuearn    +    nv_uearn      
                wtsum.totprmtrt   = wtsum.totprmtrt   +    nv_prmtrt     
                wtsum.totearntrt  = wtsum.totearntrt  +    nv_earntrt    
                wtsum.totuearntrt = wtsum.totuearntrt +    nv_uearntrt   
                wtsum.totprmfac   = wtsum.totprmfac   +    nv_prmfac     
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Pd_detailnon_backup C-Win 
PROCEDURE Pd_detailnon_backup :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:      
   ...
   IF nv_expdat <> ? AND nv_expdat >= 0 AND nv_expdat <= 3650 THEN DO:
        ...
        ELSE DO: 
            ...
            PUT STREAM ns2 nv_dir                                               "|"
                           ...
                           uwm100.policy                                        "|"  
                           uwm100.endno  FORMAT "X(10)"                         "|"
                           /* uwm100.comdat */ nn_comdate FORMAT "99/99/9999"   "|"
                           /* uwm100.expdat */ nn_expdate FORMAT "99/99/9999"   "|"
                           nv_expdat     FORMAT "->>>>>>9"                      "|"
                           nv_datecal    FORMAT "->>>>>>9"                      "|"
                           uwm100.prem_t FORMAT "->>,>>>,>>>,>>>.99"            "|"    
                           nv_earn       FORMAT "->>,>>>,>>>,>>>.99"            "|" 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Pd_detailnon_newCA C-Win 
PROCEDURE Pd_detailnon_newCA :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
FOR EACH bufuwm100 NO-LOCK WHERE  bufuwm100.policy = buwm100.policy AND
  ...
  ELSE ASSIGN nvd_comdat = uwm100.comdat
      ...
      IF nvc_expdat <> ? AND nvc_expdat >= 0 AND nvc_expdat <= 3650 THEN DO: 
         ...
         RUN pd_datecalmainCA.
         /*
         PUT STREAM ns3 
                           nv_dir                                                 "|"
                           n_branch                                               "|"   
                           buwm100.poltyp                                          "|"    
                           buwm100.trndat FORMAT "99/99/9999"                      "|"   
                           buwm100.policy                                          "|"  
                           buwm100.endno  FORMAT "X(10)"                           "|"
                           buwm100.comdat FORMAT "99/99/9999"                         "|"
                           buwm100.expdat FORMAT "99/99/9999"                         "|"
                           nvc_expdat     FORMAT ">>>>>>9"                         "|"
                           nv_datecal    FORMAT ">>>>>>9"                         "|"
                           buwm100.prem_t FORMAT "->>,>>>,>>>,>>>.99"              "|"   
                           nv_earn       FORMAT "->>,>>>,>>>,>>>.99"              "|" 
                           nv_uearn      FORMAT "->>,>>>,>>>,>>>.99"   "|". 
                           */
            RUN pd_wrk0f_ca.  /*A64-0380*/
            ...
            PUT STREAM ns3
                ...
                nv_earnfac  FORMAT "->>,>>>,>>>,>>>.99" "|" 
                nv_uearnfac FORMAT "->>,>>>,>>>,>>>.99" "|" /*end A58-0242 Benjaporn J. 13/07/2015 */
                buwm100.polsta                          "|"  /*A56-0092*/
                /*--A64-0272--*/
                buwm100.agent FORMAT "X(10)" "|" 
                nv_agentname FORMAT "X(70)" "|" 
                buwm100.acno1 FORMAT "X(10)" "|" 
                nv_acnoname  FORMAT "X(70)"  SKIP.
                */

            RUN pd_report_newCA_Non.  

            /****************  AAAAAAAAAAAAAA ***************
            
            ASSIGN nv_ctotprmcom   = nv_ctotprmcom   + bufuwm100.prem_t    
                   nv_ctotearn     = nv_ctotearn     + nv_earn     
                   nv_ctotuearn    = nv_ctotuearn    + nv_uearn 
                   nv_ctotprmtrt   = nv_ctotprmtrt   + nv_prmtrt
                   nv_ctotearntrt  = nv_ctotearntrt  + nv_earntrt 
        ...
        ELSE DO: 
            ...
            PUT STREAM ns2
                ...
                /*A64-0272*/
                buwm100.agent  FORMAT "X(10)"            "|"
                buwm100.acno1  FORMAT "X(10)" SKIP.   
                */
        END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_getendofmonth C-Win 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE Pd_HeaderMotor_New C-Win 
PROCEDURE Pd_HeaderMotor_New :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:        A64-0380   By Nattanicha K.
------------------------------------------------------------------------------*/
ASSIGN
    nv_today  =  TODAY
    nv_row    =  1.

OUTPUT STREAM ns4 TO VALUE(nv_output_newmot).
PUT STREAM ns4  nv_text                         "|"       SKIP 
                "Branch From : "  fi_branchfr   "|"
                "To : "  fi_branchto            "|"
                "Releas Flag : "  fi_releas     "|"       SKIP
                "Agent From : "   fi_agentfr    "|"
                "To : "           fi_agentto    "|"  
                "Policy Type : "  fi_poltyp " = Motor"     "|"
                "Transection Date : "  fi_trndat " to " fi_trndatto  "|" SKIP  
                "As Of Date : "  fi_asdate      "|"
                "Report Date:  " nv_today       "|"       
                fi_stime "  [WACR60]"  SKIP . 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_HeaderNon_New C-Win 
PROCEDURE pd_HeaderNon_New :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       A64-0380  By Nattanicha K.
...
OUTPUT STREAM ns5 TO VALUE(nv_output_newnon).
PUT STREAM ns5  nv_text                         "|"       SKIP 
                "Branch From : "  fi_branchfr   "|"
                "To : "  fi_branchto            "|"
                "Releas Flag : "  fi_releas     "|"       SKIP
                "Agent From : "   fi_agentfr    "|"
...
/*nv_expdat  = uwm100.expdat - uwm100.comdat + 1. -----A64-0272---*/
...
IF uwm100.poltyp = "C90" THEN DO:
   ...
   IF uwm100.comdat = ? THEN DO: 
      ASSIGN nv_expdat = ((uwm100.trndat + 90) - (uwm100.trndat)) + 1
             nn_comdate = uwm100.trndat.
   END.
   ELSE DO: 
       
       ASSIGN nv_expdat  = uwm100.expdat - uwm100.comdat + 1
              nn_comdate = uwm100.comdat.
...
FOR EACH uwm100 NO-LOCK USE-INDEX uwm10092 WHERE 
    uwm100.expdat  <=  fi_asdate     AND 
    ((MONTH(uwm100.expdat) = MONTH(fi_asdate)) AND 
     (YEAR(uwm100.expdat) =  YEAR(fi_asdate))) AND
    uwm100.agent   >=  fi_agentfr     AND
    uwm100.agent   <=  fi_agentto     AND
   ...
   /*---------A64-0380----------*/
   IF uwm100.expdat >= fi_asdate THEN DO:
   END.
   ELSE DO:
      IF uwm100.comdat = uwm100.expdat THEN DO: 
          IF uwm100.polsta = "CA" THEN NEXT loopmain.
          /*--- A65-0aaa IF uwm100.expdat < fi_asdate THEN NEXT loopmain.  ---*/
          /*--- A65-0aaa ---*/
          IF (MONTH(uwm100.expdat) = MONTH(fi_asdate)) AND 
              (YEAR(uwm100.expdat) =  YEAR(fi_asdate)) THEN DO:
          END.
          ELSE NEXT loopmain.
          /*--- end A65-0aaa ---*/
      END.
...
/*Add by Kridtiya i. A58-0180*/
   ...
   IF nv_count > 1000000 THEN DO:
       ...
       /*RUN Pd_HeaderMotor. A64-0380 */
       /*---A64-0380---*/
       nv_output_newmot  = (fi_output + "_" + STRING(n_rec)) + "_" + "bi" .
       RUN Pd_HeaderMotor_new.
       /*---end A64-0380---*/
       n_rec = n_rec + 1.
       nv_count = 0.
   ...
   ASSIGN
       ...
       nv_sum    = 0       n_tstppa   = 0
       n_an      = 0       n_taxpa    = 0
       nvexch    = 1       n_prmall   = 0   n_prmallCA = 0  n_prmallERR = 0 /*A64-0380*/
       nv_prmtre = 0.      
   ...
   IF LAST-OF(uwm100.poltyp) THEN DO:
       ...
       ASSIGN
          ...
          FIND FIRST wtotal WHERE wtotal.poltyp = uwm100.poltyp /*SUBSTR(uwm100.poltyp,2,2)*/ NO-LOCK NO-ERROR.
          IF NOT AVAIL wtotal THEN DO:
              CREATE wtotal.
              ASSIGN 
                  wtotal.poltyp    = uwm100.poltyp   /*SUBSTR(uwm100.poltyp,2,2)*/
                  ...
                  /*A64-0380*/
                  wtotal.totprmall   = nv_totprmall
                  wtotal.totearnall  = nv_totearnall
                  wtotal.totuearnall = nv_totuearnall
                  /* comment by Benjaporn J. A58-0242 
          ...
          ASSIGN
              ...
              nv_totuearnfac  = 0  
              /*A64-0380*/
              nv_totprmall    = 0    nv_totearnall = 0
              nv_totuearnall = 0.
              /* comment by Benjaporn J. A58-0242 
...
OUTPUT STREAM ns6 TO VALUE(nv_output_newsummot).
PUT STREAM ns6  "As of Date"              "|"     
                "D/I"                     "|"   
                "สาขา"                    "|"   
                "ประเภทกรมธรรม์"          "|"   
                "เบี้ยประกัน"             "|"   
...
FOR EACH wtotal BREAK BY wtotal.poltyp.
    ...
    IF wtotal.totprmcom = 0 AND wtotal.totsumprm = 0 AND
       ...
       /*A64-0380*/
       wtotal.totprmall = 0 AND wtotal.totearnall = 0 AND 
       wtotal.totuearnall = 0 AND
        /* comment by Benjaporn J. A58-0242
...
OUTPUT STREAM ns4 CLOSE.    /*A64-0380*/
OUTPUT STREAM ns5 CLOSE.    /*A64-0380*/
OUTPUT STREAM ns6 CLOSE.    /*A64-0380*/
OUTPUT STREAM ns7 CLOSE.    /*A64-0380*/
END PROCEDURE.
...
FOR EACH uwm100 NO-LOCK USE-INDEX uwm10008 WHERE 
    uwm100.trndat  >=  fi_trndat      AND
    uwm100.trndat  <=  fi_trndatto    AND
    /*uwm100.expdat  >=  fi_asdate      AND  ----end A64-0272---*/
    uwm100.agent   >=  fi_agentfr     AND
    uwm100.agent   <=  fi_agentto     AND
    uwm100.branch  >=  fi_branchfr    AND
    uwm100.branch  <=  fi_branchto    AND
    ...
    /*----A64-0272---*/
    IF uwm100.expdat <> ? THEN DO: 

       /*---------A64-0380----------*/
       IF uwm100.expdat > fi_asdate THEN NEXT loopmain.
       ELSE DO:
         IF MONTH(uwm100.expdat) <> MONTH(fi_asdate) AND YEAR(uwm100.expdat) <> YEAR(fi_asdate) THEN NEXT loopmain.
         IF uwm100.comdat = uwm100.expdat THEN DO: 
             IF uwm100.polsta = "CA" THEN NEXT loopmain.
         END.
       END.
    ...
    ELSE DO:
       IF uwm100.poltyp = "C90" THEN DO:
          IF MONTH(uwm100.trndat + 90) <> MONTH(fi_asdate) AND YEAR(uwm100.trndat + 90) <> YEAR(fi_asdate) THEN NEXT loopmain.
       END.
       /* IF MONTH(uwm100.trndat + กี่วัน) <> MONTH(fi_asdate) AND YEAR(uwm100.trndat + กี่วัน) <> YEAR(fi_asdate) THEN NEXT loopmain. */
   ...
   IF nv_count > 1000000 THEN DO:
       ...
       RUN Pd_HeaderNon.
       /*---A64-0380---*/
       nv_output_newnon = (fi_output + "_" + STRING(n_rec)) + "_" + "bi" .
       RUN Pd_HeaderNon_new.
       /*---end A64-0380---*/
       n_rec = n_rec + 1.
       nv_count = 0.
...
OUTPUT STREAM ns7 TO VALUE(nv_output_newsumnon).
PUT STREAM ns7  "As of Date"              "|"   
                "D/I"                     "|"   
                "สาขา"                    "|"   
                "ประเภทกรมธรรม์"          "|"   
                "เบี้ยประกัน"             "|"   
...
FOR EACH wtsum NO-LOCK:
    PUT STREAM ns7
      ...
      wtsum.totuearnfac    SKIP.
END.
/*------------------- Comment for Not Import upr001_fil ------------
/*A64-0380*/
PUT STREAM ns3
    "Cancel - Grand Total"  "|" "|" "|" "|" "|" "|" "|" "|" "|" "|" "|" "|" "|"
    /* nv_ctotprmcom   "|"   */    nv_ctotprmall   "|"
    /* nv_ctotearn     "|"   */    nv_ctotearnall  "|"
    /* nv_ctotuearn    "|"   */    nv_ctotuearnall "|"
    /* nv_ctotprmtrt   "|"   */    nv_ctotprmtrt   "|"
    /* nv_ctotearntrt  "|"   */    nv_ctotearntrt  "|"
    /* nv_ctotuearntrt "|"   */    nv_ctotuearntrt "|"
    /* nv_ctotprmfac   "|"   */    nv_ctotprmfac   "|"
    /* nv_ctotearnfac  "|"   */    nv_ctotearnfac  "|"
    /* nv_ctotuearnfac SKIP. */    nv_ctotuearnfac SKIP.
  /*--end A56-0092---*/    /* end A58-0242 Benjaporn J. 13/07/2015 */
  -----------------------------------------------------*/
ounon_sta = "YES".
...
FOR EACH uwm100 NO-LOCK USE-INDEX uwm10008 WHERE 
    ...
    ELSE DO:
       IF uwm100.poltyp = "C90" THEN DO:
          IF (uwm100.trndat + 90) < fi_asdate THEN NEXT loopmain.
       END.
    END.
    /*---end A64-0272---*/
...
FOR EACH uwm100 NO-LOCK USE-INDEX uwm10008 WHERE
       ...
       /*uwm100.trndat  <=  fi_asdate               AND */
         uwm100.trndat  <=  fi_trndatto             AND   /* A58-0242 Benjaporn J. 13/07/2015 */
        /* uwm100.expdat  <   fi_asdate               AND ---A64-0272---*/
         uwm100.agent   >=  fi_agentfr              AND
         uwm100.agent   <=  fi_agentto              AND
  INDEX( nv_brdes, "," + TRIM(uwm100.branch)) <> 0  AND
      (( fi_releas = "Y"  AND UWM100.RELEAS = YES ) OR
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_reportCA C-Win 
PROCEDURE pd_reportCA :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
FOR EACH wfcan NO-LOCK:
       PUT STREAM ns3       
           wfcan.asdat                     "|"                                 
           wfcan.dir_ri                    "|"                                 
           wfcan.branch                    "|"                                 
           wfcan.poltyp                    "|"                              
           wfcan.trndat                    FORMAT "99/99/9999"                      "|"                     
           wfcan.policy                                                          "|"                        
           wfcan.endno                     FORMAT "X(10)"                           "|"                     
           wfcan.rencnt                    FORMAT ">>9"                             "|"                     
           wfcan.endcnt                    FORMAT ">>9"                             "|"                     
           wfcan.comdat                    FORMAT "99/99/9999"                      "|"                     
           wfcan.expdat                    FORMAT "99/99/9999"                      "|"                     
           wfcan.expday                    FORMAT ">>>>>>9"                         "|"                     
           wfcan.datecal                   FORMAT ">>>>>>9"                         "|"                     
           wfcan.prmcom                    FORMAT "->>,>>>,>>>,>>>.99"              "|"                     
           wfcan.sumprm                    FORMAT "->>,>>>,>>>,>>>.99"              "|"                     
           wfcan.earn                      FORMAT "->>,>>>,>>>,>>>.99"              "|"                     
           wfcan.uearn                     FORMAT "->>,>>>,>>>,>>>.99"              "|"                     
           wfcan.earn1                     FORMAT "->>,>>>,>>>,>>>.99"              "|"                     
           wfcan.uearn1                    FORMAT "->>,>>>,>>>,>>>.99"              "|"                     
           wfcan.prmall                    FORMAT "->>,>>>,>>>,>>>.99"              "|"                     
           wfcan.earnall                   FORMAT "->>,>>>,>>>,>>>.99"              "|"                     
           wfcan.uearnall                  FORMAT "->>,>>>,>>>,>>>.99"              "|"                     
           wfcan.prmtrt                    FORMAT "->>,>>>,>>>,>>>.99"                "|"                   
           wfcan.earntrt                   FORMAT "->>,>>>,>>>,>>>.99"                "|"                   
           wfcan.uearntrt                  FORMAT "->>,>>>,>>>,>>>.99"                "|"                   
           wfcan.prmfac                    FORMAT "->>,>>>,>>>,>>>.99"                "|"                   
           wfcan.earnfac                   FORMAT "->>,>>>,>>>,>>>.99"                "|"                   
           wfcan.uearnfac                  FORMAT "->>,>>>,>>>,>>>.99"                "|"                   
           wfcan.tranty                      "|"                              
           wfcan.agent                     FORMAT "X(10)" "|"                                               
           wfcan.agentname                 FORMAT "X(70)" "|"                                               
           wfcan.acno1                     FORMAT "X(10)" "|"                                               
           wfcan.acnoname                  FORMAT "X(70)"  SKIP.  

        ASSIGN /*Grand total*/
           nv_ctotprmcom   = nv_ctotprmcom      + wfcan.prmcom   
           nv_ctotsumprm   = nv_ctotsumprm      + wfcan.sumprm   
           nv_ctotearn     = nv_ctotearn        + wfcan.earn     
           nv_ctotuearn    = nv_ctotuearn       + wfcan.uearn    
           nv_ctotearn1    = nv_ctotearn1       + wfcan.earn1    
           nv_ctotuearn1   = nv_ctotuearn1      + wfcan.uearn1   
           /*A64-0380*/                           
           nv_ctotprmall    = nv_ctotprmall     + wfcan.prmall   
           nv_ctotearnall   = nv_ctotearnall    + wfcan.earnall  
           nv_ctotuearnall  = nv_ctotuearnall   + wfcan.uearnall 
           /*---A64-0380---*/                     
           nv_ctotprmtrt   = nv_ctotprmtrt      + wfcan.prmtrt   
           nv_ctotearntrt  = nv_ctotearntrt     + wfcan.earntrt  
           nv_ctotuearntrt = nv_ctotuearntrt    + wfcan.uearntrt 
           nv_ctotprmfac   = nv_ctotprmfac      + wfcan.prmfac   
           nv_ctotearnfac  = nv_ctotearnfac     + wfcan.earnfac  
           nv_ctotuearnfac = nv_ctotuearnfac    + wfcan.uearnfac.
   END.                                           
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_reportCA_Non C-Win 
PROCEDURE pd_reportCA_Non :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_report_new C-Win 
PROCEDURE pd_report_new :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:    /*A64-0380*/    Motor Column แยก Compulsory, Voluntory
------------------------------------------------------------------------------*/
...
PUT STREAM ns4
           ...
           uwm100.policy                                          "|"       
           uwm100.endno  FORMAT "X(10)"                           "|"       
           uwm100.rencnt FORMAT ">>9"                             "|"       
           uwm100.endcnt FORMAT ">>9"                             "|"       
           uwm100.comdat FORMAT "99/99/9999"                      "|"       
           uwm100.expdat FORMAT "99/99/9999"                      "|"       
           nv_expdat     FORMAT ">>>>>>9"                         "|"       
           nv_datecal    FORMAT ">>>>>>9"                         "|"       
           ...
           nv_uearn1     FORMAT "->>,>>>,>>>,>>>.99"              "|"       
           n_prmall      FORMAT "->>,>>>,>>>,>>>.99"              "|"       
           nv_earnall    FORMAT "->>,>>>,>>>,>>>.99"              "|"       
           nv_uearnall   FORMAT "->>,>>>,>>>,>>>.99"              "|"       
           nv_prmtrt   FORMAT "->>,>>>,>>>,>>>.99"                "|"       
           nv_earntrt  FORMAT "->>,>>>,>>>,>>>.99"                "|"       
           nv_uearntrt FORMAT "->>,>>>,>>>,>>>.99"                "|"       
           nv_prmfac   FORMAT "->>,>>>,>>>,>>>.99"                "|"       
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_report_new2 C-Win 
PROCEDURE pd_report_new2 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:    /*A64-0380*/   Non Motor Column
------------------------------------------------------------------------------*/


        IF YEAR(nn_expdate)  <>  YEAR(nv_asdat) THEN NEXT.
        IF  MONTH(nn_expdate) <> MONTH(nv_asdat) THEN NEXT.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_report_newCA C-Win 
PROCEDURE pd_report_newCA :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:    /*A64-0380*/    Motor Column แยก Compulsory, Voluntory
------------------------------------------------------------------------------*/
FIND FIRST wfcan WHERE wfcan.policy = bufuwm100.policy AND
                       wfcan.rencnt = bufuwm100.rencnt AND
                       wfcan.endcnt = bufuwm100.endcnt NO-ERROR.
IF NOT AVAIL wfcan THEN CREATE wfcan.
   ASSIGN wfcan.asdat         =         nv_asdat          
          wfcan.dir_ri        =         nv_dir            
          wfcan.branch        =         n_branch          
          wfcan.poltyp        =         bufuwm100.poltyp  
          wfcan.trndat        =         bufuwm100.trndat  
          wfcan.policy        =         bufuwm100.policy  
          wfcan.endno         =         bufuwm100.endno   
          wfcan.rencnt        =         bufuwm100.rencnt  
          wfcan.endcnt        =         bufuwm100.endcnt  
          wfcan.comdat        =         bufuwm100.comdat  
          wfcan.expdat        =         bufuwm100.expdat  
          wfcan.expday        =         nvc_expdat        
          wfcan.datecal       =         nv_datecal        
          wfcan.prmcom        =         n_prmcom          
          wfcan.sumprm        =         n_sumprm          
          wfcan.earn          =         nv_earn           
          wfcan.uearn         =         nv_uearn          
          wfcan.earn1         =         nv_earn1          
          wfcan.uearn1        =         nv_uearn1         
          wfcan.prmall        =         n_prmallCA        
          wfcan.earnall       =         nv_earnallCA      
          wfcan.uearnall      =         nv_uearnallCA     
          wfcan.prmtrt        =         nv_prmtrt         
          wfcan.earntrt       =         nv_earntrt        
          wfcan.uearntrt      =         nv_uearntrt       
          wfcan.prmfac        =         nv_prmfac         
          wfcan.earnfac       =         nv_earnfac        
          wfcan.uearnfac      =         nv_uearnfac       
          wfcan.agent         =         bufuwm100.agent   
          wfcan.agentname     =         nv_agentname      
          wfcan.acno1         =         bufuwm100.acno1   
          wfcan.acnoname      =         nv_acnoname .
          
          /* bufuwm100.polsta  */
          IF bufuwm100.tranty = "C" THEN wfcan.tranty = "CA".
          ELSE wfcan.tranty = "IF".
...
PUT STREAM ns3
           ...
           n_branch                                               "|"       
           bufuwm100.poltyp                                          "|"       
           bufuwm100.trndat          FORMAT "99/99/9999"                      "|"       
           bufuwm100.policy                                                "|"       
           bufuwm100.endno           FORMAT "X(10)"                           "|"       
           bufuwm100.rencnt          FORMAT ">>9"                             "|"       
           bufuwm100.endcnt          FORMAT ">>9"                             "|"       
           bufuwm100.comdat          FORMAT "99/99/9999"                      "|"       
           bufuwm100.expdat          FORMAT "99/99/9999"                      "|"       
           nvc_expdat                FORMAT ">>>>>>9"                         "|"       
           nv_datecal                FORMAT ">>>>>>9"                         "|"       
           n_prmcom                  FORMAT "->>,>>>,>>>,>>>.99"              "|"       
           n_sumprm                  FORMAT "->>,>>>,>>>,>>>.99"              "|"       
           ...
           nv_earn1                  FORMAT "->>,>>>,>>>,>>>.99"              "|"       
           nv_uearn1                 FORMAT "->>,>>>,>>>,>>>.99"              "|"       
           n_prmallCA                FORMAT "->>,>>>,>>>,>>>.99"              "|"       
           nv_earnallCA              FORMAT "->>,>>>,>>>,>>>.99"              "|"       
           nv_uearnallCA             FORMAT "->>,>>>,>>>,>>>.99"              "|"       
           nv_prmtrt                 FORMAT "->>,>>>,>>>,>>>.99"                "|"       
           nv_earntrt                FORMAT "->>,>>>,>>>,>>>.99"                "|"       
           nv_uearntrt               FORMAT "->>,>>>,>>>,>>>.99"                "|"       
           nv_prmfac                 FORMAT "->>,>>>,>>>,>>>.99"                "|"       
           ...
           nv_uearnfac               FORMAT "->>,>>>,>>>,>>>.99"                "|"       
           bufuwm100.polsta                                          "|"       
           bufuwm100.agent           FORMAT "X(10)" "|"                                  
           nv_agentname              FORMAT "X(70)" "|"                                  
           bufuwm100.acno1           FORMAT "X(10)" "|"                                  
           nv_acnoname               FORMAT "X(70)"  SKIP.    
           */                           
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_report_newCA2 C-Win 
PROCEDURE pd_report_newCA2 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
PUT STREAM ns2
           ...
           nv_earn1      FORMAT "->>,>>>,>>>,>>>.99"              "|"       
           nv_uearn1     FORMAT "->>,>>>,>>>,>>>.99"              "|"       
           n_prmallERR      FORMAT "->>,>>>,>>>,>>>.99"              "|"       
           nv_earnallERR    FORMAT "->>,>>>,>>>,>>>.99"              "|"       
           nv_uearnallERR   FORMAT "->>,>>>,>>>,>>>.99"              "|"       
           nv_prmtrt   FORMAT "->>,>>>,>>>,>>>.99"                "|"       
           nv_earntrt  FORMAT "->>,>>>,>>>,>>>.99"                "|"       
           nv_uearntrt FORMAT "->>,>>>,>>>,>>>.99"                "|"       
           nv_prmfac   FORMAT "->>,>>>,>>>,>>>.99"                "|"       
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_report_newCA_Non C-Win 
PROCEDURE pd_report_newCA_Non :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:    /*A64-0380*/    Motor Column แยก Compulsory, Voluntory
...
FIND FIRST wfcan WHERE wfcan.policy = bufuwm100.policy AND
                       wfcan.rencnt = bufuwm100.rencnt AND
                       wfcan.endcnt = bufuwm100.endcnt NO-ERROR.
IF NOT AVAIL wfcan THEN DO: 
   CREATE wfcan.
   ASSIGN wfcan.policy        =         bufuwm100.policy
          wfcan.rencnt        =         bufuwm100.rencnt  
          wfcan.endcnt        =         bufuwm100.endcnt 
          wfcan.expday        =         nvc_expdat        
          wfcan.datecal       =         nv_datecal.
...
/*           wfcan.earn1         =         nv_earn1  */
/*           wfcan.uearn1        =         nv_uearn1 */
          wfcan.prmall        =         bufuwm100.prem_t       
          wfcan.earnall       =         nv_earn      
          wfcan.uearnall      =         nv_uearn.
          /*--AAAAA--
          wfcan.prmtrt        =         nv_prmtrt
          wfcan.earntrt       =         nv_earntrt        
          wfcan.uearntrt      =         nv_uearntrt       
          ...
          wfcan.uearnfac      =         nv_uearnfac 
          --AAAA---*/
          IF bufuwm100.tranty = "C" THEN DO:
             ASSIGN nv_prmtrt   = nv_prmtrt * (-1)
                    nv_earntrt  = nv_earntrt * (-1)
                    nv_uearntrt = nv_uearntrt * (-1)
                    nv_prmfac   = nv_prmfac * (-1)
                    nv_earnfac  = nv_earnfac * (-1)
                    nv_uearnfac = nv_uearnfac * (-1)
                    wfcan.tranty  =  "CA".
          END.
          ELSE ASSIGN wfcan.tranty  = "IF".      /* bufuwm100.polsta  */

          ASSIGN wfcan.prmtrt   = nv_prmtrt
                 wfcan.earntrt  = nv_earntrt
                 wfcan.uearntrt = nv_uearntrt
                 wfcan.prmfac   = nv_prmfac
                 wfcan.earnfac  = nv_earnfac
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_wrk0f C-Win 
PROCEDURE pd_wrk0f :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
------------------------------------------------------------------------------*/
      ...
      IF  nv_datecal >= nv_expdat THEN DO: 

          IF uwm100.poltyp = "C90" THEN DO:
             ASSIGN nv_uearntrt = nv_prmtrt.
                    nv_earntrt  = nv_prmtrt - nv_uearntrt.

             IF (nv_datecal = nv_expdat) AND nv_expdat > 91 THEN 
                ASSIGN nv_earntrt = nv_prmtrt
                       nv_uearntrt  = nv_prmtrt - nv_earntrt.
          END.
          ELSE DO:
              ASSIGN nv_earntrt = nv_prmtrt
      ...
      ELSE DO:
         ...
         IF uwm100.poltyp = "C90" THEN DO:
            IF uwm100.comdat = ? THEN DO:
               IF nv_prmtrt <> 0 THEN DO:

                  IF nv_expdat <= 91 THEN DO:
                      ASSIGN nv_uearntrt = nv_prmtrt
                             nv_earntrt  = nv_prmtrt - nv_uearntrt .
                  END.
                  ELSE DO:
            ...
            END.
            ELSE DO:
                nv_earntrt = ROUND((nv_prmtrt / nv_expdat) * nv_datecal,2).
                nv_uearntrt = ROUND(nv_prmtrt - nv_earntrt,2).
            END.
         END.
         ELSE DO:
            nv_earntrt = ROUND((nv_prmtrt / nv_expdat) * nv_datecal,2).
      ...
      IF  nv_datecal >= nv_expdat THEN DO: 
          ...
          IF uwm100.poltyp = "C90" THEN DO:
              ASSIGN nv_uearnfac = nv_prmfac.
                     nv_earnfac  = nv_prmfac - nv_uearnfac.
              IF (nv_datecal = nv_expdat) AND nv_expdat > 91 THEN 
                 ASSIGN nv_earnfac = nv_prmfac
                        nv_uearnfac  = nv_prmfac - nv_earnfac.
          END.
          ELSE DO:
              ASSIGN nv_earnfac = nv_prmfac
          ...
          IF  uwm100.poltyp = "C90" THEN DO:
            IF uwm100.comdat = ? THEN DO:
               IF nv_prmfac <> 0 THEN DO:
                  ...
                  END.
               END.
               ELSE ASSIGN nv_uearnfac = 0
                           nv_earnfac  = 0.
               
            END.
            ELSE DO:
               nv_earnfac = ROUND((nv_prmfac / nv_expdat) * nv_datecal,2).
               nv_uearnfac = ROUND(nv_prmfac - nv_earnfac,2). 
            END.
          END.
          ELSE DO:
             nv_earnfac = ROUND((nv_prmfac / nv_expdat) * nv_datecal,2).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_wrk0f_ca C-Win 
PROCEDURE pd_wrk0f_ca :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
/*
      ...
      nv_prmtrt = n_prmf1 + n_prmf2 + n_prmt + n_prms + n_prmq + n_prmtfp +
                  n_prmps + n_prmbtr + n_prmotr + n_prms8 + n_prmf4 + n_prmftr + n_prmrq.    
      IF   nv_datecal >= nvc_expdat THEN nv_earntrt = nv_prmtrt.
      ELSE nv_earntrt = (nv_prmtrt / nvc_expdat) * nv_datecal.
      nv_uearntrt = nv_prmtrt - nv_earntrt.
      /*---FAC---*/
      nv_prmfac = n_rf_prm + n_rb_prm .  
      IF   nv_datecal >= nvc_expdat THEN nv_earnfac = nv_prmfac.
      ELSE nv_earnfac = (nv_prmfac / nvc_expdat) * nv_datecal.
      nv_uearnfac = nv_prmfac - nv_earnfac. 
...
/*-------------A64-0380-----------*/
      ...
      ELSE DO:
         ...
         IF bufuwm100.poltyp = "C90" THEN DO:
            ...
            END.
            ELSE DO:
                nv_earntrt = ROUND((nv_prmtrt / nvc_expdat) * nv_datecal,2).
                nv_uearntrt = ROUND(nv_prmtrt - nv_earntrt,2).
            END.
         END.
         ELSE DO:
      ...
      ELSE DO:
          IF  bufuwm100.poltyp = "C90" THEN DO:
            ...
            END.
            ELSE DO:
               nv_earnfac = ROUND((nv_prmfac / nvc_expdat) * nv_datecal,2).
               nv_uearnfac = ROUND(nv_prmfac - nv_earnfac,2). 
            END.
          END.
          ELSE DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_wrk0f_clear C-Win 
PROCEDURE pd_wrk0f_clear :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
