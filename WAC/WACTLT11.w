...
\---------------------------------------------------------------------------------------------\         
\ Modify By : Montrikon s. 15/12/2022 [A65-0006]                                              \
\           > โปรแกรม Text file วางบิล TIB เปลี่ยนหน้า interface                              \
\           > กรณีสลักหลัง ไม่ออกในรายงาน ให้ Recheck                                         \ 
\           > แก้ไขการดึง Campaign ให้ตรงกับคอลัมน์ Subins                                    \
\           > รอบวันของการวางบิล เปลี่ยนในค่าเริ่มต้น Default ค่าเป็นวันที่ปัจจุบัน.          \
\           > ดึง Payer Code = "FTIB" กับ "FCASH" และ ค่าว่าง เท่านั้น.                       \
\           > Agent-Code "A0MF29TLT1" ไม่ออก พรบ.                                             \
\           > กรณีกรมธรรม์ ที่มี Digit หลังปี 2 หลัก = "TB" ให้ Split File เป็น File "Other". \
\           > พรบ. ต้องแสดงค่าเบี้ย Comp.                                                     \
\           > พรบ. คิด %Comm = "12" %OV = "0".                                                \
\           > กรมธรรม์ที่มี Digit หลังปี 2 หลัก = "TB"                                        \
\              - %Comm = "18" &OV = "4".                                                      \
\           > Campaign = "**G*"                                                               \
\              - %Comm = "18" %OV = "0".                                                      \
\           > Campaign <> "**G*"                                                              \
...
\           > Campaign Code = "ZSZZ"                                                          \
\              - %Comm = "0" %OV = "0".                                                       \
\           > Campaign Code = "GAPHINOTIB"งาน GAP                                             \
\              - %Comm = "18" OV = "22".                                                      \
\---------------------------------------------------------------------------------------------\
...
CREATE WIDGET-POOL.
/************   Program   **************
CREATE BY :  Nontamas H. A63-0391
            คำนวณผลประโยชน์ตามเงื่อนไข Producer, campaign, Finance Code
            และ แยกออกเป็น 3 file ตาม Producer 
Wac
        -Wactlt11.w
        -Wactlt0.i
Whp
...
DEFINE WORKFILE vehreg72 NO-UNDO
    ...
    FIELD riskno  AS INTE FORMAT "99999" /* "999" Montrikon s. [A65-0006] */
    FIELD itemno  AS INTE FORMAT "99999" /* "999" Montrikon s. [A65-0006] */
...
DEFINE TEMP-TABLE wBill
        ...
        FIELD wdealer        AS CHAR FORMAT "X(10)" /*A65-0006*/
...
DEFINE            VAR nv_sumprem AS DECI FORMAT "->>>,>>>,>>>,>>9.99". /* Add -  Montrikon s.  [A65-0006] */
DEFINE            VAR nv_sumcomp AS DECI FORMAT "->>>,>>>,>>>,>>9.99". /* Add -  Montrikon s.  [A65-0006] */
DEFINE            VAR nv_sum     AS DECI FORMAT "->>>,>>>,>>>,>>9.99". /* Add -  Montrikon s.  [A65-0006] */
...
DEFINE NEW SHARED WORKFILE wdetail NO-UNDO
    ...
    FIELD wdealer           AS CHAR   FORMAT "X(10)"    /*A65-0006*/
    FIELD wAcno             AS CHAR   FORMAT "X(10)".   /*A65-0006*/
    .
...
/* Add Montrikon s. 15/12/2022 [A65-0006] */

DEF VAR nv_camp70  AS CHAR FORMAT "X(4)".
DEF VAR nv_wdealer AS CHAR FORMAT "X(10)". 
DEF VAR nv_wendno  AS CHAR FORMAT "X(10)".

DEF BUFFER bcfuwm100 FOR uwm100. 
DEF BUFFER bagtprm_fil FOR agtprm_fil.

DEF VAR nv_dealer AS CHAR FORMAT "X(10)" INIT "".

/* End Montrikon s. 15/12/2022 [A65-0006] */
...
buBranch2 bu_clr bu_del fiFile-Nameinput bu_file bu_SplitFile RECT-5 RECT-1 ~
RECT-6 RECT-7 RECT-8 RECT-2 RECT-3 RECT-4 
...
fi_bindate fiFile-Name1 fiFile-Nameinput 
...
DEFINE VARIABLE fibdes AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 50 BY 1
     BGCOLOR 7 FGCOLOR 4 FONT 6 NO-UNDO.
...
DEFINE VARIABLE fi_process AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 62.67 BY 1.05
     BGCOLOR 7 FGCOLOR 4 FONT 2 NO-UNDO.
...
DEFINE FRAME fr_main
     ...
     fi_process AT ROW 21.38 COL 19.33 COLON-ALIGNED NO-LABEL
     fi_binloop AT ROW 14.05 COL 29.5 COLON-ALIGNED NO-LABEL
     fi_bindate AT ROW 15.38 COL 29.5 COLON-ALIGNED NO-LABEL
     fiFile-Name1 AT ROW 16.91 COL 29.5 COLON-ALIGNED NO-LABEL
     Btn_OK AT ROW 16.86 COL 97.33
     Btn_con AT ROW 21.38 COL 85.83
     Btn_Exit AT ROW 21.38 COL 113.33
     buBranch AT ROW 3.76 COL 36.67
     buBranch2 AT ROW 5.19 COL 36.67
     bu_clr AT ROW 8.14 COL 92
     bu_del AT ROW 9.71 COL 92.17
     fiFile-Nameinput AT ROW 19.57 COL 19.17 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     bu_file AT ROW 19.57 COL 91.33 WIDGET-ID 16
     bu_SplitFile AT ROW 19.52 COL 96 WIDGET-ID 14
     " รอบของการวางบิล" VIEW-AS TEXT
          SIZE 19.5 BY 1 AT ROW 14.05 COL 7
          BGCOLOR 5 FGCOLOR 7 
     "          การส่งข้อมูล Text File เพื่อวางบิลเรียกเก็บเงินค่าเบี้ยฯ จาก TIB" VIEW-AS TEXT
     ...
     " Output To TextFile" VIEW-AS TEXT
          SIZE 19.5 BY 1 AT ROW 16.91 COL 7
          BGCOLOR 5 FGCOLOR 7 
     ...
     "Input File :" VIEW-AS TEXT
          SIZE 11.5 BY 1 AT ROW 19.57 COL 7.33 WIDGET-ID 20
          BGCOLOR 5 FGCOLOR 7 FONT 6
     ...
     " Branch From":25 VIEW-AS TEXT
          ...
          BGCOLOR 5 FGCOLOR 7 
     RECT-5 AT ROW 2.95 COL 3.33
     RECT-1 AT ROW 16.52 COL 96
     RECT-6 AT ROW 21.05 COL 112.17
     RECT-7 AT ROW 1.24 COL 28.5
     RECT-8 AT ROW 21.05 COL 84.83
     RECT-2 AT ROW 6.48 COL 91
     RECT-3 AT ROW 7.95 COL 91
     RECT-4 AT ROW 9.48 COL 91
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "wactlt11 - การส่งข้อมูล Text File เพื่อวางบิล TIB"
         HEIGHT             = 22.52
         WIDTH              = 125
         MAX-HEIGHT         = 22.52
         MAX-WIDTH          = 125
...
ON END-ERROR OF C-Win /* wactlt11 - การส่งข้อมูล Text File เพื่อวางบิล TIB */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* wactlt11 - การส่งข้อมูล Text File เพื่อวางบิล TIB */
DO:
...
DO:
    /*-------------A63-0391-----------------*/
    fi_process = "" .
    fiFile-Nameinput = INPUT fiFile-Nameinput.
    ...
    ELSE DO:
        fi_process = "Please wait Split File".
        DISP fi_process WITH FRAME fr_main.
        RUN pd_acno1.
        RUN pd_acno2.
        RUN pd_acno3. 
        fi_process = "Split File Complete" .
        DISP fi_process WITH FRAME fr_main.
    END.
...
/********************  T I T L E   F O R  C - W I N  ****************/
  ...
  gv_prgid = "Wactlt11".
  gv_prog  = "ข้อมูล Text File เพื่อวางบิล (TIB)".
...
/*********************************************************************/
   ...
   ASSIGN
      ...
      fi_process    = ""
      fi_binloop    = 90
      fi_bindate    = TODAY /* DATE(MONTH(TODAY),20,YEAR(TODAY)) [A65-0006] */
      n_comdatF     = ?
      n_comdatT     = ?
      n_OutputFile1 = "" 
      ...
      fiFile-Name1  = "D:\TIB_ex1"   /*kridtiya i. A53-0167*/ /* Montrikon s. [A65-0006] */
      tim01         = ""
      tim02         = "" 
      se_producer   = "".
...
------------------------------------------------------------------------------*/
  ...
  ENABLE fiBranch fiBranch2 fi_producer se_producer bu_add ra_type cbAsDat 
         ...
         fiFile-Nameinput bu_file bu_SplitFile RECT-5 RECT-1 RECT-6 RECT-7 
         RECT-8 RECT-2 RECT-3 RECT-4 
      WITH FRAME fr_main IN WINDOW C-Win.
...
ASSIGN nv_pol72 = ""
 ...
 FIND LAST  bcfuwm100 USE-INDEX uwm10001 NO-LOCK 
      WHERE bcfuwm100.policy = uwm100.policy 
        AND bcfuwm100.releas = YES NO-ERROR.
 IF AVAIL bcfuwm100 THEN ASSIGN nv_camp70   = ""                
                                nv_camp70   = bcfuwm100.campaign. 
/* END [A65-0006] */
...
END.
ELSE DO:
    IF uwm100.acno1 = "A0MF29TLT1" THEN NEXT. /* [A65-0006] */
    ...
    RUN pdnopol72_1. /* Add Montrikon S. [A65-0006] */
...
FIND FIRST uwm100 USE-INDEX uwm10001          WHERE
           ...
           uwm100.endno  = wagtprm_fil.endno      /* Add [A65-0006] */
           NO-LOCK NO-ERROR NO-WAIT.
IF AVAIL uwm100 THEN DO:
    FIND LAST bwagtprm_fil WHERE bwagtprm_fil.policy = uwm100.policy
                             AND bwagtprm_fil.endno  = uwm100.endno /* Add [A65-0006] */
        NO-LOCK NO-WAIT NO-ERROR.
    IF NOT AVAIL bwagtprm_fil  THEN NEXT.
    ASSIGN  nv_pol72  = uwm100.policy   /* Policy (V72) */
        nv_comdat72 = uwm100.comdat       /* Comdat (V72) */
...
END.
    ...
    /* Add [A65-0006] */
    ASSIGN nv_comp_net = 0  
           nv_comp_prm = 0  
           nv_stamp72  = 0  
           nv_vat72    = 0. 
    
    //IF wagtprm_fil.policy = "DI7266V00210"  THEN MESSAGE "OK" wagtprm_fil.policy wagtprm_fil.vehreg wagtprm_fil.prem_comp  VIEW-AS ALERT-BOX.

    ASSIGN nv_comp_net = wagtprm_fil.prem_comp
           nv_comp_prm = wagtprm_fil.prem_comp
           nv_stamp72  = wagtprm_fil.stamp    
           nv_vat72    = wagtprm_fil.tax.     
        
    FOR EACH bagtprm_fil NO-LOCK USE-INDEX       by_acno               
        WHERE      bagtprm_fil.asdat           = n_asdat                       
        AND        bagtprm_fil.acno            = wagtprm_fil.acno 
        AND        bagtprm_fil.policy          = wagtprm_fil.policy
        AND       (bagtprm_fil.trntyp         <> wagtprm_fil.trntyp 
        AND        bagtprm_fil.docno          <> wagtprm_fil.docno). 
    
      FIND FIRST bcfuwm100 USE-INDEX uwm10001 WHERE 
                bcfuwm100.policy  = bagtprm_fil.policy AND
                bcfuwm100.endno  <> uwm100.endno       NO-LOCK NO-ERROR NO-WAIT.
       IF AVAIL bcfuwm100 THEN DO:
     
          IF TRIM(bcfuwm100.dealer) = "FTIB" AND TRIM(nv_dealer) = "FTIB" THEN DO:
 
             ASSIGN  nv_comp_net = nv_comp_net + bagtprm_fil.prem_comp
                     nv_comp_prm = nv_comp_prm + bagtprm_fil.prem_comp
                     nv_stamp72  = nv_stamp72  + bagtprm_fil.stamp    
                     nv_vat72    = nv_vat72    + bagtprm_fil.tax.     
          END.

          IF SUBSTR(bcfuwm100.policy,7,2) = "TB" AND SUBSTR(uwm100.policy,7,2) = "TB" THEN  DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdnopol72_1 C-Win 
PROCEDURE pdnopol72_1 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
/* Add pdnopol72_1 Montrikon S. [A65-0006] */
    ASSIGN nv_nor_net  = 0
           nv_nor_prm  = 0
           nv_stamp70  = 0
           nv_vat70    = 0.
   
    ASSIGN nv_nor_net  = Wagtprm_fil.prem  
           nv_nor_prm  = Wagtprm_fil.prem  
           nv_stamp70  = Wagtprm_fil.stamp 
           nv_vat70    = Wagtprm_fil.tax.     
    ...
    FOR EACH bagtprm_fil NO-LOCK USE-INDEX by_acno               
     ...
     FIND FIRST bcfuwm100 USE-INDEX uwm10001 WHERE 
       ...
       IF AVAIL bcfuwm100 THEN DO:
          ...
          IF bcfuwm100.acno1 = "A0MF29TLT1" THEN NEXT.
     
          IF TRIM(bcfuwm100.dealer) = "FTIB" AND TRIM(nv_dealer) = "FTIB" THEN DO:
     
             ASSIGN nv_nor_net  = nv_nor_net  + bagtprm_fil.prem
                    nv_nor_prm  = nv_nor_prm  + bagtprm_fil.prem
                    nv_stamp70  = nv_stamp70  + bagtprm_fil.stamp 
                    nv_vat70    = nv_vat70    + bagtprm_fil.tax.
          END.
          IF SUBSTR(bcfuwm100.policy,7,2) = "TB" AND SUBSTR(uwm100.policy,7,2) = "TB" THEN  DO:
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH wBill USE-INDEX wBill02 NO-LOCK
        ...
        PUT STREAM filebill1
            ...
            wBill.wendno                            FORMAT "X(10)"      /* 32. 401 - 410 */ /* [A65-0006] */
            wBill.wdealer                           FORMAT "X(10)"      /* 33. 411 - 420 */ /* [A65-0006] */
            SKIP.
...
REPEAT:   
    ...
    IF INDEX(TRIM(SUBSTRING(nv_daily,308,10)), "-") >= 1 THEN NEXT. /* Add เบี้ยติดลบให้ Next [A65-0006] */
    IF INDEX(TRIM(SUBSTRING(nv_daily,318,10)), "-") >= 1 THEN NEXT. /* Add เบี้ยติดลบให้ Next [A65-0006] */
    ...
    ASSIGN                                                                       
        ...
        wdetail.wnor_covamt      = DECI(TRIM(SUBSTRING(nv_daily,188,10))) / 100    /*13*/      
        wdetail.wcomp_covamt     = DECI(TRIM(SUBSTRING(nv_daily,198,10))) / 100    /*14*/ 
        wdetail.wNetPrem         = DECI(TRIM(SUBSTRING(nv_daily,208,10))) / 100    /*15*/ 
        wdetail.wCompNetPrem     = DECI(TRIM(SUBSTRING(nv_daily,218,10))) / 100    /*16*/ 
        wdetail.wgrossprem       = DECI(TRIM(SUBSTRING(nv_daily,228,10))) / 100    /*17*/ 
        wdetail.wCompGrossPrem   = DECI(TRIM(SUBSTRING(nv_daily,238,10))) / 100    /*18*/ 
        wdetail.wtotal_prm       = DECI(TRIM(SUBSTRING(nv_daily,248,10))) / 100    /*19*/ 
        wdetail.wnor_comm        = DECI(TRIM(SUBSTRING(nv_daily,258,10))) / 100    /*20*/ 
        wdetail.wcomp_comm       = DECI(TRIM(SUBSTRING(nv_daily,268,10))) / 100    /*21*/ 
        wdetail.wnor_vat         = DECI(TRIM(SUBSTRING(nv_daily,278,10))) / 100    /*22*/ 
        wdetail.wcomp_vat        = DECI(TRIM(SUBSTRING(nv_daily,288,10))) / 100    /*23*/ 
        wdetail.wnor_tax3        = DECI(TRIM(SUBSTRING(nv_daily,298,10))) / 100    /*24*/ 
        wdetail.wcomp_tax3       = DECI(TRIM(SUBSTRING(nv_daily,308,10))) / 100    /*25*/ 
        wdetail.wNetPayment      = DECI(TRIM(SUBSTRING(nv_daily,318,10))) / 100    /*26*/ 
        wdetail.wsubins          = TRIM(SUBSTRING(nv_daily,328,4))                 /*27*/ 
        wdetail.wcomp_sub        = TRIM(SUBSTRING(nv_daily,332,4))                 /*28*/ 
        wdetail.wcomp_comdat     = TRIM(SUBSTRING(nv_daily,336,8))                 /*29*/ 
        wdetail.wcomp_expdat     = TRIM(SUBSTRING(nv_daily,344,8))                 /*30*/ 
        wdetail.wremark          = TRIM(SUBSTRING(nv_daily,352,49))                /*31*/ 
        wdetail.wendno           = TRIM(SUBSTRING(nv_daily,401,10))                /*32*/  /* [A65-0006]*/ 
        wdetail.wdealer          = TRIM(SUBSTRING(nv_daily,411,10)).               /*33*/  /* [A65-0006]*/
...
PUT STREAM ns2  "head " ","     /*1*/    
"รอบการวางบิน"          ","     /*2*/   
"รอบของวันที่วางบิน"    ","     /*3*/   
"Recordno."             ","     /*4*/   
"Type"                  ","     /*5*/   
"Policy "               ","     /*6*/   
"Policy_V72 "           ","     /*7*/   
...
for each wdetail  no-lock.       
    PUT STREAM ns2   
     ...
     wdetail.wcha_no          ","    /*9*/ 
     wdetail.wengine          ","    /*10*/
     wdetail.wnor_comdat      ","    /*11*/
     wdetail.wnor_expdat      ","    /*12*/
     wdetail.wnor_covamt      ","    /*13*/ 
     wdetail.wcomp_covamt     ","    /*14*/  
     wdetail.wNetPrem         ","    /*15*/  
     wdetail.wCompNetPrem     ","    /*16*/  
     wdetail.wgrossprem       ","    /*17*/  
     wdetail.wCompGrossPrem   ","    /*18*/  
     wdetail.wtotal_prm       ","    /*19*/
     wdetail.wnor_comm        ","    /*20*/
     wdetail.wcomp_comm       ","    /*21*/
     wdetail.wnor_vat         ","    /*22*/
     wdetail.wcomp_vat        ","    /*23*/
     wdetail.wnor_tax3        ","    /*24*/
     wdetail.wcomp_tax3       ","    /*25*/
     wdetail.wNetPayment      ","    /*26*/ 
     wdetail.wsubins          ","    /*27*/ 
     wdetail.wcomp_sub        ","    /*28*/ 
     wdetail.wcomp_comdat     ","    /*29*/ 
     wdetail.wcomp_expdat     ","    /*30*/                     
     wdetail.wremark          ","    /*31*/
     wdetail.wendno           ","    /*32*/   /* [A65-0006] */
     wdetail.wdealer                 /*33*/   /* [A65-0006] */
     SKIP.
END.
...
----------------------A63-0391------*/
       ...
       DISPLAY  "Process : " + Agtprm_fil.policy + '   ' + Agtprm_fil.trnty
        ...
        IF AVAIL uwm100 THEN DO:
            IF TRIM(uwm100.dealer) <> "FTIB" THEN NEXT. /*A63-0391*/
...
FOR EACH wfAcno USE-INDEX wList01 NO-LOCK:
    ...
    FOR EACH  Agtprm_fil USE-INDEX by_acno     WHERE          /*Add kridtiya i. A59-0362 */
       ...
       (Agtprm_fil.trntyp   BEGINS 'M'         OR
        Agtprm_fil.trntyp   BEGINS 'R')        AND  /* Add Montrikon s. [A65-0006] */
       (Agtprm_fil.polbran   >= n_branch       AND
        Agtprm_fil.polbran   <= n_branch2)     AND
        Agtprm_fil.bal        > 0              NO-LOCK:
        /* เบี้ยเป็น 0 แต่ยังค้างค่า comm. (bal <> 0) */
        ...
        FIND LAST acm001 USE-INDEX acm00104 WHERE
            acm001.policy = Agtprm_fil.policy AND 
            acm001.recno  = Agtprm_fil.endno  NO-LOCK NO-ERROR NO-WAIT. /* Montrikon s. [A65-0006] */
        IF AVAIL acm001 THEN IF acm001.bal = 0 THEN NEXT.               /* Montrikon s. [A65-0006] */
           /* IF acm001.trnty1 = "R" AND acm001.trnty2 = "C" THEN NEXT.    Montrikon s. [A65-0006] */
...
FOR EACH wagtprm_fil  /*NO-LOCK-----A63-0391*/.                                    /*Kridtiya i. A53-0241  16/08/10 */
    ASSIGN
        nv_pol72       = ""     nv_norpol   = ""
        nv_job_nr      = ""     nv_insure   = ""
        nv_subins      = ""     nv_comp_sub = ""
    ...
    DISPLAY  "Process : " + wAgtprm_fil.policy + '   ' + wAgtprm_fil.trnty
        ...
        /* Add Montrikon s. [A65-0006] */
        FIND FIRST uwm100 USE-INDEX uwm10001 WHERE 
             uwm100.policy  = wAgtprm_fil.policy AND
             TRIM(uwm100.dealer) <> ""           AND
             TRIM(uwm100.dealer) <> "FTIB"       AND     /* <- A63-0391 */
             TRIM(uwm100.dealer) <> "FCASH"      NO-LOCK NO-ERROR.
        IF AVAIL uwm100 THEN NEXT.
        /* End Montrikon s. [A65-0006] */
        ...
        IF AVAIL uwm100 THEN DO:
            ...
            nv_dealer = uwm100.dealer. /* [A65-0006] */

            /* Add Montrikon s. [A65-0006] */
            FIND LAST bcfuwm100 USE-INDEX uwm10001 WHERE 
                      bcfuwm100.policy  = wAgtprm_fil.policy NO-LOCK NO-ERROR NO-WAIT.
            IF AVAIL  bcfuwm100 THEN IF bcfuwm100.polsta = "CA" THEN NEXT.   
            /* End Montrikon s. [A65-0006] */
           ...
           FIND uwm100 WHERE RECID(uwm100) = nv_rec100 NO-LOCK NO-ERROR NO-WAIT.   /*A50-0070*/
            ...
            /* create data to table wBill. Add Montrikon s. [A65-0006]. */
            IF (TRIM(bcfuwm100.dealer) = "FTIB" AND 
                TRIM(nv_dealer) = "FTIB")   AND
                uwm100.acno1 = "B3MF101860"    THEN RUN pdProc_2B3M.
            ELSE RUN pdProc_2All.
            /* End Montrikon s. [A65-0006]. */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdProc_2All C-Win 
PROCEDURE pdProc_2All :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
/* Add pdProc_2All Montrikon S. [A65-0006] */
/*------------ create data to table wBill -----------*/
    FIND FIRST wBill USE-INDEX  wBill01                       WHERE
    ...
    ASSIGN wBill.wrecordno      = vCountRec   /*4  Record no. 999999    inte   999999  */
           ...
           wBill.wcomp_expdat   = nv_expdat72   /*30 Effective Compulsory date yyyymmdd   99/99/9999 */
           wBill.wremark        = nv_remark     /*31 TLT. Remark         char x(49) */
           wBill.wdealer        = TRIM(nv_dealer) /* Add [A65-0006] */
           .                 
    END. /* find first wBill */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdProc_2B3M C-Win 
PROCEDURE pdProc_2B3M :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
/*------------ create data to table wBill Add Kridtiya i. A53-0314 -----------*/
    FIND FIRST wBill USE-INDEX  wBill01     WHERE
               wBill.wAcno   = wAgtprm_fil.acno    AND
               wBill.wPolicy = wAgtprm_fil.policy  AND
            /* wBill.wEndno  = wAgtprm_fil.endno   AND             Add Montrikon S. [A65-0006]
               wBill.wtrnty1 = SUBSTR(wAgtprm_fil.trnty,1,1)  AND
               wBill.wtrnty2 = SUBSTR(wAgtprm_fil.trnty,2,1)  AND
               wBill.wdocno  = wagtprm_fil.docno                   End Montrikon S. [A65-0006] */
               wBill.wdealer = TRIM(bcfuwm100.dealer)
    NO-ERROR NO-WAIT.
    IF NOT AVAIL wBill THEN DO:
       vCountRec = vCountRec + 1.
       DISPLAY "Create data to Table wBill ..." @ fi_Process WITH FRAME {&FRAME-NAME}.
       ...
       ASSIGN wBill.wrecordno      = vCountRec   /*4  Record no. 999999    inte   999999  */
              ...
              wBill.wcomp_expdat   = nv_expdat72   /*30 Effective Compulsory date yyyymmdd   99/99/9999 */
              wBill.wremark        = nv_remark     /*31 TLT. Remark         char x(49) */
              wBill.wdealer        = TRIM(bcfuwm100.dealer) /* Add [A65-0006] */
              .
    END. /* find first wBill */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_acno1 C-Win 
PROCEDURE pd_acno1 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
------------------------------------------------------------------------------*/
   nv_output = "".
   IF SUBSTR(fiFile-Nameinput,LENGTH(fiFile-Nameinput) - 3,4) <> ".csv" THEN fiFile-Nameinput = TRIM(fiFile-Nameinput).
   ELSE fiFile-Nameinput = SUBSTR(fiFile-Nameinput,1,LENGTH(fiFile-Nameinput) - 4).
   nv_output = fiFile-Nameinput + "_A0MF29TLT1.csv".
   ...
   FOR EACH wdetail2 WHERE wdetail2.wsubins   = "Z3ZG" OR
                           wdetail2.wsubins   = "Z3Z4" OR /* Add [A65-0006] */
                           wdetail2.wcomp_sub = "Z3ZG" OR
                           wdetail2.wcomp_sub = "Z3Z4" BREAK BY wdetail2.wnorpol : /* Add [A65-0006] */
  
       IF wdetail2.wdealer    <> "FTIB"       THEN NEXT.    /* Add [A65-0006] */        
       IF wdetail2.wendno     <> ""           THEN NEXT.
       IF SUBSTR(wdetail2.wnorpol,7,2) = "TB" OR 
          SUBSTR(wdetail2.wpol72,7,2)  = "TB" THEN NEXT. /* End [A65-0006] */   

       DISPLAY  "Split Data File : " + wdetail2.wnorpol @ fi_Process WITH FRAME fr_main .
       
       PUT STREAM ns2
           wdetail2.head             ","    /*1*/  
           wdetail2.n_binloop        ","    /*2*/ 
           wdetail2.fi_bindate       ","    /*3*/ 
           wdetail2.wRecordno        ","    /*4*/ 
           wdetail2.wjob_nr          ","    /*5*/ 
           wdetail2.wnorpol          ","    /*6*/ 
           wdetail2.wpol72           ","    /*7*/ 
           wdetail2.winsure          ","    /*8*/ 
           wdetail2.wcha_no          ","    /*9*/ 
           wdetail2.wengine          ","    /*10*/
           wdetail2.wnor_comdat      ","    /*11*/
           wdetail2.wnor_expdat      ","    /*12*/
           wdetail2.wnor_covamt      ","    /*13*/ 
           wdetail2.wcomp_covamt     ","    /*14*/  
           wdetail2.wNetPrem         ","    /*15*/  
           wdetail2.wCompNetPrem     ","    /*16*/  
           wdetail2.wgrossprem       ","    /*17*/  
           wdetail2.wCompGrossPrem   ","    /*18*/  
           wdetail2.wtotal_prm       ","    /*19*/
           wdetail2.wnor_comm        ","    /*20*/
           wdetail2.wcomp_comm       ","    /*21*/
           wdetail2.wnor_vat         ","    /*22*/
           wdetail2.wcomp_vat        ","    /*23*/
           wdetail2.wnor_tax3        ","    /*24*/
           wdetail2.wcomp_tax3       ","    /*25*/
           wdetail2.wNetPayment      ","    /*26*/ 
           wdetail2.wsubins          ","    /*27*/ 
           wdetail2.wcomp_sub        ","    /*28*/ 
           wdetail2.wcomp_comdat     ","    /*29*/ 
           wdetail2.wcomp_expdat     ","    /*30*/                     
           wdetail2.wremark          SKIP.  /*31*/
       DELETE wdetail2.
   END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_acno2 C-Win 
PROCEDURE pd_acno2 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
------------------------------------------------------------------------------*/
   ...
   IF SUBSTR(fiFile-Nameinput,LENGTH(fiFile-Nameinput) - 3,4) <> ".csv" THEN fiFile-Nameinput = TRIM(fiFile-Nameinput).
   ELSE fiFile-Nameinput = SUBSTR(fiFile-Nameinput,1,LENGTH(fiFile-Nameinput) - 4).
   nv_output = fiFile-Nameinput + "_B3MF101860.csv".
   ...
   FOR EACH wdetail2 WHERE (wdetail2.wsubins   <> "Z3ZG"  AND    /* ADD [A65-0006] */
                            wdetail2.wsubins   <> "Z3Z4") /*
                            wdetail2.wsubins    = "Z1GD"  OR
                            wdetail2.wsubins    = "Z2GD"  OR
                            wdetail2.wsubins    = "Z3GD"  OR
                            wdetail2.wsubins    = "ZAGD"  OR
                            wdetail2.wsubins    = "ZBGD"  OR
                            wdetail2.wsubins    = "ZCGD"  OR
                            wdetail2.wsubins    = "ZSZZ"  OR
                            wdetail2.wsubins    = "Z1IN"  OR
                            wdetail2.wsubins    = "Z2IN"  OR
                            wdetail2.wsubins    = "Z1ID"  OR
                            wdetail2.wsubins    = "Z2ID"  OR
                            wdetail2.wsubins    = "Renew" OR
                            wdetail2.wsubins    = "K3GZ"  OR*/
                                                          AND  
                           (wdetail2.wcomp_sub <> "Z3ZG"  AND
                            wdetail2.wcomp_sub <> "Z3Z4") /* 
                            wdetail2.wcomp_sub  = "Z1GD"  OR
                            wdetail2.wcomp_sub  = "Z2GD"  OR
                            wdetail2.wcomp_sub  = "Z3GD"  OR
                            wdetail2.wcomp_sub  = "ZAGD"  OR
                            wdetail2.wcomp_sub  = "ZBGD"  OR
                            wdetail2.wcomp_sub  = "ZCGD"  OR
                            wdetail2.wcomp_sub  = "ZSZZ"  OR
                            wdetail2.wcomp_sub  = "Z1IN"  OR
                            wdetail2.wcomp_sub  = "Z2IN"  OR
                            wdetail2.wcomp_sub  = "Z1ID"  OR
                            wdetail2.wcomp_sub  = "Z2ID"  OR
                            wdetail2.wcomp_sub  = "Renew" OR
                            wdetail2.wcomp_sub  = "K3GZ"  */ BREAK BY wdetail2.wnorpol : /* END [A65-0006]*/

       IF SUBSTR(wdetail2.wnorpol,7,2) = "TB"   OR         /* Add [A65-0006] */
          SUBSTR(wdetail2.wpol72,7,2)  = "TB"   THEN NEXT.        
       IF        wdetail2.wdealer     <> "FTIB" THEN NEXT. /* End [A65-0006] */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_acno3 C-Win 
PROCEDURE pd_acno3 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
------------------------------------------------------------------------------*/
   ...
   IF SUBSTR(fiFile-Nameinput,LENGTH(fiFile-Nameinput) - 3,4) <> ".csv" THEN fiFile-Nameinput = TRIM(fiFile-Nameinput).
   ELSE fiFile-Nameinput = SUBSTR(fiFile-Nameinput,1,LENGTH(fiFile-Nameinput) - 4).
   nv_output = fiFile-Nameinput + "_Other.csv".
   ...
   FOR EACH wdetail2 BREAK BY wdetail2.wnorpol :
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_CommOVComdate C-Win 
PROCEDURE pd_CommOVComdate :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:   A63-0391    
------------------------------------------------------------------------------*/
 ...
 ASSIGN 
     ...
     nv_finint = uwm100.dealer.
 
 ASSIGN 
    nv_subins   = ""
    nv_comp_sub = "".

 IF nv_norpol <> "" AND agtprm_fil.poltyp <> "v72" THEN nv_subins = uwm100.campaign.
 ELSE nv_subins = "".

 IF nv_pol72  <> "" THEN nv_comp_sub = uwm100.campaign.
 
 IF nv_subins  = "" AND nv_comp_sub = "" THEN DO:
     LOOP_FINDTEXT:
     REPEAT:
         nv_fptr = uwm100.fptr02.
         DO WHILE nv_fptr <> 0 AND uwm100.fptr02 <> ? :
 ...
 /*---------70------------*/
 IF nv_acno1  = "A0MF29TLT1" AND 
    nv_finint = "FTIB"       AND  
    nv_subins = "Z3ZG"       THEN
     ASSIGN /*comm 0%, OV 0%*/
         nv_percomm  = 0 
         nv_perov    = 0 
         nv_comm_per70 = nv_percomm + nv_perov.
 
 ELSE IF nv_acno1  = "B3MF101860" AND 
         nv_finint = "FTIB"       AND   
        (nv_subins = "Z1GD"       OR  
         nv_subins = "Z2GD"       OR  
         nv_subins = "Z3GD"       OR  
         ...
         nv_subins = "ZBGD"       OR  
         nv_subins = "ZCGD")      THEN
         ASSIGN /*comm 18%, no OV*/
          nv_percomm  = 18 
          nv_comm_per70 = nv_percomm.
 
 ELSE IF nv_acno1  = "B3MF101860" AND 
         nv_finint = "FTIB"       AND 
         nv_subins = "ZSZZ"       THEN
     ASSIGN /*no Comm no OV, */
         nv_comm_per70 = 0.
 ...
 ELSE DO:
     ...
     FIND LAST xmm018 USE-INDEX xmm01801  WHERE
         xmm018.agent   = Agtprm_fil.acno AND
         xmm018.poltyp  = nv_poltyp70     NO-LOCK NO-ERROR NO-WAIT.
     IF AVAIL xmm018 THEN nv_comm_per70 = xmm018.commsp.
 END.

 /*---------72------------*/
 IF nv_finint = "FTIB" AND 
    nv_acno1  = "A0MF29TLT1" AND  
    nv_subins = "Z3ZG" THEN ASSIGN nv_comm_per72  = 0.

 ELSE IF nv_finint   = "FTIB"       AND 
         nv_acno1    = "B3MF101860" AND 
        (nv_comp_sub = "Z1GD"  OR
         nv_comp_sub = "Z2GD"  OR
         nv_comp_sub = "Z3GD"  OR
         nv_comp_sub = "ZAGD"  OR
         ...
         nv_comp_sub = "Z1ID"  OR
         nv_comp_sub = "Z2ID"  OR
         nv_comp_sub = "Renew" OR
         nv_comp_sub = "K3GZ" ) THEN nv_comm_per72 = 12. 
 ELSE DO:
     nv_comm_per72  = 0.
     /* Find Commission Special */
     FIND LAST xmm018 USE-INDEX xmm01801  WHERE
         xmm018.agent   = Agtprm_fil.acno AND
         xmm018.poltyp  = nv_poltyp72     NO-LOCK NO-ERROR NO-WAIT.
     IF AVAIL xmm018 THEN nv_comm_per72 = xmm018.commsp.
     ELSE nv_comm_per72 = 12.
 END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_CommOVTrndate C-Win 
PROCEDURE pd_CommOVTrndate :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
/* Add pd_CommOVTrndate Montrikon S. [A65-0006] */
 ASSIGN 
    nv_subins   = ""
    nv_comp_sub = "".

    IF nv_norpol <> "" AND wagtprm_fil.poltyp <> "v72" THEN nv_subins = nv_camp70.
    ELSE nv_subins = "".
    
    IF nv_pol72  <> "" THEN nv_comp_sub = uwm100.campaign.
    ELSE nv_comp_sub = "".

IF wAgtprm_fil.endno = "" THEN
    ASSIGN
       nv_percomm     = 0
       nv_perov       = 0
       nv_comm_per70  = 0
...
IF wagtprm_fil.poltyp = "V72" THEN DO:
   ...
   // MESSAGE wagtprm_fil.poltyp VIEW-AS ALERT-BOX.

   ASSIGN 
      nv_percomm = 12
      nv_perov   = 0
      nv_comm_per72 = nv_percomm + nv_perov.
END.

/*----------------------------------------- กรมธรรม์คู่ พ.ร.บ ----------------------------------------------------*/
    
ELSE IF wagtprm_fil.poltyp = "V70" AND 
        nv_pol72  <> ""            THEN DO:
    ...
    IF SUBSTR(wagtprm_fil.policy,7,2) = "TB" THEN
    ...
    ELSE IF SUBSTR(nv_subins,3,1) = "G"    OR
                   nv_subins      = "SZTF" THEN /* <- NEW */
    ...
    ELSE IF nv_subins = "GAPHINOTIB" THEN
    ...
    ELSE /*IF SUBSTR(nv_subins,3,1) <> "G" THEN*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pd_CommOVTrndate_bck C-Win 
PROCEDURE pd_CommOVTrndate_bck :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:  A63-0391     
------------------------------------------------------------------------------*/
/* Comment Montrikon S. [A65-0006] 
 ASSIGN 
     nv_acno1  = uwm100.acno1 
     nv_finint = uwm100.dealer.
 ...
 IF nv_norpol <> "" AND wagtprm_fil.poltyp <> "v72" THEN nv_subins = uwm100.campaign.
 ELSE nv_subins = "".
 ...
 ELSE DO:
     ...
     /* Find Commission Special */
     FIND LAST xmm018 USE-INDEX xmm01801  WHERE
         xmm018.agent   = wAgtprm_fil.acno AND
         xmm018.poltyp  = nv_poltyp70     NO-LOCK NO-ERROR NO-WAIT.
     IF AVAIL xmm018 THEN nv_comm_per70 = xmm018.commsp.
 END.
...
------------------------------------------------------------------------------*/
  ...
  REPEAT:
      IMPORT DELIMITER ","
              ...
              nv_wcomp_expdat     /*30*/ 
              nv_wremark          /*31*/
              nv_wendno           /*32*/   /* ADD [A65-0006]  */
              nv_wdealer          /*33*/   /* ADD [A65-0006]  */
              .
  

      IF TRIM(nv_whead) = "SAFE"  THEN DO:
          nv_cnt = nv_cnt + 1.

          CREATE wdetail2.
          ASSIGN 
              wdetail2.head           = TRIM(nv_whead)          /*1*/  
              wdetail2.n_binloop      = TRIM(nv_wbinloop)       /*2*/  
              wdetail2.fi_bindate     = TRIM(nv_wbindate)       /*3*/  
              wdetail2.wRecordno      = TRIM(nv_wRecordno)      /*4*/  
              wdetail2.wjob_nr        = TRIM(nv_wjob_nr)        /*5*/  
              wdetail2.wnorpol        = TRIM(nv_wnorpol)        /*6*/  
              wdetail2.wpol72         = TRIM(nv_wpol72)         /*7*/  
              wdetail2.winsure        = TRIM(nv_winsure)        /*8*/  
              wdetail2.wcha_no        = TRIM(nv_wcha_no)        /*9*/  
              wdetail2.wengine        = TRIM(nv_wengine)        /*10*/ 
              wdetail2.wnor_comdat    = TRIM(nv_wnor_comdat)    /*11*/ 
              wdetail2.wnor_expdat    = TRIM(nv_wnor_expdat)    /*12*/ 
              wdetail2.wnor_covamt    = DECI(nv_wnor_covamt)    /*13*/ 
              wdetail2.wcomp_covamt   = DECI(nv_wcomp_covamt)   /*14*/ 
              wdetail2.wNetPrem       = DECI(nv_wNetPrem)       /*15*/ 
              wdetail2.wCompNetPrem   = DECI(nv_wCompNetPrem)   /*16*/ 
              wdetail2.wgrossprem     = DECI(nv_wgrossprem)     /*17*/ 
              wdetail2.wCompGrossPrem = DECI(nv_wCompGrossPrem) /*18*/ 
              wdetail2.wtotal_prm     = DECI(nv_wtotal_prm)     /*19*/ 
              wdetail2.wnor_comm      = DECI(nv_wnor_comm)      /*20*/ 
              wdetail2.wcomp_comm     = DECI(nv_wcomp_comm)     /*21*/                
              wdetail2.wnor_vat       = DECI(nv_wnor_vat)       /*22*/ 
              wdetail2.wcomp_vat      = DECI(nv_wcomp_vat)      /*23*/ 
              wdetail2.wnor_tax3      = DECI(nv_wnor_tax3)      /*24*/ 
              wdetail2.wcomp_tax3     = DECI(nv_wcomp_tax3)     /*25*/ 
              wdetail2.wNetPayment    = DECI(nv_wNetPayment)    /*26*/ 
              wdetail2.wsubins        = TRIM(nv_wsubins)        /*27*/ 
              wdetail2.wcomp_sub      = TRIM(nv_wcomp_sub)      /*28*/ 
              wdetail2.wcomp_comdat   = TRIM(nv_wcomp_comdat)   /*29*/ 
              wdetail2.wcomp_expdat   = TRIM(nv_wcomp_expdat)   /*30*/ 
              wdetail2.wremark        = TRIM(nv_wremark)        /*31*/ 
              wdetail2.wendno         = TRIM(nv_wendno)          /*32*/ /* ADD [A65-0006]  */
              wdetail2.wdealer        = TRIM(nv_wdealer)         /*33*/ /* ADD [A65-0006]  */      
              .
      END.
      ELSE NEXT.
      ASSIGN
          ...
          nv_wcomp_expdat   = ""  
          nv_wremark        = ""
          nv_wendno         = ""  /* ADD [A65-0006]  */
          nv_wdealer        = ""  /* ADD [A65-0006]  */
          .
...
IF vChkFirstAdd = 1 THEN DO:
    DO WITH FRAME  fr_main :
        ...
        /* vProdCod = "A0M7023,B3M0008". /*A58-0094*/. Add Comment Montrikon S. [A65-0006] */ 
       
        vProdCod = "A0MF29TLT1,B3MF101860,". /* + vProdCod. [A65-0006] */  /*A63-0391*/  
