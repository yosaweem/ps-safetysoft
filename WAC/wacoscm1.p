/* program   :  WACOSCM1.P  Outstanding claim paid for profit center report (Summary) */
...
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X7;K"   '"' "Acc.no."            '"'   SKIP.  /*A47-0140*/
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X8;K"   '"' "Producer"           '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X9;K"   '"' "Loss date"          '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X10;K"  '"' "Nature"             '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X11;K"  '"' "PV/CF"              '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X12;K"  '"' "Req.no."            '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X13;K"  '"' "Entry date"         '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X14;K"  '"' "paid date"          '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X15;K"  '"' "Total claim"        '"'   SKIP.  /*A47-0140*/
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X16;K"  '"' "Survey Fee"         '"'   SKIP.  /*A47-0140*/
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X17;K"  '"' "Netvat"             '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X18;K"  '"' "Vat"                '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X19;K"  '"' "Tax 3%"             '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X20;K"  '"' "Netamt"             '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X21;K"  '"' "1st Treaty"         '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X22;K"  '"' "2nd Treaty"         '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X23;K"  '"' "Fac. RI"            '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X24;K"  '"' "Q.S. 5%"            '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X25;K"   '"' "TFP"               '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X26;K"   '"' "MPS"               '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X27;K"   '"' "Eng.Fac."          '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X28;K"   '"' "Marine O/P"        '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X29;K"   '"' "R.Q."              '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X30;K"   '"' "BTR"               '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X31;K"   '"' "OTR"               '"'   SKIP.  /*A47-0140*/
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X32;K"   '"' "FTR"               '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X33;K"   '"' "F/O I"             '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X34;K"  '"' "F/O II"             '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X35;K"  '"' "F/O III"            '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X36;K"  '"' "F/O IV"             '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X37;K"  '"' "RET"                '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X38;K"  '"' "Gross RET"          '"'   SKIP.  /*A47-0140*/
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X39;K"  '"' "XOL"                '"'   SKIP.  /*A47-0140*/
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X40;K"  '"' "Acno"               '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X41;K"  '"' "Payee"              '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X42;K"  '"' "Clicod"             '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X43;K"  '"' "User ID"            '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X44;K"  '"' "Adjustor"           '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X45;K"  '"' "Detail"             '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X46;K"  '"' "Release"            '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X47;K"  '"' "Status"             '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X48;K"  '"' "Coins. "            '"'   SKIP.
PUT STREAM ns2 "C;Y" STRING(nv_row) ";X49;K"  '"' "Co %  "             '"'   SKIP.
----*/
...
NO-LOCK:
  ...
  IF AVAIL clm100 THEN DO:
    ...
    IF NOT AVAIL Szr016 THEN DO:
       ...
       ------*/
       ASSIGN Szr016.poltyp = Clm100.poltyp + "|" + nv_dirclm   /* V70|D , V70|I */
              Szr016.branch = CAPS(nv_brn)
       /*--- A500178 ---*/
              Szr016.claim  = Clm100.claim
...
BREAK BY Szr016.branch
      ...
      ------*/
      BY SUBSTR (Szr016.poltyp,5,1)  /* V70|D */
     /*--- A500178 ---*/
      BY Szr016.claim :
      ...
      FIND FIRST s0m005 USE-INDEX s0m00501    WHERE
                 ...
                 s0m005.key2 = substring(szr016.poltyp,1,3)
    ...
    IF LAST-OF (SUBSTRING (Szr016.claim,1,1)) THEN DO:  /* I,D */
        ...
        nv_row = nv_row + 1.  
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X1;K"   '"' "Total claim :"                  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X2;K"   '"' SUBSTRING (Szr016.claim,1,1)     '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X5;K"   '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) Szr016.gross)
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X6;K"   '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_1st)      
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X7;K"   '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_2nd)      
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X8;K"   '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_facri)    
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X9;K"   '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_qs5)      
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X10;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_tfp)      
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X11;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_mps)      
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X12;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_eng)      
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X13;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_mar)      
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X14;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_rq)       
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X15;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_btr)      
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X16;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_otr)
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X17;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_ftr)      
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X18;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_fo1)      
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X19;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_fo2)      
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X20;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_fo3)      
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X21;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_fo4)      
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X22;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_net)      
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X23;K"   '"' (ACCUM TOTAL BY SUBSTR (Szr016.claim,1,1) nvw_xol)      
                                                           FORMAT ">>>,>>>,>>9.99-"        '"'   SKIP.
    ...
    IF LAST-OF (SUBSTRING (Szr016.poltyp,5,1)) THEN DO:  /* I,D */
        ...
        nv_row = nv_row + 1.  
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X1;K"   '"' "Total claim :"                  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X2;K"   '"' SUBSTRING (Szr016.poltyp,5,1)     '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X5;K"   '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) Szr016.gross) FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X6;K"   '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_1st)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X7;K"   '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_2nd)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X8;K"   '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_facri)    FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X9;K"   '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_qs5)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X10;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_tfp)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X11;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_mps)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X12;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_eng)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X13;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_mar)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X14;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_rq)       FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X15;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_btr)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X16;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_otr)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X17;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_ftr)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X18;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_fo1)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X19;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_fo2)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X20;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_fo3)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X21;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_fo4)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X22;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_net)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X23;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,5,1) nvw_xol)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
        ...
        IF LAST-OF (SUBSTR (Szr016.poltyp,2,2)) THEN DO:
            ...
            nv_row = nv_row + 1.  
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X1;K"   '"' nvw_nbran                        '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X2;K"   '"' SUBSTR (Szr016.poltyp,2,2)       '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X3;K"   '"' nvw_ntype                        '"'   SKIP.

            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X5;K"   '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) Szr016.gross) FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X6;K"   '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_1st)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X7;K"   '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_2nd)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X8;K"   '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_facri)    FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X9;K"   '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_qs5)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X10;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_tfp)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X11;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_mps)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X12;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_eng)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X13;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_mar)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X14;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_rq)       FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X15;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_btr)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X16;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_otr)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X17;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_ftr)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X18;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_fo1)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X19;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_fo2)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X20;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_fo3)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X21;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_fo4)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X22;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_net)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X23;K"  '"' (ACCUM TOTAL BY SUBSTR (Szr016.poltyp,2,2) nvw_xol)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.

           /***-------------------------------------------------------------***/
            IF LAST-OF (Szr016.branch) THEN DO:
              
                /***---  Output to Text File / D.Sansom 06/2002 -------------***/
                /*---jeab total
                PUT STREAM ns2
                "Total : " nvw_nbran "|"  "|"  "|"
                "|" "|" "|" "|" "|" "|" "|"
                
                (ACCUM TOTAL BY Szr016.branch Szr016.gross) 
                  FORMAT ">>>,>>>,>>9.99-" "|"
                (ACCUM TOTAL BY Szr016.branch nvw_1st)      
                  FORMAT ">>>,>>>,>>9.99-" "|"
                (ACCUM TOTAL BY Szr016.branch nvw_2nd)      
                  FORMAT ">>>,>>>,>>9.99-" "|"
                (ACCUM TOTAL BY Szr016.branch nvw_facri)    
                  FORMAT ">>>,>>>,>>9.99-" "|"
                (ACCUM TOTAL BY Szr016.branch nvw_qs5)      
                  FORMAT ">>>,>>>,>>9.99-" "|"
                (ACCUM TOTAL BY Szr016.branch nvw_tfp)      
                  FORMAT ">>>,>>>,>>9.99-" "|"
                (ACCUM TOTAL BY Szr016.branch nvw_mps)      
                  FORMAT ">>>,>>>,>>9.99-" "|"
                
                (ACCUM TOTAL BY Szr016.branch nvw_eng)      
                  FORMAT ">>>,>>>,>>9.99-" "|"
                (ACCUM TOTAL BY Szr016.branch nvw_mar)      
                  FORMAT ">>>,>>>,>>9.99-" "|"
                (ACCUM TOTAL BY Szr016.branch nvw_rq)       
                  FORMAT ">>>,>>>,>>9.99-" "|"
                (ACCUM TOTAL BY Szr016.branch nvw_btr)      
                  FORMAT ">>>,>>>,>>9.99-" "|"
                (ACCUM TOTAL BY Szr016.branch nvw_otr)      
                  FORMAT ">>>,>>>,>>9.99-" "|"
                (ACCUM TOTAL BY Szr016.branch nvw_ftr)      
                  FORMAT ">>>,>>>,>>9.99-" "|"
                
                (ACCUM TOTAL BY Szr016.branch nvw_fo1)      
                  FORMAT ">>>,>>>,>>9.99-" "|"
                (ACCUM TOTAL BY Szr016.branch nvw_fo2)      
                  FORMAT ">>>,>>>,>>9.99-" "|"
                (ACCUM TOTAL BY Szr016.branch nvw_fo3)      
                  FORMAT ">>>,>>>,>>9.99-" "|"
                (ACCUM TOTAL BY Szr016.branch nvw_fo4)      
                  FORMAT ">>>,>>>,>>9.99-" "|"
                
                (ACCUM TOTAL BY Szr016.branch nvw_net)      
                  FORMAT ">>>,>>>,>>9.99-" "|"
                (ACCUM TOTAL BY Szr016.branch nvw_xol)      
                  FORMAT ">>>,>>>,>>9.99-" "|"
            ...
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X2;K"   '"' nvw_nbran                        '"'   SKIP.
    
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X5;K"   '"' (ACCUM TOTAL BY Szr016.branch Szr016.gross) FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X6;K"   '"' (ACCUM TOTAL BY Szr016.branch nvw_1st)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X7;K"   '"' (ACCUM TOTAL BY Szr016.branch nvw_2nd)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X8;K"   '"' (ACCUM TOTAL BY Szr016.branch nvw_facri)    FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X9;K"   '"' (ACCUM TOTAL BY Szr016.branch nvw_qs5)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X10;K"  '"' (ACCUM TOTAL BY Szr016.branch nvw_tfp)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X11;K"  '"' (ACCUM TOTAL BY Szr016.branch nvw_mps)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X12;K"  '"' (ACCUM TOTAL BY Szr016.branch nvw_eng)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X13;K"  '"' (ACCUM TOTAL BY Szr016.branch nvw_mar)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X14;K"  '"' (ACCUM TOTAL BY Szr016.branch nvw_rq)       FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X15;K"  '"' (ACCUM TOTAL BY Szr016.branch nvw_btr)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X16;K"  '"' (ACCUM TOTAL BY Szr016.branch nvw_otr)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X17;K"  '"' (ACCUM TOTAL BY Szr016.branch nvw_ftr)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X18;K"  '"' (ACCUM TOTAL BY Szr016.branch nvw_fo1)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X19;K"  '"' (ACCUM TOTAL BY Szr016.branch nvw_fo2)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X20;K"  '"' (ACCUM TOTAL BY Szr016.branch nvw_fo3)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X21;K"  '"' (ACCUM TOTAL BY Szr016.branch nvw_fo4)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X22;K"  '"' (ACCUM TOTAL BY Szr016.branch nvw_net)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.
            PUT STREAM ns2 "C;Y" STRING(nv_row) ";X23;K"  '"' (ACCUM TOTAL BY Szr016.branch nvw_xol)      FORMAT ">>>,>>>,>>9.99-"  '"'   SKIP.

            /***---------------------------------------------------------***/                 
            IF LAST (Szr016.branch) THEN DO:  
  
                nv_row = nv_row + 1.  
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X1;K"   '"' "Grand Total All Branch"         '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X5;K"   '"' (ACCUM TOTAL Szr016.gross) FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X6;K"   '"' (ACCUM TOTAL nvw_1st)   FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X7;K"   '"' (ACCUM TOTAL nvw_2nd)   FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X8;K"   '"' (ACCUM TOTAL nvw_facri) FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X9;K"   '"' (ACCUM TOTAL nvw_qs5)   FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X10;K"  '"' (ACCUM TOTAL nvw_tfp)   FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X11;K"  '"' (ACCUM TOTAL nvw_mps)   FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X12;K"  '"' (ACCUM TOTAL nvw_eng)   FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X13;K"  '"' (ACCUM TOTAL nvw_mar)   FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X14;K"  '"' (ACCUM TOTAL nvw_rq)    FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X15;K"  '"' (ACCUM TOTAL nvw_btr)   FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X16;K"  '"' (ACCUM TOTAL nvw_otr)   FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X17;K"  '"' (ACCUM TOTAL nvw_ftr)   FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X18;K"  '"' (ACCUM TOTAL nvw_fo1)   FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X19;K"  '"' (ACCUM TOTAL nvw_fo2)   FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X20;K"  '"' (ACCUM TOTAL nvw_fo3)   FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X21;K"  '"' (ACCUM TOTAL nvw_fo4)   FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X22;K"  '"' (ACCUM TOTAL nvw_net)   FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X23;K"  '"' (ACCUM TOTAL nvw_xol)   FORMAT ">>>,>>>,>>9.99-"    '"'   SKIP.

                nv_row = nv_row + 1.
                PUT STREAM ns2 "C;Y" STRING(nv_row) ";X1;K"   '"' "Grand Total by policy line"         '"'   SKIP.
                 ...
                 FOR EACH W016 BREAK BY W016.wfDI BY W016.wfpoltyp
                     ...
                     IF FIRST-OF (W016.wfDI) THEN DO:
                         ...
                         nv_row = nv_row + 1.
                         PUT STREAM ns2 "C;Y" STRING(nv_row) ";X1;K"   '"' "Summary of"           '"'   SKIP.
                         PUT STREAM ns2 "C;Y" STRING(nv_row) ";X2;K"   '"' CAPS(w016.wfDI)        '"'   SKIP.
                            
                     END. /* DI */

              
                     nv_row = nv_row + 1.  
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X1;K"   '"' W016.wfpoltyp  '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X2;K"   '"' W016.wfpoldes  '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X5;K"   '"' wfgross FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X6;K"   '"' wf1st   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X7;K"   '"' wf2nd   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X8;K"   '"' wffacri FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X9;K"   '"' wfqs5   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X10;K"  '"' wftfp   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X11;K"  '"' wfmps   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X12;K"  '"' wfeng   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X13;K"  '"' wfmar   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X14;K"  '"' wfrq    FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X15;K"  '"' wfbtr   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X16;K"  '"' wfotr   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X17;K"  '"' wfftr   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X18;K"  '"' wffo1   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X19;K"  '"' wffo2   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X20;K"  '"' wffo3   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X21;K"  '"' wffo4   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X22;K"  '"' wfret   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                     PUT STREAM ns2 "C;Y" STRING(nv_row) ";X23;K"  '"' wfxol   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.     


                     IF LAST-OF (W016.wfDI) THEN DO:
           
                        nv_row = nv_row + 1.  
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X1;K"   '"' "All"                     '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X2;K"   '"' W016.wfDI                 '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X5;K"   '"' ACCUM TOTAL BY W016.wfDI wfgross FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X6;K"   '"' ACCUM TOTAL BY W016.wfDI wf1st   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X7;K"   '"' ACCUM TOTAL BY W016.wfDI wf2nd   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X8;K"   '"' ACCUM TOTAL BY W016.wfDI wffacri FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X9;K"   '"' ACCUM TOTAL BY W016.wfDI wfqs5   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X10;K"  '"' ACCUM TOTAL BY W016.wfDI wftfp   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X11;K"  '"' ACCUM TOTAL BY W016.wfDI wfmps   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X12;K"  '"' ACCUM TOTAL BY W016.wfDI wfeng   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X13;K"  '"' ACCUM TOTAL BY W016.wfDI wfmar   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X14;K"  '"' ACCUM TOTAL BY W016.wfDI wfrq    FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X15;K"  '"' ACCUM TOTAL BY W016.wfDI wfbtr   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X16;K"  '"' ACCUM TOTAL BY W016.wfDI wfotr   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X17;K"  '"' ACCUM TOTAL BY W016.wfDI wfftr   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X18;K"  '"' ACCUM TOTAL BY W016.wfDI wffo1   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X19;K"  '"' ACCUM TOTAL BY W016.wfDI wffo2   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X20;K"  '"' ACCUM TOTAL BY W016.wfDI wffo3   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X21;K"  '"' ACCUM TOTAL BY W016.wfDI wffo4   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X22;K"  '"' ACCUM TOTAL BY W016.wfDI wfret   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.
                        PUT STREAM ns2 "C;Y" STRING(nv_row) ";X23;K"  '"' ACCUM TOTAL BY W016.wfDI wfxol   FORMAT ">>>,>>>,>>9.99-" '"'   SKIP.   
                        
                     END.  /***--- LAST-OF (W016.wfDI) ---***/
                     
                 END. /***--- FOR EACH W016 BREAK BY W016.wfDI BY W016.wfpoltyp ---***/
        ...
        END.  /*--- LAST-OF (SUBSTR (Szr016.poltyp,2,2)) ---*/
        /***----------------------------------------------------------------***/
