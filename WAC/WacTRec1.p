/************************************************************************/
/* WacTRec1.p    : Program Tranfer Receipt Bill(RC) Br.To HO            */
...
OUTPUT TO VALUE (nv_filename) APPEND  NO-ECHO.
    ...
    EXPORT DELIMITER ";" 
        "wtmar100 - Transfer Confirm Receipt System : Reports Name ' " + "Receipt Bill(RC) Br.To HO" + " '"
...
FOR EACH brstat.arm100    USE-INDEX arm10011
    ...
    ELSE DO: /*------------- AVALIBLE ON SICFN THEN UPDATE -----------*/
        ...
        DO TRANSACTION:
            IF ((brstat.arm100.prjsta = "CA") AND (brstat.arm100.prjsta <> sicfn.arm100.prjsta) ) OR  
                (brstat.arm100.rvno <> "" ) THEN DO:               
                ASSIGN
