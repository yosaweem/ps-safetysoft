...
Modify By  : Nattanicha K. A64-0380  31/03/2022
             - changed the logic of cancelation earn in Unearned report, 
             - add new fields (as at date, renew count and endorse count)
...
/*---A64-0380---*/
DEF VAR nv_output_newmot  AS CHAR FORMAT "X(70)" INIT "".
DEF VAR nv_output_newnon  AS CHAR FORMAT "X(70)" INIT "".
DEF VAR nv_output_newsummot  AS CHAR FORMAT "X(70)" INIT "".
DEF VAR nv_output_newsumnon  AS CHAR FORMAT "X(70)" INIT "".
...
DEFINE FRAME fr_main
     ...
     "Output To :" VIEW-AS TEXT
          ...
          BGCOLOR 3 FONT 6
     "Earn / Unearn Premium Report" VIEW-AS TEXT
          SIZE 30.67 BY 1.24 AT ROW 1.57 COL 52.67
          BGCOLOR 3 FGCOLOR 7 FONT 6
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  gv_prgid = "WACR60".
  gv_prog  = "Earn/Unearn Premium Report".
...
IF AVAIL buwm100 THEN DO:
   ...
   /*RUN pd_detailnon_newCA.---------A64-0380*/
...
FOR EACH uwm100 NO-LOCK USE-INDEX uwm10008 WHERE 
    ...
    /*---uwm100.expdat  >=  fi_asdate      AND ------A64-0380----*/
    uwm100.agent   >=  fi_agentfr     AND
    uwm100.agent   <=  fi_agentto     AND
