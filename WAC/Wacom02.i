...
---*/
          ...
          EXPORT DELIMITER ";"  nv_RptName + " Premium"         nv_TTprem   nv_Tprem[1 FOR 4]. 
          EXPORT DELIMITER ";"  nv_RptName + " Commission"      nv_TTcomm   nv_Tcomm[1 FOR 4].
          EXPORT DELIMITER ";"  nv_RptName + " Bal. O/S"        nv_TTbal    nv_Tbal[1 FOR 4].
          EXPORT DELIMITER ";"  nv_RptName + " Cheque Returned" nv_TTretc   nv_Tretc[1 FOR 4].
          EXPORT DELIMITER ";"  nv_RptName + " Suspense"        nv_TTsusp   nv_Tsusp[1 FOR 4].
          EXPORT DELIMITER ";"  nv_RptName + " Net. A/R"        nv_TTnetar  nv_Tnetar[1 FOR 4].
          EXPORT DELIMITER ";"  nv_RptName + " Net. OTHER"      nv_TTnetoth nv_Tnetoth[1 FOR 4].
        
          EXPORT DELIMITER ";" "Summary of Bal. O/S : " + nv_RptName + " " + nv_RptTyp1
              /*"Current = " + STRING(nv_Tbal[1] + nv_Tbal[2] ,">>,>>>,>>>,>>9.99-") + nv-1 +*/
              "ไม่เกิน 60 วัน = " + STRING(nv_Tbal[1] /*+ nv_Tbal[4] + nv_Tbal[5]*/,">>,>>>,>>>,>>9.99-") + nv-1 +
              "61 - 90  วัน = "   + STRING(nv_Tbal[2] /*+ nv_Tbal[7] + nv_Tbal[8]*/,">>,>>>,>>>,>>9.99-") + nv-1 +
              "91 - 365 วัน = "   + STRING(nv_Tbal[3] /*+ nv_Tbal[10] + nv_Tbal[11]*/ ,">>,>>>,>>>,>>9.99-") + nv-1 +
              "365 วันขึ้นไป = "  + STRING(nv_Tbal[4] /*+ nv_Tbal[13] + nv_Tbal[14] */,">>,>>>,>>>,>>9.99-") .
