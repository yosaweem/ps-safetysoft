/* WACPMDE.P  :  uzx00702.p  Premium for profit center report (Detail) */
...
DEF WORKFILE   work_fil
    ...
    FIELD  policy    LIKE  uwm100.policy   COLUMN-LABEL  "policy"
    FIELD  endcnt    LIKE  uwm100.endcnt   COLUMN-LABEL  "endcnt"
    /*FIELD  endno     LIKE  uwm100.endno    COLUMN-LABEL  "endno"*//*Comment A53-0039*/
    FIELD  endno     AS CHAR FORMAT "X(10)"  COLUMN-LABEL  "endno"  /*Add A53-0039*/
    FIELD  trndat    LIKE  uwm100.trndat   COLUMN-LABEL  "trndat" 
...
MESSAGE "output  "  nv_output VIEW-AS ALERT-BOX.
...
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X6;K"   '"' "Policy no"     '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X7;K"   '"' "Endcnt"        '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X8;K"   '"' "End.no"        '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X9;K"   '"' "Trndat"        '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X10;K"  '"' "Sum Insured"  '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X11;K"  '"' "เบี้ยประกันภัย"      '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X12;K"  '"' "ค่านายหน้าประกันภัย" '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X14;K"  '"' "เบี้ย RET"   '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X15;K"  '"' "%RET"        '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X16;K"  '"' "คอม RET"     '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X18;K"  '"' "เบี้ย Qbaht" '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X19;K"  '"' "%Qbaht"      '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X20;K"  '"' "คอม Qbaht"   '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X22;K"  '"' "เบี้ย 1ST"   '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X23;K"  '"' "%1ST"        '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X24;K"  '"' "คอม 1ST"     '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X26;K"  '"' "เบี้ย 2ND"   '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X27;K"  '"' "%2ND"        '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X28;K"  '"' "คอม 2ND"     '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X30;K"  '"' "เบี้ย TFP"   '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X31;K"  '"' "%TFP"        '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X32;K"  '"' "คอม TFP"     '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X34;K"  '"' "เบี้ย FO1"   '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X35;K"  '"' "%FO1"        '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X36;K"  '"' "คอม FO1"     '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X38;K"  '"' "เบี้ย FO2"   '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X39;K"  '"' "%FO2"        '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X40;K"  '"' "คอม FO2"     '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X42;K"  '"'"เบี้ย FO3"    '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X43;K"  '"'"%FO3"         '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X44;K"  '"'"คอม FO3"      '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X46;K"  '"'"เบี้ย FO4"    '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X47;K"  '"'"%FO4"         '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X48;K"  '"'"คอม FO4"      '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X50;K"  '"'"เบี้ย Q/S"    '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X51;K"  '"'"%Q/S"         '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X52;K"  '"'"คอม Q/S"      '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X54;K"  '"' "เบี้ย MPS"   '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X55;K"  '"' "%MPS"        '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X56;K"  '"' "คอม MPS"     '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X58;K"  '"' "เบี้ย BTR"   '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X59;K"  '"' "%BTR"        '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X60;K"  '"' "คอม BTR"     '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X62;K"  '"' "เบี้ย OTR"   '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X63;K"  '"' "%OTR"        '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X64;K"  '"' "คอม OTR"     '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X66;K"  '"' "เบี้ย FTR"   '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X67;K"  '"' "%FTR"        '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X68;K"  '"' "คอม FTR"     '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X70;K"  '"' "เบี้ย S8"    '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X71;K"  '"' "%S8"         '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X72;K"  '"' "คอม S8"      '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X74;K"  '"' "เบี้ย OTHER" '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X75;K"  '"' "%OTHER"      '"'   SKIP.
PUT STREAM ns1 "C;Y" STRING(nv_row) ";X76;K"  '"' "คอม OTHER"   '"'   SKIP.
    ...
    FOR EACH uwm100  NO-LOCK  USE-INDEX uwm10008  WHERE
       ...
       END.
        ...
        /*---- A500178 ---*/
         ...
         ASSIGN
           nt_sigr        = nt_sigr   + uwm100.sigr_p  /*sumsi รวม*/
           nt_prem        = nt_prem   + uwm100.prem_t  /*Premium รวม*/
           nt_com         = nt_com    + uwm100.com1_t. /*commission รวม */
...
/*---% Comm ---*/   work_fil.wpstat = nt_stat_per
             ...
             -----------------*/ 
               ...
               ASSIGN  
                    ...
                    work_fil.policy     = uwm100.policy
                    work_fil.endcnt     = uwm100.endcnt
                    work_fil.endno      = uwm100.endno
                    work_fil.trndat     = uwm100.trndat
                 
/*---Premium---*/   work_fil.wsigr  =  nt_sigr
                    work_fil.wprem  =  nt_prem
                    work_fil.wstat  =  nt_stat_pr
                    work_fil.wret   =  nt_ret_pr
                    work_fil.w0q    =  nt_0q_pr
                    work_fil.w0t    =  nt_0t_pr
                    work_fil.w0s    =  nt_0s_pr
                    work_fil.wf1    =  nt_f1_pr
                    work_fil.wf2    =  nt_f2_pr
                    work_fil.wf3    =  nt_f3_pr
                    work_fil.wf4    =  nt_f4_pr 
                    work_fil.w0rq   =  nt_0rq_pr
                    work_fil.w0ps   =  nt_0ps_pr
                    work_fil.wbtr   =  nt_btr_pr
                    work_fil.wotr   =  nt_otr_pr
                    work_fil.wftr   =  nt_ftr_pr
                    work_fil.ws8    =  nt_s8_pr   
                    work_fil.wother =  nt_other_pr
/*-------------*/                   
...
/*---% Comm ---*/   work_fil.wpstat = nt_stat_per
                    ...
                    work_fil.wccom   = nt_com
                    work_fil.wcstat  = nt_stat_co
                    work_fil.wcret   = nt_ret_co
                    work_fil.wc0q    = nt_0q_co
                    work_fil.wc0t    = nt_0t_co
                    work_fil.wc0s    = nt_0s_co
                    work_fil.wcf1    = nt_f1_co
                    work_fil.wcf2    = nt_f2_co
                    work_fil.wcf3    = nt_f3_co
                    work_fil.wcf4    = nt_f4_co 
                    work_fil.wc0rq   = nt_0rq_co
                    work_fil.wc0ps   = nt_0ps_co
                    work_fil.wcbtr   = nt_btr_co
                    work_fil.wcotr   = nt_otr_co
                    work_fil.wcftr   = nt_ftr_co
                    work_fil.wcs8    = nt_s8_co   
                    work_fil.wcother = nt_other_co.
    ...
    FOR EACH  work_fil  
      ...
      IF  work_fil.ws8     < 0 THEN
       ...
       IF AVAIL s0m005 THEN nv_grptyp = s0m005.key1.
        ...
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X6;K"   '"' work_fil.policy  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X7;K"   '"' work_fil.endcnt  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X8;K"   '"' work_fil.endno   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X9;K"   '"' work_fil.trndat  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X10;K"  '"' work_fil.wsigr   FORMAT "->>>,>>>,>>>,>>9.99" '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X11;K"  '"' work_fil.wprem   FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X12;K"  '"' work_fil.wccom   FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X14;K"  '"' work_fil.wret    FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X15;K"  '"' work_fil.wpret   FORMAT ">>,>>>,>>>,>>9.99%"  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X16;K"  '"' work_fil.wcret   FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X18;K"  '"' work_fil.wstat   FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X19;K"  '"' work_fil.wpstat  FORMAT ">>,>>>,>>>,>>9.99%"  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X20;K"  '"' work_fil.wcstat  FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X22;K"  '"' work_fil.w0t     FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X23;K"  '"' work_fil.wp0t    FORMAT ">>,>>>,>>>,>>9.99%"  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X24;K"  '"' work_fil.wc0t    FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X26;K"  '"' work_fil.w0s     FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X27;K"  '"' work_fil.wp0s    FORMAT ">>,>>>,>>>,>>9.99%"  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X28;K"  '"' work_fil.wc0s    FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X30;K"  '"' work_fil.w0q     FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X31;K"  '"' work_fil.wp0q    FORMAT ">>,>>>,>>>,>>9.99%"  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X32;K"  '"' work_fil.wc0q    FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X34;K"  '"' work_fil.wf1     FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X35;K"  '"' work_fil.wpf1    FORMAT ">>,>>>,>>>,>>9.99%"  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X36;K"  '"' work_fil.wcf1    FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X38;K"  '"' work_fil.wf2     FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X39;K"  '"' work_fil.wpf2    FORMAT ">>,>>>,>>>,>>9.99%"  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X40;K"  '"' work_fil.wcf2    FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X42;K"  '"' work_fil.wf3     FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X43;K"  '"' work_fil.wpf3    FORMAT ">>,>>>,>>>,>>9.99%"  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X44;K"  '"' work_fil.wcf3    FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X46;K"  '"' work_fil.wf4     FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X47;K"  '"' work_fil.wpf4    FORMAT ">>,>>>,>>>,>>9.99%"  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X48;K"  '"' work_fil.wcf4    FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X50;K"  '"' work_fil.w0rq    FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X51;K"  '"' work_fil.wp0rq   FORMAT ">>,>>>,>>>,>>9.99%"  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X52;K"  '"' work_fil.wc0rq   FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X54;K"  '"' work_fil.w0ps    FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X55;K"  '"' work_fil.wp0ps   FORMAT ">>,>>>,>>>,>>9.99%"  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X56;K"  '"' work_fil.wc0ps   FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X58;K"  '"' work_fil.wbtr    FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X59;K"  '"' work_fil.wpbtr   FORMAT ">>,>>>,>>>,>>9.99%"  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X60;K"  '"' work_fil.wcbtr   FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X62;K"  '"' work_fil.wotr    FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X63;K"  '"' work_fil.wpotr   FORMAT ">>,>>>,>>>,>>9.99%"  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X64;K"  '"' work_fil.wcotr   FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X66;K"  '"' work_fil.wftr    FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X67;K"  '"' work_fil.wpftr   FORMAT ">>,>>>,>>>,>>9.99%"  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X68;K"  '"' work_fil.wcftr   FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X70;K"  '"' work_fil.ws8     FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X71;K"  '"' work_fil.wps8    FORMAT ">>,>>>,>>>,>>9.99%"  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X72;K"  '"' work_fil.wcs8    FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X74;K"  '"' work_fil.wother  FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X75;K"  '"' work_fil.wpother FORMAT ">>,>>>,>>>,>>9.99%"  '"'   SKIP.
        PUT STREAM ns1 "C;Y" STRING(nv_row) ";X76;K"  '"' work_fil.wcother FORMAT "->,>>>,>>>,>>9.99"   '"'   SKIP.
