...
/************   Program   **********************
Modify by : Ranu I 11/06/2015 Assign no. A58-0172 
            Dupicate Program wacr04.w , Wac_sm03.prl เป็นโปรแกรมใหม่   
            สำหรับให้สาขา NZI ใช้งาน
Wac
        wacr0004n.p , wacr04n.w  
WPrl
        -wacr04n.prl
Whp
        -WhpBran.w
        -WhpAcno2.w
 - Default branch 90-98
...
"Yes", 2
     SIZE 14.5 BY 1
     BGCOLOR 33 FGCOLOR 6 FONT 6 NO-UNDO.
...
DEFINE FRAME frbtn
     ...
     RECT-103 AT ROW 1.19 COL 1.67
     RECT-95 AT ROW 1.76 COL 4
     RECT-97 AT ROW 4.38 COL 4
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 102.5 ROW 17.91
         SIZE 23.5 BY 6.26
         BGCOLOR 3 .

DEFINE FRAME frSt
     cbAsDat AT ROW 3.1 COL 25.5 COLON-ALIGNED NO-LABEL
     fiacno1 AT ROW 10.67 COL 11 COLON-ALIGNED NO-LABEL
     fiacno2 AT ROW 11.95 COL 11 COLON-ALIGNED NO-LABEL
     raY AT ROW 14.05 COL 19 NO-LABEL
     raZ AT ROW 14.05 COL 51 NO-LABEL
     toReprint AT ROW 4.38 COL 98
     fiDoc2 AT ROW 4.38 COL 84.33 COLON-ALIGNED NO-LABEL
     fiDate AT ROW 5.95 COL 83.5 COLON-ALIGNED NO-LABEL
     fiPowerName AT ROW 7.76 COL 80.33 COLON-ALIGNED NO-LABEL
     fiPosition AT ROW 9.1 COL 80.17 COLON-ALIGNED NO-LABEL
     fiContractName AT ROW 12.76 COL 84.5 COLON-ALIGNED NO-LABEL
     fiExt AT ROW 14 COL 84.67 COLON-ALIGNED NO-LABEL
     buAcno AT ROW 10.67 COL 25
     buAcno2 AT ROW 11.95 COL 25
     fiBranch AT ROW 6.24 COL 12.33 COLON-ALIGNED NO-LABEL
     fiBranch2 AT ROW 7.52 COL 12.33 COLON-ALIGNED NO-LABEL
     fidoc AT ROW 4.38 COL 74.33 COLON-ALIGNED NO-LABEL
     fiMonth AT ROW 5.95 COL 89.5 COLON-ALIGNED NO-LABEL
     fiYear AT ROW 5.95 COL 95 COLON-ALIGNED NO-LABEL
     fibdes AT ROW 6.24 COL 23.33 COLON-ALIGNED NO-LABEL
     fibdes2 AT ROW 7.43 COL 23.33 COLON-ALIGNED NO-LABEL
     finame1 AT ROW 10.67 COL 26.83 COLON-ALIGNED NO-LABEL
     finame2 AT ROW 11.86 COL 26.83 COLON-ALIGNED NO-LABEL
     "To" VIEW-AS TEXT
          SIZE 4.5 BY 1.05 AT ROW 11.95 COL 6.5
          BGCOLOR 33 FGCOLOR 2 FONT 6
     "From" VIEW-AS TEXT
          SIZE 5.5 BY 1.05 AT ROW 10.67 COL 6.5
          BGCOLOR 33 FGCOLOR 2 FONT 6
     " Producer Code":20 VIEW-AS TEXT
          SIZE 62.5 BY 1.05 AT ROW 9.33 COL 4
          BGCOLOR 1 FGCOLOR 7 FONT 2
     " Ext. Number :":30 VIEW-AS TEXT
          SIZE 14 BY 1.05 AT ROW 14 COL 71.33
          BGCOLOR 33 FGCOLOR 2 FONT 6
     " Letter Detail":20 VIEW-AS TEXT
          SIZE 49 BY 1 AT ROW 2.81 COL 68
          BGCOLOR 1 FGCOLOR 7 FONT 2
     "/" VIEW-AS TEXT
          SIZE 1.5 BY 1 AT ROW 5.95 COL 90
          BGCOLOR 33 FONT 6
     " Print Type Z" VIEW-AS TEXT
          SIZE 13 BY 1 AT ROW 14.05 COL 37
          BGCOLOR 1 FGCOLOR 7 FONT 6
     " Branch" VIEW-AS TEXT
          SIZE 62.5 BY 1.05 AT ROW 4.91 COL 4
          BGCOLOR 1 FGCOLOR 7 FONT 2
     "ที่ กง.":10 VIEW-AS TEXT
          SIZE 6.5 BY 1.05 AT ROW 4.38 COL 69.33
          BGCOLOR 33 FGCOLOR 2 FONT 6
     " Contract" VIEW-AS TEXT
          SIZE 49 BY 1.05 AT ROW 11.43 COL 68
          BGCOLOR 1 FGCOLOR 7 FONT 2
     "From" VIEW-AS TEXT
          SIZE 5.5 BY 1.05 AT ROW 6.24 COL 6.5
          BGCOLOR 33 FGCOLOR 2 FONT 6
     "/" VIEW-AS TEXT
          SIZE 1.5 BY 1.05 AT ROW 4.38 COL 84.33
          BGCOLOR 33 FGCOLOR 0 FONT 2
     "ชื่อผู้มีอำนาจ":20 VIEW-AS TEXT
          SIZE 11.5 BY 1 AT ROW 7.76 COL 69.5
          BGCOLOR 33 FGCOLOR 2 FONT 6
     " Print Type Y" VIEW-AS TEXT
          SIZE 13 BY 1 AT ROW 14.05 COL 5
          BGCOLOR 1 FGCOLOR 7 FONT 6
     " As Of Date":20 VIEW-AS TEXT
          SIZE 17 BY 1 AT ROW 3.1 COL 5
          BGCOLOR 1 FGCOLOR 7 FONT 2
     " Notice by Agent for NZI (Process ST Monthly)" VIEW-AS TEXT
          SIZE 118.5 BY 1.05 AT ROW 1 COL 1
          BGCOLOR 1 FGCOLOR 7 FONT 2
     "/" VIEW-AS TEXT
          SIZE 1.5 BY 1 AT ROW 5.95 COL 95.5
          BGCOLOR 33 FONT 6
     "ตำแหน่ง" VIEW-AS TEXT
          SIZE 7.83 BY 1 AT ROW 9.1 COL 73
          BGCOLOR 33 FGCOLOR 2 FONT 6
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 7.67 ROW 2.05
         SIZE 119 BY 15.38
         BGCOLOR 3 .
...
DEFINE FRAME frSt
     " Contract Name :":30 VIEW-AS TEXT
          SIZE 16.5 BY 1.05 AT ROW 12.76 COL 69
          BGCOLOR 33 FGCOLOR 2 FONT 6
     "ชำระภายในวันที่" VIEW-AS TEXT
          SIZE 14 BY 1.05 AT ROW 5.95 COL 69
          BGCOLOR 33 FGCOLOR 2 FONT 6
     "To" VIEW-AS TEXT
          SIZE 3.5 BY 1.05 AT ROW 7.52 COL 6.5
          BGCOLOR 33 FGCOLOR 2 FONT 6
     RECT-104 AT ROW 13.76 COL 4
     RECT-106 AT ROW 2.33 COL 2.33
     RECT-108 AT ROW 11.43 COL 68
     RECT-110 AT ROW 4.05 COL 94.5
     RECT-83 AT ROW 4.91 COL 4
     RECT-84 AT ROW 9.33 COL 4
     RECT-86 AT ROW 2.81 COL 4
     RECT-88 AT ROW 2.81 COL 68
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 7.67 ROW 2.05
         SIZE 119 BY 15.38
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Wacr04N - Notice for Agent (NZI)"
         HEIGHT             = 25.24
         WIDTH              = 133.33
         MAX-HEIGHT         = 25.24
         MAX-WIDTH          = 133.33
...
ON END-ERROR OF C-Win /* Wacr04N - Notice for Agent (NZI) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Wacr04N - Notice for Agent (NZI) */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY cbAsDat fiacno1 fiacno2 raY raZ toReprint fiDoc2 fiDate fiPowerName 
          fiPosition fiContractName fiExt fiBranch fiBranch2 fidoc fiMonth 
          fiYear fibdes fibdes2 finame1 finame2 
      WITH FRAME frSt IN WINDOW C-Win.
  ENABLE cbAsDat fiacno1 fiacno2 raY raZ toReprint fiDoc2 fiDate fiPowerName 
         fiPosition fiContractName fiExt buAcno buAcno2 fiBranch fiBranch2 
         fiMonth fiYear fibdes fibdes2 finame1 finame2 RECT-104 RECT-106 
         RECT-108 RECT-110 RECT-83 RECT-84 RECT-86 RECT-88 
      WITH FRAME frSt IN WINDOW C-Win.
        ...
        FOR EACH buffagtprm WHERE buffagtprm.asdat = n_asdat AND       /* หาจำนวน Acno ทั้งหมดในช่วง*/
            ...
            IF FIRST-OF(buffAgtprm.acno) THEN DO:
                ...
                FOR EACH Agtprm_fil USE-INDEX by_acno WHERE Agtprm_fil.asdat = n_asdat AND       /* +1 ให้กับเลขที่จดหมายจนเท่ากับจำนวน Acno ที่ได้ */
                         Agtprm_fil.acno = vAcnoCount AND Agtprm_fil.polbran >= n_branch AND 
                         Agtprm_fil.polbran <= n_branch2 BREAK BY Agtprm_fil.acno:
    
                         ASSIGN nv_bran = "90"
                                n_letter  = SUBSTRING(Agtprm_fil.poldes,36,1).
                 ...
                 END. /*else*/
                   ...
                   IF LAST-OF(agtprm_fil.acno) THEN DO:                   /*create เลข running ลง docno_fil*/
                      FIND LAST docno_fil USE-INDEX docno01 WHERE 
                                ...
                                docno_fil.poltyp = nv_bran /*agtprm_fil.polbran*/   AND
...
DO:
           ASSIGN 
                n_chk =0
                report-library =  "Wac/wprl/wacr04n.prl"
                report-name  =  "Letter NZI". 
           ...
           ASSIGN 
             /* nv_pic = "WIMAGE\Wasana_NZI.jpg". */ /* Benjaporn J. A59-0148 [26/04/2016] */
                ...
                IF nv_pic = ? OR nv_pic = "" THEN DO:
                    MESSAGE "not found picture" SKIP VIEW-AS ALERT-BOX.
                END.
