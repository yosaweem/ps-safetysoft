...
/* Connected Databases 
          ...
          sicfn            PROGRESS
*/
&Scoped-define WINDOW-NAME wacrb07
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _DEFINITIONS wacrb07 
/*------------------------------------------------------------------------
  ...
  Created: Sayamol N. A55-0024
  Dupplicate From WACR007.W
...
Modify by Sayamol N. A55-0181  เพิ่มเงื่อนไข
      ...
      - Default Billing = Due (1)    06/06/2012   
...
&Scoped-define INTERNAL-TABLES acproc_fil accmmd_fil
...
&Scoped-define QUERY-STRING-frST FOR EACH accmmd_fil SHARE-LOCK
&Scoped-define OPEN-QUERY-frST OPEN QUERY frST FOR EACH accmmd_fil SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-frST accmmd_fil
&Scoped-define FIRST-TABLE-IN-QUERY-frST accmmd_fil
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fuLeapYear wacrb07 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fuMaxday wacrb07 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fuNumMonth wacrb07 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fuNumYear wacrb07 
...
DEFINE VAR wacrb07 AS WIDGET-HANDLE NO-UNDO.
...
DEFINE VARIABLE cbRptList AS CHARACTER FORMAT "x(256)" 
...
DEFINE QUERY frST FOR 
      accmmd_fil SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE brAcproc_fil
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brAcproc_fil wacrb07 _STRUCTURED
...
DEFINE FRAME frST
     ...
     fiBranch AT ROW 3.95 COL 23.5 COLON-ALIGNED NO-LABEL
     fiacno1 AT ROW 6.52 COL 23.17 COLON-ALIGNED NO-LABEL
     fiBranch2 AT ROW 5.1 COL 23.5 COLON-ALIGNED NO-LABEL
     ...
     "  BILLING REPORT  [CBC] - FOR BRANCH" VIEW-AS TEXT
          SIZE 46 BY .62 AT ROW 1.14 COL 48.5
          BGCOLOR 1 FGCOLOR 15 FONT 6
     "  To":25 VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wacrb07 ASSIGN
         HIDDEN             = YES
         TITLE              = "wacrb07 - BILLING REPORT  [CBC] FOR BRANCH"
         HEIGHT             = 23.91
         WIDTH              = 133.33
         MAX-HEIGHT         = 44.67
         MAX-WIDTH          = 213.33
...
IF NOT wacrb07:LOAD-ICON("wimage/safety.ico":U) THEN
...
/* SETTINGS FOR FILL-IN fi_BuillDate IN FRAME frST
   LABEL "Fill 1:"                                                      */
IF SESSION:DISPLAY-TYPE = "GUI":U AND VALID-HANDLE(wacrb07)
THEN wacrb07:HIDDEN = no.
...
"acproc_fil.type" "Ty" "X(3)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[3]   > "_<CALC>"
"IF (acproc_fil.type = ""01"") THEN (""Monthly"") ELSE (""Daily"")" "Detail" ? ? ? ? ? ? ? ? no ? no no "10" yes no no "U" "" ""
...
"SUBSTRING (acproc_fil.enttim,10,3)" "Sta" "X(1)" ? ? ? ? ? ? ? no ? no no "3" yes no no "U" "" ""
     _FldNameList[7]   > sicfn.acproc_fil.trndatfr
"acproc_fil.trndatfr" "TranDate Fr" ? "date" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" ""
     _FldNameList[8]   > sicfn.acproc_fil.trndatto
"acproc_fil.trndatto" "TranDate To" ? "date" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" ""
     _FldNameList[9]   > sicfn.acproc_fil.typdesc
"acproc_fil.typdesc" ? "X(53)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _Query            is NOT OPENED
*/  /* BROWSE brAcproc_fil */
&ANALYZE-RESUME

&ANALYZE-SUSPEND _QUERY-BLOCK FRAME frST
/* Query rebuild information for FRAME frST
     _TblList          = "stat.accmmd_fil"
     _Query            is OPENED
*/  /* FRAME frST */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME wacrb07
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wacrb07 wacrb07
ON END-ERROR OF wacrb07 /* wacrb07 - BILLING REPORT  [CBC] FOR BRANCH */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wacrb07 wacrb07
ON WINDOW-CLOSE OF wacrb07 /* wacrb07 - BILLING REPORT  [CBC] FOR BRANCH */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL brAcproc_fil wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn_Cancel wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn_OK wacrb07
...
DO:
   DO WITH FRAME {&FRAME-NAME} :
        ASSIGN  
            ...
            FRAME frST rs_billing rs_billing   /*A55-0181*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL buAcno1 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL buAcno2 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL buAdd wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL buClicod wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL buDel wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL cbRptList wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiacno1 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiacno2 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiBranch wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiBranch2 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiCcode1 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiTyp1 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiTyp10 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiTyp11 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiTyp12 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiTyp13 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiTyp14 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiTyp2 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiTyp3 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiTyp4 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiTyp5 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiTyp6 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiTyp7 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiTyp8 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fiTyp9 wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_BuillDate wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi_Tax wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL raReportTyp wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL rsOutput wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL rs_billing wacrb07
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CUSTOM _MAIN-BLOCK wacrb07 
...
/********************  T I T L E   F O R  C - W I N  ****************/
  ...
  gv_prgid = "WACRB07".
  gv_prog  = "BILLING REPORT [CBC] FOR BRANCH".
  RUN  WUT\WUTHEAD (WACRB07:HANDLE,gv_prgid,gv_prog).
  RUN  WUT\WUTWICEN (WACRB07:HANDLE).        
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE disable_UI wacrb07  _DEFAULT-DISABLE
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE enable_UI wacrb07  _DEFAULT-ENABLE
PROCEDURE enable_UI :
/*------------------------------------------------------------------------------
...
------------------------------------------------------------------------------*/
  VIEW FRAME DEFAULT-FRAME IN WINDOW wacrb07.
  {&OPEN-BROWSERS-IN-QUERY-DEFAULT-FRAME}
  ENABLE RECT-604 
      WITH FRAME frMain IN WINDOW wacrb07.
  {&OPEN-BROWSERS-IN-QUERY-frMain}

  {&OPEN-QUERY-frST}
  GET FIRST frST.
  DISPLAY rs_billing fiBranch fiacno1 fiBranch2 fiacno2 raReportTyp fiTyp1 
      ...
      WITH FRAME frST IN WINDOW wacrb07.
  ENABLE rs_billing fiBranch fiacno1 fiBranch2 fiacno2 raReportTyp fiTyp1 
         fiTyp2 fiTyp3 fiTyp4 fiTyp5 fiTyp6 fiTyp7 fiTyp8 fiTyp9 fiTyp10 
         fiTyp11 fiTyp12 fiTyp13 fiTyp14 seCliCod buAcno1 buAcno2 fiCcode1 
         buClicod cbRptList brAcproc_fil fi_BuillDate fi_Tax fibdes buAdd buDel 
         fibdes2 finame1 finame2 fiInclude fiAsdat fiProcessDate fiProcess 
         RECT-101 RECT-102 RECT-104 RECT-105 RECT-106 RECT-107 RECT12 RECT-602 
         RECT-603 RECT-108 RECT-109 RECT-112 RECT-113 RECT-114 RECT-115 
      WITH FRAME frST IN WINDOW wacrb07.
  {&OPEN-BROWSERS-IN-QUERY-frST}
  DISPLAY rsOutput cbPrtList 
      WITH FRAME frOutput IN WINDOW wacrb07.
  ENABLE rsOutput cbPrtList 
      WITH FRAME frOutput IN WINDOW wacrb07.
  {&OPEN-BROWSERS-IN-QUERY-frOutput}
  ENABLE RECT-600 RECT-601 Btn_OK Btn_Cancel 
      WITH FRAME frOK IN WINDOW wacrb07.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDCheckDate wacrb07 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdChkUsr wacrb07 
PROCEDURE pdChkUsr :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
------------------------------------------------------------------------------*/
IF n_user <> " " THEN DO:
   ASSIGN fiBranch = SUBSTR(n_user,6,LENGTH(n_user))
          fiBranch2 = SUBSTR(n_user,6,LENGTH(n_user)).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdClicod wacrb07 
PROCEDURE pdClicod :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdDeptGrp wacrb07 
PROCEDURE pdDeptGrp :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdExportF1 wacrb07 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdExportF2 wacrb07 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdInitData wacrb07 
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
FIND FIRST  xmm023 USE-INDEX xmm02301 WHERE xmm023.branch = fiBranch NO-ERROR.
    IF AVAIL xmm023  THEN  DO:
        DO WITH FRAME frST :
            ASSIGN fibdes     = xmm023.bdes.
             DISP fiBranch fibdes .
         END.
    END.     

FIND FIRST  xmm023 USE-INDEX xmm02301 WHERE xmm023.branch = fiBranch2 NO-ERROR.
    IF AVAIL xmm023  THEN  DO:
        DO WITH FRAME frST :
            ASSIGN fibdes2     = xmm023.bdes.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdOldOK wacrb07 
PROCEDURE pdOldOK :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE PDOutPut wacrb07 
PROCEDURE PDOutPut :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
       ...
       IF raReportTyp = 1 OR  raReportTyp = 2 OR  raReportTyp = 3 THEN DO:    /*--AG/BR , FI/Dealer, LS--*/
               IF n_type = "Motor" THEN DO:  
                  ...
                  RB-FILTER    = 'agtprm_fil.asdat = ' + 
                                  ...
                                  STRING (YEAR (n_asdat)) + 
                                  " AND " + 
                                  /*"agtprm_fil.duedat <= " +  comment by Sayamol N. A55-0181    */
                                       "agtprm_fil.duedat " + nv_flag +  /*--- Sayamol N. A55-0181 ---*/
            ...
            ASSIGN                
                ...
                RB-OTHER-PARAMETERS =  "rb_vCliCod     = " + STRING(vCliCod) + CHR(10) +  
                                       ...
                                       "rb_n_User =" + STRING(nv_User). /*Lukkana M. A55-0369 04/12/2012*/
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdRunRB wacrb07 
PROCEDURE pdRunRB :
/*------------------------------------------------------------------------------
  Purpose:     record
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdSym100 wacrb07 
PROCEDURE pdSym100 :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pdUpdateQ wacrb07 
PROCEDURE pdUpdateQ :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE ProcGetPrtList wacrb07 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE ProcGetRptList wacrb07 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fuLeapYear wacrb07 
FUNCTION fuLeapYear RETURNS LOGICAL
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fuMaxday wacrb07 
FUNCTION fuMaxday RETURNS INTEGER
  (INPUT vDate AS DATE ) :
/*------------------------------------------------------------------------------
  Purpose:  
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fuNumMonth wacrb07 
FUNCTION fuNumMonth RETURNS INTEGER
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fuNumYear wacrb07 
FUNCTION fuNumYear RETURNS INTEGER
  (INPUT vDate AS DATE ) :
/*------------------------------------------------------------------------------
  Purpose:  
