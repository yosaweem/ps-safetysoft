...
เพิ่มการคำนวณแยกระยะเวลาของ Commission, Bal O/S,
 Cheque Returned, Suspense, Net. A/R, Net. OTHER  ค้างจ่าย 
 ---*/
...
/*--------- About Program -----------------------------*/
/* นำตัวอย่างมาจาก  wacr05.w */
ปรับจากโปรแกรม wacr06.w ต่างกันแค่เงื่อนไขที่ดึงข้อมูลเท่านั้น
Wac
...
Wut
        -WutDiCen.p
        -WutWiCen.p
รายละเอียด ดูจาก    wacr06.w 
- ใช้หลักการเดียวกับ aging report  by trndate    แต่ให้นับจำนวน เบี้ยค้าง   เป็น  จำนวนวัน  แทน จำนวนเดือน
...
- แยก Report Motor , Non Motor , All
- แบ่งช่วงวันเป็น 1-15, 16-30, 31-45, 46-60, 61-90, 91-180, 181-270, 271-365, เกิน 365
- การคิดวันจะคิดจาก (As Date - Com Date) + 1
...
DEF VAR vgpname AS CHAR.
    ...
    OUTPUT TO VALUE (n_OutputFile + "Gp") NO-ECHO.  /* SUMMARY */
        ...
        FOR EACH wtGrpSum USE-INDEX wtGrpSum2
            ...
            END.
                ...
                EXPORT DELIMITER ";" "Summary of : " + wtGTrptname + " " + wtGTacno
                    "ไม่เกิน 30 วัน" + STRING(wtGTbal[1]  ,">>,>>>,>>>,>>9.99-") + nv-1 + 
                    "31 - 60 วัน"    + STRING(wtGTbal[2]  ,">>,>>>,>>>,>>9.99-") + nv-1 + 
                    "61 - 90 วัน"    + STRING(wtGTbal[3]  ,">>,>>>,>>>,>>9.99-") + nv-1 + 
                    "91 - 120 วัน"   + STRING(wtGTbal[4]  ,">>,>>>,>>>,>>9.99-") + nv-1 +
                    "121 - 150 วัน"  + STRING(wtGTbal[5]  ,">>,>>>,>>>,>>9.99-") + nv-1 +
                    "151 - 180 วัน"  + STRING(wtGTbal[6]  ,">>,>>>,>>>,>>9.99-") + nv-1 +
                    "181 - 210 วัน"  + STRING(wtGTbal[7]  ,">>,>>>,>>>,>>9.99-") + nv-1 +
                    "211 - 240 วัน"  + STRING(wtGTbal[8]  ,">>,>>>,>>>,>>9.99-") + nv-1 +        
                    "241 - 270 วัน"  + STRING(wtGTbal[9]  ,">>,>>>,>>>,>>9.99-") + nv-1 +
                    "271 - 300 วัน"  + STRING(wtGTbal[10] ,">>,>>>,>>>,>>9.99-") + nv-1 +
                    "301 - 330 วัน"  + STRING(wtGTbal[11] ,">>,>>>,>>>,>>9.99-") + nv-1 +
                    "331 - 365 วัน"  + STRING(wtGTbal[12] ,">>,>>>,>>>,>>9.99-") + nv-1 +        
                    "365 วันขึ้นไป"  + STRING(wtGTbal[13] ,">>,>>>,>>>,>>9.99-") .
        ...
        EXPORT DELIMITER ";"  "".
        EXPORT DELIMITER ";" "G R A N D  T O T A L"
                "ไม่เกิน 30 วัน" + STRING(nv_GTbal[1] ,">>,>>>,>>>,>>9.99-") + nv-1 +     
                "31 - 60 วัน"    + STRING(nv_GTbal[2] ,">>,>>>,>>>,>>9.99-") + nv-1 +     
                "61 - 90 วัน"    + STRING(nv_GTbal[3] ,">>,>>>,>>>,>>9.99-") + nv-1 +  
                "91 - 120 วัน"   + STRING(nv_GTbal[4] ,">>,>>>,>>>,>>9.99-") + nv-1 +           
                "121 - 150 วัน"  + STRING(nv_GTbal[5] ,">>,>>>,>>>,>>9.99-") + nv-1 +     
                "151 - 180 วัน"  + STRING(nv_GTbal[6] ,">>,>>>,>>>,>>9.99-") + nv-1 +     
                "181 - 210 วัน"  + STRING(nv_GTbal[7] ,">>,>>>,>>>,>>9.99-") + nv-1 +  
                "211 - 240 วัน"  + STRING(nv_GTbal[8] ,">>,>>>,>>>,>>9.99-") + nv-1 +           
                "241 - 270 วัน"  + STRING(nv_GTbal[9] ,">>,>>>,>>>,>>9.99-") + nv-1 +     
                "271 - 300 วัน"  + STRING(nv_GTbal[10] ,">>,>>>,>>>,>>9.99-") + nv-1 +     
                "301 - 330 วัน"  + STRING(nv_GTbal[11] ,">>,>>>,>>>,>>9.99-") + nv-1 +  
                "331 - 365 วัน"  + STRING(nv_GTbal[12] ,">>,>>>,>>>,>>9.99-") + nv-1 +         
                "365 วันขึ้นไป"  + STRING(nv_GTbal[13] ,">>,>>>,>>>,>>9.99-") .
...
ASSIGN nv_GTTprem     = 0
    ...
    OUTPUT TO VALUE (n_OutputFile + "sumIC") NO-ECHO.  /* SUMMARY */
        ...
        FOR EACH wtoicSum BREAK BY wtICAgent 
            ...
            OUTPUT TO VALUE (n_OutputFile + "sumIC") APPEND NO-ECHO.  /* SUMMARY */    
                ...
                EXPORT DELIMITER ";" "Summary of : " + wtICrptname + " " + wtICAgent + " :: " + wtICpolgrp + " :: " + wtICinsref    
                        "ไม่เกิน 15 วัน" + STRING(wtICprem[1]  ,">>,>>>,>>>,>>9.99-") + nv-1 + 
                        "16 - 30 วัน"    + STRING(wtICprem[2]  ,">>,>>>,>>>,>>9.99-") + nv-1 + 
                        "31 - 45 วัน"    + STRING(wtICprem[3]  ,">>,>>>,>>>,>>9.99-") + nv-1 + 
                        "46 - 60 วัน"    + STRING(wtICprem[4]  ,">>,>>>,>>>,>>9.99-") + nv-1 +
                        "61 - 90 วัน"    + STRING(wtICprem[5]  ,">>,>>>,>>>,>>9.99-") + nv-1 +
                        "91 - 180 วัน"   + STRING(wtICprem[6]  ,">>,>>>,>>>,>>9.99-") + nv-1 +
                        "181 - 270 วัน"  + STRING(wtICprem[7]  ,">>,>>>,>>>,>>9.99-") + nv-1 +
                        "271 - 365 วัน"  + STRING(wtICprem[8]  ,">>,>>>,>>>,>>9.99-") + nv-1 +        
                        "365 วันขึ้นไป"  + STRING(wtICprem[9]  ,">>,>>>,>>>,>>9.99-") .
                EXPORT DELIMITER ";" "".
             OUTPUT CLOSE.
             -------------------------*/
             /*----A54-0119---*/
            OUTPUT TO VALUE (n_OutputFile + "sumIC") APPEND NO-ECHO.  /* SUMMARY */    
                ...
                EXPORT DELIMITER ";" "Summary of : " + wtICrptname + " " + wtICAgent + " :: " + wtICpolgrp + " :: " + wtICinsref    
                        ...
                        "46 - 60 วัน"    + STRING(wtICprem[4]  ,">>,>>>,>>>,>>9.99-") + nv-1 +
                        "61 - 90 วัน"    + STRING(wtICprem[5]  ,">>,>>>,>>>,>>9.99-") + nv-1 +
                        "91 - 120 วัน"   + STRING(wtICprem[6]  ,">>,>>>,>>>,>>9.99-") + nv-1 +
                        "121 - 150 วัน"  + STRING(wtICprem[7]  ,">>,>>>,>>>,>>9.99-") + nv-1 +
                        "151 - 180 วัน"  + STRING(wtICprem[8]  ,">>,>>>,>>>,>>9.99-") + nv-1 +        
                        "181 - 210 วัน"  + STRING(wtICprem[9]  ,">>,>>>,>>>,>>9.99-") + nv-1 +
                        "211 - 240 วัน"  + STRING(wtICprem[10]  ,">>,>>>,>>>,>>9.99-") + nv-1 + 
                        "241 - 270 วัน"  + STRING(wtICprem[11]  ,">>,>>>,>>>,>>9.99-") + nv-1 + 
                        "271 - 300 วัน"  + STRING(wtICprem[12]  ,">>,>>>,>>>,>>9.99-") + nv-1 + 
                        "301 - 330 วัน"  + STRING(wtICprem[13]  ,">>,>>>,>>>,>>9.99-") + nv-1 +
                        "331 - 365 วัน"  + STRING(wtICprem[14]  ,">>,>>>,>>>,>>9.99-") + nv-1 +
                        "365 วันขึ้นไป"  + STRING(wtICprem[15]  ,">>,>>>,>>>,>>9.99-").
                EXPORT DELIMITER ";" "".
             OUTPUT CLOSE.
             /*--- end A54-0119 ---*/
        ...
        EXPORT DELIMITER ";"  "".
        EXPORT DELIMITER ";" "G R A N D  T O T A L"
                "ไม่เกิน 15 วัน" + STRING(nv_GTprem[1] ,">>,>>>,>>>,>>9.99-") + nv-1 +     
                "16 - 30 วัน"    + STRING(nv_GTprem[2] ,">>,>>>,>>>,>>9.99-") + nv-1 +     
                "31 - 45 วัน"    + STRING(nv_GTprem[3] ,">>,>>>,>>>,>>9.99-") + nv-1 +  
                "46 - 60 วัน"   + STRING(nv_GTprem[4] ,">>,>>>,>>>,>>9.99-") + nv-1 +           
                "61 - 90 วัน"  + STRING(nv_GTprem[5] ,">>,>>>,>>>,>>9.99-") + nv-1 +     
                "91 - 180 วัน"  + STRING(nv_GTprem[6] ,">>,>>>,>>>,>>9.99-") + nv-1 +     
                "181 - 270 วัน"  + STRING(nv_GTprem[7] ,">>,>>>,>>>,>>9.99-") + nv-1 +  
                "271 - 365 วัน"  + STRING(nv_GTprem[8] ,">>,>>>,>>>,>>9.99-") + nv-1 +           
                "365 วันขึ้นไป"  + STRING(nv_GTprem[9] ,">>,>>>,>>>,>>9.99-") .
    ...
    -------------*/
        ...
        EXPORT DELIMITER ";" "G R A N D  T O T A L"
                ...
                "46 - 60 วัน"   + STRING(nv_GTprem[4] ,">>,>>>,>>>,>>9.99-") + nv-1 +           
                "61 - 90 วัน"   + STRING(nv_GTprem[5] ,">>,>>>,>>>,>>9.99-") + nv-1 +     
                "91 - 120 วัน"   + STRING(nv_GTprem[6] ,">>,>>>,>>>,>>9.99-") + nv-1 +     
                "121 - 150 วัน"   + STRING(nv_GTprem[7] ,">>,>>>,>>>,>>9.99-") + nv-1 +  
                "151 - 180 วัน"   + STRING(nv_GTprem[8] ,">>,>>>,>>>,>>9.99-") + nv-1 +           
                "181 - 210 วัน"   + STRING(nv_GTprem[9] ,">>,>>>,>>>,>>9.99-") + nv-1 +
                "211 - 240 วัน"   + STRING(nv_GTprem[10] ,">>,>>>,>>>,>>9.99-") + nv-1 +   
                "241 - 270 วัน"   + STRING(nv_GTprem[11] ,">>,>>>,>>>,>>9.99-") + nv-1 +  
                "271 - 300 วัน"   + STRING(nv_GTprem[12] ,">>,>>>,>>>,>>9.99-") + nv-1 +  
                "301 - 330 วัน"   + STRING(nv_GTprem[13] ,">>,>>>,>>>,>>9.99-") + nv-1 +   
                "331 - 365 วัน"    + STRING(nv_GTprem[14] ,">>,>>>,>>>,>>9.99-") + nv-1 +  
                "365 วันขึ้นไป"    + STRING(nv_GTprem[15] ,">>,>>>,>>>,>>9.99-").
    OUTPUT CLOSE.
