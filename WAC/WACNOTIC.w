...
/************   Program   **************
/* CREATE BY :  Ranu I.  Assign : A58-0192 Date : 15/06/2015    */
               Dupilcate program wacr04.w 
Wac
        -Wacnotic.w
WPrl
        -Wacnotic.prl
...
- โปรแกรมจะดึง จาก Statement A4 (Daily) และ Monthly ในวันสินเดือน Type = 01 , 05  
- Branch from - To ต้องเป็นสาขาเดียวกัน
- Producer From - To ต้องเป็น Producer code เดียวกัน
- เช็คการรันนิ่งเลขที่จดหมายจาก ปี และ เดือน ปัจจุบัน 
*************************************************************************/ 
/* Modify by : Ranu I. A58-0238 16/07/2015                              */
/*             แก้ไขข้อมูลช่อง AC Name แสดงข้อมูลไม่ตรงโค้ด             */
/*             แก้ไขที่ Procedures pdDisp                               */
/*----------------------------------------------------------------------*/
/* Modify by : Ranu I. A58-0246 10/08/2015                              */
/*             แก้ไขสีหน้าจอเพี้ยน และ process ช้า                      */
/*----------------------------------------------------------------------*/
/* ***************************  Definitions  ************************** */
/*----------------------------------------------------------------------
...
DEF  VAR report-library AS CHAR INIT "Wac/wprl/wacnotic.prl". 
DEF  VAR report-name  AS CHAR INIT "Notic". 
...
/*-- A58-0172 --*/
DEF VAR nv_type     AS CHAR FORMAT "x(2)".
DEF VAR n_detail    AS CHAR FORMAT "x(50)" INIT "".
...
&Scoped-define BROWSE-NAME brletterno

/* Internal Tables (found by Frame, Query & Browse Queries)             */
&Scoped-define INTERNAL-TABLES wdocno_fil

/* Definitions for BROWSE brletterno                                    */
&Scoped-define FIELDS-IN-QUERY-brletterno wdocno_fil.bran wdocno_fil.letterno SUBSTR(wdocno_fil.asdat,7,2) + "/" + SUBSTR(wdocno_fil.asdat,5,2) + "/" + SUBSTR(wdocno_fil.asdat,1,4) wdocno_fil.acno wdocno_fil.acname wdocno_fil.n_user   
&Scoped-define ENABLED-FIELDS-IN-QUERY-brletterno   
&Scoped-define SELF-NAME brletterno
&Scoped-define QUERY-STRING-brletterno FOR EACH wdocno_fil NO-LOCK
&Scoped-define OPEN-QUERY-brletterno OPEN QUERY {&SELF-NAME} FOR EACH wdocno_fil NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brletterno wdocno_fil
&Scoped-define FIRST-TABLE-IN-QUERY-brletterno wdocno_fil


/* Definitions for FRAME frSt                                           */
&Scoped-define OPEN-BROWSERS-IN-QUERY-frSt ~
    ~{&OPEN-QUERY-brletterno}
...
DEFINE VARIABLE fidetail AS CHARACTER FORMAT "X(50)":U 
     VIEW-AS FILL-IN 
     SIZE 23.17 BY 1
...
/* Query definitions                                                    */
&ANALYZE-SUSPEND
DEFINE QUERY brletterno FOR 
      wdocno_fil SCROLLING.
&ANALYZE-RESUME

/* Browse definitions                                                   */
DEFINE BROWSE brletterno
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brletterno C-Win _FREEFORM
  QUERY brletterno NO-LOCK DISPLAY
      wdocno_fil.bran                           COLUMN-LABEL "Branch"     FORMAT "x(2)"
      wdocno_fil.letterno                       COLUMN-LABEL "Letter no." FORMAT  ">>>>>>>99"
      ...
      wdocno_fil.acname                         COLUMN-LABEL "AC Name."   FORMAT "x(40)"
      wdocno_fil.n_user                         COLUMN-LABEL "Userid "   FORMAT "x(8)"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 62.17 BY 4.48
         BGCOLOR 103 FGCOLOR 0 FONT 1 ROW-HEIGHT-CHARS .52 FIT-LAST-COLUMN.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME DEFAULT-FRAME
     IMAGE-24 AT ROW 1.48 COL 3.17
...
DEFINE FRAME frOutput
     rsOutput AT ROW 2.76 COL 4.67 NO-LABEL
     cbPrtList AT ROW 3.81 COL 16.83 COLON-ALIGNED NO-LABEL
     fiFile-Name AT ROW 5.1 COL 16.83 COLON-ALIGNED NO-LABEL
     " Output To":10 VIEW-AS TEXT
          SIZE 48.5 BY 1.05 AT ROW 1 COL 1
          BGCOLOR 1 FGCOLOR 7 FONT 2
     RECT-82 AT ROW 2.24 COL 3
     RECT-289 AT ROW 2.67 COL 4.17
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 5.5 ROW 18.95
         SIZE 49 BY 6.14
         BGCOLOR 32 .
...
DEFINE FRAME frbtn
    ...
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 105.83 ROW 18.91
         SIZE 23.5 BY 6.48
         BGCOLOR 32 .

DEFINE FRAME frSt
     fiBranch AT ROW 4.05 COL 11.5 COLON-ALIGNED NO-LABEL
     fiBranch2 AT ROW 5.24 COL 11.5 COLON-ALIGNED NO-LABEL
     fiacno1 AT ROW 8.1 COL 9.5 COLON-ALIGNED NO-LABEL
     fiacno2 AT ROW 9.29 COL 9.5 COLON-ALIGNED NO-LABEL
     cbAsDat AT ROW 11.1 COL 22.83 COLON-ALIGNED NO-LABEL
     raY AT ROW 2.71 COL 81.5 NO-LABEL
     raZ AT ROW 2.71 COL 110 NO-LABEL
     fiDoc2 AT ROW 5.81 COL 85.17 COLON-ALIGNED NO-LABEL
     toReprint AT ROW 5.81 COL 100.67
     fiDate AT ROW 7.38 COL 85.33 COLON-ALIGNED NO-LABEL
     fiContractName AT ROW 13.76 COL 87.83 COLON-ALIGNED NO-LABEL
     fiExt AT ROW 15 COL 87.67 COLON-ALIGNED NO-LABEL
     fidetail AT ROW 11.1 COL 39.5 COLON-ALIGNED NO-LABEL
     buBranch AT ROW 4.05 COL 20
     buBranch2 AT ROW 5.24 COL 20
     buAcno AT ROW 8.1 COL 25
     buAcno2 AT ROW 9.29 COL 25
     brletterno AT ROW 12.48 COL 4.17
     fidoc AT ROW 5.81 COL 75.17 COLON-ALIGNED NO-LABEL
     fibdes AT ROW 4.05 COL 23.17 COLON-ALIGNED NO-LABEL
     fibdes2 AT ROW 5.24 COL 23.17 COLON-ALIGNED NO-LABEL
     finame1 AT ROW 8.05 COL 26.83 COLON-ALIGNED NO-LABEL
     finame2 AT ROW 9.24 COL 26.83 COLON-ALIGNED NO-LABEL
     fiPowerName AT ROW 9.19 COL 82 COLON-ALIGNED NO-LABEL
     fiPosition AT ROW 10.43 COL 82 COLON-ALIGNED NO-LABEL
     fiMonth AT ROW 7.38 COL 91.67 COLON-ALIGNED NO-LABEL
     fiYear AT ROW 7.38 COL 97.5 COLON-ALIGNED NO-LABEL
     "/" VIEW-AS TEXT
          SIZE 1.5 BY 1 AT ROW 7.38 COL 91.83
          BGCOLOR 34 FONT 6
     "ที่ FI.":10 VIEW-AS TEXT
          SIZE 5 BY 1.05 AT ROW 5.81 COL 70.5
          BGCOLOR 34 FGCOLOR 2 FONT 6
     " Contract" VIEW-AS TEXT
          SIZE 55.17 BY 1.05 AT ROW 12.14 COL 68.33
          BGCOLOR 3 FGCOLOR 15 FONT 2
     "/" VIEW-AS TEXT
          SIZE 1.5 BY 1 AT ROW 7.38 COL 97.67
          BGCOLOR 34 FONT 6
     " Branch" VIEW-AS TEXT
          SIZE 62.5 BY 1.05 AT ROW 2.52 COL 4.17
          BGCOLOR 3 FGCOLOR 15 FONT 2
     " Print Type Z" VIEW-AS TEXT
          SIZE 13 BY 1 AT ROW 2.71 COL 96.83
          BGCOLOR 3 FGCOLOR 15 FONT 6
     "From" VIEW-AS TEXT
          SIZE 5.5 BY 1.05 AT ROW 4.05 COL 7
          BGCOLOR 34 FGCOLOR 2 FONT 6
     " Extension Number :":30 VIEW-AS TEXT
          SIZE 19.67 BY 1.05 AT ROW 15 COL 69.17
          BGCOLOR 34 FGCOLOR 2 FONT 6
     "ตำแหน่ง" VIEW-AS TEXT
          SIZE 7.5 BY 1 AT ROW 10.43 COL 72.33
          BGCOLOR 34 FGCOLOR 2 FONT 6
     " Producer Code":20 VIEW-AS TEXT
          SIZE 62.5 BY 1.05 AT ROW 6.67 COL 4
          BGCOLOR 3 FGCOLOR 15 FONT 2
     " Print Type Y" VIEW-AS TEXT
          SIZE 13 BY 1 AT ROW 2.71 COL 68.33
          BGCOLOR 3 FGCOLOR 15 FONT 6
     " Letter Detail":20 VIEW-AS TEXT
          SIZE 55.5 BY 1 AT ROW 4.24 COL 68
          BGCOLOR 3 FGCOLOR 15 FONT 2
     "To" VIEW-AS TEXT
          SIZE 3.5 BY 1.05 AT ROW 5.24 COL 7
          BGCOLOR 34 FGCOLOR 2 FONT 6
     "From" VIEW-AS TEXT
          SIZE 5.5 BY 1.05 AT ROW 8 COL 5.5
          BGCOLOR 34 FGCOLOR 2 FONT 6
     "ชื่อผู้มีอำนาจ":20 VIEW-AS TEXT
          SIZE 11.5 BY 1 AT ROW 9.19 COL 72
          BGCOLOR 34 FGCOLOR 2 FONT 6
     " Contract Name :":30 VIEW-AS TEXT
          SIZE 16.83 BY 1.05 AT ROW 13.76 COL 71.67
          BGCOLOR 34 FGCOLOR 2 FONT 6
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 5 ROW 1.81
...
DEFINE FRAME frSt
     "ชำระภายในวันที่" VIEW-AS TEXT
          SIZE 14 BY 1.05 AT ROW 7.38 COL 72.5
          BGCOLOR 34 FGCOLOR 2 FONT 6
     "To" VIEW-AS TEXT
          SIZE 4.5 BY 1.05 AT ROW 9.19 COL 6.5
          BGCOLOR 34 FGCOLOR 2 FONT 6
     "/" VIEW-AS TEXT
          SIZE 1.5 BY 1.05 AT ROW 5.81 COL 85.17
          BGCOLOR 34 FGCOLOR 0 FONT 2
     " As Of Date":20 VIEW-AS TEXT
          SIZE 17 BY 1 AT ROW 11.1 COL 5
          BGCOLOR 3 FGCOLOR 15 FONT 2
     "จดหมายสอบถามเบี้ยประกันภัย ( Process ST A4 Daily)" VIEW-AS TEXT
          SIZE 125 BY 1.05 AT ROW 1 COL 1
          BGCOLOR 1 FGCOLOR 7 FONT 6
     RECT-104 AT ROW 13.76 COL 4
     RECT-106 AT ROW 2.19 COL 2.17
     RECT-108 AT ROW 13.19 COL 68.17
     RECT-110 AT ROW 5.71 COL 99.17
     RECT-287 AT ROW 8.76 COL 70
     RECT-83 AT ROW 3.57 COL 4
     RECT-84 AT ROW 7.67 COL 4
     RECT-86 AT ROW 10.76 COL 4
     RECT-88 AT ROW 5.24 COL 68.17
     RECT-303 AT ROW 2.62 COL 68
     RECT-304 AT ROW 2.62 COL 96.5
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 5 ROW 1.81
         SIZE 125.5 BY 16.81
...
DEFINE FRAME FRAME-A
     " 2. ถ้าทราบ Letter No เดิมให้ใส่ที่ช่อง Letter No" VIEW-AS TEXT
          SIZE 38.17 BY 1.05 AT ROW 3.33 COL 3.33
          BGCOLOR 34 
     " 1. คลิกพิมพ์ซ้ำ" VIEW-AS TEXT
          SIZE 38.17 BY 1.05 AT ROW 2.29 COL 3.33
          BGCOLOR 34 
     " 3. ถ้าไม่ทราบคลิกปุ่ม OK เครื่องจะบอก Letter No" VIEW-AS TEXT
          SIZE 38.17 BY 1.05 AT ROW 4.38 COL 3.33
          BGCOLOR 34 
     " 4. ให้นำ Letter No ที่ได้มาใส่ที่ช่อง Letter No" VIEW-AS TEXT
          SIZE 38.17 BY 1.29 AT ROW 5.33 COL 3.33
          BGCOLOR 34 
     "วิธีการพิมพ์ซ้ำ" VIEW-AS TEXT
          SIZE 43 BY 1.05 AT ROW 1 COL 1
          BGCOLOR 1 FGCOLOR 7 FONT 6
     RECT-288 AT ROW 2.14 COL 3
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 58.5 ROW 18.95
         SIZE 43.5 BY 6.14
         BGCOLOR 32 .
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Notice by Agent ( Process Daily)"
         HEIGHT             = 25.24
         WIDTH              = 133.33
         MAX-HEIGHT         = 25.24
         MAX-WIDTH          = 133.33
...
ASSIGN XXTABVALXX = FRAME frSt:MOVE-BEFORE-TAB-ITEM (FRAME frOutput:HANDLE)
       XXTABVALXX = FRAME FRAME-A:MOVE-BEFORE-TAB-ITEM (FRAME frSt:HANDLE)
/* END-ASSIGN-TABS */.
...
/* SETTINGS FOR FRAME frSt
   Custom                                                               */
/* BROWSE-TAB brletterno buAcno2 frSt */
ASSIGN 
       brletterno:SEPARATOR-FGCOLOR IN FRAME frSt      = 8.

ASSIGN 
       fidetail:READ-ONLY IN FRAME frSt        = TRUE.
...
&ANALYZE-SUSPEND _QUERY-BLOCK BROWSE brletterno
/* Query rebuild information for BROWSE brletterno
     _START_FREEFORM
...
ON END-ERROR OF C-Win /* Notice by Agent ( Process Daily) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Notice by Agent ( Process Daily) */
DO:
...
DO:
   ...
   IF  n_toac = "" THEN n_toac = "B999999999". 
      ...
      IF fidetail = "" THEN DO:
          Message "Please Select As of Date !!" VIEW-AS ALERT-BOX ERROR.
          Apply "Entry" To cbAsdat.
          RETURN NO-APPLY.
      END.
      ...
      END. 
        ...
        ELSE DO:
            MESSAGE "Branch : "  n_Branch " ถึง " n_Branch2 SKIP (1)
                                ...
                                VIEW-AS ALERT-BOX QUESTION
            BUTTONS YES-NO
            TITLE "Confirm Reprint"    UPDATE CHOICE1 AS LOGICAL.
            CASE CHOICE1:
            WHEN TRUE THEN    DO:
                RUN ProcReprint.
            END.
...
DO:
    ...
    IF n_asdat  =  DATE( INPUT cbAsDat) THEN RUN proDetail.
    DISP fidetail WITH FRAM frST.
    RUN pdRunningNo.   /* หา running no เบอร์ ล่าสุด ใน table docno_fil */
    RUN pddisp.
 ...
 *                 RETURN NO-APPLY.*/
    ...
    DISP n_agent1 @ fiAcno1 
              n_agent1 @ fiAcno2 finame1 WITH FRAME frST.
...
ASSIGN
   ...
   /* FOR EACH docno_fil USE-INDEX docno01 WHERE LENGTH(docno_fil.branch) = 8 AND 
        docno_fil.poltyp = n_branch NO-LOCK BREAK BY docno_fil.startno DESC. -- A58-0246--*/
    FOR EACH docno_fil WHERE docno_fil.poltyp = n_branch NO-LOCK BREAK BY docno_fil.startno DESC. /*-- A58-0426--*/
    ...
    IF (nv_doc1 > vMaxdoc OR nv_doc1 = vMaxdoc) THEN RUN pdRunningNo. /*-- A58-0426--*/
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fiBranch fiBranch2 fiacno1 fiacno2 cbAsDat raY raZ fiDoc2 toReprint 
          fiDate fiContractName fiExt fidetail fidoc fibdes fibdes2 finame1 
          finame2 fiPowerName fiPosition fiMonth fiYear 
      WITH FRAME frSt IN WINDOW C-Win.
  ENABLE fiBranch fiBranch2 fiacno1 fiacno2 cbAsDat raY raZ fiDoc2 toReprint 
         fiDate fiContractName fiExt fidetail buBranch buBranch2 buAcno buAcno2 
         brletterno fibdes fibdes2 finame1 finame2 fiPowerName fiPosition 
         fiMonth fiYear RECT-104 RECT-106 RECT-108 RECT-110 RECT-287 RECT-83 
         RECT-84 RECT-86 RECT-88 RECT-303 RECT-304 
      WITH FRAME frSt IN WINDOW C-Win.
...
d2 = DATE(d-mon,d-day,YEAR(TODAY) - 1).
 ...
 /* vAcProc_fil = "" .*/
  ...
  FOR EACH AcProc_fil USE-INDEX by_type_asdat  WHERE (acproc_fil.type = "01" OR acproc_fil.type = "05" )
           /*AND SUBSTRING(acProc_fil.enttim,10,3) <>  "NO" NO-LOCK BY asdat DESC  :  ---A58-0246---*/
            AND AcProc_fil.asdat >= d2  NO-LOCK 
            BREAK BY TYPE DESC
                  BY asdat DESC:   /*--- A58-0246---*/
      /*IF AcProc_fil.asdat >= d2 THEN   --- A58-0246---*/
      ASSIGN
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
DEF VAR name1 AS CHAR FORMAT "x(60)". /*---A58-0238---*/
FOR EACH wdocno_fil : DELETE wdocno_fil. END.

    FOR EACH  docno_fil USE-INDEX docno01  WHERE LENGTH (docno_fil.branch) = 8 AND
                                docno_fil.poltyp = n_branch   AND
                                docno_fil.seqtyp >= n_agent1   AND
                                docno_fil.seqtyp <= n_agent2 AND
                                STRING(docno_fil.startno) <> "" NO-LOCK.
       /*---A58-0238---*/
       FIND FIRST xmm600 USE-INDEX xmm60001 WHERE xmm600.acno = docno_fil.seqty NO-LOCK NO-ERROR. 
            ASSIGN name1 = xmm600.NAME.
       /*---A58-0238---*/
       IF SUBSTRING(docno_fil.branch,1,4) = STRING(YEAR(n_asdat),"9999")  THEN DO:
            ...
            ASSIGN 
                ...
                wdocno_fil.letterno = docno_fil.startno.
        END.
        ELSE DO:
            CREATE wdocno_fil.
            ASSIGN 
...
OPEN QUERY brletterno FOR EACH wdocno_fil WHERE letterno <> 0 NO-LOCK BY asdat DESC.
...
ASSIGN
    ...
    nv_use  = nv_year + nv_mon.
     /*-- for each เอาเลขที่จดหมายปัจจุบัน--*/
    /* FOR EACH docno_fil USE-INDEX docno01 WHERE LENGTH(STRING(docno_fil.branch)) = 8 
    NO-LOCK BREAK BY docno_fil.startno DESC. -- A58-0246-- */                                            
    FOR EACH docno_fil WHERE  docno_fil.poltyp = n_branch NO-LOCK BREAK BY docno_fil.startno DESC. /*-- A58-0246--*/
            IF SUBSTR(STRING(docno_fil.startno),1,4) = nv_use THEN DO:
...
/*
    FIND LAST docno_fil WHERE docno_fil.branch = STRING(YEAR(n_asdat), "9999") +
              STRING(MONTH(n_asdat), "99") +
              STRING(DAY(n_asdat), "99")
    NO-LOCK NO-ERROR.  /*หาค่ามากที่สุดของเลขที่จดหมาย*/
        ...
        IF FIRST-OF(buffAgtprm.acno) THEN DO:
            ...
            FOR EACH Agtprm_fil USE-INDEX by_acno WHERE (Agtprm_fil.asdat = n_asdat AND       /* +1 ให้กับเลขที่จดหมายจนเท่ากับจำนวน Acno ที่ได้ */
             ...
             IF n_int = 0 THEN DO: /* ถ้า agtprm_fil.poldes = "" แล้วแสดงว่ายังไม่เคยพิมพ์*/
               RUN checkrunning.
               /*IF vMaxdoc > nv_doc1 AND vMaxdoc <> nv_doc1 THEN -- A58-0238--*/
    ...
    FOR EACH buffagtprm WHERE buffagtprm.asdat = n_asdat AND       /* หาจำนวน Acno ทั้งหมดในช่วง*/
        ...
        IF FIRST-OF(buffAgtprm.acno) THEN DO:
            ...
            FOR EACH Agtprm_fil WHERE Agtprm_fil.asdat = n_asdat AND       /* +1 ให้กับเลขที่จดหมายจนเท่ากับจำนวน Acno ที่ได้ */
               ...
               IF SUBSTRING(Agtprm_fil.poldes,36,8) <> "OUSE" AND SUBSTRING(Agtprm_fil.poldes,36,8) <> "" THEN DO:
                   MESSAGE "ไม่สามารถพิมพ์จดหมายได้ เนื่องจาก1" SKIP
                           "มีการพิมพ์จดหมายเตือนเบี้ยประกันภัยค้างชำระแล้ว" SKIP
                           "Leter No : " SUBSTRING(agtprm_fil.poldes,36,4) " / " SUBSTRING(agtprm_fil.poldes,40,4)  SKIP(1)
                           "Producer Code : " vAcnoCount SKIP
               ...
               END.
               ELSE
               IF SUBSTRING(Agtprm_fil.poldes,36,8) = "OUSE" AND SUBSTRING(Agtprm_fil.poldes,36,8) = "" THEN DO:  /* ถ้า agtprm_fil.poldes = "" แล้วแสดงว่ายังไม่เคยพิมพ์*/
                  FIND LAST docno_fil USE-INDEX docno01 WHERE 
                            docno_fil.branch = STRING(YEAR(n_asdat), "9999") + 
                            STRING(MONTH(n_asdat), "99") + 
                            STRING(DAY(n_asdat), "99")   AND
...
DO:
           ASSIGN 
                n_chk = 0
                report-library =  "Wac/wprl/wacnotic.prl"
                report-name  =  "Notic".
           /*---- A58-0172 : RANU ---*/
           ASSIGN 
                nv_pic = nv_a4a_38 .
 ...
 *                                 "rb_n_doc2  = " + STRING(vDoc2, "9999") + CHR(10) +*/
                                  ...
                                  "rb_n_ID = " + STRING(n_User) + CHR(10) +
                                  "rb_n_acno = " + STRING(vAcnoBe) + CHR(10) +
                                  "rb_n_branch = " + STRING(n_branch) + CHR(10) +
                                  "rb_branch = " + STRING(branch) + CHR(10) +
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proDetail C-Win 
PROCEDURE proDetail :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
...
------------------------------------------------------------------------------*/
 FOR EACH AcProc_fil USE-INDEX by_type_asdat WHERE AcProc_fil.asdat = n_asdat NO-LOCK.
     IF acproc_fil.TYPE = "01" THEN
             fidetail = " Process Monthly".
      ELSE 
              fidetail = " Process Daily".
END.
DISP fidetail WITH FRAM frST.
